...
local firnisMillChicken = require("petsystem.pets.1055_firnisMillChicken").petProperties
local gynkeseGuardDog = require("petsystem.pets.1056_gynkeseGuardDog").petProperties
local runewickianMilkCow = require("petsystem.pets.1057_runewickianMilkCow").petProperties
local meadowWoolSheep = require("petsystem.pets.1058_meadowWoolSheep").petProperties
