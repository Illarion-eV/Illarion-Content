...
-- sausage on bread
product = cooking:addProduct(catId, 3631, 1)
product:addIngredient(2, 4) -- flour
...
-- banana bread
product = cooking:addProduct(catId, 3609, 1)
...
-- blackberry muffin
product = cooking:addProduct(catId, 454, 1)
product:addIngredient(2, 3) -- flour
...
-- apple pie
product = cooking:addProduct(catId, 353, 1)
product:addIngredient(2, 4) -- flour
product:addIngredient(2529, 2) -- honeycomb
...
-- cherry cake
product = cooking:addProduct(catId, 303, 1)
product:addIngredient(2, 4) -- flour
...
-- egg salad sandwich
product = cooking:addProduct(catId, 3571, 1)
product:addIngredient(2, 1) -- flour
...
-- strawberry cake
product = cooking:addProduct(catId, 354, 1)
product:addIngredient(2, 4) -- flour
product:addIngredient(2529, 3) -- honeycomb
...
-- nut bread
product = cooking:addProduct(catId, 3723, 1)
product:addIngredient(2, 4) -- flour
product:addIngredient(2529, 3) -- honeycomb
...
-- custard pie
product = cooking:addProduct(catId, 1153, 1)
product:addIngredient(2, 2) -- flour
...
-- elderberry pie
product = cooking:addProduct(catId, 3610, 1)
