...
module("questsystem.information_galmair_1.trigger41", package.seeall)
...
local RADIUS = 1
local LOOKAT_TEXT_DE = "Du findest eine Notiz 'Gefunden, gut! Bringe mir nun einen Schinken. Elesil'"
local LOOKAT_TEXT_EN = "You find a note 'Found, good! Bring me ham now. Elesil'"
