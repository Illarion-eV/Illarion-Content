...
module("questsystem.information_galmair_1.trigger46", package.seeall)
...
local NPC_REPLY_DE = "Findet das Geschichtsbuch von Glamair and liest darin."
local NPC_REPLY_EN = "Find the histroy book of Glamair and read it."
