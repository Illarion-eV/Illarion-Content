...
module("questsystem.information_galmair_1.trigger47", package.seeall)
...
local NPC_REPLY_DE = "Findet das Geschichtsbuch von Galmair and liest darin."
local NPC_REPLY_EN = "Find the histroy book of Galmair and read it."
