...
module("questsystem.information_cadomyr_1.trigger29", package.seeall)
...
local NPC_REPLY_DE = "Welcher von diesen drei magischen Steinen gehört zu uns: Smaragd, Topas oder Blaustein?"
