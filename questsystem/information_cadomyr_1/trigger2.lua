...
module("questsystem.information_cadomyr_1.trigger2", package.seeall)
...
local NPC_REPLY_DE = "Sehr gut, hier nun die n‰chste Aufgabe. Wie heiﬂt die erste Villa gleich links vom Markt?"
