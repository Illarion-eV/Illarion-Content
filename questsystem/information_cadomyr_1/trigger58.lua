...
module("questsystem.information_cadomyr_1.trigger58", package.seeall)
...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Geh zum Zhambra Tempel und finde die Art der Krieger heraus in dem du die Statuen dort betrachtest.", "Go to the temple of Zhambra and figure out the required kind through looking at statues there."):execute()
end
