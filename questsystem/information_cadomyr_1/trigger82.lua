...
module("questsystem.information_cadomyr_1.trigger82", package.seeall)

local QUEST_NUMBER = 641
local PRECONDITION_QUESTSTATE = 26
local POSTCONDITION_QUESTSTATE = 26

local NPC_TRIGGER_DE = "[Ss]maragd|[Ss]aphir"
local NPC_TRIGGER_EN = "[Ee]merald|[Ss]apphire"
local NPC_REPLY_DE = "Falsch! Nächster Versuch. Smaragd, Topas oder Saphir?"
local NPC_REPLY_EN = "Wrong! Try it again. Emerald, Topaz or Sapphire?"
