...
function HANDLER(PLAYER)
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Gehe in die Sir Reginald Gruft und suche nach einer Nummer auf einen Sarg dort. Vergiﬂ nicht die Lampe dort zu verwenden.", "Go to the Sir Reginald Tomb and look for a number at one of the coffins there. Don't forget to use the lamp there."):execute()
