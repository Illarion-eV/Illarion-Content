...
module("questsystem.Sirani.trigger6", package.seeall)
...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Du fühlst eine wohlige Wärme und Liebe  in dir aufsteigen als du den Segen empfängst.", "You feel a comforting warmth and love rising inside you as you receive the blessing."):execute()
end
