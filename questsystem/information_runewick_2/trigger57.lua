...
function HANDLER(PLAYER)
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Geh nun mit den erhaltenen Smaragd, Blaustein und Topas zum Gasthof Hanfschlinge und suche die restliche Person. ", "Go with the received emerald, sapphire and topaz to the Hemp Necktie Inn and look for the remaining person there."):execute()
