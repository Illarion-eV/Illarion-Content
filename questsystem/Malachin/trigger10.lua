...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Malachin nimmt deine Opfergabe an. Sein Segen möge dir, bei Schlacht oder Jagd, Schutz erbringen.", "Malachin accepts your olation. His blessing may protect you during a battle or a hunt. "):execute()
end
