...
module("questsystem.Malachin.trigger1", package.seeall)
...
local LOOKAT_TEXT_EN = "You step closer to the altar, you say a prayer and you consider what olation at  Malachin`s honor you could provide."
