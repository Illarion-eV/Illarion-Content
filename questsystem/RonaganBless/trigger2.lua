...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Für einen Moment siehst du Licht in der Dunkelheit. Du fühlst dich sicher und weißt das du nicht alleine auf dieser Welt.", "For a moment you see  a light in the dark. You feel save and you know you are not alone on this world."):execute()
end
