...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Du fühlst eine wohlige Wärme in dir aufsteigen als du den Segen empfängst.", "You feel a comforting warmth rising inside you as you receive the blessing."):execute()
end
