...
module("questsystem.Irmorom.trigger7", package.seeall)

local QUEST_NUMBER = 10000
local PRECONDITION_QUESTSTATE = 15
local POSTCONDITION_QUESTSTATE = 17

local POSITION = position(213, 232, 1)
local RADIUS = 2
...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Irmorom freut sich über deine Hingabe. Du fühlst innere Kraft und Stärke in dir aufsteigen als du seinen Segen empfängst.", "Irmorom is pleased about your devotion. You feel power and  strength rising inside you as you receive his blessing."):execute()
end
