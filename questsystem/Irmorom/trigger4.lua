...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "Du fühlst eine wohlige Wärme in dir aufsteigen.", "You feel a comforting warmth rising inside you."):execute()
    handler.createplayeritem.createPlayerItem(PLAYER, 310, 990, 1):execute()
end
