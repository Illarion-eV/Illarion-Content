...
function InitTree()
	...
	AddTree({834,843,0},"","The tree bears an engraving ~When we die, we will be brought to a big garden gate. Oldra stands at this gate, welcomes us, and if we have been good, we can enjoy the wonders of the never ending garden, and meet old and new friends in it.~", 2,5); --Oldra's Column
	AddTree({839,850,0},"","The tree bears an engraving ~When we die, we will be brought to a big garden gate. Oldra stands at this gate, welcomes us, and if we have failed, we are allowed a rest, and send back to be reborn with a new name to make a good sense of our life.~", 7,5); --Oldra's Column
	--Snakehead Coast
