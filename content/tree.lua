...
function InitTree()
	...
	AddTree({5,5,0},"Der Schleimige Setzling - Dieser Säumling verbreitet nicht nur einen üblen Geruch, sondern ist auch mit Schleim überzogen, welcher von ihm heruntertropft.","The Glutinous Seedling - This seedling does not only bruits a bad smell but is also covered by slime, which drops down.", 11,0);
	--Gnuremground
