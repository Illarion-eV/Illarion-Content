...
tutorialInformDE["henry"] = "Am Ende des Piers steht ein Mann mit wachsamen Augen und schreibt unermüdlich in sein ledergebundenes Buch. Während er Neuankömmlinge freundlich begrüßt und ihnenen seine Hilfe anbietet, erteilt er strenge Anweisungen an ungeduldige Händler und unhöfliche Matrosen."
...
tutorialInformDE["nimbur"] = "Ein korpulenter Zwerg hält einen Becher in der Hand und probiert fröhlich sein neustes Gebräu. Er scheint einverstanden damit einen Schluck zu teilen; Hände die nach seinem Geheimrezept trachten, können sich allerdings auf einen ordentlichen Hieb mit dem Kochlöffel einstellen."
...
tutorialInformDE["pathway"] = "Ein abgenutzter, mit Gras überwachsener Weg aus Kopfsteinpflaster führt vom geschäftigen Pier, vorbei an einem knisternden Lagerfeuer und einem ruhigen Obstgarten. Der Weg mündet in einen offenen Vorbau eines hochaufragenden Gebäudes."
...
tutorialInformDE["teleporter"] = "Die Luft um das marmorverzierte Pult knistert vor Energie. Auf dem Pult liegt eine vergilbte und abgenutzte Schriftrolle, auf der in ordentlicher Schrift die Zielorte niedergeschrieben wurden."
...
tutorialInformDE["viola"] = "Eine kluge und fleißige Halblingsdame winkt jeden, der verloren aussieht, mit einer fröhlichen Begrüßung zu sich. Aus einem wettergegerbten Koffer voller Pergamente verteilt sie Fahrkarten und führt Neuankömmlinge zu den wartenden Fähren."
...
tutorialInformDE["first encounter"] = "In der Ferne siehst du eine Person, die ihren Geschäften nachgeht. Da du erst vor kurzem angekommen bist, ist es kaum verwunderlich, dass du die Person auch beim Näherkommen nicht erkennst."
...
tutorialInformDE["postSkip"] = "Die Ankunft eines Schiffes sorgt für reges Treiben. Passagiere gehen von Bord und Waren werden an Land geschafft. Im Süden, wo weitere Schiffe beladen werden, ertönen Rufe vom Pier."
...
--Quest 336: Brewery
tutorialTextDE["brewery"] = "Um ein Handwerk auszuführen, muss ein dafür vorgesehenes Werkzeug mit einem passenden statischen Werkzeug zusammen verwendet werden. Die statischen Werkzeuge können am einfachsten in den jeweils dafür spezialisierten Reichen gefunden werden. Jedes Handwerk hat ein entsprechendes Menü, in dem alle Produkte, die dein Charakter aktuell herstellen kann, aufgelistet sind. Wenn du ein Item im Menü anklickst, siehst du ein Bild des Produkts und die zur Herstellung erforderlichen Materialien, sowie die Produktionsdauer. Wenn du deine Fähigkeiten in einem Skill verbesserst, werden dem Menü komplexere Produkte hinzugefügt."
...
tutorialTextDE["campfire"] = "Die Charaktere, denen du in Illarion begegnest, haben alle ihre eigene Persönlichkeit mit ihren jeweiligen Stärken und Schwächen. Sie sind von ihrer Vergangenheit geformt und werden angetrieben von ihren persönlichen Zielen. Interargiere mit ihnen und entdecke ihre Geschichten, während du gleichzeitig deine eigene verfasst. Gemeinsam entscheidet ihr die Zukunft Illarions. Mit jeder Erzählung von epischen Abenteuern oder einfach nur dem Austausch aktuellem Klatsches am Lagerfeuer, wirst du ein Teil ihrer Geschichte, ebenso wie sie Teil deiner Geschichte werden. Egal, ob eure Charaktere in Zukunft Freunde oder Feinde werden, kooperatives Rollenspiel bedeutet, dass wir miteinander und nicht gegeneinander spielen."
...
--Quest 337: Quests
tutorialTextDE["entrance"] = "Unzählige Wegen kreuzen sich am Gasthof zur Hanfschlinge. Reisende, Händler, Abenteuer und Gesetzlose, sie alle haben ihre Gründe vorbeizukommen. Die Taverne und ihre Umgebung bieten Gelegenheit, andere Charaktere zu treffen und ein Leben außerhalb der Reiche zu führen. Dieses neutrale Territorium ist frei von den Auflagen der Stadtverwalter und ihrer Gesetze, aber es fehlen auch der Schutz und die anderen Vorteile, die die Städte mit sich bringen. Einige Gesetzeslose können aus den Reichen verbannt sein, es steht jedoch jedem frei den Gasthof zur Hanfschlinge zu betreten.\n\nViele Quests beginnen in und um diese Taverne. Achte auf GM- oder Spieler-Quests im Illarion Launcher und auf der Website. Zahlreiche statische Quests in ganz Illarion können durch das Sprechen mit NPCs ausgelöst werden. Um deinen aktuellen Stand in den NPC-Quests zu sehen, kannst du das Questlog mit der Taste 'Q' öffnen oder das Schriftrollen-Symbol in der rechten unteren Ecke des Fensters anklicken."
...
--Quest 356: NPCs
tutorialTextDE["henry"] = "In Illarion wirst du vielen Nicht-Spieler-Charakteren (NPCs) begegnen, die Funktionen wie Quests, Dienste und Handel anbieten. Um mit dem Mann zu sprechen, musst du die Chat-Box aktivieren (grün), indem du darauf klickst oder die 'Enter'-Taste verwendest. Gib 'Hallo' ein, um ihn zu begrüßen und drück 'Enter'. Alternativ kannst du NPCs doppelklicken, um grundlegende Gesprächsoptionen zu aktivieren. Alle NPCs reagieren auf bestimmte Schlüsselwörter, wenn du innerhalb von zwei Feldern um sie herum stehst. Wenn du bei der Kommunikation mir einem NPC nicht weiterkommst, kannst du um 'Hilfe' bitten und erhältst eine Liste von empfohlenen Schlüsselwörtern.\n\nBefolge den Rat von Henry Cunnigan um zu lernen wie du dich ausrüsten und wie du Gegenstände benutzen kannst. Wenn du unsicher bist, was du für eine Quest als nächstes tun musst, kannst du das Questprotokoll benutzen, indem du 'Q' drückst oder auf das Schriftrollen-Symbol in der unteren rechten Ecke des Fensters klickst."
...
--Quest 341: Market
tutorialTextDE["market"] = "Auf dem Markt bieten sich an den Ständen zwischen Hafen und Taverne reichlich Möglichkeiten zum Handel. Neben Angeboten für den täglichen Bedarf findest du hier aber auch verschiedene Güter und Dienstleistungen, die in den Reichen sonst nicht so einfach verfügbar sind. NPC Händler werden dir allerdings Preise weit unter dem Wert deiner Waren anbieten. Besser ist es Geschäfte mit anderen Spielern zu machen, die meistens bereit sind fairere Preise zu bezahlen.\n\nDer Zugriff auf die Menüs zum Handel erfolgt durch Ansprechen des jeweilgen NPC unter Nutzung der Schlüsselworte 'Handel', 'Kaufen' oder 'Verkaufen'. Solche Schlüsselwörter sollten in Sätzen verwendet werden, die der Rolle deines Charakters entsprechen. Durch Doppel-Klick auf einen NPC kannst du auch Basis-Optionen für ein Gespräch nutzen, die die persönliche Charakterdarstellung jedoch erheblich begrenzen."
...
--Quest 357: Crafting
tutorialTextDE["nimbur"] = "Illarion hat ein komplexes Handwerkssystem, bei dem Rohstoffe gessamelt und veredelt werden müssen, um anschließend damit zahlreiche Gegenstände herstellen zu können. Diese sind in verschiedene Handwerkskills aufgesteilt. Jedes Reich ist auf verschiedene Handwerke spezialisiert, was bedeutet, dass alle dafür notwendigen Werkzeuge zur Verfügung stehen, Rohstoffe einfach zu erlangen sind und der Verkauf von Waren an örtliche Händler bessere Preise erzielt.\n\nBefolge die Ratschläge von Nimbur Goldbrew, um zu lernen, wie du Rohstoffe sammeln und Gegenstände herstellen kannst. Vielleicht findest du auch noch heraus, wie du dein erstes Monster tötest!"
...
--Quest 354: Fighting
tutorialTextDE["orchard rat"] = "Um anzugreifen, klickst du mit der rechten Maustaste auf das Monster oder du drückst die Taste 'F', um das nähste Monster anzugreifen. Ein roter Ring markiert dein aktuelles Ziel, sowohl bei Monstern als auch bei Charakteren. Sobald ein Monster getötet wurde, können fallengelassene Items gesammelt werden. Dazu kannst du die Taste 'P' drücken oder die Gegenstände einzeln mit der Maus in einen Inventarplatz ziehen. Deine Gesundheit wird durch den roten Balnken in der unteren rechten Ecke des Fensters angezeigt. Wenn dein Charakter getötet wird, können drei Gegenstände aus seiner Tasche fallen. Gegenstände, die der Charakter ausgerüstet hat oder die sich am Gürtel befinden sind davon nicht betroffen."
...
tutorialTextDE["teleporter"] = "Hier am neutralen Gasthof zur Hanfschlinge, sowie vor dem Eingang zu jeder Stadt, gibt es einen Teleporter. Mit einem Doppelklick auf das Pult kannst du sie verwenden und für den Preis von fünf Silbermünzen kannst du in ein anderes Reich reisen. Portalbücher können für zehn Silberstücke gekauft werden und sie öffnen an einer beliebigen Stelle auf der Karte ein Portal, welches dich zu einem bestimmten Teleporter zurückbringt. Im Vorhof der Taverne verkauft Lobely Portalbücher an seinem Stand."
...
--Quest 338: Realms
tutorialTextDE["viola"] = "Sprich mit Viola Baywillow, um mehr über die drei Reiche Illarions zu erfahren. Sie kann auch Auskunft über die Herrscher, Götter, Motive, Handwerke und Landschaften der Reiche geben, um dir dabei zu helfen, dich für das Reich zu entscheiden, das am besten zu dir passt. Aber denk dran, dass Illarion eine dynamische Welt ist und sich zum Beispiel Gesetze und Politik durch den Einfluss von Spielercharakteren schnell ändern können. Mach dir keine Sorgen, wenn du feststellst, dass dein neues Zuhause nicht deinen Wünschen entspricht. Keine Sorge falls dir dein neuen Zuhause nicht gefällt, kannst du jederzeit zu einem späteren Zeitpunkt umziehen oder sogar ein Vogelfreier werden, indem du mit dem Notar deines Reiches sprichst.\n\nWenn du dich für Cadomyr, Galmair oder Runewick entschieden hast, folge der Straße nach Westen zum Hafen und nimm eine Fähre in das Reich deiner Wahl. Diese erste Fahrt ist kostenlos und du erhälst sicheres Geleit ins Stadtzentrum, wo dir das Tutorial weiterhin hilft, dich in deinem neuen Zuhause zurechtzufinden. Wenn du dich noch nicht bereit fühlst, eine Wahl zu treffen, kannst du auch Troll's Haven und alles, was es zu bieten hat, erkunden."
...
tutorialTextDE["wilderness"] = "In Illarion gibt es viel zu entdecken, aber du solltest nicht alleine reisen, weil dieses Land auch viele gefährliche Monster beherrbergt. Auf deinen Reisen solltest du vorsichtig sein, insbesondere, wenn du Höhlen und Dungeons betrittst. Die Karte in der oberen rechten Ecke hilft dir zwar bis zu einem gewissen Grad beim Navigieren, aber du solltest trotzdem immer deine Umgebung im Auge behalten. Schau dir die Wegweiser genau an und sprich mit anderen Charakteren.\n\nWenn du das Tutorial noch nicht abgeschlossen hast, empfehlen wir dir, umzukehren und damit fortzufahren, bevor du dich weiter hinaus wagst. Für jemanden, der neu hier ist, bieten die Reiche einen sicheren Ort. Dort kannst du dich einleben, bevor du die Karte weiter erkundest. Um dir die Wahl deines neuen Zuhauses zu erleichtern, sprich mit Viola Baywillow. Sie kann dir einige Informationen zu den drei verschiedenen Reichen geben."
...
tutorialTextDE["first encounter"] = "Vielleicht möchtest du dich einem anderen Charakter vorstellen oder durch dein Rollenspiel eine andere Aktion vollziehen. Zusätzlich zum normalen Sprechen kann dein Charakter auch schreien oder flüstern (innerhalb von zwei Felden) indem du dem Text #s bzw. #w voranstellst. Mit vorangestelltem #me schickst du einen Emote, mit dem du das Erscheinungsbild deines Charakters oder eine Handlung beschreiben kannst. Mit #o kannst du eine Nachricht OOC (Out Of Character) an einen anderen Spieler schicken. Diese sollten jedoch auf ein Minimum beschränkt werden, um die Spielatmosphäre nicht zu stören.\n\nWenn sich dein Charakter einem anderen vorgestellt hat, kannst du innerhalb von zwei Feldern um den anderen Charakter herum #i verwenden, damit der Namen deines Charakters dem anderen angezeigt werden kann. So kann man dich in Zukunft wiedererkennen. Wenn du mit dem Mauszeiger über einen Charakter fährst, siehst du dessen Namen und Gesundheitszustand. Die Namen von NPCs und Spieler-Charakteren sind gelb, während Monsternamen rot sind."
...
tutorialTextDE["skipYes"] = "Du hast dich entschieden, das Tutorial zu überspringen. Wenn du bereit bist, kannst du ein Boot vom Haupthafen zum Reich deiner Wahl nehmen. Die Straßen von den Häfen können manchmal gefährlich sein, aber da du neu in diesem Land bist, wirst du sicher in die Stadt deiner Wahl eskortiert werden. Viola Baywillow kann dir bei Bedarf weitere Informationen über die drei Reiche Illarions geben. Bist du einem Reich beigetreten, kannst du die Entscheidung jederzeit überdenken und die Zugehörigkeit zu einem späteren Zeitpunkt noch ändern oder sogar ein Gesetzloser werden."
...
tutorialTextDE["welcome"] = "Eine anstrengende Reise neigt sich ihrem Ende zu. Ein neues und spannendes Abenteuer erwartet dich in Illarion. Alle Charaktere denen du in deiner Zeit hier begegnest, sind lebendige Einwohner dieser mysteriösen Welt. Ob du als edler Ritter ruhmreiche Taten vollbringst, das Leben eines fleißigen Handwerkers führst, ein Vermögen als Kaufmann verdienst, als eloquenter Priester Anhänger hinter dir sammelst, mit Zaubereien verblüffst oder aber deinen Lebensunterhalt als hinterhältiger Dieb sicherstellst, es sind deine Taten, die Illarions Zukunft formen.\n\nSchon bald wirst du vor die vielleicht wichtigste Wahl in deinem gesamten Leben gestellt. Zieht es dich zu Ruhm und Ehre nach Cadomyr, willst du in Reichtum und Wohlstand in Galmair leben oder doch eher nach Wissen und Magie in Runewick streben?"
