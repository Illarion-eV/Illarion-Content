...
--Quest 357: Crafting
tutorialTextDE["nimbur"] = "Illarion hat ein komplexes Handwerkssystem, bei dem Rohstoffe gesammelt und veredelt werden, um anschließend damit zahlreiche Gegenstände herzustellen. Diese sind auf verschiedene Handwerksskills verteilt. Jedes Reich ist auf bestimmte Handwerke spezialisiert, was bedeutet, dass dort alle dafür notwendigen Werkzeuge zur Verfügung stehen, Rohstoffe einfach zu erlangen sind und der Verkauf von Waren an örtliche Händler bessere Preise erzielt.\n\nBefolge die Ratschläge von Nimbur Goldbrew, um zu lernen, wie du Rohstoffe sammeln und Gegenstände herstellen kannst. Vielleicht findest du auch noch heraus, wie du dein erstes Monster erlegst!"
