...
tutorialTextDE["teleporter"] = "Hier am neutralen Gasthof zur Hanfschlinge, sowie vor dem Eingang zu jeder Stadt, gibt es einen Teleporter. Mit einem Doppelklick auf das Pult kannst du ihn verwenden und für den Preis von fünf Silbermünzen in ein anderes Reich reisen. Portalbücher können für fünfzig Silberstücke gekauft werden und sie öffnen an einer beliebigen Stelle ein Portal, welches dich zu einem bestimmten Teleporter zurückbringt. Im Vorhof der Taverne verkauft Lobely Portalbücher an seinem Stand."
tutorialTextEN["teleporter"] = "Here at the neutral Hemp Necktie Inn, as well as outside the entrance to each of the towns, there is a teleporter. Double click on the podium to use it and for five silver you will be able to travel to another realm. Portal books can also be bought for fifty silver to use anywhere on the map to transport you to a designated teleporter. Lobely sells portal books from his stall in the tavern forecourt."
...
tutorialTextDE["NewbieTextCadomyr"] = "Herzlichen Glückwunch! Du hast dich für Cadomyr, dem Reich von Ruhm und Ehre, entschieden. Vom Hafen aus wurde dir sicheres Geleit in das Stadtzentrum gewährt. Jemand hat die Notarin bereits von deiner Ankunft unterrichtet, so dass dein Name bereits auf die Einwohnerliste gesetzt wurde. Du hast nun die Gelegenheit Cadomyrs Zukunft mitzugestalten, ganz gleich, ob du danach strebst, geadelt zu werden oder ob es dir genügt, aufrichtig zu dienen."
...
tutorialTextDE["NewbieTaskTextCadomyr"] = "Neu in einer Stadt zu sein, ist niemals einfach. Du kennst weder die Gegend, noch die Leute, und sie kennen dich nicht. Nimm dir etwas Zeit mit anderen Charakteren zu sprechen, um mehr über dein neues Zuhause zu erfahren. Einige NPCs haben ein '!' über ihren Köpfen. Diese NPCs stellen dir Aufgaben. Falls du einmal bei einer Aufgabe nicht weiter weißt , sieh einfach in deinen Questlogs (Q) nach. Beim Erkunden deiner Umgebung werden dir interessante Orte als rote Symbole auf der Karte angezeigt."
...
tutorialTextDE["NewbieTextRunewick"] = "Herzlichen Glückwunsch! Du hast dich für Runewick, dem Reich der Weisheit und der Magie, entschieden. Vom Hafen aus wurde dir sicheres Geleit in das Stadtzentrum gewährt. Jemand hat die Notarin bereits von deiner Ankunft unterrichtet, so dass dein Name bereits auf die Einwohnerliste gesetzt wurde. Es liegt nun auch an dir, die Zukunft Runewicks mitzugestalten. Ganz gleich, ob du in die akademische Elite aufsteigen oder die Felder bestellen möchtest."
...
tutorialTextDE["NewbieTextGalmair"] = "Herzlichen Glückwunsch! Du hast dich für Galmair, das Reich des Wohlstands und des Reichtums, entschieden. Jemand hat den Notar bereits von deiner Ankunft unterrichtet, so dass dein Name bereits auf die Einwohnerliste gesetzt wurde. Egal, ob du daran arbeiten möchtest, deinen Einfluss zu vergrößern, oder ob du dich in der Werkstatt abmühen möchtest, du hast die Möglichkeit Galmairs Zukunft mitzugestalten."
