...
--Quest 357: Crafting
tutorialTextDE["nimbur"] = "Illarion hat ein komplexes Handwerkssystem, bei dem Rohstoffe gesammelt und veredelt werden, um anschließend damit zahlreiche Gegenstände herzustellen. Diese sind auf verschiedene Handwerksskills verteilt. Jedes Reich ist auf bestimmte Handwerke spezialisiert, was bedeutet, dass alle dafür notwendigen Werkzeuge zur Verfügung stehen, Rohstoffe einfach zu erlangen sind und der Verkauf von Waren an örtliche Händler bessere Preise erzielt.\n\nBefolge die Ratschläge von Nimbur Goldbrew, um zu lernen, wie du Rohstoffe sammeln und Gegenstände herstellen kannst. Vielleicht findest du auch noch heraus, wie du dein erstes Monster erlegst!"
...
--Quest 325: Moving
tutorialTextDE["skipNo"] = "Du bist von Bord gegangen und machst nun deine ersten Schritte auf dem Pier. Um dich zu bewegen, klicke mit der linken Maustaste auf ein Feld auf dem Pier. Alternativ kannst du auch den Ziffernblock, die Pfeil-Tasten oder WASD verwenden. Um zu rennen, drücke die STRG-Taste oder klicke auf das Stiefel-Symbol in der unteren rechten Ecke des Spielfensters.\n\nDrücke die F1-Taste, um eine Übersicht über alle Befehle anzuzeigen. Antworten auf häufig gestellte Fragen (FAQ) findest du auf unserer Internetseite www.illarion.org. Außerdem erhälst du jederzeit Hilfe auf unserem Discord-Server unter https://discord.gg/yj3htPN oder in unserem Forum. "
