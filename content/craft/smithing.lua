...
-- magical broadsword         
product = smithing:addProduct(catId, 2654, 97, 100, 175, 351, 1);
...
-- magical dwarven axe        
product = smithing:addProduct(catId, 2662, 98, 100, 177, 354, 1);
...
product:addIngredient(2572); -- Dagger Handle
