...
Product {item = "oilBottle", Ingredient {item = "glassIngot", amount = 2}},
Product {item = "emptyLiquorBottle", Ingredient {item = "glassIngot", amount = 2}},
Product {item = "emptyPotion", Ingredient {item = "glassIngot", amount = 3}}
},

ProductGroup {name = {english = "Glasses", german = "Gläser"},
Product {item = "glassMug", Ingredient {item = "glassIngot", amount = 3}},
...
Product {item = "emptySalveJar", Ingredient {item = "glassIngot", amount = 10}, Ingredient {item = "topazPowder", amount = 1}, Ingredient {item = "amethystPowder", amount = 1}}
}
}
return glassblowing