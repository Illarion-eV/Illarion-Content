...
Product {item = "mortar", Ingredient {item = "clay", amount = 8}},
Product {item = "clayMug", Ingredient {item = "clay", amount = 4}},
Product {item = "clayCup", Ingredient {item = "clay", amount = 8}},
Product {item = "mugWithLid", Ingredient {item = "clay", amount = 10}},
Product {item = "emptyAlchemyBomb", Ingredient {item = "clay", amount = 10}, Ingredient {item = "emeraldPowder", amount = 1}},
Product {item = "vase", Ingredient {item = "clay", amount = 12}, Ingredient {item = "diamondPowder", amount = 2}, Ingredient {item = "rubyPowder", amount = 1}}
}
}
return pottery