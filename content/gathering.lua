...
function InitGathering(DebugUser)
	if(Init == nil) then
		...
		woodchopping:AddSpecialRandomItem(2551,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Findari, die Gï¿½ttin der Luft, mit einem Kleinod aus Reiner Luft.","For your hard and honest labour, Findari, the Godess of Air, awards you with a treasure of Pure Air.", DebugUser); --Pure air
		woodchopping:AddSpecialRandomItem(45,1,333,1,0.005,"Im Unterholz erspï¿½hst du einen grï¿½n funkelnden Gegenstand. Du findest einen magischen Smaragd.","In the undergrowth you spot a green sparkling object. You find a magical emerald.", DebugUser); --Magical emerald
		woodchopping:AddSpecialRandomItem(2441,1,333,0,0.005,"Im Erdboben machst du einen alten, rostigen Helm aus. Ein ï¿½berbleibsel einer lï¿½ngst vergessenen Schlacht?","On the soil you find an old, rusty helmet. A remnant of a long-forgotten battle?"); --Storm cap
		...
		honeygathering:AddSpecialRandomItem(2551,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Findari, die Gï¿½ttin der Luft, mit einem Kleinod aus Reiner Luft.","For your hard and honest labour, Findari, the Godess of Air, awards you with a treasure of Pure Air."); --Pure air
		honeygathering:AddSpecialRandomItem(46,1,333,1,0.005,"Im Inneren des Bienenstocks bemerkst du ein rot glï¿½hendes Licht. Du findest einen magischen Rubin.","Inside the hive, you notice a red light. You find a magical ruby."); --Magical ruby
		...
		farming:AddSpecialRandomItem(2552,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Ushara, die Gï¿½ttin der Erde, mit einem Kleinod aus Reiner Erde.","For your hard and honest labour, Ushara, the Godess of Earth, awards you with a treasure of Pure Earth."); --Pure earth
		farming:AddSpecialRandomItem(46,1,333,1,0.005,"Beim Durchpflï¿½gen des Erdbodens stï¿½ï¿½t du auf einen grï¿½n scheinenden Stein. Du findest einen magischen Smaragd.","While plowing the soil you notice a green shining stone. You find a magical emerald."); --Magical ruby
		...
		farming:AddMonster(111,0.02,"Du stï¿½ï¿½t bei der Erdarbeit auf alte Knochen. Leider hat sie kein Hund hier vergraben und die Stï¿½rung der Totenruhe bleibt nicht ungesï¿½hnt.","While ploughing, you find some old bones. Unfortunately, no dog has buried them here, and the disturbance of the dead will not remain unpunished.",4,7);
		farming:AddSpecialRandomItem(2935,1,333,0,0.05,"Da hat wohl jemand eine Schï¿½ssel verloren, mit der er Saatgut augestreut hat. Nun gehï¿½rt sie dir.","Somebody has lost a bowl, used for seeding. Now it belongs to you."); --soup bowl
		farming:AddSpecialRandomItem(2760,1,333,0,0.1,"Zwischen den Feldfrï¿½chten findest du ein altes Seil. Nï¿½tzlich, oder?","Among the crops you find an old rope. Useful, ain't it?"); --rope

		 
		--fruitgathering

		fruitgathering:AddSpecialRandomItem(2551,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Findari, die Gï¿½ttin der Luft, mit einem Kleinod aus Reiner Luft.","For your hard and honest labour, Findari, the Godess of Air, awards you with a treasure of Pure Air."); --Pure air
		fruitgathering:AddSpecialRandomItem(197,1,333,1,0.005,"Zwischen all den Frï¿½chten siehst du auf einmal ein strahlendes Etwas. Du findest einen magischen Amethyst.","Between all the fruit you suddenly spot a flickering reflection. You find a magical amethyst."); --Magical amethyst
		fruitgathering:AddSpecialRandomItem(65,1,333,0,0.005,"Bei genauer Betrachtung entpuppt sich ein Ast am Boden als Bogen. Ob den ein elfischer Spï¿½her hier deponiert hat?","On closer inspection, a branch on the ground turns out to be bow. Was it disposed by an elven scout here?"); --short bow
		fruitgathering:SetTreasureMap(0.015,"Ein herumliegendes Stï¿½ck Papier scheint sich vorzï¿½glich dazu zu eignen, die Frï¿½chte einzuwickeln. Als du es dir genauer anschaust, erlebst du eine ï¿½berraschungï¿½","A piece of paper, lying around, seems to be specifically suited to wrap the fruits. On closer inspection you experience a surprise...");
		fruitgathering:AddMonster(121,0.02,"Eine Wespe schnellt heran, um dir die sï¿½ï¿½en Frï¿½chte streitig zu machen.","A wasp shoots up to you to dispute the sweet fruit.",4,7);
		fruitgathering:AddSpecialRandomItem(2295,1,333,0,0.05,"ï¿½ber einem Ast hï¿½ngt ein paar alter Handschuhe. Der Besitzer vermisst die offenbahr nicht.","Over a branch hangs a pair of old gloves. The owner does not miss them it would seem."); --cloth gloves
		...
		mining:AddSpecialRandomItem(2552,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Ushara, die Gï¿½ttin der Erde, mit einem Kleinod aus Reiner Erde.","For your hard and honest labour, Ushara, the Godess of Earth, awards you with a treasure of Pure Earth."); --Pure earth
		mining:AddSpecialRandomItem(197,1,333,1,0.005,"Deine Spitzhacke zertrï¿½mmert den Fels und zum Vorschein kommt ein eingeschlossener Edelstein. Du findest einen magischen Amethyst.","Your pickaxe smashes the rock and reveals an enclosed gemstone. You find a magical amethyst."); --Magical amethyst
		mining:AddSpecialRandomItem(310,1,333,0,0.005,"Zwerge scheinen alten Krï¿½gen keine Beachtung beizumessen, insbesondere, wenn sie leer sind. Auch hier liegt einfach einer herum.","Dwarves seem to pay no attention to old pitchers, especially if they are empty. Here, one lies around."); --mug with lid
		...
		mining:AddMonster(301,0.02,"Als du den Fels maltrï¿½tierst, erbebt die Erde und der Stein, den du eben noch mit der Spitzhacke schlugst, erhebt sich...","While you mistreat the rock, the earth shakes and the stone you just struck with a pickaxe rises...",4,7);
		mining:AddSpecialRandomItem(1908,1,333,0,0.05,"Diese Mine wurde offensichtlich kï¿½rzlich von Zwergen aufgesucht. Wie sonst erklï¿½rt sich der Bierkrug, den du zwischen dem Gerï¿½ll findest?","This mine was apparently recently visited by dwarves. How else would you explain the mug, which you find among the rubble?"); --beer mug
		...
		mining:AddInterruptMessage("Du wischst dir den Schweiï¿½ von der Stirn.", "You wipe sweat off your forehead.");
		...
		mining:AddInterruptMessage("Du ï¿½berprï¿½fst kurz die Struktur der Ader, an der du gerade grï¿½bst.", "You interrupt to examine the deposit you are mining at.");
		...
		sanddigging:AddMonster(161,0.02,"Tief im Sand stï¿½ï¿½t du auf etwas schwarzes, krabbelndes. Ein vorschnellender Stachel ist nur der Vorbote dessen, was du gerade erweckt hast.","Deep in the sand you reveal something black, crawling. A darting sting is only the harbinger of what you've just awakened.",4,7);
		...
		claydigging:AddSpecialRandomItem(2554,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Tanora, die Gï¿½ttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water."); --Pure water
		claydigging:AddSpecialRandomItem(283,1,333,1,0.005,"Tief im Matsch stï¿½ï¿½t deine Schaufel auf etwas hartes. Du findest einen magischen Schwarzstein.","Deep in the mud your shovel hits on something hard. You find a magical blackstone."); --Magical blackstone
		...
		claydigging:SetTreasureMap(0.015,"Von einer Lederhï¿½lle umgeben, findest du eine alte Karte. Die hat definitiv niemand absichtlich hier hinterlassen.","Surrounded by a leather cover, you find an old map. It was definitely not left here intentionally.");
		claydigging:AddMonster(341,0.02,"Im Morast stï¿½ï¿½t du auf eine bedauernswerte Moorleiche. Jedoch scheinst du derjenige zu sein, den man fortan betrauern wird.","In the mud you find an deplorable bog body. However, you seem to be the one who will be mourned henceforth.",4,7);
		...
		herbgathering:AddMonster(132,0.02,"Einige Fliegen steigen aus dem Gestrï¿½pp auf, offensichtlich unerfreut ï¿½ber die Stï¿½rung.","Some flies appear from the bushes, apparently displeased about the disturbance.",4,7);
		...
		herbgathering:AddSpecialRandomItem(2570,1,333,0,0.1,"Ein Griff einer alten Sichel liegt achtlos weggeworfen zwischen Blï¿½ttern und ï¿½sten herum.","A handle of an old sickle lies between the leaves and branches, carelessly tossed away."); --Sickle hilt


		--fishing

		--fishing:AddSpecialRandomItem(2554,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Tanora, die Gï¿½ttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water."); --Pure water
		--fishing:AddSpecialRandomItem(284,1,333,1,0.005,"Im Wasser kaum auszumachen, erspï¿½hst du ein blaues Funkeln am Boden des Gewï¿½ssers. Du findest einen magischen Blaustein.","In the water, you spot a barely noticeable blue sparkle at the bottom of the water. You find a magical bluestone."); --Magical bluestone
		--fishing:AddSpecialRandomItem(51,1,333,0,0.005,"Ein Eimer verfï¿½ngt sich in deiner Angelschnur. Den hat hier wohl jemand verloren.","A bucket gets caught in your fishing line. Someone must have lost it here."); --Bucket
		--fishing:SetTreasureMap(0.015,"Statt eines Fisches hast du eine Karte am Haken hï¿½ngen.","Instead of a fish you find a map hanging on your hook.");
		--fishing:AddMonster(101,0.02,"Ein heftiger Ruck reiï¿½t dir fast die Angel aus der Hand. Noch wï¿½hrend du dich wunderst teilt sich das Wasser vor dir und eine glitschige Wasserleiche steigt aus den Wellen empor.","A heavy force pulls on your fishing rod. While you are wondering what it could be, the water in front of you ripples and a slimy mummy climbs out of the water.",4,7);
		--fishing:AddSpecialRandomItem(92,1,333,0,0.05,"Du ziehst eine glitzernde ï¿½llampe aus dem Wasser. Wo die wohl herkommt...?","You pull a sparkling oil lamp out of the water. Where did that come from?"); --Oil lamp
		--fishing:AddSpecialRandomItem(53,1,333,0,0.1,"Ein alter, durchlï¿½cherter Lederstiefel hï¿½ngt am Haken.","An old, perforated leather boot hangs on your hook."); --Leather boots
		
		fishing:AddSpecialRandomItem(2554,1,333,0,10,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Tanora, die Gï¿½ttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water."); --Pure water
		fishing:AddSpecialRandomItem(284,1,333,1,10,"Im Wasser kaum auszumachen, erspï¿½hst du ein blaues Funkeln am Boden des Gewï¿½ssers. Du findest einen magischen Blaustein.","In the water, you spot a barely noticeable blue sparkle at the bottom of the water. You find a magical bluestone."); --Magical bluestone
		fishing:AddSpecialRandomItem(51,1,333,0,10,"Ein Eimer verfï¿½ngt sich in deiner Angelschnur. Den hat hier wohl jemand verloren.","A bucket gets caught in your fishing line. Someone must have lost it here."); --Bucket
		fishing:SetTreasureMap(5,"Statt eines Fisches hast du eine Karte am Haken hï¿½ngen.","Instead of a fish you find a map hanging on your hook.");
		fishing:AddMonster(101,5,"Ein heftiger Ruck reiï¿½t dir fast die Angel aus der Hand. Noch wï¿½hrend du dich wunderst teilt sich das Wasser vor dir und eine glitschige Wasserleiche steigt aus den Wellen empor.","A heavy force pulls on your fishing rod. While you are wondering what it could be, the water in front of you ripples and a slimy mummy climbs out of the water.",4,7);
		fishing:AddSpecialRandomItem(92,1,333,0,10,"Du ziehst eine glitzernde ï¿½llampe aus dem Wasser. Wo die wohl herkommt...?","You pull a sparkling oil lamp out of the water. Where did that come from?"); --Oil lamp
		fishing:AddSpecialRandomItem(53,1,333,0,10,"Ein alter, durchlï¿½cherter Lederstiefel hï¿½ngt am Haken.","An old, perforated leather boot hangs on your hook."); --Leather boots
