...
function InitGathering()
	if(Init == nil) then
		...
		sanddigging:AddInterruptMessage("Das Graben im Sand macht dich sehr durstig und du hälst kurz inne.", "Digging for sand makes you thirsty. You have to take a short break.");
		...
		--fishing:AddSpecialRandomItem(2554,1,333,0,0.005,"Für deine harte und ehrliche Arbeit belohnt dich Tanora, die Göttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water."); --Pure water
		...
		fishing:AddSpecialRandomItem(2554,1,333,0,10,"Für deine harte und ehrliche Arbeit belohnt dich Tanora, die Göttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water."); --Pure water
		fishing:AddSpecialRandomItem(284,1,333,1,10,"Im Wasser kaum auszumachen, erspähst du ein blaues Funkeln am Boden des Gewässers. Du findest einen magischen Blaustein.","In the water, you spot a barely noticeable blue sparkle at the bottom of the water. You find a magical bluestone."); --Magical bluestone
		fishing:AddSpecialRandomItem(51,1,333,0,10,"Ein Eimer verfängt sich in deiner Angelschnur. Den hat hier wohl jemand verloren.","A bucket gets caught in your fishing line. Someone must have lost it here."); --Bucket
		fishing:SetTreasureMap(5,"Statt eines Fisches hast du eine Karte am Haken hängen.","Instead of a fish you find a map hanging on your hook.");
		fishing:AddMonster(101,5,"Ein heftiger Ruck reißt dir fast die Angel aus der Hand. Noch während du dich wunderst teilt sich das Wasser vor dir und eine glitschige Wasserleiche steigt aus den Wellen empor.","A heavy force pulls on your fishing rod. While you are wondering what it could be, the water in front of you ripples and a slimy mummy climbs out of the water.",4,7);
		fishing:AddSpecialRandomItem(92,1,333,0,10,"Du ziehst eine glitzernde Öllampe aus dem Wasser. Wo die wohl herkommt...?","You pull a sparkling oil lamp out of the water. Where did that come from?"); --Oil lamp
		fishing:AddSpecialRandomItem(53,1,333,0,10,"Ein alter, durchlöcherter Lederstiefel hängt am Haken.","An old, perforated leather boot hangs on your hook."); --Leather boots
		...
		potashproducing:SetTreasureMap(0.015,"Fein säuberlich aufgerollt findest du eine Schatzkarte in einem ausgehöhlten Ast. Gut, dass du das Holz noch nicht verbrannt hattest!","You find a treasure map in a hollowed-out branch, neatly rolled up. Luckily you did not burn it!");
