...
function InitGathering()
    if(startGathering == nil) then
        ...
        farming:AddRandomItem(51,1,333,{},prob_frequently,"Da hat wohl jemand eine Eimer verloren, mit der er Saatgut augestreut hat. Nun gehört sie dir.","You dig up an old bucket. Now it belongs to you."); --bucket
