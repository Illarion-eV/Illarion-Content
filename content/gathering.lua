...
function InitGathering()
	if(Init == nil) then
		...
		fruitgathering:SetTreasureMap(0.015,"Ein herumliegendes Stï¿½ck Papier scheint sich vorzï¿½glich dazu zu eignen, die Früchte einzuwickeln. Als du es dir genauer anschaust, erlebst du eine ï¿½berraschungï¿½","A piece of paper, lying around, seems to be specifically suited to wrap the fruits. On closer inspection you experience a surprise...");
		fruitgathering:AddMonster(121,0.02,"Eine Wespe schnellt heran, um dir die sï¿½ï¿½en Früchte streitig zu machen.","A wasp shoots up to you to dispute the sweet fruit.",4,7);
