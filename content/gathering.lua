...
function InitGathering(DebugUser)
	if(Init == nil) then
		...
		woodchopping:AddSpecialRandomItem(2551,1,333,0,0.005,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Findari, die Gï¿½ttin der Luft, mit einem Kleinod aus Reiner Luft.","For your hard and honest labour, Findari, the Godess of Air, awards you with a treasure of Pure Air."); --Pure air
		woodchopping:AddSpecialRandomItem(45,1,333,1,0.005,"Im Unterholz erspï¿½hst du einen grï¿½n funkelnden Gegenstand. Du findest einen magischen Smaragd.","In the undergrowth you spot a green sparkling object. You find a magical emerald."); --Magical emerald
		...
		fishing:AddSpecialRandomItem(2554,1,333,0,10,"Fï¿½r deine harte und ehrliche Arbeit belohnt dich Tanora, die Gï¿½ttin des Wassers, mit einem Kleinod aus Reinem Wasser.","For your hard and honest labour, Tanora, the Godess of Water, awards you with a treasure of Pure Water.", DebugUser); --Pure water
		fishing:AddSpecialRandomItem(284,1,333,1,10,"Im Wasser kaum auszumachen, erspï¿½hst du ein blaues Funkeln am Boden des Gewï¿½ssers. Du findest einen magischen Blaustein.","In the water, you spot a barely noticeable blue sparkle at the bottom of the water. You find a magical bluestone.", DebugUser); --Magical bluestone
