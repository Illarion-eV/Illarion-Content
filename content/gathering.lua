...
function InitGathering()
    if(startGathering == nil) then
        ...
        herbgathering:AddRandomItem(3787,1,333,{},prob_rarely,"Du findest innerhalb der Pflanze verwobene Seide. Vorsichtig gelingt es dir sie zu entfernen.","You find silk interwoven amongst the plant, you carefully remove it."); -- silk
