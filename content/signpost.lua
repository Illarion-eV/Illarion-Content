...
function InitWegweiser()
    ...
    --Norden
    AddWeg({-84,-320,0},"Zur Nordmine - Achtung, Wölfe und Goblins!","To the Northern Mine - Attention, Wulfs and Goblins!",0,0);
    ...
    AddWeg({-115,-110,0},"Zu den Werkstätten","To the Workshops",0,0);
    AddWeg({139,-123,0},"Norden - Die Wüste und ...","North - The Desert and ...",0,0);
    AddWeg({263,-315,0},"Dieses Schild ist kürzlich ausgebessert und übermalt: 'Burg Northerot - Heimstätte diverser Flüche und anderer Entitäten'","This sign is newly repaird & painted over: 'Castle Northerot - home of serval magical curses and other entities'",0,0);
    ...
    --Osten
    AddWeg({204,-195,0},"Dieses Schild zeigt 'Northerot', wurde aber teilweise überschrieben und zeigt nun 'Varshikar'","This sign reads 'Northerot', but has been partially painted over and now reads 'Varshikar'",2,0);
    ...
    AddWeg({-149,-100,0},"Zum Hospital. Läden und Geschäfte im Osten der Stadt","To the Hospital. Shops in the east of the town.",2,0);
    ...
    AddWeg({-465,-471,0},"Besprechungs und Diskussionsräume","Conference and discussion rooms",2,0);
    AddWeg({-472,-484,0},"Böse Spieler gibts hier zu sehen","Mean players you can find here",2,0);
    ...
    --Süden
    AddWeg({-282,44,0},"Zu den Fähren","To the Ferries",4,0);
    ...
    AddWeg({-81,-66,0},"Süden - Die südlichen Wälder. Achtung gefährliche Kreaturen!","South - The southern Forests, Be careful, dangerous creatures!",4,0);
    ...
    AddWeg({-489,-452,0},"Achtung Testgelände! Betreten auf eigene Gefahr!","Danger proving ground! Entry on own risk",4,0);
    AddWeg({348,-38,0},"Hier!","Here!",4,0);

    --Westen
    AddWeg({-407,83,0},"Zum Hospital","To the Hospital",6,0);
    AddWeg({-452,-12,0},"Caelum","Caelum",6,0);
    AddWeg({-82,-280,0},"Zur Nordmine - Achtung, Wölfe und Goblins!","To the northern mine - Attention, wolves and goblins!",6,0);
    AddWeg({-99,-189,0},"Westen - Der Leuchtturm","West - The Lighthouse",6,0);
    AddWeg({-208,-205,0},"Westen - Die Sümpfe, dahinter der Leuchtturm","West - The Swamps, and beyond the Lighthouse",6,0);
    AddWeg({-76,-112,0},"Westen - Zu der Bibiliothek, der Taverne, die Werkstätten & dem Südtor.","West - To the Library, the Tavern, Workshops & Southgate",6,0);
    AddWeg({307,231,0},"Zu den Fähren","To the Ferries",6,0);
    ...
    AddWeg({-466,-471,0},"Bestrafungs und Hinrichtungsräume","Punishment and execution rooms",6,0);
    AddWeg({-478,-484,0},"Böse Spieler die nicht von allein lieb werden wollen, dort hinein.","Mean Players who don't become nice on their own, in there.",6,0);
    AddWeg({-476,-476,0},"Böse Spieler die gar nicht lieb werden wollten.","Mean Players who don't want to become nice.",6,0);
...
--    AddWeg({ -95,-111,0},"Bibliothek von Troll's Bane - Bücherverbrennung immer Samstags","Library of Troll's Bane - Book Burning every Saturday",0,0);
...
--    
    ...
    --Friedhof
    AddGrave({101,33,0},"Hier ruht Charsi. Man sollte nicht alles trinken, was man auf der Straße findet.","Here rests Charsi. Drinking everything youfind on the street is bad.",1,0);
    ...
    --TB Prison
    AddGrave({-107,-139,0},"In Erinnerung an Johnny Lant, einem Verbündeten","Forever remember Johnny Lant, an Ally",1,0);
    ...
    -- Nördlich des Trollwaldes (temporär ~Kadiya )
    ...
    AddGrave({-435,47,0},"Hier liegt Rosy Bottoms. 'Herzallerliebste Schwester, Du wurdest gerächt. ~Dusty Bottoms'.","Here Lies Rosy Bottoms Dearest. 'Sister You have been avenged. ~Dusty Bottoms'",1,0);
    AddGrave({-439,46,0},"Hier liegt Baron Dusty Bottoms vom westlichen Meer, Gründer vom Weiler Greenbriar, Diplomat, Kaufmann und Meisterhandwerker, Treuer Freund zu X und Demonen gleich. Ruhe in Frieden.","Here Lies Baron Dusty Bottoms of the Western Sea, Founder of the 'Hamlet of Greenbriar', Diplomat, Merchant and Master Craftsman, Truest friend to Men and Demons alike. Rest in Peace.",3,0);
    AddGrave({-439,58,0},"Hier liegt Zal'undin, nun und für immer.","Here lies Zal'undin, now and forever.",3,0);
    AddGrave({-435,55,0},"Franz Strohblum, er starb in den Waeldern von Greenbriar als Widerstandskämpfer gegen die Horden des Tempels.","Franz Strohblum, he die in the Forest of Greenbriar as a resistance fighter to the hordes of the temple.",2,0);
    ...
    AddPennant({-41,142,-9},"Der ehrwürdige Herzog von Irundar","The venerable Duke of Irundar",1,0);
    AddPennant({-38,142,-9},"Der ehrwürdige Herzog von Irundar","The venerable Duke of Irundar",1,0);
    ...
    AddPennant({-101,-139,0},"Gefängnis","Prison",1,0); 
    ...
    AddPennant({-95,-100,-3},"Königreich Silberbrand","Kingdom of Silverbrand",2,0); 
    AddPennant({-96,-93,0},"Taverne \"Fluffy Sheep\" - Territorium Silberbrand","Tavern \"Fluffy Sheep\" - Territory of Silverbrand",2,0);
    AddPennant({-69,-106,-3},"Abstieg auf eigene Gefahr! Horror, Erbrechen und Arachnophobie nicht auszuschließen!","The use of downstairs at own risk! Horror, sickness and arachnophobia can not be excluded!",6,0);
    AddPennant({-219,-121,-3},"Abstieg auf eigene Gefahr! Horror, Erbrechen und Arachnophobie nicht auszuschließen!","Use of downstairs at own risk! Horror, sickness and arachnophobia can not be excluded!",6,0);
    AddPennant({-124,-72,-3},"Abstieg auf eigene Gefahr! Horror, Erbrechen und Arachnophobie nicht auszuschließen!","Use of downstairs at own risk! Horror, sickness and arachnophobia can not be excluded!",4,0);
    ...
    --Varshikar--
    AddPennant({240,-394,0},"Achtung, Tote Gräber!","Danger, dead gravediggers inside!",6,0);
    AddPennant({240,-391,0},"Achtung, Tote Gräber!","Danger, dead gravediggers inside!",6,0);
    AddPennant({250,-381,0},"Die Warnung ist ernstgemeint, wirklich!","The warn is serious! Really!",4,0);
    
    --Silverbrand-- 
    AddPennant({119,-195,-3},"Königssaal","Royal Hall",2,0);
    AddPennant({119,-192,-3},"Königssaal","Royal Hall",2,0); 
    ...
    -- Merenium-Mine-- 
    AddPennant({395,147,-10},"Lange, Bleibt draußen!","Longlegs, Stay Outside!",7,0); 
    ...
    AddPennant({-87,-108,0},"Geht in die Taverne, kauft euch ein Bier und hört auf Borgate. Er ist ein weiser Zwerg.","Go into the tavern, buy a beer and listen to Borgate. He is a wise dwarf.",1,0); 
    
    -- Noobia --
    AddPennant({73,40,101},"Oldren Shmagging - Koch und Bäcker","Oldren Shmagging - cook and baker",2,0);
    AddPennant({73,42,101},"Schreiner (zur Zeit im Urlaub)","carpenter (currently on holiday)",2,0);
    AddPennant({73,44,101},"Vandor Serias - Glasbläser","Vandor Serias - glassblower",2,0);
	...
	AddPillar({317, 241, 0},"~ Das primitive Relief einer Person, die an ein Tor, ähnlich dem neben der Säule, klopft und wohl auch rufend um Einlass zu bitten scheint. ~","~ The primitive relief of a person that is knocking on a gate, similar to the one beside the pillar. Also, they seem to be pleading loudly for entrance. ~",1,0);
	...
	AddPillar({317, 236, 0},"~ Die Statue einer gebeugten, alten Frau mit Kleidung und Haaren aus Efeu. Sie lächelt gütig, beinah großzügig. Zudem hält sie eine Miniatur des Magnol-Anwesens in ihren Händen. ~","~ The statue of an old, bent woman with clothes and hair made of ivy. She is smiling gratefully, even almost generously. Additionally she is holding a miniature of the Magnol-house in her hands. ~",2,0);
	AddPillar({314, 236, 0},"~ Die Statue eines Jünglings, fein gekleidet und mit einem sehr freundlichen Lächeln auf den Lippen. Er hat eine Hand ausgesteckt, als wolle er die des Ankömmlings schütteln. ~","~ The statue of a young man, nicely clad and bearing a very friendly smile on his lips. One of his hands is extended as if to shake that of the newcomer. ~",2,0);
	AddPillar({315, 233, 1},"~ Die Statue eines Hünen, dessen Körper fast vollständig in Flammen gehüllt ist. Ein strenger, mahnender Ausdruck ruht in den Zügen seines kantigen Gesichts. ~","~The statue of a giant whose body is almost fully covered in flames. His facial expression and the look in his eyes are strict and warning. ~",2,0);
	AddPillar({317, 233, 1},"~ Die Statue eines schielenden aber lächelnden Greises, der am Stock geht und dessen magerer Körper mit Lumpen eingekleidet ist. Mit seiner Rechten hält er einen Krug hoch und prostet dir zu. ~","~ The statue of a cross-eyed but smiling old man who walks with the help of a stick and whose thin body is clad with rags. With his right hand he is holding up a mug to toast you. ~",2,0);
	AddPillar({312, 232, 2},"~ Das Relief zwei junger Männer, die auf einem Steg stehen und dich, beide mit Reisebündeln beladen, hoffnungsvoll aber auch etwas unsicher ansehen. ~","~ The relief of two young men standing on a landing stage. Loaded with travelling bags they are both looking at you hopefully but also with a certain uncertainty. ~",1,0);
	AddPillar({325, 232, 2},"~ Das Relief einer wunderschönen, kurzhaarigen Elfe, die am Fuße eines Baumes sitzt. Zwischen ihren Knien hält sie eine Harfe und ihre zerbrechlichen Finger streicheln die Saiten. ~","~ The relief of a beautiful, short-haired elfess who is sitting at the bottom of a tree. Between her knees she holds a harp while her delicate fingers stroke the cords. ~",1,0);
	...
	AddPillar({325, 239, 2},"~ Das Relief einer traurigen Szene. Ein junger Holzfäller, sein Beil in der Linken, wird von einem riesigen, umfallenden Apfelbaum, der pralle Früchte trägt, begraben. ~","~ The relief of a tragic scene. A young lumberjack, holding his hatchet in the left hand, is buried beneath a giant, falling apple tree. Its branches bear big, proud fruits. ~",1,0);
	AddPillar({314, 234, 2},"~ Das Relief einer aufgewühlten See, deren hohe Wogen eine Nussschale von Segelboot bedrängen. Es ist eine zusammengekauerte Gestalt an Bord, die ihre Arme um den Mast geschlungen hat. ~","~ The relief of a rough sea pressuring a tiny sailboat. There is a crouching figure on board with her arms wrapped around the mast. ~",1,0);
	AddPillar({323, 234, 2},"~ Das Relief eines gemütlichen Bauernhauses, das von weiten Feldern umgeben ist. Auf diesen kann man einen Mann mit Schlapphut sehen, der eine Vogelscheuche aufstellt. ~","~ The relief of a comfortable farmhouse surrounded by great fields on which you can recognize a man with slouch hat setting up a scarecrow. ~",1,0);
	AddPillar({314, 237, 2},"~ Das Relief zweier Männer, eines Menschen und eines Zwergen. Letzterer steht hinter einem Thresen und poliert Krüge mit einem dreckigen Tuch. Der Mensch hebt einen Krug an seine Lippen. ~","~ The relief of two men, a human and a dwarf. The latter is standing behind a counter and polishes mugs with a dirty piece of cloth. The other man is lifting a mug to his lips, looking dull. ~",1,0);
	AddPillar({323, 237, 2},"~ Das wirklich detailgetreue Relief einer Taube, die einen Ozean überfliegt. Man sieht eine kleine Kapsel, an ihr Bein gebunden, doch sie wird halb verdeckt von einem ihrer ausgestreckten Flügel. ~","~ The really authentic relief of a dove flying across the ocean. You can see a small tin bound to her leg but it is almost hidden by one of her outspread wings. ~",1,0);
	...
	-- Tol Vanima (Magnus Haus) --
	AddChimney({316,233,1},"~ Das Bild einer Gruppe wurde in den Kaminsims geschnitzt, Gnome. Sie sind um einen Tisch versammelt und füllen kleine Flaschen, wobei sie alle irgendwie nervös wirken. ~","~ Carved into the mantelpiece is the image of a group of Gnomes. They are gathered around a table filling small bottles and seem somewhat nervous. ~", 1, 0);
