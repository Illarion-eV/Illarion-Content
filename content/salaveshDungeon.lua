...
-- This script handles the small features of the DragonLair treasure chest in the Salavesh Dungeon.
-- INSERT INTO triggerfields VALUES (691, 388, -3,'content.salaveshDungeon');
-- INSERT INTO triggerfields VALUES (693, 394, -3,'content.salaveshDungeon');
...
M.positionChest = position(693,390,-3)

function M.MoveToField(user)
    if user.pos == pos1stChar or user.pos == pos2ndChar then
