...
function InitGrave()
	...
	AddGrave({106,632,-4},"Nach etwas Zeit erkennst du schließlich eine 18.","After some time you can recognize an 18.", 4,0);
...
--[[    --Elven Ruins
    ...
    --Galmair hinterlands
    AddGrave({408,308,0},"Folgende Zeilen sind mit roter Farbe geschrieben: '10 Peitschenschläge für den Don belügen; 100 Peitschenschläge für den Don betrügen; 1000 Peitschenschläge für den Don bestehlen!'","With red colour the following words are written: '10 whip lashes for lying to the Don; 100 whip lashes for betraying the Don; 1000 whip lashes for stealing from the Don!'", 3,5);--Sport Hole
    --Glittering Cave
	...
	AddGrave({907,803,-3},"Nach etwas Zeit erkennst du schließlich eine 18.","After some time you can recognize an 18.", 4,5); --tomb
	...
	AddGrave({879,759,0},"Zur Erinnerung an all jene Opfer dieser sinnlosen Kampagne zwischen Cadomyr und Galmair in 30 v.VdH. Elara und das Feuer des Triumphes sollen diesen rot-weißen und schwarz-gelben Dummköpfen helfen ihre Kurzsichtigkeit zu überkommen."," In remembrance of all victims of the mindless campaign between Cadomyr and Galmair in 30 BW. Elara and the Fire of Triumph may help those red-white and black-yellow fools to overcome their short sightedness.", 1,5); --Fire of Triumph
	AddGrave({871,757,0},"Zur Erinnerung an all jene die wiederbelebt werden konnten dank unserer in der arkanen Kunst talentierten Einheiten in 31 v.VdH, welche aber nachher wieder niedergemetzelt wurden. Oldra und das Feuer des Triumphes sollen sie behüten.","In remembrance of all those who had been reanimated by our talented arcane art units in 31 BW, but who were slaughtered again afterwards. Oldra and the Fire of Triumph may protect them.", 1,5); --Fire of Triumph
	--[[--Snakehead Coast 
