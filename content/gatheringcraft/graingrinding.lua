...
function StartGathering(User, SourceItem, ltstate)
    ...
    local created = common.CreateItem(User, 2, amount, 333, nil) -- create the new produced items
    ...
    if common.ToolBreaks( User, toolItem, graingrinding:GenWorkTime(User,toolItem) ) then -- damage and possibly break the tool
        common.HighInformNLS(User,
