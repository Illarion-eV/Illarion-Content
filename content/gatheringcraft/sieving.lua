...
function StartGathering(User, SourceItem, ltstate)
    ...
    local sieving = gathering.sieving;
    ...
    local created = common.CreateItem(User, 316, amount, 333, nil) -- create the new produced items
    ...
    if common.GatheringToolBreaks( User, toolItem, sieving:GenWorkTime(User,toolItem) ) then -- damage and possibly break the tool
        common.HighInformNLS(User,
