...
--  end
    ...
    local created = common.CreateItem(User, Stones[WorkOnStone[User.id]].productId, Stones[WorkOnStone[User.id]].amount, 333, nil) -- create the new produced items
    ...
    if common.ToolBreaks( User, toolItem, stonecutting:GenWorkTime(User, toolItem) ) then -- damage and possibly break the tool
        common.HighInformNLS(User,
