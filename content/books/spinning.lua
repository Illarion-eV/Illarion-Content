...
function loadBook(toData)
    ...
    base.books.AddGermanBookText("Lange, weiße, wollene Fäden werden bevorzugt um einen feinen, starken Stoff zu weben, der wesentlich besser gefärbt werden kann.",178,5,toData);
    ...
    base.books.AddGermanBookText("Die Wolle, die sich die meisten leisten können, ist blau und grün und wird von der Mittelklasse getragen.",2679,80,toData);
