...
function loadBook(toData)
    ...
    base.books.AddGermanBookText("Apfelhauch:\n\n Man nehme zwei Batzen Teig und fome daraus erstmal eine Runde Form. Dann schï¿½llt und entkern man die ï¿½pfel, aï¿½erbem muss man sie noch in Stück schneiden. Man nimmt eine der rrunden",353,0,toData); -- ### Apfelkuchen ###
