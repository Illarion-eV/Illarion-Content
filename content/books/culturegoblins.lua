...
function loadBook(toData)
    ...
    base.books.AddGermanBookText("Wir, die Goblins, stehen in einer gewissen Beziehung zu Orks, glaube ich. Sicher, wir sind flinker und gewitzter. Wir haben große Augen, Ohren und Münder. Unser ganzer Körper ist mit einem Kurzhaarfell bedeckt.",0,0,toData);
    base.books.AddGermanBookText("Unser Gesicht weist eine grüne lederartige Haut auf. Man sagt auch, wir besäßen eine Fistelstimme. Ich wurde mal mit einem Säugling verglichen, der heult, weil er seinen Schnuller verloren hat. Was soll's.",0,0,toData);
    base.books.AddGermanBookText("Wir sind etwas klein und nicht gerade sehr stark und leben in lockeren Familienbanden, deren Führung sich untereinander stark unterscheidet. Wir sind nicht böse, nein, aber auch nicht auf den Kopf gefallen und wir mögen keine langweiligen Religionen.",0,0,toData);
    base.books.AddGermanBookText("Man sagt, ich würde mich schrecklich kleiden und manchmal auch muffeln, aber das glaube ich nicht. Auch dass meine Essmanieren schlecht wären, sagt man, und das was ich esse sei nicht schmackhaft - also ich finde es köstlich.",0,0,toData);
    ...
    base.books.AddGermanBookText("Geruch und Geschmack sind bei uns stark ausgeprägt, und wir sind sehr geschickt mit den Händen. Wir geben gute Alchemisten ab oder Handwerker, sogar Diebe. Aber ich bin natürlich keiner, das schwöre ich.",0,0,toData);
    base.books.AddGermanBookText("Wir mögen keine Magie, aber einige von uns haben wohl Talent dazu. Ich habe von diesem weisen <highlor-angurian> zauberer gehört. Wer weiß, vielleicht nur ein Gerücht!",0,0,toData);
    ...
    base.books.AddGermanBookText("Manche von uns, so habe ich gehört, leben in Dörfern in Gynkese oder sogar Salkamaeria. Dort arbeiten sie als Diener, Boten oder Kaufleute. Einige sogar als Alchemisten!",0,0,toData);
end;
