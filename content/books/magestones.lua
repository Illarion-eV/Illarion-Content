...
function loadBook(toData)
    ...
    base.books.AddGermanBookText("Das Umwandeln solcher Steine gelingt nicht immer. Je höher die Qualität ist, die erreicht werden soll, desto größer ist die Gefahr dass der Umwandlungsversuch fehlschlägt.",0,0,toData);
