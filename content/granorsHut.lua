...
function M.readingBook(user)
    ...
    local granorBergenhieb = common.getNpc(position(15, 685, 1), 5, "Granor Bergenhieb")
    granorBergenhieb:talk(Character.say, "#me lacht dreckig auf. 'Sowas passiert, wenn man ungefragt anderer Leute Dinge anfässt. Aber hält ja nur leider 'ne halbe Stunde an...'", "#me laughs maliciously. 'Well, that happens to those who touch other peoples' things without being allowed. Yet, it will only last half an hour...'")
end
