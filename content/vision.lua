...
VisionTextDE[3]={};
VisionTextDE[3][1]="Die Schatten eines Mannes und eines Zwergen erscheinen neben der Werkbank. Beide arbeiten am selben Werkst¸ck. Der Zwerg beschwert sich bei dem Mann: 'So wird das nie etwas. Lass mich dir mal zeigen wie das geht.'";
VisionTextDE[3][2]="Der Mann tritt zur¸ck und sieht dem Zwergen zu, wie dieser seinen Hammer gegen das Werkst¸ck schwingt. 'Siehst du? So musst du das machen', sagt der Zwerg.";
...
VisionTextDE[4][10]="Die Vision der beiden M‰nner verschwindet.";
VisionTextEN[4]={};
...
VisionTextDE[5]={};
VisionTextDE[5][1]="Ein Mann wirkt als w¸rde er schreibend beim Tisch sitzen als er erscheint, w‰hrend ein anderer den Raum betritt. 'Sie sagten mir, du willst mich sprechen. Was ist passiert?'";
VisionTextDE[5][2]="Der Mann am Tisch blickt auf und dreht sich zu dem anderen. 'Wir haben verloren. Ich weiﬂ nicht wie, aber er hat verloren'.";
...
VisionTextDE[6]={};
VisionTextDE[6][1]="Zwei M‰nner erscheinen und sind dabei, die Kammer zu reinigen. Einer fragt den anderen: 'Und er f¸rchtet nicht, dass einer ihn betr¸gen w¸rde?'";
