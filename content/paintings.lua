...
function InitPaintings()
    ...
    AddPicture({91,574,0},"Das Bild zeigt rot-weiß gekleidete Ritter einen von einem offensichtlich mächtigen Ork-Schamanen geführten Ork-Stamm abschlachten. Dies findet in der Nähe eines hohen Berges statt, aus welchen glühendes Wasser herauskommt. Unten rechts steht: 19 AS.","The picture shows red-white dressed knights slaughtering an orc tribe led by an obviously powerful shaman. The action takes place high in a mountain close to where glowing water comes out. At the bottom right is a date: 19 AS.", 4,5); --inn
 ...
 --[[   --Runewick Harbour/Farm
    ...
    AddPicture({949,754,4},"Das Gemälde zeigt ein Panorama einer alten, zerstörten Brücke.","The painting shows the panorama of an old, destroyed bridge.", 4,5)
    AddPicture({949,755,4},"Das Gemälde zeigt einen Magier der einen Feuerball zu dir wirft.","The painting shows a mage, throwing a fireball at you.", 4,5)
