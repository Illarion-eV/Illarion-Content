...
function InitPaintings()
    ...
    AddPicture({129,524,0},"","You see a man is lying in his bed. He seems very sick. A young woman is sitting next to him and is holding one of his hands. He hands her a crown with a shivering hand while she is shimmering in an almost divine sun light. At the bottom right is a date: 22 AS.", 7,0); --palace
