...
function InitPaintings()
    ...
    AddPicture({91,576,0},"","The pictures shows two knights fighting each other with joy. You can also see other people who watching and cheering them. Big red-white banners on the roof of the building are shimmering in the sun. At the bottom right is a date: since 56 BS.", 4,5); --inn
    AddPicture({86,574,0},"","The pictures shows proud and fearless knights walking on red-white adorned ships. Women stay at the shore and waving white towels. There is also a priest on the picture who obviously prays. At the bottom right is a date: 16 BS.", 4,5); --inn
    ...
    AddPicture({96,600,1},"","The pictures shows a small group of red-white dressed knights chasing fearless hundreds of bandits over a big river in a desert. At the bottom right is a date: 109 BS.", 4,5); --building
