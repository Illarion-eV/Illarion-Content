...
function InitPaintings()
    ...
    AddPicture({129,524,0},"","A man is lying in his bed. He seems very sick. A young woman is sitting next to him and is holding one of his hands. He hands her a crown while she is shimmering in an almost divine sun light. At the bottom right is a date: 32 AS.", 7,5); --palace
    --AddPicture({130,518,0},"","", 5,5); --queens room
    --AddPicture({135,516,0},"","", 3,5); --queens room
    --AddPicture({138,516,0},"","", 3,5); --queens room
    AddPicture({117,579,0},"","The picture shows proud knights watching ordinary folk building a palace at the periphery of a desert close at a mountain. One of the knights has a long beard and wears a crown. He holds also a red-white banner. At the bottom right is a date: 16 BS.", 4,5); --taverne
    AddPicture({91,572,0},"","An outnumbered red-white dressed knight raises his sword to counter an attack of hundred black-yellow dressed soldiers. Other thousand of these soldiers lying around. They are probably dead. At the bottom right is a date: 30 AS.", 4,5); --inn
    AddPicture({91,574,0},"","The pictures shows how red-white dressed knights are slaughtering an orc-tribe leaded by an obviously powerful shaman. The action takes place close at a high mountain where glowing water comes out. At the bottom right is a date: 19 AS.", 4,5); --inn
    AddPicture({91,576,0},"","The pictures shows two knights fighting each other with joy. You can also see other people who watching and cheering them. Big red-white banners on the roof of the building are shimmering in the sun. At the bottom right is a date: since 6 AS.", 4,5); --inn
    AddPicture({86,574,0},"","The pictures shows proud and fearless knights walking on red-white adorned ships. Women stay at the shore and waving white towels. There is also a priest on the picture who obviously prays. At the bottom right is a date: 13 BS.", 4,5); --inn
    AddPicture({91,581,1},"","A red-white dressed knight kneels in front of dark-dressed man with a wizard hat. The knights holds his sword triumphing at the throat of the man. Folk of different races are watching and celebrating the knight. At the bottom right is a date: 0 AS.", 4,5); --inn
    AddPicture({85,578,1},"","Knights with swords and red-white banners are slaughtering a dragon who tries to cover them with flames while in the background a group of blue-grey dressed mages running away with a treasure chest. At the bottom right is a date: 15 AS.", 5,5); --inn
    ...
    --Galmair
    AddPicture({313,231,1},"","The painting shows a rich dressed gray skinned and haired man, who is wearing an apron and swings his big golden hammer at an anvil.", 4,5); --Irmoroms Temple
    AddPicture({313,233,1},"","The painting shows a rich dressed gray skinned and haired man, who is wearing an apron and swings his big golden axe against a rock.", 4,5); --Irmoroms Temple
