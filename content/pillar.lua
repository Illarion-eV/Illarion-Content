...
-------------------- Sï¿½ulen/Statuen  ----------------
    ...
    AddPillar({123,547,1},"Eine junge, attraktive Frau blickt entschlossen in die Ferne. Siehält tapfer einen goldenen Schlüssel in ihrer linken und einen goldenen Zepter in ihrer rechten Hand. Ihr majestätisches Kleid trägt einen einhörnigen Löwen auf ihrer Brust.","A young, attractive woman looks resolutely into the distance. She holds a golden key in her left hand and a golden sceptre in her right hand. Her majestic dress bears a single horned lion on the chest.", 2,0); --palace
    AddPillar({120,547,1},"Eine junge, attraktive Frau blickt entschlossen in die Ferne. Siehält tapfer einen goldenen Schlüssel in ihrer linken und einen goldenen Zepter in ihrer rechten Hand. Ihr majestätisches Kleid trägt einen einhörnigen Löwen auf ihrer Brust.","A young, attractive woman looks resolutely into the distance. She holds a golden key in her left hand and a golden sceptre in her right hand. Her majestic dress bears a single horned lion on the chest.", 2,0); --palace
...
--[[    AddPillar({804,549,0},"","", 5, 5);
    ...
    AddPillar({366,253,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '1. Der Don beschützt dich wenn du die Gebühr bezahlst.'","The statue holds a golden plate with following engraving: '1. The Don protects you if you pay the fee.'", 3, 5); --Galmair's Crest
    AddPillar({369,253,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '2. Zahl die Abgaben und die Zinsen, und kein Leid soll dir widerfahren.'","The statue holds a golden plate with following engraving: '2. Pay the toll, and the interest, and no harm will be done.'", 3, 5); --Galmair's Crest
    AddPillar({366,250,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '3. Handle frei, bleibe und gehe wie es dir beliebt.'","The statue holds a golden plate with following engraving: '3. Trade freely, stay and depart as you wish.'", 3, 5); --Galmair's Crest
    AddPillar({369,250,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '4. Komm zum Don wenn du Hilfe benötigst. Er ist dein Pate.'","The statue holds a golden plate with following engraving: '4. Come to the Don if you need help. He is your godfather.'", 3, 5); --Galmair's Crest
    AddPillar({366,247,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '5. Eine Abmachung mit dem Don, ist eine mit deinem Schicksal.'","The statue holds a golden plate with following engraving: '5. A deal with the Don is a deal with your fate.'", 3, 5); --Galmair's Crest
    AddPillar({369,247,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: '6. Hast du Schaden angerichtet, so kompensiere ihn großzügig mit der zweifachen Menge des Schadens.'","The statue holds a golden plate with following engraving: '6. If you did harm, compensate generously, twice the damage.", 3, 5); --Galmair's Crest
    AddPillar({366,244,0},"Die Statue hält eine Goldtafel mit folgender Gravierung: 'Folge diesen sechs einfachen Regeln des Don, und du kannst tun und lassen was immer du möchtest. Nun tritt ein.'","The statue holds a golden plate with following engraving: 'Follow the simple rules of the Don and you can do whatever you like. Come in now.'", 3, 5); --Galmair's Crest
	...
	AddPillar({415,273,-6},"An einer Seite der Säule entdeckst du einen Schlitz, über dem eine silberne Münze eingelassen wurde.", "On one side of the pillar you see a slit with a silver coin inserted above it.",1,0)
