...
-------------------- Sï¿½ulen/Statuen  ----------------
    ...
    AddPillar({132,619,1},"Ein stolzer und mutiger Krieger reitet einen einhörnigen Löwen in einem Angriff. Sein erhobenes, glänzendes Breitschwert spiegelt das Licht.","A proud and brave knight is riding on a single horned lion into an attack. His raised shiny broadsword reflects the light. The big red white banner in his other hand seems to be used as a lance.", 9,0); --
    ...
    AddPillar({129,619,1},"Ein Krieger mit einer scheinenden goldenen Rüstung schwenkt einen weißen Banner mit beiden Händen während er zu schreien scheint.","A knight with a shiny golden armour waves a white banner with both hands while he seems to yell. On the banner are following words written in red: 'In friendship and loyalty'.", 6,0); --
    ...
    AddPillar({120,548,0},"Auf der Säule steht geschrieben: 'Gebaut mit der Tapferkeit von Malachin, der Loyalität von Zhambra, und der Liebe von Sirani'.","At the column is written: 'Build with the braveness of Malachin, the loyalty of Zhambra, and the love of Sirani'.", 11,0); --palace
