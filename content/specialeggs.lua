...
function createSpecialEgg(user, amount)
	...
	user:createItem(eggIds[Random.uniform(1,#eggIds)],amount,333,{nameDe="Buntes Ei",nameEn="Coloured Egg",descriptionDe="Das Ei ist mir verschiedenen bunten Verzierungen versehen worden.",descriptionDe="There are various colourful decoration on the egg.",rareness=ItemLookAt.uncommonItem,specialEgg="true"})
