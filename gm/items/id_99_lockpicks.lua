...
local function resetTutorial(user)
    ...
    local questlist={154,309,310,311,312,313,314,315,319,320,321,322,323,324,325,326,327,328,329,330,331,332,333,336,337,338,339,340,341,344,345,346,347,348,349,353,354}
