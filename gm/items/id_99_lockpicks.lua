	...
	elseif (string.find(User.lastSpokenText,"attributes")~=nil) then
 	...
 	elseif (string.find(User.lastSpokenText,"npc")~=nil) then
        ...
        elseif (string.find(User.lastSpokenText,"crafting"))~=nil then
            User:increaseSkill(Skill.carpentry,Counter-User:getSkill(Skill.carpentry));
            User:increaseSkill(Skill.smithing,Counter-User:getSkill(Skill.smithing));
            User:increaseSkill(Skill.cooking,Counter-User:getSkill(Skill.cooking));
            User:increaseSkill(Skill.fishing,Counter-User:getSkill(Skill.fishing));
            User:increaseSkill(Skill.alchemy,Counter-User:getSkill(Skill.alchemy));
            User:increaseSkill(Skill.gemcutting,Counter-User:getSkill(Skill.gemcutting));
            User:increaseSkill(Skill.glassBlowing,Counter-User:getSkill(Skill.glassBlowing));
            User:increaseSkill(Skill.goldsmithing,Counter-User:getSkill(Skill.goldsmithing));
            User:increaseSkill(Skill.woodcutting,Counter-User:getSkill(Skill.woodcutting));
            User:increaseSkill(Skill.mining,Counter-User:getSkill(Skill.mining));
            User:increaseSkill(Skill.herblore,Counter-User:getSkill(Skill.herblore));
            User:increaseSkill(Skill.tailoring,Counter-User:getSkill(Skill.tailoring));
        ...
        elseif (string.find(User.lastSpokenText,"fighting"))~=nil then
            User:increaseSkill(Skill.concussionWeapons,Counter-User:getSkill(Skill.concussionWeapons));
            User:increaseSkill(Skill.cdistanceWeapons,Counter-User:getSkill(Skill.distanceWeapons));
            User:increaseSkill(Skill.cdodge,Counter-User:getSkill(Skill.dodge));
            User:increaseSkill(Skill.cparry,Counter-User:getSkill(Skill.parry));
            User:increaseSkill(Skill.cpoisoning,Counter-User:getSkill(Skill.poisoning));
            User:increaseSkill(Skill.cpunctureWeapons,Counter-User:getSkill(Skill.punctureWeapons));
            User:increaseSkill(Skill.cslashingWeapons,Counter-User:getSkill(Skill.slashingWeapons));
            User:increaseSkill(Skill.ctactics,Counter-User:getSkill(Skill.tactics));
            User:increaseSkill(Skill.cwrestling,Counter-User:getSkill(Skill.wrestling));
