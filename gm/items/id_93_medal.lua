...
function UseItemWithField(User,SourceItem, TargetPos, Counter, Param)
	...
	elseif (SourceItem.data==6) then --flood
		...
		location[1]=position(TargetPos.pos.x-1,TargetPos.pos.y-1,TargetPos.z);
		location[2]=position(TargetPos.pos.x-1,TargetPos.pos.y,TargetPos.z);
		location[3]=position(TargetPos.pos.x-1,TargetPos.pos.y+1,TargetPos.z);
		location[4]=position(TargetPos.pos.x,TargetPos.pos.y-1,TargetPos.z);
		location[5]=position(TargetPos.pos.x,TargetPos.pos.y,TargetPos.z);
		location[6]=position(TargetPos.pos.x,TargetPos.pos.y+1,TargetPos.z);
		location[7]=position(TargetPos.pos.x+1,TargetPos.pos.y-1,TargetPos.z);
		location[8]=position(TargetPos.pos.x+1,TargetPos.pos.y,TargetPos.z);
		location[9]=position(TargetPos.pos.x+1,TargetPos.pos.y+1,TargetPos.z);
	
		rocks={1246, 915, 1245, 1254, 232, 233, 914, 1265, 1273, 1257, 1276, 1278, 1250, 1251};
	
		for i,table.getn(location) do
	...
	elseif (SourceItem.data==8) then --thunderstorm
		...
		location={}; --Affected positions
		location[1]=position(TargetPos.pos.x-9,TargetPos.pos.y-1,TargetPos.z);
		location[2]=position(TargetPos.pos.x-7,TargetPos.pos.y+7,TargetPos.z);
		location[3]=position(TargetPos.pos.x-5,TargetPos.pos.y+3,TargetPos.z);
		location[4]=position(TargetPos.pos.x-3,TargetPos.pos.y-5,TargetPos.z);
		location[5]=position(TargetPos.pos.x-1,TargetPos.pos.y-1,TargetPos.z);
		location[6]=position(TargetPos.pos.x+2,TargetPos.pos.y+4,TargetPos.z);
		location[7]=position(TargetPos.pos.x+4,TargetPos.pos.y-3,TargetPos.z);
		location[8]=position(TargetPos.pos.x+6,TargetPos.pos.y-8,TargetPos.z);
		location[9]=position(TargetPos.pos.x+8,TargetPos.pos.y+5,TargetPos.z);
		location[10]=position(TargetPos.pos.x+10,TargetPos.pos.y+7,TargetPos.z);
	...
	elseif (SourceItem.data==9) then --meteor shower
		...
		flames[1]=position(TargetPos.pos.x-10,TargetPos.pos.y-2,TargetPos.z);
		flames[2]=position(TargetPos.pos.x-8,TargetPos.pos.y+6,TargetPos.z);
		flames[3]=position(TargetPos.pos.x-6,TargetPos.pos.y+4,TargetPos.z);
		flames[4]=position(TargetPos.pos.x-4,TargetPos.pos.y-7,TargetPos.z);
		flames[5]=position(TargetPos.pos.x-2,TargetPos.pos.y-3,TargetPos.z);
		flames[6]=position(TargetPos.pos.x+1,TargetPos.pos.y+4,TargetPos.z);
		flames[7]=position(TargetPos.pos.x+3,TargetPos.pos.y-5,TargetPos.z);
		flames[8]=position(TargetPos.pos.x+5,TargetPos.pos.y-9,TargetPos.z);
		flames[9]=position(TargetPos.pos.x+7,TargetPos.pos.y+6,TargetPos.z);
		flames[10]=position(TargetPos.pos.x+9,TargetPos.pos.y+8,TargetPos.z);
		
		for i,table.getn(flames) do
