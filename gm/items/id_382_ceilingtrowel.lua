...
function changeItems(User, SourceItem,TargetItem)
  ...
  if (TargetItem and TargetItem.id~=0) then
	...
	User:requestInputDialog(InputDialog("Set an option for the Item", "Possible actions:  setdata <key> <value>, setqual <value>, setwaer <value>, setnumber <value>, field, count <value>" ,false, 255, cbInputDialog))	
  end
 end
