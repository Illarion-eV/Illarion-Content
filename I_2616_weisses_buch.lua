...
-- UPDATE common SET com_script='I_2616_weisses_buch.lua' WHERE com_itemid=2616;
-- UPDATE itemname SET itn_german='weisses Buch', itn_english='white book' WHERE itn_itemid=2616;
require("base.books")
...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
          ...
          if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Weibliche Feen haben bunte Flügel, ähnlich Schmetterlingen. Die Schwingen der männlichen Feen dagegen sind grünlich und durchsichtig.",0,0,0);
            base.books.AddGermanBookText("Unsere Flügel sind kräftig und sie schlagen rasend schnell. Dadurch können wir auch starken Stürmen trotzen. Dennoch sind wir letztlich recht zerbrechlich, was uns nicht gerade zu Kämpfern macht.",0,0,0);
            base.books.AddGermanBookText("Unsere abgeschnittenen oder verstümmelten Gliedmaßen wachsen nach, insbesondere unsere Flügel, die binnen weniger Wochen regenerieren.",0,0,0);
            base.books.AddGermanBookText("Tatsächlich wird erzählt, dass uns einmal ein <count of Albar> bejagd hat und uns die Flügel abschnitt, um sie als Raritäten zu verhökern. Dann jedoch starb er unerwartet an einer seltsamen Verbrennung, die von einer Zauberbrosche ausging.",0,0,0);
            base.books.AddGermanBookText("Für gewöhnlich bevölkern wir Plätze in der freien Natur, hauptsächlich tief in den Wäldern. Wir siedeln gerne in der Nähe von Elben-Niederlassungen, zumal wir gut mit ihnen auskommen.",0,0,0);
            base.books.AddGermanBookText("Feen werden etwa 400 Jahre alt, fast könnten wir es also mit den Elben aufnehmen - aber nur fast. Wir genießen die Gesellschaft unserer Artgenossen und pflegen unsere Lebensart.",0,0,0);
            base.books.AddGermanBookText("Unsere Könige und Königinnen sind stets verheirat, ledige Feen können niemals Herrscher sein. Unsere Adligen haben keinen Landbesitz, weil es unmöglich ist, Ushara's Land zu besitzen.",0,0,0);
            base.books.AddGermanBookText("Wir haben ein besonderes Verhältnis zur Natur, wie die Elben. Wir sind dafür bekannt, bisweilen den Idealen Adrons zu folgen. Und wir verabscheuen alles Unnatürliche, sowie Untote und Dämonen.",0,0,0);
            ...
            base.books.AddGermanBookText("Wir haben gerne unseren Spaß und treiben Schabernack, sind aber schreckhaft. Wir vergessen nie, wie man uns behandelt hat und halten stets Wort.",0,0,0);
            ...
            base.books.AddGermanBookText( "Loyalität; ein Zwerg hinterfragt nicht er handelt. Die Hierarchie wird eingehalten, denn Zwerge lieben die Ordnung. Ordnung bewahrt sie davor allzu viel Denken zu müssen. Denn denken tut weh. ", 0, 0, 1 );
            ...
            base.books.AddGermanBookText( "Dies hat wohl dazu geführt das die Zwerge einen der Ihren zum König gemacht haben. Der sollte dann einfach nur die Richtung angeben, damit klar ist wo draufgehauen wird.", 0, 0, 1 );
            base.books.AddGermanBookText( "Wohl in der Hoffnung das dieser schneller Versteht und schon weiß was richtig ist, nun ja und wenn er es auch nicht weiß, nach der Schlacht beschwert sich eh keiner mehr, weil die Zwerge", 0, 0, 1 );
            base.books.AddGermanBookText( "hatten ihren Spaß und der Rest existiert nicht mehr. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Streitlust, was ist schöner als ein Hammer der auf einem Kopf einschlägt oder ein zünftiges Streitgespräch mit zahllosen Beleidigungen und Schmähungen? ", 0, 0, 1 );
            base.books.AddGermanBookText( "Streiten ist eindeutig eine der Lieblingsbeschäftigung der Zwerge, ganz einfach aus dem Grunde weil sie das gut können. Zwerge pflegen ihre Streitkultur genauso wie ihre Kampfkraft und", 0, 0, 1 );
            base.books.AddGermanBookText( "trainieren sie auch untereinander mit Freude und Vergnügen. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Schmiedekunst und andere Handwerke, ein jeder Zwerg kann schmieden, da dies aber nichts Ungewöhnliches unter den Zwergen ist reden sie meist gar nicht darüber und ", 0, 0, 1 );
            base.books.AddGermanBookText( "erwähnen das Schmieden als Beruf nicht einmal. Ansonsten bleibt zu sagen, dass Zwerge in vielen Handwerken bewandert sind und dort auch meist Qualitäten erreichen wo andere nur", 0, 0, 1 );
            ...
            base.books.AddGermanBookText( "Das wühlen im Gestein um an die Schätze der Mutter zu kommen darf hierbei nicht vergessen werden, immerhin sind sie ein Geschenk der Mutter und das sollte man in Ehren halten und zu Tage fördern. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Was Zwerge über das Kroppzeug mit dem sie sich die Welt teilen müssen denken: ", 0, 0, 1 );
            base.books.AddGermanBookText( "Elfen sind verachtenswerte vollkommen unwürdige und lächerliche Kreaturen, ihre Arroganz und das Getue um Magie und Bäume (Die ja bekanntlich nur zum Tunnel abstützen da sind) ist im besten Falle ", 0, 0, 1 );
            base.books.AddGermanBookText( "lächerlich. Außerdem sind sie einfach dämlich weil sie einfach nicht verstehen das Gold, Reichtum und ein gepflegter Streit das einzig wahre sind. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Echsen vereinen in sich eigentlich alles was Zwerge verachten, Wasser und Fische. Dem Wasser gegenüber haben sie eine tiefliegende Abneigung weil Wasser (gerade in überfluteten Tunneln) ", 0, 0, 1 );
            base.books.AddGermanBookText( "den Tod bedeutet. Diese Viecher sollten im Wasser bleiben wo sie hingehören und unsere Augen nicht mit ihrem Anblick beleidigen. ", 0, 0, 1 );
            ...
            base.books.AddGermanBookText( "Kaum hat man sich kurz umgedreht und kommt nach 60 Jahren wieder einmal vorbei, sind sie gestorben. Am besten schließt man mit ihnen keine Freundschaft denn wenn man ihnen nach einer", 0, 0, 1 );
            base.books.AddGermanBookText( "normalen Zeit von 50 Jahren das Vertrauen schenkt und anfängt sie lieb zu gewinnen kann man sie schon zu Grabe tragen. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Halblinge die kleinen Brüder der Menschen leben auch nicht viel länger. Allerdings kann man mit ihnen feste Feste feiern weil sie Bier und gutes Essen genauso schätzen wie wir. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Ihr Fleiß und ihre Hingabe zum Anbau und zur Zubereitung von Essen kommt der Handwerkskunst der Zwerge nahezu gleich. Sie sind freundliche kleine Kerle, allerdings sollte man sie nicht allzu", 0, 0, 1 );
            base.books.AddGermanBookText( "hart anfassen da Ihnen die Stabilität von unsereins abgeht. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Orks - Orks stinken sie sind Kreaturen Moshrans und damit in Irmoroms Schöpfung nicht vorgesehen. Ihre Existenz ist eine Beleidigung für jeden Gläubigen. ", 0, 0, 1 );
            base.books.AddGermanBookText( "Ferner lehnen sie jedwede Art von Ordnung ab. Ihre Verbände sind unorganisiert und der mangelnde Respekt gegenüber höher Gestellten verhindert das sie auch nur Ansatzweise zum gesellschaftlichen", 0, 0, 1 );
            base.books.AddGermanBookText( "Umgang geeignet sein könnten. Ihre Anführer kommen alleine durch Brutalität nach oben. Weisheit, Alter und Erfahrung spielen bei Ihnen überhaupt keine Rolle.", 0, 0, 1 );
            base.books.AddGermanBookText( "Einige Gedanken über das Zwergendasein einfach mal so: ", 0, 0, 1 );
            base.books.AddGermanBookText( "Was bedeutet es ein Zwerg zu sein? das ist so eine Sache denn stereotypen gibt es bei den Zwergen genauso wenig wie bei Menschen. Es gibt erhebliche Unterschiede und Ausnahmen bestätigen die Regel. ", 0, 0, 1 );
			...
			base.books.AddGermanBookText("Pergament 1:\nAufgewachet, Kronenträger! Aufgewachet Kronenlose!\n\nIhr die ihr nichts weiter seid als bekrönte Halunken und barköpfige Schurken.",0,25,2);
			base.books.AddGermanBookText("Ronagan, der klügste Gott, selbst ist es der Eure Autorität nun in Frage stellt! ",0,25,2);
			base.books.AddGermanBookText("Woher nehmen sich gewöhnliche sterbliche Wesen die Atroganz einen goldenen Reif am Haupt zu tragen und anderen zu befehlen und nach willkührlichen Gesetzten zu richten? ",0,25,2);
			base.books.AddGermanBookText("Wir, die unter Schutze Ronagan stehenden, stehlen Euch den goldenen Reif von der Stirn, auf dass ihr Euch besinnt welch kümmerliche Wesen ihr seid!",0,25,2);
			base.books.AddGermanBookText("Allen anderen steht es nun frei, sich slebst als König zu versuchen, denn wir verkünden, mit diesigem Schreiben, die Versteigerung der goldenen Krone von Schurkin Friedwulfa,",0,25,2);
			base.books.AddGermanBookText("Herrscherin unter Irmoroms Thron, dem Reiche Silberbrand. Sollen die Unwürdigen die schöne Krone tragen und behaupten sie seinen ein Jemand von Wichtigkeit,",0,25,2);
			base.books.AddGermanBookText("von Gottes gnaden erwählt! Ronagan lacht über euch, aber bietet uns dennoch eine stolze Summe die eines Königs würdig ist, per Taube.",0,25,2);
			...
			base.books.AddGermanBookText("Pergament 2:\nAn die barköpfigen Könige der Zwerge unterm Thron des Irmorom.",0,25,2);
			...
			base.books.AddGermanBookText("Der König der Stätte pilgert mit einem stinkenden Kürbis gekröhnt vom Zwergenlande zum Hafen der Insel Gobaith. Begelitet von dem närrischen Gefolge Ihrer Majestät, im Schlafrocke gekleidet. ",0,25,2);
			...
			base.books.AddGermanBookText("Wer die Dummheit bekämpft erntet das Lächeln Ronagans, heißt es. So wollen wir euch im Alternativ lediglich um einen Gefallen bitten, so dass ihr dumm bleibt und wir nicht belächelt werden.",0,25,2);
			...
			base.books.AddGermanBookText("Gronne des Gönigs vom Silberland\n\n Diese Gronne möchten wir gegen die wahre Krone tauschen, uns geschmacklich gemacht von weiteren 47 Münzen in Silber, sowie 74 Münzen in Kupfer. ",0,25,2);
			base.books.AddGermanBookText("So diese, unsere Forderung nicht folge geleistet, packen wir den goldenen Ringe einem Schweine auf die hintere Backe, dass das Vieh alles mit Fäkal besprkenkle! ",0,25,2);
			base.books.AddGermanBookText("Auf das nicht die Backe des Schweines gekröhnt werde, verbleibe\ndas Volk der Schatten,\ndie Kinder Ronagans,\n Rufus der Langfinger\n mit verabscheuendem aber heiteren Gruße.",0,25,2);
			base.books.AddGermanBookText("Pergament 3:\n\nAm Schweinepfuhle saß ich.\nUnbekümmert dem grunzen lauschend. Fraß ich.",0,25,2);
			base.books.AddGermanBookText("Äpfel. Indessen ein Galan zu mir tritt.\nDunkles Haar, weht im flotten Schritt.\nIm schattigen Gewand gehüllt,spricht er, die Stimme von Kraft erfüllt.",0,25,2);
			base.books.AddGermanBookText("Errinere ich dich nun an, was du einst schriebst.\n Es ist auch nicht nötig das du mir die Krone gibst.\nIch nahm sie dir, also du gefressen Frucht.\nManch einem ist Stehlen Sucht. ",0,25,2);
			base.books.AddGermanBookText("Er hebt den Reif. Zu krönen des Schweines Backe.\nDer König der Zwergen ist ja nacke!\n\n\nRufus der Langfinger.",0,25,2);
            --------------------------------------------------
...
function LookAtItem(User,Item)
  if base.books.InitTitle() then
	  ...
	  base.books.AddGermanBookTitle("Buch mit dem Titel \"Barköpfige Könige \"",2);
