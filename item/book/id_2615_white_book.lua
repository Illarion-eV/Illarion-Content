...
function UseItem(User, SourceItem, TargetItem, Counter, Param) 
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then 
          ...
          if base.books.InitBook() then 
             ...
             base.books.AddGermanBookText("lï¿½chelte selbstsicher. Natï¿½rlich würde er die Kugel für sich behalten und einen tollen Preis dafür erhalten. Damit kï¿½nnte er sich dann so einige Wï¿½nsche erfï¿½llen, und natürlich nochmehr Reichtum",0,50,1); 
...
--             base.books.AddEnglishBookText("robbed and then killed; probably from his own kind.\n \nThe old man was never seen again.",0,50,1); 
             ...
             base.books.AddGermanBookText("nicht an, und halt bloss dein Maul!\" sagte der Einsame barsch. Dann sah man plï¿½tzlich eine kaum wahrnehmbares Bewegung in den Beinen des Alten. Er lehnte sich zurück und setzte sich endlich neben den",0,50,2); 
             ...
             base.books.AddGermanBookText("Und ï¿½berall sind die Menschen gleich, Reiche und Arme! Sie nehmen, was sie kriegen können und sind gierig und aggressiv. Und keine der großen Stï¿½dte der Menschen, sei sie noch so berï¿½hmt, hat sich",0,50,2); 
             ...
             base.books.AddGermanBookText("schien sich etwas beruhigt zu haben. Er sprach erneut: \"Soso, und deswegen habt ihr wohl auch keinen Arm, hm? Dieben schlï¿½gt man den Arm ab, damit sie nichtmehr stehlen können\". Dann plï¿½tzlich",0,50,3); 
			...
			base.books.AddGermanBookText("Brewyn zog mutlos zurück zu seinem Haus in dem Hï¿½gel,\n Annie hatte Recht, für den Winter blieb ihnen kein einziger Krï¿½mel.\n",0,5,7);
