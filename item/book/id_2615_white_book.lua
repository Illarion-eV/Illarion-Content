...
function UseItem(User, SourceItem, TargetItem, Counter, Param) 
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then 
          ...
          if base.books.InitBook() then 
             ...
             base.books.AddGermanBookText("wï¿½rde versuchen, seine Scham zu verbergen, dass er in einem solch jï¿½mmerlichen Zustand war: seine Kleidung war alt, und sie stank. Bis auf die schmutzige Augenbinde, war nicht viel von seiner Mimik",0,50,0); 
             ...
             base.books.AddGermanBookText("auszuweichen, ging er geradewegs in die Masse von Leuten herein. Im nï¿½chsten Augenblick wurde er auch schon unsanft zurï¿½ckgestoï¿½en und landete hart auf dem Boden.\n \"Verzieh dich, du Penner! Was",0,50,0); 
             ...
             base.books.AddGermanBookText("auf seine Krï¿½cke und ganz plï¿½tzlich sah man ein Lï¿½cheln auf seinen Lippen. \"Aber, aber, mein werter Herr. Seid nicht zornig, bitte nicht! Ich habe hier eben diesen goldenen Ring gefunden, und ihr",0,50,0); 
             ...
             base.books.AddGermanBookText("finden wï¿½rde, denn just als es ihm gelang, den Ring mit einem gewaltsamen Ruck abzuziehen, hatte er keinen Ring mehr in der Hand, sondern eine lebensechte goldene Schlange, die zu wachsen schien.",0,50,0); 
             ...
             base.books.AddGermanBookText("noch einer und so weiter. Es mag für Menschen aus anderen Gefilden merkwï¿½rdig sein, diese ziemlich lange Karawane von Karren zu sehen, aber scheinbar war dies einer der grï¿½ï¿½ten Hï¿½ndler für Waren",0,50,1); 
             ...
             base.books.AddGermanBookText("im Weg stand, so wurde er einfach ï¿½berrollt - Hier galt ganz klar sein Recht, und wenn Er hier fuhr, dann hatten alle anderen von \"seiner\" Straï¿½e zu gehen. So war das nunmal, und dabei wï¿½rde es auch",0,50,1); 
             base.books.AddGermanBookText("bleiben, wï¿½re da nicht plï¿½tzlich dieser alte blinde Mann am Straï¿½enrand, der lautstark seinen Namen rief und mit einem Arm winkte. Es kï¿½mmerte ihn nicht sonderlich, schlieï¿½lich war er eine sehr",0,50,1); 
             ...
             base.books.AddGermanBookText("lï¿½chelte selbstsicher. Natï¿½rlich wï¿½rde er die Kugel für sich behalten und einen tollen Preis dafür erhalten. Damit kï¿½nnte er sich dann so einige Wï¿½nsche erfï¿½llen, und natürlich nochmehr Reichtum",0,50,1); 
             ...
             base.books.AddGermanBookText("furchtbar schwer, aber seine Gier war so groß, dass er sie mit aller Kraft hochzog und zu seinem Karren brachte. Es kam ihm vor, als wï¿½rde sie immer schwerer und schlieï¿½lich musste er sie",0,50,1); 
...
--             base.books.AddEnglishBookText("robbed and then killed; probably from his own kind.\n \nThe old man was never seen again.",0,50,1); 
             ...
             base.books.AddGermanBookText("alter, blinder Tattergreis setzte sich neben ihn und grï¿½ï¿½te ihn freundlich. \"Hallo, mein Freund, darf ich mich zu dir setzen?\" sprach er besonnen und lï¿½chelte freundlich. Der Einsame blickte",0,50,2); 
             ...
             base.books.AddGermanBookText("Anstatt sich hinzusetzen, blieb der Blinde jedoch stehen und richtete seinen Kopf auf den Einsamen. Er stierte ihn so intensiv an, dass man annehmen kï¿½nnte, er hï¿½tte tatsï¿½chlich Augen unter der Binde,",0,50,2); 
             ...
             base.books.AddGermanBookText("nicht an, und halt bloss dein Maul!\" sagte der Einsame barsch. Dann sah man plï¿½tzlich eine kaum wahrnehmbares Bewegung in den Beinen des Alten. Er lehnte sich zurï¿½ck und setzte sich endlich neben den",0,50,2); 
             base.books.AddGermanBookText("Einsamen. Mit einer Hand streifte er sich ï¿½ber den Bart, zog etwas daran, als wï¿½rde er nachdenken und schaute mit abwesendem Blick in die etwas ferner gelegenen Straï¿½en. Nun find der Alte an zu",0,50,2); 
             ...
             base.books.AddGermanBookText("Und ï¿½berall sind die Menschen gleich, Reiche und Arme! Sie nehmen, was sie kriegen kï¿½nnen und sind gierig und aggressiv. Und keine der großen Stï¿½dte der Menschen, sei sie noch so berï¿½hmt, hat sich",0,50,2); 
             ...
             base.books.AddGermanBookText("Vielleicht ist es ein Test an euch, das sage ich euch ganz offen! Auch euch mï¿½chte ich prï¿½fen! Noch habe ich die Hoffnung in die Menschen nicht verloren!\" sagte er dann und lï¿½chelte etwas. In dem",0,50,2); 
             ...
             base.books.AddGermanBookText("Niemehr? Vielleicht doch, aber kann man das nicht sicher sagen, weil nie groß darï¿½ber erzï¿½hlt wurde. Es gab einen dunklen Wald, fernab von jeder Zivilisation. Sowohl Tags, als auch Nachts war es",0,50,3); 
             ...
             base.books.AddGermanBookText("Oder eben andere, die anfingen zu kï¿½mpfen. Der Alte schien unbeeindruckt, und anstatt sich irgendwie zu bewegen fing er plï¿½tzlich an zu reden: \"Was ist mit eurem Arm passiert? Wieso ï¿½berfï¿½llt ein",0,50,3); 
             ...
             base.books.AddGermanBookText("hï¿½tte er eine Rechtfertigung für einen Diebstahl! \"Ja, du hast richtig gehï¿½rt, ich bin ein Dieb, aber anders wï¿½rde ich sterben, und ich stehe dazu!\" sprudelte es nur so aus seinem Mund. Der Alte",0,50,3); 
             base.books.AddGermanBookText("schien sich etwas beruhigt zu haben. Er sprach erneut: \"Soso, und deswegen habt ihr wohl auch keinen Arm, hm? Dieben schlï¿½gt man den Arm ab, damit sie nichtmehr stehlen kï¿½nnen\". Dann plï¿½tzlich",0,50,3); 
             ...
             base.books.AddGermanBookText("gerecht und ihr schï¿½mt euch für eure Taten, das sehe ich euch doch an!\" sagte er dann mit langsamen Worten und lï¿½chelte immernoch. \"Die Gï¿½tter wï¿½rden euch sicher eine zweite Chance gewï¿½hren, doch",0,50,3); 
             ...
             base.books.AddGermanBookText("nicht lï¿½sen. Doch plï¿½tzlich verbleichte der Sand und wurde zu schmutziger Erde, die durch seine Finger auf den Boden rieselte und verschwand. Ein kalter Wind fuhr durch den Wald und blies ihm die",0,50,3); 
             ...
             base.books.AddGermanBookText("packte er sich an den Kopf, als wolle er ï¿½berprï¿½fen, ob er Fieber oder irgendeine schlimme Krankheit hï¿½tte. Umso grï¿½ï¿½er war der Schock, als er merkte, dass er sich mit der vï¿½llig falschen Hand ï¿½ber",0,50,3); 
            ...
            base.books.AddGermanBookText( " Somit soll nun und heute verkï¿½ndet sein, welche Zwerge des Weiteren in Amt und Wï¿½rden gestellt seien. ", 0, 0, 4 );
			...
			base.books.AddGermanBookText("Brewyn zog mutlos zurï¿½ck zu seinem Haus in dem Hï¿½gel,\n Annie hatte Recht, für den Winter blieb ihnen kein einziger Krï¿½mel.\n",0,5,7);
			base.books.AddGermanBookText("Zurï¿½ck sich der Lï¿½gner in seinen Sessel verzog,\n der Bedauernswerte sich und seine Füße mit Komfort und falscher Sicherheit belog.\n \n",0,5,7);
