...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("indem sie sich für eine Woche in die Wï¿½lder der Umgebung zurückziehen und dort in selbst gebauten Erdhï¿½hlen ï¿½bernachten. In dieser Woche ernï¿½hren sie sich ausschlieï¿½lich von den Frï¿½chten der Wï¿½lder.",0,15,0);
            ...
            base.books.AddGermanBookText( " Doch nicht alle Götter waren an den steinernen Knochen interessiert, Moshran schuf Wesen aus Chitin und fï¿½llte sie mit Nargï¿½n's Nasenschleim, welchen er ihm ", 0, 0, 3 );   
			...
			base.books.AddGermanBookText("5. HALTET WORT\nGebt kein Wort, das ihr nicht halten kï¿½nnt und haltet, was ihr sagt. Nur im Konfliktfall um eurer oder der Gilde Ehre, bittet darum, euer Wort zurücknehmen zu dï¿½rfen. Dies sei Ehre",0,0,5);
