...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("~Das Lichterfest~\n Wird von allen Vï¿½lkern zu Beginn eines neuen Jahres gefeiert. Dabei werden in den Dï¿½rfern und Stï¿½dten große Lagerfeuer entfacht und die Hï¿½user mit Lampen und Laternen geschmï¿½ckt.",0,15,0);
            ...
            base.books.AddGermanBookText("sondern eher ein Ausdruck der offenen Zuneigung. Doch gibt es auch hier sehr große lokale Unterschiede. Und was in dem einen Dorf als angemessen und sittsam erscheint, mag anderswo als tï¿½dliche",0,15,0);
            ...
            base.books.AddGermanBookText("Eltern arrangiert werden und den Kindern kein Mitspracherecht eingerï¿½umt wird. So ist es auch nicht unï¿½blich, dass sich das Paar zum ersten Mal am Fest der Bindung kennen lernt. Im Vorfeld der Feier",0,15,0);
            ...
            base.books.AddGermanBookText("So soll es den Charakter und die Dauerhaftigkeit der Verbindung reprï¿½sentieren und wurde daher ï¿½ber dem gemeinsamen Bett aufgehï¿½ngt.\n \n~Das Erdhï¿½hlenfest~\n Gedenktag der Hablinge in der letzten",0,15,0);
            ...
            base.books.AddGermanBookText("indem sie sich für eine Woche in die Wï¿½lder der Umgebung zurï¿½ckziehen und dort in selbst gebauten Erdhï¿½hlen ï¿½bernachten. In dieser Woche ernï¿½hren sie sich ausschlieï¿½lich von den Frï¿½chten der Wï¿½lder.",0,15,0);
            ...
            base.books.AddGermanBookText("ihrer Heimat sich den Feierlichkeiten anschlieï¿½en. Die Priester Oldras setzen den Tag im Monat Olos fest, welcher nach ihrer Meinung von der Gunst der Gï¿½ttin bedacht ist, doch man mag auch behaupten,",0,15,0);
            ...
            base.books.AddGermanBookText("Jene, die Moshran verehren, begrï¿½ï¿½en den Monat Mas mit Freude und Ehrerbietung. Sie geben sich gï¿½nzlich der Ekstase hin und feiern diese Tage wild und ungestï¿½m. Nur wenig ist bekannt von diesen",0,15,0);
            base.books.AddGermanBookText("Feiern, doch wird erzï¿½hlt, dass sich die Orks mit roter Farbe den Kï¿½rper bemalen und um große Scheiterhaufen herum tanzen. Nach einiger Zeit verfallen sie in eine Art Raserei, bei der es hï¿½ufig zu",0,15,0);
            ...
            base.books.AddGermanBookText("des eigenen Stammes, die sich freiwillig dem Opfertod hingeben. Die Orks glauben, dass dieser Tod die grï¿½ï¿½te Ehre ist, die einem Krieger zuteil werden kann und dass ein so Verstorbener mit dem Segen",0,15,0);
            base.books.AddGermanBookText("und der Gunst Moshrans in einem starken Kï¿½rper wiedergeboren wird.\n Fï¿½r den anderen Teil der Orks, welche sich von Moshran losgesagt haben, sind es Tage der Trauer und Verzweiflung. Sie gedenken",0,15,0);
            ...
            base.books.AddGermanBookText("wï¿½rde. Unter dem Deckmantel in Verhandlungen mit ihm zu treten, lockten sie ihn in eine Falle und ermordeten ihn. Der junge Staat zerbrach daraufhin und die Umstï¿½nde brachten viel Leid ï¿½ber die Orks.",0,15,0);
            ...
            base.books.AddGermanBookText("seinen Meuchelmï¿½rdern gekï¿½pft wurde und ihm die Hï¿½nde abgeschlagen wurden: als Zeichen, dass die Orks fï¿½hrer- und machtlos seien. Mit ihren blutï¿½berstrï¿½mten Gesichtern stimmen sie Klagelieder an,",0,15,0);
            ...
            base.books.AddGermanBookText("Echsenmenschen sind eine erstaunliche Rasse. Sie sind etwas grï¿½ï¿½er als ein durchnittlicher Mensch und laufen aufrecht auf zwei Beinen, wobei ihnen der krï¿½ftige Schwanz zusï¿½tzliche Trittsicherheit gibt.",0,0,1);
            ...
            base.books.AddGermanBookText("Sie haben auch die Fï¿½higkeit, unter Wasser zu atmen. Dies sei, so meinen Einige, auf ihre Gottheit zurï¿½ckzufï¿½hren, auf Tanora oder 'Zelphia', wie die Echsenmenschen sie nennen.",0,0,1);
            ...
            base.books.AddGermanBookText("Aus der Ferne mï¿½gen diese Gebï¿½ude globig, wie große grobe Steine wirken. Aus der Nï¿½he jedoch kï¿½nnte man zahlreiche komplexe, in Stein gemeiselte Symbole feststellen.",0,0,1);
            ...
            base.books.AddGermanBookText("Auf diese Weise kï¿½nnen Echsenmenschen Hunderte von Jahren ï¿½berdauern. Von einigen sagt man, sie seien mit einem Heiligenschein um die Augen aufgewacht und davongelaufen, ohne dass man sie je wiedergesehen habe.",0,0,1);
            ...
            base.books.AddGermanBookText("Laut einer Legende gibt es einen Kï¿½nig der Echsenmenschen, auch 'Ushnak-Sskhath' genannt. Er haust in einem entfernten Tempel im tiefsten Teil des Meeres.",0,0,1);
            ...
            base.books.AddGermanBookText("Echsenmenschen erzählen ihrem Nachwuchs, dass der Lizard-Kï¿½nig, wenn sie nicht artig sind, kï¿½me, um sie in ihren Trï¿½umen heimzusuchen. Niemand hat je den Echsen-Kï¿½nig gesehen, aber viele junge Echsenmenschen machen sich auf, ihn zu finden.",0,0,1);
            base.books.AddGermanBookText("Echsen-Krieger sind meist \"Jï¿½ger der Tempelwache\", eine Art Paladin. Sie wachen ï¿½ber den Tempeleingang und die Priesterschaft, halten Recht und Gesetz aufrecht und bekï¿½mpfen das Bï¿½se und die Bestechlichkeit.",0,0,1);
            ...
            base.books.AddGermanBookText("'Ruhm und Ehre der Gï¿½ttin' ist ihr Wahlspruch mit dem sie dem ï¿½beltï¿½ter ans Leder gehen.",0,0,1);
            ...
            base.books.AddGermanBookText("Fang'n wa mal kleen an. Dat Wichtiste fï¿½r'n Kriejer iss watt'n Kriejer anhat. Weil wenn'n Kriejer 'n schwere Rï¿½stung trï¿½gt, dann wirder langsam und kann`n Schlï¿½gen vonne Jegner nich' ausweichen, klar?",2617,0,2); 
            ...
            base.books.AddGermanBookText("Also, gute Krieger untersuchen ihre Rï¿½stung uff Schwachstellen und Vorzï¿½ge! Macht viele Tests mit schwachen Ungeheuern und findet heraus, welche Rï¿½stung zu euch passt. Hilft, am Leben zu bleiben.",2617,0,2); 
            ...
            base.books.AddGermanBookText("Als Erstes: Passt auf Euern Arsch auf! Wenn der Verreckling dir erstmal im Nacken sitzt, dann isses schnell aus mit der Herrlichkeit und du hï¿½rst die Gï¿½tter singen.",2617,0,2); 
            ...
            base.books.AddEnglishBookText( " But not every god was interrested in the stone-bones. Moshran formed creatures out of chitin, filling their bodies with Nargï¿½n's nasal mucus, which he had stolen from him, when Nargï¿½n had a cold. ", 0, 0, 3 );
            ...
            base.books.AddGermanBookText( " Doch selbst nahdem er so viel Zeit mit der Gestaltung des Felsens verbracht hatte, schien es ihm immernoch wie ein Fels und er beschloï¿½ die anderen Gï¿½tter um ihre Mithilfe zu bitten.  ", 0, 0, 3 );   
            ...
            base.books.AddGermanBookText( " Da wurde den Gï¿½ttern bewusst was für ein Kunstwerk sie geschaffen hatten, nun da sie es sehen konnten, und auf einmal gab es nur noch ein Gesprï¿½chsthema auf dem Berg des Ursprungs.  ", 0, 0, 3 );   
            base.books.AddGermanBookText( " Wild durcheinander und mit kindlicher Begeisterung schufen die verschiedensten Gï¿½tter die verschiedensten Pflanzen und Lebewesen auf Illarion.", 0, 0, 3 );
            ...
            base.books.AddGermanBookText( " verschiedensten Tieren und Pflanzen gewachsen. Da wurden die anderen Gï¿½tter neugierig und baten Irmorom ebenfalls um steinerne Knochen, auf das auch sie stabile Lebewesen schaffen kï¿½nnten. ", 0, 0, 3 );
            base.books.AddGermanBookText( " Doch nicht alle Gï¿½tter waren an den steinernen Knochen interessiert, Moshran schuf Wesen aus Chitin und fï¿½llte sie mit Nargï¿½n's Nasenschleim, welchen er ihm ", 0, 0, 3 );   
            ...
            base.books.AddGermanBookText( " An sich war dies noch nicht einmal so grausam wie es andere Rassen unter ihren Gï¿½ttern ereilte, doch war es jenen untersagt unter der Erde zu leben und sie fristeten ihr dasein ", 0, 0, 3 );   
            ...
            base.books.AddGermanBookText( " Cherga an den richtigen Ort geleitet werden wenn das Ende naht, denn ansonsten wï¿½rden sie auch nie wieder ihre Ahnen treffen die in den großen Hallen des Borag - Urubur Irmoroms Gï¿½ste sind.", 0, 0, 3 );
			...
			base.books.AddGermanBookText("Vermï¿½chtnis der Evergreen Halblinge, die Insel Briar und den Weiler Greenbriar selbst, wieder zu einem Ort zu machen, an dem die kleinen Leute lachen, spielen und ï¿½ber sich selbst bestimmen dï¿½rfen.",0,0, 4);
			...
			base.books.AddGermanBookText("andere Aufgaben kï¿½nnen von diesem selbst versehen, oder durch diesen an andere Halblinge ï¿½bertragen werden.\nDie Entscheidungen des Familienoberhauptes, der als einziger von Oldra's Weisheitsapfel",0,0, 4);
			...
			base.books.AddGermanBookText("- Nutzungsrechte an Gebï¿½uden kï¿½nnen sowohl von Sippenmitgliedern als auch Ehrenbï¿½rgern gemietet, gepachtet oder ihnen verliehen werden.\nï¿½ber die Verleihung entscheidet das Familienoberhaupt.",0,0, 4);
			...
			base.books.AddGermanBookText("- Verdiente Halblinge, die sich um den Weiler bemï¿½ht haben, kï¿½nnen mit dem Titel \"Ehrenwerter Halbling\" bedacht werden.\nVerdienten Nicht-Halblingen kann der Titel \"Freund der Halblinge\" verliehen",0,0, 4);
			...
			base.books.AddGermanBookText("Sie sind mit dieser Ehrenbï¿½rgerschaft aller politischen Verpflichtungen entbunden, und dï¿½rfen weiterhin die Ruhe und den Frieden des Weilers ungestï¿½rt genieï¿½en, wenn sie sich nett benehmen.",0,0, 4);
			...
			base.books.AddGermanBookText("5. HALTET WORT\nGebt kein Wort, das ihr nicht halten kï¿½nnt und haltet, was ihr sagt. Nur im Konfliktfall um eurer oder der Gilde Ehre, bittet darum, euer Wort zurï¿½cknehmen zu dï¿½rfen. Dies sei Ehre",0,0,5);
