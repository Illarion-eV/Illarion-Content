...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
          ...
          if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Tatsï¿½chlich wird erzï¿½hlt, dass uns einmal ein <count of Albar> bejagd hat und uns die Flï¿½gel abschnitt, um sie als Raritï¿½ten zu verhï¿½kern. Dann jedoch starb er unerwartet an einer seltsamen Verbrennung, die von einer Zauberbrosche ausging.",0,0,0);
            ...
            base.books.AddGermanBookText( "Menschen sind viel zu kurzlebig um in ihrer Existenz auch nur Ansatzweise die Weisheit der Gï¿½tter zu erkennen oder ordentliche Fertigkeiten im Handwerk zu erreichen.", 0, 0, 1 );
			...
			base.books.AddGermanBookText("So sollen sie laut und falsch ihr Instrument spielend umherziehen, bis die goldene Krone zurï¿½ckgereicht wird. ",0,25,2);
