...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
          ...
          if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Tatsï¿½chlich wird erzählt, dass uns einmal ein <count of Albar> bejagd hat und uns die Flï¿½gel abschnitt, um sie als Raritï¿½ten zu verhï¿½kern. Dann jedoch starb er unerwartet an einer seltsamen Verbrennung, die von einer Zauberbrosche ausging.",0,0,0);
