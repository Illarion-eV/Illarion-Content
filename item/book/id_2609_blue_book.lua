...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Es ist gut möglich, dass Jemand, der sich im Wald verirrt, mitten durch eine Elfenzivilisation geht, ohne es zu bemerken. Ihre Hï¿½user würden nur gesehen werden, wenn durch einen Elf gekennzeichnet.",0,0,0);
