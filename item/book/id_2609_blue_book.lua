...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Sie versuchen einen ausgeglichenen Lebensstil zu fï¿½hren, so ersetzen sie alles, was sie aus der Natur entnehmen. Ihre Hï¿½user sind oft um Bäume gebaut und paï¿½en sich ihrer natürlichen Umgebung an.",0,0,0);
            base.books.AddGermanBookText("Es ist gut mï¿½glich, dass Jemand, der sich im Wald verirrt, mitten durch eine Elfenzivilisation geht, ohne es zu bemerken. Ihre Hï¿½user wï¿½rden nur gesehen werden, wenn durch einen Elf gekennzeichnet.",0,0,0);
            base.books.AddGermanBookText("Das fï¿½hrte zu Gerï¿½chten, Elfen brauchten Magie, um ihre Hï¿½user vor anderen zu verbergen. Einige glauben sogar, sie kï¿½nnten das Wachstum der Bäume kontrollieren, um einen Raum für Hï¿½user zu schaffen.",0,0,0);
            base.books.AddGermanBookText("Alles in allem erscheinen ihre Behausungen sehr zerbrechlich, als ob sie Gï¿½ste wï¿½ren und die ursprï¿½ngliche Form der Natur wiederherstellen wï¿½rden. ",0,0,0);
            ...
            base.books.AddGermanBookText("Im Allgemeinen sind Elfen von gemï¿½ï¿½igtem Gemï¿½t und freundlich, nicht nur gegenï¿½ber den Ihren, sondern auch gegenï¿½ber anderen Rassen. Trotzdem fï¿½hlen sie sich mit anderen Elfen wohler.",0,0,0);
            ...
            base.books.AddGermanBookText("Die früher erwï¿½hnte Ausgeglichenheit und Gelassenheit trifft auf die Jï¿½ngeren nicht zu. Die ganz jungen Elfen neigen mehr dazu, in Konflikte zu geraten. Dies ï¿½ndert sich jedoch mit der Zeit.",0,0,0);
            base.books.AddGermanBookText("Die Langlebigkeit der Elfen beinfluï¿½t oft ihre Sicht auf Probleme. Grï¿½ï¿½ere Probleme eines Menschen sind nicht so tragisch für einen Elfen, da sie schon früher Dinge dieser Natur erfahren haben.",0,0,0);
            ...
            base.books.AddGermanBookText("Elfisches Handwerk kann sehr erlesen sein, jedoch ist das nicht auf irgend ein spezielles Talent zurï¿½ckzufï¿½hren, sondern auf die Menge an Zeit, welche sie brauchen um ihre Produkte zu perfektionieren.",0,0,0);
			...
			base.books.AddGermanBookText("mir großmï¿½tig geholfen und auch das eine oder andere Buch hergeliehen. Deshalb mï¿½chte ich, ihnen allen an dieser Stelle nochmalig von Herzen dafür danken.",0,11,2); 
			...
			base.books.AddGermanBookText("Weiters soll Pippiat ein ungewï¿½hnlich breites Gesï¿½ï¿½ gehabt haben und ich mï¿½chte auch unsere Familie dafür rï¿½hmen. So deuten alle Gegebenheiten darauf hin das wohl Perigren Blumigfluss aus den",0,11,2); 
			...
			base.books.AddGermanBookText("abwechselnd Blumfussig oder Blumfuï¿½ens genannt, Regelmï¿½ï¿½ig in Chroniken der Familienvï¿½ter und anderen Bï¿½chern genannt. So zum Beispiel Marijana Blumfuï¿½ens, die den Wettbewerb im Jahr -534 um den",0,11,2); 
