...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Es ist gut mï¿½glich, dass Jemand, der sich im Wald verirrt, mitten durch eine Elfenzivilisation geht, ohne es zu bemerken. Ihre Hï¿½user würden nur gesehen werden, wenn durch einen Elf gekennzeichnet.",0,0,0);
			...
			base.books.AddGermanBookText("Weiters soll Pippiat ein ungewï¿½hnlich breites Gesï¿½ï¿½ gehabt haben und ich möchte auch unsere Familie dafür rï¿½hmen. So deuten alle Gegebenheiten darauf hin das wohl Perigren Blumigfluss aus den",0,11,2); 
