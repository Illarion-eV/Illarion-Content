...
M.bookList["parchment_longo"] = {english = "A note", german = "Eine Nachricht", bookId = 503, bookGraphic = pell}
M.bookList["travel_companions_tanorakind"] = {english = "Looking for travel companions!", german = "Reisegefährten gesucht!", bookId = 504, bookGraphic = pell}
M.bookList["vincent_wallery_bank"] = {english = "Vincent Wallery Bank", german = "Vincent Wallery Bank", bookId = 505, bookGraphic = pell}
