...
function init()
	...
	killerhuhn:bind(0, handler.createmonster.createMonster(position(50,604,0),3,40,2));
	killerhuhn:bind(1, handler.createmonster.createMonster(position(50,604,0),3,40,3));
