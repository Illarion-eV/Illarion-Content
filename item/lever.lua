...
function init()
	...
	dronrul1.bind(0, User:talkLanguage(Character.say,Player.german ,"#me legt den Hebel um."));
	dronrul1.bind(0, User:talkLanguage(Character.say,Player.english,"#me turns the lever."));
	...
	dronrul1.bind(1, User:talkLanguage(Character.say,Player.german ,"#me legt den Hebel um."));
	dronrul1.bind(1, User:talkLanguage(Character.say,Player.english,"#me turns the lever."));
