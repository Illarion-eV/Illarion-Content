...
function init()
	...
	dronrul1 = base.lever.Lever(position(446,753,-3),true);
	dronrul1:bind(1, handler.deleteitem.deleteItem(position(442,754,-3),613));
	dronrul1:bind(0, handler.createitem.createItem(position(442,754,-3),613, 333, 1, true));
