...
function init()
	...
	dronrul1.bind(0, Char:talkLanguage(Character.say,Player.german ,"#me legt den Hebel um."));
	dronrul1.bind(0, Char:talkLanguage(Character.say,Player.english,"#me turns the lever."));
	...
	dronrul1.bind(1, Char:talkLanguage(Character.say,Player.german ,"#me legt den Hebel um."));
	dronrul1.bind(1, Char:talkLanguage(Character.say,Player.english,"#me turns the lever."));
