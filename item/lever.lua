...
function init()
	...
	killerhuhn:bind(0, handler.createmonster.createMonsters(position(50,604,0),5,40));
	killerhuhn:bind(1, handler.createmonster.createMonsters(position(50,604,0),12,40));
