...
function LookAtItem(User,Item)
    ...
    if (specialnames==nil) then
        specialnames={};
        specialnames[3001]={"Zwergenschlï¿½ssel","dwarven key"};
        specialnames[3002]={"Zwergenschlï¿½ssel","dwarven key"};
        specialnames[4080]={"Garons Schmieden Schlï¿½ssel","Garons goldsmith workshop key"};
        specialnames[4036]={"Gefï¿½ngnissschlï¿½ssel #1","Prisonkey #1"};
        specialnames[4037]={"Gefï¿½ngnissschlï¿½ssel #2","Prisonkey #2"};
        specialnames[4001]={"Stadttor Schlï¿½ssel","Towngate key"};
        specialnames[5014]={"Graue Zuflucht Schlï¿½ssel #1","Grey Refuge key #1"}
        specialnames[5015]={"Graue Zuflucht Schlï¿½ssel #2","Grey Refuge key #2"}
        specialnames[7100]={"Greenbriar Tavernen Schlï¿½ssel","Greenbriar Taverne key"};
        specialnames[7101]={"Greenbriar 1 Schlï¿½ssel","Greenbriar 1 key"};
        specialnames[7102]={"Greenbriar 2 Schlï¿½ssel","Greenbriar 2 key"};
        specialnames[7103]={"Greenbriar 3 Schlï¿½ssel","Greenbriar 3 key"};
        specialnames[1060]={"Varshikar 1 Schlï¿½ssel","Varshikar 1 key"};
        specialnames[1061]={"Varshikar 2 Schlï¿½ssel","Varshikar 2 key"};
        specialnames[1062]={"Varshikar 3 Schlï¿½ssel","Varshikar 3 key"};
        specialnames[1063]={"Varshikar 4 Schlï¿½ssel","Varshikar 4 key"};
        specialnames[1064]={"Varshikar 5 Schlï¿½ssel","Varshikar 5 key"};
        specialnames[1065]={"Varshikar 6 Schlï¿½ssel","Varshikar 6 key"};
        specialnames[1066]={"Varshikar 7 Schlï¿½ssel","Varshikar 7 key"};
