...
local M = {}local customPotion = require("alchemy.base.customPotion")
-- UPDATE items SET itm_script='item.id_1167_potionbottle' WHERE itm_id IN (1167);
...
function M.UseItem(user, SourceItem)
    ...
    elseif SourceItem.pos == position(608, 178, -3) and (user:getQuestProgress(533) == 1) then -- player adding violet potion to the red
        ...
        character.ChangeHP(user, 1000) -- player gains health
        user:setQuestProgress(533, 0)
