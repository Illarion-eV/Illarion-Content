...
local function RosalineLookAt(User, Item)
    ...
    itemLookat.name = common.GetNLS(User, "Kˆnigin Rosaline", "Queen Rosaline")
    itemLookat.description = common.GetNLS(User,
        "Dieses Monument zeigt die junge Kˆnigin Rosaline. Eine Auflistung der Herrscher von Cadomyr ist auf einer Messingtafel am Sockel den Monuments zu lesen.",
...
local function ReginaldLookAt(User, Item)
    ...
    itemLookat.description = common.GetNLS(User,
        "Dieses Monument zeigt Sir Reginald Edwards, den verstorbenen Kˆnig Cadomyrs und Vater von Kˆnigin Rosaline. Die Sitten Cadomyrs sind auf einer Messingtafel am Sockel den Monuments zu lesen.",
...
function M.UseItem(User, SourceItem, ltstate)
    ...
    elseif SourceItem.pos == position(118, 566, 0) then --Queen Rosaline's statue
        ...
        local dialogText = common.GetNLS(User,
            "1. Kˆnig Edward - 16 BS\n\n2. Kˆnig Reginald - 0 AS\n\n3. Kˆnigin Rosaline Edwards - 22 AS",
