...
"Du siehst eine Frau die ihren Kï¿½rper mit Seidentï¿½chern verdeckt.",
"Du siehst eine Gruppe von Musikern auf einem belebtem Marktplatz.",
"Du siehst einen alten Mann mit Wanderstock den Wald entlang gehen, der nach Krï¿½utern Ausschau hï¿½lt.",
...
"Du siehst ein Panorama einer alten, zerstï¿½rten Brï¿½cke.",
...
"Du siehst einen Taschendieb, der sich wï¿½hrend eines Festes an die Habseligkeiten anderer hermacht.",
"Du siehst eine nackte Elfenfrau, umhï¿½llt mit Strï¿½uchern und Blï¿½ttern des Waldes.",
...
"Du siehst einen Gelehrten beim durchstï¿½bern einer Bibiliothek.",
...
"Du siehst einen betrunkenen, dickbï¿½uchigen Mann beim Philosophieren. Ein Passant wirft ihm eine Mï¿½nze zu.",
"Du siehst einen vernarbten Ork, der dich grimmig ansieht.",
"Du siehst eine Gruppe von Orks beim Feiern des Radosh.",
"Du siehst einen Zwergen, der nach langem Graben einen Edelstein entdeckt hat, unglï¿½ubig starrt er ihn an.",
...
"Du siehst ein verlaufenes Bild, es scheint so, als ob eine Fee zentriert im Bild wï¿½re.",
"Du siehst wie ein Elf in den Wald hineinstarrt, du erkennst, dass sich im Wald etwas versteckt, das Ausschau nach dem Elfen hï¿½lt.",
