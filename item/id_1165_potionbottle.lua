...
-- UPDATE items SET itm_script='item.id_1165_potionbottle' WHERE itm_id IN (1165);
...
function M.UseItem(User, SourceItem)
    ...
    elseif SourceItem.pos == position(610, 183, -3) and (User:getQuestProgress(534) == 1) then -- player adding dark blue potion to the yellow
        common.CreateItem(User, 329, 1, 222, {["potionEffectId"] = 521, descriptionEn = "Halfling female transformation potion", descriptionDe = "Wandeltrank Halblingsfrau"}) -- halfing female transformation potion
        User:inform(
