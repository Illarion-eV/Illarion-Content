...
local messageG = {}
messageG[1] = "[Queststatus] Du findest einen großen Smaragd in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[2] = "[Queststatus] Du findest einen großen Rubin in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[3] = "[Queststatus] Du findest einen großen Amethyst in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[4] = "[Queststatus] Du findest einen großen Saphir in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[5] = "[Queststatus] Du findest einen großen Topas in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[6] = "[Queststatus] Du findest einen großen Diamant in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
messageG[7] = "[Queststatus] Du findest einen großen Obsidian in dem ein Drachenkopf eingeschliffen ist. Wahrscheinlich hat Obsidimine hiervon gesprochen."
