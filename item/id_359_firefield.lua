...
function M.CharacterOnField(User)
    ...
    if (FieldItem.quality > 100) and User.pos.z ~= 40 and FieldItem:getData("illusion") == "false" then --no harmful flames in the working camp or if it is a magical illusion
