...
local product = tailoring:AddProduct( CurrentCatID, 830, { 40, 60}, 1, { 15, 30 } );
...
--Grey Dress
product = tailoring:AddProduct( CurrentCatID, 802, { 0, 20}, 1, { 5, 10 } );
product:AddProductionSteps( { 176, 1, "all" }, 3 ); -- Grey Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--White Dress
product = tailoring:AddProduct( CurrentCatID, 806, { 4, 24}, 1, { 6, 12 } );
product:AddProductionSteps( { 178, 1, "all" }, 3 ); -- White Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Green Dress
product = tailoring:AddProduct( CurrentCatID, 803, { 7, 27}, 1, { 7, 14 } );
product:AddProductionSteps( { 54, 1, "all" }, 3 ); -- Green Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Green Dress
product = tailoring:AddProduct( CurrentCatID, 836, { 9, 29}, 1, { 7, 14 } );
product:AddProductionSteps( { 54, 1, "all" }, 2 ); -- Green Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 175, 1, "all" }, 1 ); -- Black Cloth: 1x1

--Black Dress
product = tailoring:AddProduct( CurrentCatID, 805, { 13, 33}, 1, { 8, 16 } );
product:AddProductionSteps( { 175, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black White Dress
product = tailoring:AddProduct( CurrentCatID, 838, { 15, 35}, 1, { 9, 18 } );
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 175, 1, "all" }, 2 ); -- Black Cloth: 2x1

--Red Dress
product = tailoring:AddProduct( CurrentCatID, 804, { 16, 36}, 1, { 9, 18 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Red Dress
product = tailoring:AddProduct( CurrentCatID, 837, { 18, 38}, 1, { 9, 18 } );
product:AddProductionSteps( { 175, 1, "all" }, 1 ); -- Black Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 174, 1, "all" }, 2 ); -- Red Cloth: 2x1

--Yellow Dress
product = tailoring:AddProduct( CurrentCatID, 801, { 21, 41}, 1, { 10, 20 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Yellow Dress
product = tailoring:AddProduct( CurrentCatID, 834, { 23, 43}, 1, { 11, 22 } );
product:AddProductionSteps( { 175, 1, "all" }, 2 ); -- Black Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1

--Black Yellow Dress
product = tailoring:AddProduct( CurrentCatID, 835, { 27, 47}, 1, { 12, 24 } );
product:AddProductionSteps( { 175, 1, "all" }, 2 ); -- Black Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1

--Blue Dress
product = tailoring:AddProduct( CurrentCatID, 385, { 29, 49}, 1, { 12, 24 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Blue Dress
product = tailoring:AddProduct( CurrentCatID, 833, { 32, 52}, 1, { 13, 26 } );
product:AddProductionSteps( { 175, 1, "all" }, 2 ); -- Black Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 179, 1, "all" }, 1 ); -- Blue Cloth: 1x1

--Blue Dress
product = tailoring:AddProduct( CurrentCatID, 800, { 34, 54}, 1, { 13, 26 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Grey Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 850, { 36, 56}, 1, { 14, 28 } );
product:AddProductionSteps( { 176, 1, "all" }, 5 ); -- Grey Cloth: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--White Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 852, { 38, 58}, 1, { 14, 28 } );
product:AddProductionSteps( { 178, 1, "all" }, 5 ); -- White Cloth: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Black Red Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 851, { 39, 59}, 1, { 15, 30 } );
product:AddProductionSteps( { 175, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 174, 1, "all" }, 2 ); -- Red Cloth: 2x1

--Red Yellow Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 849, { 41, 61}, 1, { 15, 30 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 177, 1, "all" }, 2 ); -- Yellow Cloth: 2x1

--Yellow Green Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 848, { 43, 63}, 1, { 16, 32 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 54, 1, "all" }, 2 ); -- Green Cloth: 2x1

--Yellow Blue Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 847, { 45, 65}, 1, { 16, 32 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 179, 1, "all" }, 2 ); -- Blue Cloth: 2x1

--Blue Green Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 845, { 46, 66}, 1, { 16, 32 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 54, 1, "all" }, 2 ); -- Green Cloth: 2x1

--Blue Red Heraldic Dress
product = tailoring:AddProduct( CurrentCatID, 846, { 48, 68}, 1, { 17, 34 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 174, 1, "all" }, 2 ); -- Red Cloth: 2x1
...
--Grey White Skirt
product = tailoring:AddProduct( CurrentCatID, 841, { 2, 22}, 1, { 5, 10 } );
product:AddProductionSteps( { 176, 1, "all" }, 1 ); -- Grey Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 2 ); -- Thread: 2x2
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1

--Green White Skirt
product = tailoring:AddProduct( CurrentCatID, 842, { 5, 25}, 1, { 6, 12 } );
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 2 ); -- Thread: 2x2
product:AddProductionSteps( { 54, 1, "all" }, 1 ); -- Green Cloth: 1x1

--Black White Skirt
product = tailoring:AddProduct( CurrentCatID, 844, { 11, 31}, 1, { 8, 16 } );
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 2 ); -- Thread: 2x2
product:AddProductionSteps( { 175, 1, "all" }, 1 ); -- Black Cloth: 1x1

--Red White Skirt
product = tailoring:AddProduct( CurrentCatID, 843, { 20, 40}, 1, { 10, 20 } );
product:AddProductionSteps( { 174, 1, "all" }, 1 ); -- Red Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 2 ); -- Thread: 2x2
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1

--Yellow White Skirt
product = tailoring:AddProduct( CurrentCatID, 840, { 25, 45}, 1, { 11, 22 } );
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1
product:AddProductionSteps( { 50, 2, "all" }, 2 ); -- Thread: 2x2
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1

--Blue White Skirt
product = tailoring:AddProduct( CurrentCatID, 839, { 30, 50}, 1, { 12, 24 } );
product:AddProductionSteps( { 179, 1, "all" }, 2 ); -- Blue Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1
...
--Grey Tunic
product = tailoring:AddProduct( CurrentCatID, 816, { 1, 21}, 1, { 5, 10 } );
product:AddProductionSteps( { 176, 1, "all" }, 4 ); -- Grey Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Grey Doublet
product = tailoring:AddProduct( CurrentCatID, 809, { 4, 24}, 1, { 6, 12 } );
product:AddProductionSteps( { 176, 1, "all" }, 3 ); -- Grey Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--White Tunic
product = tailoring:AddProduct( CurrentCatID, 820, { 6, 26}, 1, { 6, 12 } );
product:AddProductionSteps( { 178, 1, "all" }, 4 ); -- White Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--White Doublet
product = tailoring:AddProduct( CurrentCatID, 813, { 9, 29}, 1, { 7, 14 } );
product:AddProductionSteps( { 178, 1, "all" }, 3 ); -- White Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--Green Shirt
product = tailoring:AddProduct( CurrentCatID, 457, { 12, 32}, 1, { 8, 16 } );
product:AddProductionSteps( { 54, 1, "all" }, 3 ); -- Green Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Green Doublet
product = tailoring:AddProduct( CurrentCatID, 810, { 14, 34}, 1, { 8, 16 } );
product:AddProductionSteps( { 54, 1, "all" }, 3 ); -- Green Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--Green Tunic
product = tailoring:AddProduct( CurrentCatID, 817, { 17, 37}, 1, { 9, 18 } );
product:AddProductionSteps( { 54, 1, "all" }, 4 ); -- Green Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Black Shirt
product = tailoring:AddProduct( CurrentCatID, 182, { 19, 39}, 1, { 10, 20 } );
product:AddProductionSteps( { 182, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Doublet
product = tailoring:AddProduct( CurrentCatID, 812, { 22, 42}, 1, { 10, 20 } );
product:AddProductionSteps( { 182, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--Black Tunic
product = tailoring:AddProduct( CurrentCatID, 819, { 25, 45}, 1, { 11, 22 } );
product:AddProductionSteps( { 182, 1, "all" }, 4 ); -- Black Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Red Shirt
product = tailoring:AddProduct( CurrentCatID, 180, { 27, 47}, 1, { 12, 24 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Red Doublet
product = tailoring:AddProduct( CurrentCatID, 811, { 30, 50}, 1, { 12, 24 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--Red Tunic
product = tailoring:AddProduct( CurrentCatID, 818, { 33, 53}, 1, { 13, 26 } );
product:AddProductionSteps( { 174, 1, "all" }, 4 ); -- Red Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Yellow Shirt
product = tailoring:AddProduct( CurrentCatID, 458, { 35, 55}, 1, { 14, 28 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Yellow Doublet
product = tailoring:AddProduct( CurrentCatID, 808, { 38, 58}, 1, { 14, 28 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1

--Yellow Tunic
product = tailoring:AddProduct( CurrentCatID, 815, { 40, 60}, 1, { 15, 30 } );
product:AddProductionSteps( { 177, 1, "all" }, 4 ); -- Yellow Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Blue Tunic
product = tailoring:AddProduct( CurrentCatID, 814, { 43, 63}, 1, { 16, 32 } );
product:AddProductionSteps( { 179, 1, "all" }, 4 ); -- Blue Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Blue Shirt
product = tailoring:AddProduct( CurrentCatID, 181, { 46, 66}, 1, { 16, 32 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Blue Doublet
product = tailoring:AddProduct( CurrentCatID, 807, { 48, 68}, 1, { 17, 34 } );
product:AddProductionSteps( { 179, 1, "all" }, 4 ); -- Blue Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2550, 1, "all" }, 1 ); -- Copper Ingot: 1x1
...
--Leather Gloves
product = tailoring:AddProduct( CurrentCatID, 48, { 20, 40}, 1, { 10, 20 } );
product:AddProductionSteps( { 2547, 1, "all" }, 3 ); -- Leather: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Studded Leather Gloves
product = tailoring:AddProduct( CurrentCatID, 526, { 40, 60}, 1, { 15, 30 } );
product:AddProductionSteps( { 2547, 1, "all" }, 3 ); -- Leather: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2535, 1, "all" }, 1 ); -- Iron Ingot: 1x1

--Serinjah Leather Gloves
product = tailoring:AddProduct( CurrentCatID, 527, { 60, 80}, 1, { 20, 40 } );
product:AddProductionSteps( { 2547, 1, "all" }, 4 ); -- Leather: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Slouch Hat
product = tailoring:AddProduct( CurrentCatID, 356, { 0, 20}, 1, { 5, 10 } );
product:AddProductionSteps( { 2547, 1, "all" }, 3 ); -- Leather: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Thief Gloves
product = tailoring:AddProduct( CurrentCatID, 384, { 20, 40}, 1, { 10, 20 } );
product:AddProductionSteps( { 178, 1, "all" }, 3 ); -- White Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Cloth Gloves
product = tailoring:AddProduct( CurrentCatID, 2295, { 60, 80}, 1, { 20, 40 } );
product:AddProductionSteps( { 178, 1, "all" }, 4 ); -- White Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
...
product = tailoring:AddProduct( CurrentCatID, 363, { 32, 52}, 1, { 13, 26 } );
product:AddProductionSteps( { 2547, 1, "all" }, 5 ); -- Leather: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Half Leather Armour
product = tailoring:AddProduct( CurrentCatID, 365, { 42, 62}, 1, { 15, 30 } );
product:AddProductionSteps( { 2547, 1, "all" }, 6 ); -- Leather: 6x1
product:AddProductionSteps( { 50, 2, "all" }, 6 ); -- Thread: 6x2

--Light Hunting Armour
product = tailoring:AddProduct( CurrentCatID, 364, { 52, 72}, 1, { 18, 36 } );
product:AddProductionSteps( { 2547, 1, "all" }, 6 ); -- Leather: 6x1
product:AddProductionSteps( { 50, 2, "all" }, 6 ); -- Thread: 6x2

--Full Leatherarmour
product = tailoring:AddProduct( CurrentCatID, 362, { 62, 82}, 1, { 20, 40 } );
...
--Grey Coat
product = tailoring:AddProduct( CurrentCatID, 196, { 40, 60}, 1, { 15, 30 } );
product:AddProductionSteps( { 176, 1, "all" }, 5 ); -- Grey Cloth: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Grey Priest Robe
product = tailoring:AddProduct( CurrentCatID, 2418, { 43, 63}, 1, { 16, 32 } );
product:AddProductionSteps( { 176, 1, "all" }, 4 ); -- Grey Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--White Priest Robe
product = tailoring:AddProduct( CurrentCatID, 2421, { 46, 66}, 1, { 16, 32 } );
product:AddProductionSteps( { 178, 1, "all" }, 4 ); -- White Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Green Robe
product = tailoring:AddProduct( CurrentCatID, 55, { 48, 68}, 1, { 17, 34 } );
product:AddProductionSteps( { 54, 1, "all" }, 4 ); -- Green Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Black Robe
product = tailoring:AddProduct( CurrentCatID, 194, { 51, 71}, 1, { 18, 36 } );
product:AddProductionSteps( { 175, 1, "all" }, 4 ); -- Black Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Black Cult Robe
product = tailoring:AddProduct( CurrentCatID, 2378, { 54, 74}, 1, { 18, 36 } );
product:AddProductionSteps( { 175, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
product:AddProductionSteps( { 174, 1, "all" }, 1 ); -- Red Cloth: 1x1

--Black Coat
product = tailoring:AddProduct( CurrentCatID, 2384, { 57, 77}, 1, { 19, 38 } );
product:AddProductionSteps( { 175, 1, "all" }, 5 ); -- Black Cloth: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Black Priest Robe
product = tailoring:AddProduct( CurrentCatID, 2420, { 59, 79}, 1, { 20, 40 } );
product:AddProductionSteps( { 175, 1, "all" }, 4 ); -- Black Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Novice Mage Robe
product = tailoring:AddProduct( CurrentCatID, 547, { 62, 82}, 1, { 20, 40 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1

--Red Priest Robe
product = tailoring:AddProduct( CurrentCatID, 2419, { 65, 85}, 1, { 21, 42 } );
product:AddProductionSteps( { 174, 1, "all" }, 4 ); -- Red Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Red Mage Robe
product = tailoring:AddProduct( CurrentCatID, 2377, { 68, 88}, 1, { 22, 44 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1

--Yellow Robe
product = tailoring:AddProduct( CurrentCatID, 195, { 71, 91}, 1, { 23, 46 } );
product:AddProductionSteps( { 177, 1, "all" }, 4 ); -- Yellow Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Yellow Priest Robe
product = tailoring:AddProduct( CurrentCatID, 368, { 73, 93}, 1, { 23, 46 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
product:AddProductionSteps( { 178, 1, "all" }, 1 ); -- White Cloth: 1x1

--Brown Priest Robe
product = tailoring:AddProduct( CurrentCatID, 2416, { 76, 96}, 1, { 24, 48 } );
product:AddProductionSteps( { 174, 1, "all" }, 2 ); -- Red Cloth: 2x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2
product:AddProductionSteps( { 177, 1, "all" }, 2 ); -- Yellow Cloth: 2x1

--Blue Robe
product = tailoring:AddProduct( CurrentCatID, 193, { 79, 99}, 1, { 25, 50 } );
product:AddProductionSteps( { 179, 1, "all" }, 4 ); -- Blue Cloth: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Blue Coat
product = tailoring:AddProduct( CurrentCatID, 2380, { 82, 102}, 1, { 25, 50 } );
product:AddProductionSteps( { 179, 1, "all" }, 5 ); -- Blue Cloth: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Mage Robe
product = tailoring:AddProduct( CurrentCatID, 548, { 84, 104}, 1, { 26, 52 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 177, 1, "all" }, 1 ); -- Yellow Cloth: 1x1
product:AddProductionSteps( { 175, 1, "all" }, 1 ); -- Black Cloth: 1x1
...
--Master Mage Robe
product = tailoring:AddProduct( CurrentCatID, 558, { 87, 107}, 1, { 27, 54 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 6 ); -- Thread: 6x2
product:AddProductionSteps( { 177, 1, "all" }, 2 ); -- Yellow Cloth: 2x1
...
--Short Leather Legs
product = tailoring:AddProduct( CurrentCatID, 367, { 30, 50}, 1, { 12, 24 } );
product:AddProductionSteps( { 2547, 1, "all" }, 4 ); -- Leather: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Leather Legs
product = tailoring:AddProduct( CurrentCatID, 366, { 43, 63}, 1, { 16, 32 } );
product:AddProductionSteps( { 2547, 1, "all" }, 5 ); -- Leather: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2

--Short Fur trousers
product = tailoring:AddProduct( CurrentCatID, 2114, { 56, 76}, 1, { 19, 38 } );
product:AddProductionSteps( { 2547, 1, "all" }, 5 ); -- Leather: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
product:AddProductionSteps( { 2586, 1, "all" }, 2 ); -- Fur: 2x1

--Fur Trousers
product = tailoring:AddProduct( CurrentCatID, 2113, { 69, 89}, 1, { 22, 44 } );
product:AddProductionSteps( { 2547, 1, "all" }, 5 ); -- Leather: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
...
--Grey Trousers
product = tailoring:AddProduct( CurrentCatID, 823, { 1, 21}, 1, { 5, 10 } );
product:AddProductionSteps( { 176, 1, "all" }, 3 ); -- Grey Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--White Trousers
product = tailoring:AddProduct( CurrentCatID, 827, { 4, 24}, 1, { 6, 12 } );
product:AddProductionSteps( { 178, 1, "all" }, 3 ); -- White Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Green Trousers
product = tailoring:AddProduct( CurrentCatID, 183, { 8, 28}, 1, { 7, 14 } );
product:AddProductionSteps( { 54, 1, "all" }, 3 ); -- Green Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Green Trousers
product = tailoring:AddProduct( CurrentCatID, 824, { 11, 31}, 1, { 8, 16 } );
product:AddProductionSteps( { 54, 1, "all" }, 3 ); -- Green Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Trousers
product = tailoring:AddProduct( CurrentCatID, 34, { 14, 34}, 1, { 8, 16 } );
product:AddProductionSteps( { 175, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Black Trousers
product = tailoring:AddProduct( CurrentCatID, 826, { 18, 38}, 1, { 9, 18 } );
product:AddProductionSteps( { 175, 1, "all" }, 3 ); -- Black Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Red Trousers
product = tailoring:AddProduct( CurrentCatID, 459, { 21, 41}, 1, { 10, 20 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Red Trousers
product = tailoring:AddProduct( CurrentCatID, 825, { 24, 44}, 1, { 11, 22 } );
product:AddProductionSteps( { 174, 1, "all" }, 3 ); -- Red Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Yellow Trousers
product = tailoring:AddProduct( CurrentCatID, 460, { 28, 48}, 1, { 12, 24 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Yellow Trousers
product = tailoring:AddProduct( CurrentCatID, 822, { 31, 51}, 1, { 13, 26 } );
product:AddProductionSteps( { 177, 1, "all" }, 3 ); -- Yellow Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Blue Trousers
product = tailoring:AddProduct( CurrentCatID, 461, { 34, 54}, 1, { 13, 26 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Blue Trousers
product = tailoring:AddProduct( CurrentCatID, 821, { 38, 58}, 1, { 14, 28 } );
product:AddProductionSteps( { 179, 1, "all" }, 3 ); -- Blue Cloth: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
...
--Leather Shoes
product = tailoring:AddProduct( CurrentCatID, 369, { 40, 60}, 1, { 15, 30 } );
product:AddProductionSteps( { 2547, 1, "all" }, 3 ); -- Leather: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2

--Leather Boots
product = tailoring:AddProduct( CurrentCatID, 53, { 50, 70}, 1, { 17, 34 } );
product:AddProductionSteps( { 2547, 1, "all" }, 4 ); -- Leather: 4x1
product:AddProductionSteps( { 50, 2, "all" }, 4 ); -- Thread: 4x2

--Fur Boots
product = tailoring:AddProduct( CurrentCatID, 697, { 60, 80}, 1, { 20, 40 } );
product:AddProductionSteps( { 2547, 1, "all" }, 3 ); -- Leather: 3x1
product:AddProductionSteps( { 50, 2, "all" }, 3 ); -- Thread: 3x2
product:AddProductionSteps( { 2586, 1, "all" }, 2 ); -- Fur: 2x1

--Serinjah Leather Boots
product = tailoring:AddProduct( CurrentCatID, 698, { 70, 90}, 1, { 22, 44 } );
product:AddProductionSteps( { 2547, 1, "all" }, 5 ); -- Leather: 5x1
product:AddProductionSteps( { 50, 2, "all" }, 5 ); -- Thread: 5x2
...
--Sling
product = tailoring:AddProduct( CurrentCatID, 89, { 10, 30}, 1, { 7, 14 } );
