...
ReqTexts = {};
ReqTexts.german = { [392] = "Fackeln", [43] = "Kerzen", [390] = "LampenÔøΩl" };
...
function UseItem( User, SourceItem, TargetItem, counter, param, ltstate )
	if SourceItem:getType()==1 or SourceItem:getType()==2 then
		base.common.TempInformNLS(User,
			"Nimm das Licht in die Hand oder lege es am GrÔøΩtel ab.",
	...
	if this then
		...
		if ok then
            ...
            if SourceItem.id == 395 and (SourceItem.pos == position (906, 823, -3) or SourceItem.pos == position (906, 825, -3) ) and User:getQuestProgress(105) == 1 then
                base.common.TempInformNLS(User, "[Queststatus] Du entfachst die Ehrenfeuer von Runewick. Kehre zu Gregor Remethar zurÔøΩck, um deine Belohnung einzufordern.", "[Quest status] You lit the lights of honour of Runewick. Return to Gregor Remethar to claim your reward.")
		...
		elseif this.req then
			base.common.TempInformNLS(User,
				"daf¸r brauchst du ".. ReqTexts.german[this.req.id] .. " in der Hand oder im GÔøΩrtel.",
