...
local function dropBluePrints(treasureLocation, level)
    ...
    for _, blueprint in pairs(blueprints.blueprints) do
        ...
        for _, difficulty in pairs(blueprint.treasure) do
            if level <= 2 and difficulty == "small"
            or level > 2 and level <= 4 and difficulty == "average"
            or level > 4 and level <= 7 and difficulty == "big"
            or level > 7 and level <= 9 and difficulty == "giant" then
