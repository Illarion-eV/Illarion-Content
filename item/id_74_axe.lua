...
function UseItem( User, SourceItem, TargetItem, Counter, Param, ltstate )
	...
	if (SourceItem:getType() ~= 4) then -- tool in Hand
		...
		"You need to hold the hatchet in your hand!" );
		return
	end
	...
	User:learn( woodchopping.LeadSkill, woodchopping.LeadSkillGroup, woodchopping.SavedWorkTime[User.id], 100, User:increaseAttrib(woodchopping.LeadAttribute,0) );
	amount = amount - 1;
	TargetItem:setData("wood_amount", "" .. amount);
