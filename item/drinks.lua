...
module("item.id_drinks", package.seeall)
-- uses items of the new client - don't put this on the RS yet!

-- UPDATE common SET com_script='item.id_drinks' WHERE com_itemid IN (2189, 2188, 2187, 2186, 2059, 2058, 2057, 2056, 1910, 1909, 1907, 1906, 1861, 2502, 1841, 1842, 1843, 1844, 1853, 1854, 1855, 1856, 1857, 1859, 1860);
