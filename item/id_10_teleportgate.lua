...
function CharacterOnField( User )
    ...
    if( SourceItem.id == 10 ) then
        ...
        base.common.InformNLS( User,
        "Ein Gegenstand st�rt die Magie des Portals.",
...
if (Item.data==16) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zu den S�mpfen", "Magical gate to the Swamps" ) );
end;
...
if (Item.data==19) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zur Kumdah W�ste", "Magical gate to the Kumdah Desert" ) );
end;
...
if (Item.data==21) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zur Bloodskull H�hle", "Magical gate to the Bloodskull Cave" ) );
end;
...
if (Item.data==40) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zum S�dwald", "Magical gate to North Southern Woods" ) );
end;

if (Item.data==41) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zum S�dwald", "Magical gate to East Southern Woods" ) );
end;
if (Item.data==42) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zum S�dwald", "Magical gate to South Southern Woods" ) );
end;

if (Item.data==43) then
	 world:itemInform( User, Item, base.common.GetNLS( User, "Magisches Portal zum S�dwald", "Magical gate to West Southern Woods" ) );
end;
