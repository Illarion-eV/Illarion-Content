...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Diese Station lehrt dich, wie man kämpft. Groknar, der Lehrmeister, ist ein stolzer und mächtiger Orkkrieger. Stell dich ihm vor - vorsichtig. Monster und auch andere Spielercharaktere (PvP) kannst du mit einem Rechtsklick angreifen."
Description[ENGLISH][1] = "At the next station, you will learn how to fight. Groknar, the instructor, is a proud and mighty Orc warrior. Just speak up to him - carefully. To attack monsters and also other player characters (PvP), click on them once with the right mouse button."
...
Description[GERMAN][3] = "Töte noch zwei Schweine."
Description[ENGLISH][3] = "Kill two pigs."
Description[GERMAN][4] = "Töte noch ein Schwein."
Description[ENGLISH][4] = "Kill another pig."
