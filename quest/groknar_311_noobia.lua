...
Description[GERMAN][2] = "Hurr! Frischfleisch! Ich bin Groknar, der mächtigste Jäger meines Clans. Ich bring dir bei, erbärmliche Kreaturen zu erschlagen. Nimm diesen Knüppel in die Hand und erschlage drei dieser Schweine dort drüben. Du kannst mit dem Angriff auf erbärmliche Kreaturen beginnen, indem du sie einmal mit der rechten Maustaste anklickst."
Description[ENGLISH][2] = "Hurr! Fresh meat! I be Groknar, mightiest hunter of my clan. I will teach you how to smash puny creatures. Equip this club and crush three of those pigs over there. You can begin attacking puny creatures by clicking on them once with the right mouse button."
