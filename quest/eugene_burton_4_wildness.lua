...
Description[GERMAN][21] = "Kehre zu Eugene Burton zurück und bringe ihm sechs Steaks."
Description[ENGLISH][21] = "If Nargun favored you, six premium cuts of steak should be in your possession, and you should go back to Eugene, otherwise keep hunting!"
...
Description[GERMAN][31] = "Gehe in den Elsbaumwald östlich von Eugene und töte einen Elfen. Nimm dazu eine Waffe in die Hand und greife den Elfen an."
