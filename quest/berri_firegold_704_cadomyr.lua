...
Description[GERMAN][3] = "Schmilz zehn Eisenbarren für Berri Firegold an der Rennofen in Cadomyr. Um die Barren herzustellen, musst du die Tiegelzange in die Hand nehmen und die Rennofen benutzen während du vor ihr stehst."
Description[ENGLISH][3] = "Smelt ten iron ingots for Berri Firegold at the bloomery in Cadomyr's workshop. To smelt the ingots you have to take the crucible-pincers in your hand and use the bloomery."
...
QuestTarget[3] = {position(141, 582, 0), position(143, 590, 0)} -- Bloomery
