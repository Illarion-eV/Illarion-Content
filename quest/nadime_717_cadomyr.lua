...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Beschaffe zehn Schaufeln Sand und bring diese zu Nadime in der Werkstatt von Cadomyr. Dazu nimmst du die Schaufel in die Hand und benutzt sie, während du vor einer Sandgrube stehst. Die nächste Sandgrube findest du vor den Toren Cadomyrs."
Description[ENGLISH][1] = "Get ten shovels of sand and take them to Nadime at the workshop in Cadomyr. Dig the sand by using the shovel in your hand, whilst standing in front of a sandpit. The next sandpit is in front of Cadomyr's gates."
...
Description[GERMAN][3] = "Verbrenne zehn Holzscheite zu Pottasche für Nadime am Glasschmelzofen in Cadomyrs Werkstatt. Um das Holz zu verbrennen, musst du die Holzkelle in die Hand nehmen und den Glasschmelzofen benutzen, wenn du vor ihm stehst."
Description[ENGLISH][3] = "Burn ten wood to potash for Nadime at the glass melting oven in Cadomyr's workshop. To burn the wood you have to take the wooden shovel in your hand and use the glass melting oven."
...
Description[GERMAN][5] = "Schmelze zehn Glasblöcke für Nadime in der Werkstatt von Cadomyr. Für die Glasblöcke musst du die Gussform benutzen und am Glasschmelzofen stehen. Du brauchst Pottasche und Quartzsand. Den Quartzsand erhältst du, wenn du den rohen Sand mit der Holzkelle am Sieb reinigst."
Description[ENGLISH][5] = "Melt ten glass ingots for Nadime at the workshop of Cadomyr. To melt you need to stand facing the glass melting oven oven and use the mould. You need potash and quartz sand. You get quartz sand at the seive from the raw sand using the wooden shovel."
