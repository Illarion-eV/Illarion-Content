...
Description[ENGLISH][7] = "Go to Neiran El Nayale and ask him for a task. He can be found on the upper floor of the tower of fire.\n From the marketplace go to the north into the tower of fire and there through the door to the right and up the stairs. There go through the door to the south. You don't have to finish his tasks before you come back to me for another job."
...
Description[GERMAN][9] = "Gehe zu Baldo Proudtoe und frag ihn nach einer Aufgabe. Er kann in den Gärten Runewicks gefunden werden.\n Die Gärten Runewicks können gefunden werden, indem man auf dem Runewick Marktplatz durch das rote Portal geht. Du brauchst seine Aufgabe nicht zu erfüllen, wenn sie dir nicht behagt. Komm dann einfach hierher zurück, um eine weitere Aufgabe zu bekommen."
...
Description[ENGLISH][13] = "Go to Madeline Clarbelis and ask her for a task. She can be found in the Tower of Earth. The Tower of Earth can be reached from Runewick's marketplace, if you go through the Tower of Fire to the north and leave it to the east. Madeline will be reading her books. You don't have to finish her tasks before you come back to me for another job." 
...
Description[GERMAN][15] = "Gehe zu Uriel Urch und frag ihn nach einer Aufgabe. Er kann im Turm des Feuers gefunden werden, dem Gebäude nödlich vom Runewick Marktplatz. Dort sitzt er im Untergeschoss an einem Tisch und lässt sich von Rose Deepdelver mit Bier versorgen. Du brauchst seine Aufgabe nicht zu erfüllen, wenn sie dir nicht behagt. Komm dann einfach hierher zurück, um eine weitere Aufgabe zu bekommen."
Description[ENGLISH][15] = "Go to Uriel Urch and ask him for a task. He can be found in the Tower of Fire, the building to the north of the Runewick's marketplace. He will be sitting at a table in the basement where Rose Deepdelver will be serving him beer. You don't have to finish his tasks before you come back to me for another job."
...
Description[GERMAN][17] = "Gehe zu Lilith Needlehand und frag sie nach einer Aufgabe. Sie ist im Untergeschoss vom Turm des Feuers, das Gebäude nördlich des Marktplatzes von Runewick. Sie ist in ihrer Werkstatt zu finden, gleich um die Ecke von Uriel Urch. Du brauchst ihre Aufgabe nicht zu erfüllen, wenn sie dir nicht behagt. Komm dann einfach hierher zurück, um eine weitere Aufgabe zu bekommen."
Description[ENGLISH][17] = "Go to Lilith Needlehand and ask her for a task. She can be found in the basement of the Tower of Fire, the building to the north of Runewick's marketplace. She will be in her workshop right around the corner from Uriel Urch. You don't have to finish her tasks before you come back to me for another job."
...
Description[GERMAN][19] = "Phillibald hat nach dir gefragt. Suche er in der  Bibliothek der Luft und frag er nach einer Aufgabe. Du brauchst seine Aufgabe nicht zu erfüllen, wenn sie dir nicht behagt. Komm dann einfach hierher zurück, um eine weitere Aufgabe zu bekommen."
Description[ENGLISH][19] = "Phillibald was looking for you. Search for him in the Library of Air and ask him for a task. You don't have to finish his tasks before you come back to me for another job."
...
QuestTarget[2] = {position(901, 787, 1)} -- Florain
QuestTarget[3] = {position(905, 780, 0)} -- Judith
QuestTarget[4] = {position(901, 787, 1)} -- Florain
QuestTarget[5] = {position(900, 800, 1)} -- Zassaria
QuestTarget[6] = {position(901, 787, 1)} -- Florain
QuestTarget[7] = {position(897, 781, 2 )} -- Neiran
QuestTarget[8] = {position(901, 787, 1)} -- Florain
QuestTarget[9] = {position(941, 790, 0)} -- Baldo
QuestTarget[10] = {position(901, 787, 1)} -- Florain
QuestTarget[11] = {position(791, 798, 0)} -- Nana
QuestTarget[12] = {position(901, 787, 1)} -- Florain
QuestTarget[13] = {position(951, 766, 1)} -- Madeline
QuestTarget[14] = {position(901, 787, 1)} -- Florain
QuestTarget[15] = {position(902, 773, 0)} -- Uriel
QuestTarget[16] = {position(901, 787, 1)} -- Florain
QuestTarget[17] = {position(893, 756, 0)} -- Lilith
QuestTarget[18] = {position(901, 787, 1)} -- Florain
QuestTarget[19] = {position(901, 831, 1)} -- Phillibald
QuestTarget[20] = {position(901, 787, 1)} -- Florain
QuestTarget[21] = {position(843, 844, 0)} -- Cilivren
QuestTarget[22] = {position(901, 787, 1)} -- Florain
