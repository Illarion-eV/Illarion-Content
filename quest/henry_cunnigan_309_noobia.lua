...
require("base.common")
module("quest.henry_cunnigan_309_noobia", package.seeall)
...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Um mit dem Menschen zu sprechen, aktiviere die Sprachkonsole mit 'Return', schreibe z.B. 'Hallo' und drücke wieder 'Return'. Alle NPCs reagieren auf bestimmte Schlüsselwörter wenn du in ihrer Nähe stehst. Wenn es Probleme bei der Kommunikation mit einem NPC gibt, schreibe einfach 'Hilfe' und der NPC antwortet mit einer Liste möglicher Schlüsselwörter. Um zu rufen, schreibe #s vor deinen Text, #w lässt deinen Charakter flüstern, #o wird für Out-Of-Character-Nachrichten verwendet und #me leitete ein Emote ein."
Description[ENGLISH][1] = "In order to speak to the human, activate the chat box with the 'return' key, type e.g. 'Hello' and then hit 'return' again. All non-player characters (NPCs) react on certain keywords if you are standing directly beside them. If you ever get stuck trying while trying to communicate with an NPC, typing 'help' will provide you with a list of recommended commands. To shout, write #s in front of your text, #w makes your character whisper, #o is used for out of character messages and #me invokes an emote."
