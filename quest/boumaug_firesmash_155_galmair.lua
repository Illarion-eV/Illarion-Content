...
Description[GERMAN][4] = "Geh zum Notarbüro, dem Crest und dem Südtor."
Description[ENGLISH][4] = "Go to the Census Office, the Crest, and the South Gate."
...
Description[GERMAN][7] = "Besorge zwanzig Steinblöcke und bringe sie zu Boumaug. Du kannst sie von einem Händler kaufen oder mit einem Meißel in der Hand aus unbehauenen Steinen herstellen."
...
Description[GERMAN][9] = "Gehe zur Schwarzlochmine, der Hafen der Galmair, der schwarzen Brücke und der östlichen Brücke bei den Bienenkörben."
...
Description[GERMAN][15] = "Besorge zwanzig Ballen grauen Stoff und bringe sie zu Boumaug. Du kannst sie von einem Händler kaufen oder mit einer Nadel in der Hand aus Wolle auf einem Webstuhl weben, wenn Du vor ihm stehst. Du kannst Webstühle in Runewick oder Cadomyr finden."
Description[ENGLISH][15] = "Obtain twenty grey cloth and bring them to Boumaug. You can buy them from a merchant or weave wool into cloth by using needle in your hand while standing in front of a loom. You can find a loom in Runewick or Cadomyr."
...
Description[GERMAN][17] = "Besorge einen Degen sowie eine Flasche Elfenwein und bring sie zu Boumaug. Ein Schmied und ein Koch sollte das können."
