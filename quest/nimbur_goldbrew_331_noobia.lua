...
Description[GERMAN][2] = "Stell dich vor das Weinfass zwischen den beiden Tischen. Du musst den Kochlöffel in einem der Handslots deines Inventars ausrüsten. Doppelklicke den Kochlöffel oder das Fass, um das Handwerksmenü zum Brauen zu öffnen. \n\nDa du gerade erst anfängst, wirst du wohl nur leichten Alkohol im Brau-Menü aufgeführt finden. Öffne die Kategorie ?Leichter Alkohol?, indem du den Pfeil davor anklickst, und klicke auf ?Flasche voll Cider?, um sie auszuwählen. Für diese Bespiel brauchst du nur eine Flasche, aber du kannst die Anzahlt entweder durch manuelle Eingabe oder durch klicken auf ?+? oder ?-? anpassen. Starte die Produktion, indem du auf ?Herstellen? klickst. Ein Fortschrittsbalken zeigt dir an, wie lange es dauert, bis die Flasche fertig ist und am Ende erscheint die volle Flasche in deinem Inventar. \n\nGehe mit der Flasche mit Cider, die du gebraut hast zurück zu Nimbur Goldbrew."
