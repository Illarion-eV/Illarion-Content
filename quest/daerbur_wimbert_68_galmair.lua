...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel zehn rohe Steine und bringe diese Daerbur. Du kannst rohe Steine entweder beim Händler kaufen oder in der Mine finden. Nimm hierfür eine Spitzhacke in die Hand und benutzt sie, während du vor einem Stein stehst."
Description[ENGLISH][1] = "Collect ten raw stones and bring them to Daerbur. You can buy raw stones from a merchant or find them in a mine. Therefor use the pick-axe in your hand, while standing in front of a stone."
Description[GERMAN][2] = "Geh zu Daerbur Wimbert in der Dunkellochmine bei Galmair. Er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go back to Daerbur Wimbert in the Dark Hole Mine near Galmair, he certainly have another task for you."
Description[GERMAN][3] = "Sammel zwanzig Brocken Kohle und bringe diese Daerbur. Du kannst Kohle entweder beim Händler kaufen oder in der Mine finden. Nimm hierfür eine Spitzhacke in die Hand und benutzt sie, während du vor einem Stein stehst."
Description[ENGLISH][3] = "Collect twenty pieces of coal and bring them to Daerbur. You can buy coal ore from a merchant or find them in a mine. Therefor use the pick-axe in your hand, while standing in front of a stone."
Description[GERMAN][4] = "Geh zu Daerbur Wimbert in der Dunkellochmine bei Galmair. Er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go back to Daerbur Wimbert in the Dark Hole Mine near Galmair, he certainly have another task for you."
...
Description[ENGLISH][5] = "Collect five raw obsidian gems and bring them back to Daerbur. Therefor use the pick-axe in your hand, while standing in front of a stone."
Description[GERMAN][6] = "Geh zu Daerbur Wimbert in der Dunkellochmine bei Galmair. Er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][6] = "Go back to Daerbur Wimbert in the Dark Hole Mine near Galmair, he certainly have another task for you."
