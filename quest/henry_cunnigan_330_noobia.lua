...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Um die Fackel zu finden, die Henry Cunnigan dir gegeben hat, deaktiviere die Chatbox (schwarz) und drücke 'I', um dein Inventar zu öffnen, oder klick das Taschen-Icon in der rechten unteren Ecke des Bildschirms. Um deine Tasche zu öffnen, drücke 'B' oder doppelklicke die Ledertasche in deinem Inventar. \n\nZiehe nun mit der linken Maustaste die Fackel in den leeren Schild-Slot in deinem Inventar. Möglicherweise musst du zunächst ein in diesem Slot ausgerüstetes Item in deine Tasche verschieben. Um eine einzelne Fackel aus einem Stapel zu bewegen, musst du Shift gedrückt halten, während du ziehst und dann die Anzahl '1' in dem Popup Fenster mit 'OK' bestätigen."
Description[ENGLISH][1] = "To find the torch Henry Cunnigan gave you, make sure your chat box is deactivated (black) and press 'I' to open your inventory or click on the bag icon in the bottom right corner of the window. To open your bag, press 'B' or double click on the leather bag in your inventory. \n\nClick the torch and drag it to the empty shield slot in your inventory using your mouse to equip it. You may need to remove any existing item from that slot to your bag first. To separate a single torch from a stack in your inventory, hold down shift as you click and drag, accepting the default value of '1' in the pop up by clicking 'OK'."
Description[GERMAN][2] = "Doppelklicke die Fackel um sie zu entzünden. \n\nDie Fackel wird eine Zeit lang brennen und sobald sie ausgebrannt ist, verschwindet sie aus deinem Inventar."
Description[ENGLISH][2] = "To light the torch double click on it. \n\nThe torch will burn for a while and once it has burnt out it will disappear from your inventory."
Description[GERMAN][3] = "Du kannst nun die Tutorial-Quests fortsetzen, indem du zu Nimbur Goldbrew gehst, um etwas über das Sammeln, Handwerken und Kämpfen zu lernen."
Description[ENGLISH][3] = "You can continue the tutorial quests with Nimbur Goldbrew to learn about gathering, crafting and fighting."
