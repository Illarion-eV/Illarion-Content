...
require("base.common")
module("quest.arenius_batavius_104_cadomyr", package.seeall)
...
Description[ENGLISH][10] = "Go back to Arenius Batavius next to the Inn 'Lakeshore' in Cadomyr, he certainly have another task for you."
...
Description[ENGLISH][25] = "Go back to Arenius Batavius next to the Inn 'Lakeshore' in Cadomyr, he certainly have another task for you."
Description[GERMAN][26] = "Gehe in den Unterschlupf des Kults der Salavesh und töte zwei Menschennekromanten. Nimm dazu eine Waffe in die Hand und greife die Menschennekromanten an."
...
Description[GERMAN][27] = "Töte noch einen menschlichen Beschwörer."
...
Description[ENGLISH][29] = "Go back to Arenius Batavius next to the Inn 'Lakeshore' in Cadomyr, he certainly have another task for you."
Description[GERMAN][30] = "Gehe in den Unterschlupf des Kults der Salavesh und töte eine Dämonenskelett . Nimm dazu eine Waffe in die Hand und greife das Dämonenskelett an."
Description[ENGLISH][30] = "Go into the stronghold of the Cult of Salavesh and kill a demon skeleton. Take a weapon in your hand and attack the demon skeleton."
...
Description[ENGLISH][32] = "Go back to Arenius Batavius next to the Inn 'Lakeshore' in Cadomyr, he certainly have another task for you."
Description[GERMAN][33] = "Gehe in den Unterschlupf des Kults der Salavesh und töte den antiken Feuerdrachen. Nimm dazu eine Waffe in die Hand und greife den antiken Feuerdrachen an."
Description[ENGLISH][33] = "Go into the stronghold of the Cult of Salavesh and kill the ancient fire dragon. Take a weapon in your hand and attack the ancient fire dragon."
