...
Description[GERMAN][3] = "Gehe in den Unterschlupf des Kults der Salavesh und töte sechs Mumien und bringe Arenius die Eingeweide einer Mumie. Du findest den Unterschlupf in einem Berg voller Untoter nahe dem gasthaus zur Hanfschlinge."
Description[ENGLISH][3] = "Go into the stronghold of the Cult of Salavesh and kill six mummies. Then bring Arenius the entrails of one mummy. You find the stronghold deep in a mountain full of undeads near the Hemp Neckty Inn."
...
Description[GERMAN][11] = "Gehe in den Unterschlupf des Kults der Salavesh und töte zwölf Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][11] = "Go into the stronghold of the Cult of Salavesh and kill twelve skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][12] = "Töte noch 11 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][12] = "Kill 11 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][13] = "Töte noch 10 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][13] = "Kill 10 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][14] = "Töte noch 9 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][14] = "Kill 9 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][15] = "Töte noch 8 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][15] = "Kill 8 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][16] = "Töte noch 7 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][16] = "Kill 7 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][17] = "Töte noch 6 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][17] = "Kill 6 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][18] = "Töte noch 5 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][18] = "Kill 5 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][19] = "Töte noch 4 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][19] = "Kill 4 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][20] = "Töte noch 3 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][20] = "Kill 3 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][21] = "Töte noch 2 Skelette. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][21] = "Kill 2 skeletons. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
Description[GERMAN][22] = "Töte noch ein Skelett. Solltest du nicht genug Skelette finden bedenke, dass diese recht bald wieder auferstehen und Nekromanten Skelette rufen."
Description[ENGLISH][22] = "Kill one skeleton. If there aren't enough skelettons please take into consideration the skeletons stand up soon and necromancer summon some."
...
Description[GERMAN][26] = "Gehe in den Unterschlupf des Kults der Salavesh und töte zwei menschliche Nekromanten. Solltest du keinen antreffen wäre es sinnvoll einen Tag später noch einmal vorbeizuschauen."
Description[ENGLISH][26] = "Go into the stronghold of the Cult of Salavesh and kill two human necromancer. If there is no necromancer to find you may come back a day later again."
Description[GERMAN][27] = "Töte noch einen menschlichen Nekromanten. Solltest du keinen antreffen wäre es sinnvoll einen Tag später noch einmal vorbeizuschauen."
Description[ENGLISH][27] = "Kill one human necromancer. If there is no necromancer to find you may come back a day later again."
...
Description[GERMAN][30] = "Gehe in den Unterschlupf des Kults der Salavesh und töte ein Dämonenskelett. Vielleicht brauchst du auch die Hilfe deiner Freunde um so ein schreckliches Monster zu töten."
...
Description[GERMAN][33] = "Gehe in den Unterschlupf des Kults der Salavesh und töte den Nachtdrachen. Wahrscheinlich solltest du deine Freunde bitten mitzukommen. Ein Nachtdrache ist nicht leicht zu töten."
