...
Description[ENGLISH][1] = "Collect ten apples for Baldo Proudtoe in Garden. You should start by collecting apples by standing infront of an appletree using the appletree."
...
Description[ENGLISH][3] = "Collect ten grapes for Baldo Proudtoe in Garden. You should start by collecting grapes by standing infront of an bush using the bush."
