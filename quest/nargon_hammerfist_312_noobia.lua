...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "An dieser Station lernst du, wie man Rohstoffe abbaut. Der Augenmerk liegt auf Bergbau aber im Prinzip laufen alle Sammelaktionen nach dem selben Schema ab. Nun, wer ist wohl der Richtige, um dir zu zeigen, wie man nach Gold gräbt? Natürlich ein Zwerg wie Nargon Hammerfist!\n\nRohstoffe werden durch das Benutzen eines geeigneten Werkzeuges in der Nähe einer Ressourcenquelle gesammelt."
