...
require("base.common")
module("quest.madoquar_112_wildness", package.seeall)
...
Description[ENGLISH][1] = "Search the dark presence not far to the east."
Description[GERMAN][2] = "Kehre zu Madoquar zurück."
Description[ENGLISH][2] = "Return to Madoquar."
Description[GERMAN][3] = "Gehe zu Madoquar, die sich am von Galmair aufhält. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][3] = "Go back to Madoquar near the harbour of Galmair, she certainly have another task for you."
...
Description[ENGLISH][4] = "Produce a battle axe and a bar of silver and bring them to Madoquar. You can buy them from a merchant or produce them of your own. You can produce a battle axe with a hammer in your hand on the anvil. A bar of silver you can melt out of silver or with a crucible in your hand in front of a furnace."
Description[GERMAN][5] = "Gehe zu Madoquar, die sich am von Galmair aufhält. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][5] = "Go back to Madoquar near the harbour of Galmair, she certainly have another task for you."
Description[GERMAN][6] = "Suche in einer Hausruine südlich der Eiche nach Leichenteilen und bring sie Madoquar."
Description[ENGLISH][6] = "Look in the ruins south of the oak for parts of a death body and bring them Madoquar."
Description[GERMAN][7] = "Kehre zu Madoquar zurück."
Description[ENGLISH][7] = "Return to Madoquar."
Description[GERMAN][8] = "Gehe zu Madoquar, die sich am von Galmair aufhält. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][8] = "Go back to Madoquar near the harbour of Galmair, she certainly have another task for you."
