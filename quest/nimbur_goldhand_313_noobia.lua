...
-- INSERT INTO "quests" ("qst_id", "qst_script") VALUES (313, 'nimbur_goldhand_313_noobia');

require("base.common")
module("quest.nimbur_goldhand_313_noobia", package.seeall)
...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "An dieser Station wird dir beigebracht, wie man einem Handwerk nachgeht. Nimbur Goldhand ist ein sehr begabter Artisan, der die nötigen Kenntnisse vermittelt, die du benötigst, um die Laufbahn des Handwerkers einzuschlagen. Handwerke erfordern ebenso wie das Sammeln von Ressourcen ein Handwerkzeug und einen Arbeitsplatz sowie die nötigen Rohstoffe."
Description[ENGLISH][1] = "At this station, you will learn how to craft items. Nimbur Goldhand is a very skilled artisan who can teach you the necessary steps to get started with a crafting profession. Crafting requires a hand tool, just like gathering, and a static tool. You also need the necessary resources."
