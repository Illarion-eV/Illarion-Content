...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "An dieser Station wird dir beigebracht, wie man einem Handwerk nachgeht. Nimbur Goldhand ist ein sehr begabter Artisane, der die nötigen Kenntnisse vermittelt, die du benötigst, um die Laufbahn des Handwerkers einzuschlagen.\n\nHandwerke erfordern ebenso wie das Sammeln von Ressourcen ein Handwerkzeug, einen Arbeitsplatz sowie die nötigen Rohstoffe."
...
Description[GERMAN][2] = "Arr, richtig. Hör zu! Ich werd' dir alles, was ich weiß, über's Schmieden beibringen. Hier, nimm diesen Hammer und diesen Barren und geh rein und komm nicht eher raus, bis du drei Nägel in deiner Tasche hast! Um zu schmieden, stell dich vor einen Amboss und benutze den in der Hand gehaltenen Hammer. Wähle dann ein Produkt aus dem Menü, um es zu fertigen."
