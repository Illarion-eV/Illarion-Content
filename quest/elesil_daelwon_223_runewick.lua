...
QuestTarget[9] = {position(843, 820, 0), position(736, 809, 0), position(845, 790, 0), position(910, 699, 0)} --Lunord Bridge, Runewick harbour, Merryglade, Shadow Gate
QuestTarget[10] = {position(894, 817, 0)}
QuestTarget[11] = {position(894, 817, 0)}
QuestTarget[12] = {position(894, 817, 0), position(696, 314, 0), position(122, 530, 0), position(347, 229, 0)} -- Hempty,Cadomyr,Galmair
