...
Description[GERMAN][2] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][2] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][3] = "Töte zwei Höllenhunde am Fuße des Vulkans für Obsidimine. Du benötigst noch zwei."
Description[ENGLISH][3] = "Kill two hell hounds at the volcano's base for Obsidimine. You still need two."
Description[GERMAN][4] = "Töte zwei Höllenhunde am Fuße des Vulkans für Obsidimine. Du benötigst noch einen."
...
Description[GERMAN][6] = "Kehre zu Obsidimine zurück. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][6] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][7] = "Obsidimine möchte, dass Du den Toll tötest, der bekannt ist als der Feuerspeier, so dass er den Berg weiter erforschen kann."
Description[ENGLISH][7] = "Obsidimine would like you to kill the troll known as the fire spitter so that he may explore the mountain more."
Description[GERMAN][8] = "Kehre zu Obsidimine zurück."
Description[ENGLISH][8] = "Return to Obsidimine."
Description[GERMAN][9] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][9] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][10] = "Finde alle Ebenen des Vulkans und der Drachenhöhle und erstatte Obsidimine Bericht. (Hinweis: Alle Ebenen müssen besucht werden, es gibt fünf Kontrollpunkte). "
...
Description[GERMAN][12] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][12] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][13] = "Durchsuche alle Vasen in den unteren Ebenen und finde Drachensteine jeder Farbe für Obsidimine."
...
Description[GERMAN][15] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][15] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][16] = "Überprüfe die Grabsteine in den Höhlen und finde heraus, welcher Drachen als 'Hasenfresser' bekannt war."
Description[ENGLISH][16] = "Check the tombstones in the caverns below and find out which dragon was know as the 'Bunny Eater'."
Description[GERMAN][17] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][17] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][18] = "Überprüfe das Heckenlabyrinth um eine Vision zu bekommen, was mit Eme passiert ist."
...
Description[GERMAN][20] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][20] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][21] = "Suche unten in den Särge nach Hinweisen für Eme's Ableben."
...
Description[GERMAN][23] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][23] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][24] = "Obsidimine glaubt dass Eme ein Familien-Medaillon in einem Fass oder einer Truhe in den Höhlen unterhalb zurück gelassen hat. Suche es für ihn."
...
Description[GERMAN][26] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][26] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][27] = "Suche nach der Laute im unteren Drachenlager und entferne eine der goldenen Seiten, damit Obsidimine sie Irmorom opfern kann."
...
Description[GERMAN][29] = "Geh zu Obsidimine. Er hat bestimmt noch eine weitere Aufgabe für dich."
Description[ENGLISH][29] = "Go back to Obsidimine he will surely have another task for you."
Description[GERMAN][30] = "Töten den Todesdrachen, so dass Obsidimine Frieden mit Eme's Tod schließen kann "
...
Description[GERMAN][32] = "Du hast alle Aufgaben für Obsidimine erledigt."
