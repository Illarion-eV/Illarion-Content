...
Description[GERMAN][7] = "Obsidimine möchte, dass Du den Troll tötest, der als Feuerspeier bekannt ist, sodass er den Berg weiter erforschen kann."
...
Description[GERMAN][13] = "Durchsuche alle Vasen in den unteren Ebenen und finde einen Drachenstein jeder Farbe für Obsidimine."
...
Description[GERMAN][16] = "Überprüfe die Grabsteine in den unteren Höhlengängen und finde heraus, welcher Drache als 'Hasenfresser' bekannt war."
...
Description[GERMAN][18] = "Überprüfe das Heckenlabyrinth, um eine Vision über Emes Schicksal zu bekommen."
...
Description[GERMAN][21] = "Suche unten in den Särgen nach Hinweisen über Emes Ableben."
...
Description[GERMAN][24] = "Obsidimine glaubt, dass Eme ein Familienmedaillon in einem Fass, oder einer Truhe in den Höhlen unterhalb zurückgelassen hat. Suche es für ihn."
...
Description[GERMAN][30] = "Töten den Todesdrachen, sodass Obsidimine Frieden mit Emes Tod schließen kann "
