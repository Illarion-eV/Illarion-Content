        ...
        if (originator:getQuestProgress(8) == 0) then
            ...
            if CheckMoney(originator,GCoins,SCoins,CCoins) then
                ...
                if not posOfCow then
                    ...
                    thisNPC:talk(Character.say, "Hier habt ihr den Esel. Bringt ihn sicher wieder dann bekommt ihr die "..(Kaution/100).." Silberstücke Kaution wieder.", "There you have your mule. Bring him back safely then you get your "..(Kaution/100).." silvercoins surety back.")
