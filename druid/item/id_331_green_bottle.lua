...
function UseItem( User, SourceItem, TargetItem, Counter, Param, ltstate )
	...
	if base.common.GetFrontItemID(User) == 1008 then -- infront of a cauldron?
	  ...
	  elseif (cauldron:getData("cauldronData") == "") then -- nothing in the cauldron, so the stock is being filled in
		  ...
		  User:talkLanguage(User.say, Player.german, "#me kippt eienn Sud in den Kessel.");
          User:talkLanguage(User.say, Player.english, "#me pours a stock tinto the cauldron.");
