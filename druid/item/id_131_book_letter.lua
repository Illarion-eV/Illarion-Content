...
--User:inform("debug 129-1")
    if base.books.InitBook() then
        ...
        base.books.AddGermanBookText("Es liegt nun einige Jahre zurï¿½ck, als das Kloster Eldan auf Gobaith im Rahmen einer kriegerischen Auseinandersetzung angegriffen, geplï¿½ndert und gebrandschatzt wurde.",0,0,0);
        ...
        base.books.AddGermanBookText("Der Abt des Klosters, Falk vom Wald, erkannte wohl, dass die wenigen Mï¿½nche einem massiven Angriff nicht wï¿½rden standhalten kï¿½nnen. Deshalb schickte uns der Alte weg, zwang uns zur Flucht und dazu, ihn alleine zurï¿½ckzulassen. Widerwillig haben wir uns damals gefï¿½gt und in alle Winde zerstreut. Mich fï¿½hrte das Schicksal an die Gestade des Festlandes, wo ich in aller Zurï¿½ckgezogenheit eine geraume Zeit lebte.",0,0,0);
        base.books.AddGermanBookText("Dort erreicht mich seinerzeit auch die Nachricht von der Niederlegung des Klosters. Vom Alten gab es damals keine einzige Spur. Wiederum einige Zeit später erreichte mich die Nachricht, das Klostergebï¿½ude sei wieder aufgebaut worden und werde seitdem von seinen neuen Besitzern bewohnt. Nie wieder wollte ich an diesen Ort zurï¿½ckkehren, ich blieb auf dem Festland, legte mein Mï¿½nchsgelï¿½bde nieder und erlernte den Beruf eines Zimmermanns.",0,0,0);
        ...
        base.books.AddGermanBookText("Mich fï¿½hrt mein Weg indes zurï¿½ck aufs Festland, nach der Errichtung des neuen Gewï¿½lbekellers gibt es für mich hier auf Gobaith nichts mehr zu tun.",0,0,0);
        base.books.AddGermanBookText("Mit dem Gruï¿½ unseres Abtes \'Eldan auf all Euren Wegen\' verbleibe ich in grï¿½ï¿½ter Hochachtung und wï¿½nsche dem Druidentum dieses Landes eine von Neuem erblï¿½hende Hochzeit. Mï¿½gen Euch die Gï¿½tter den Weg weisen, so wie ihn der Alte in seinen Studien so lange Zeit zu ergrï¿½nden und vorauszusehen suchte.",0,0,0);     
