...
function init()
	...
	rKey[151] = 35555555; rNameDE[151] = "Hï¿½hle der Kraft";     rNameEN[151] = "Cave Of Power";      --"strength"
	rKey[152] = 53555555; rNameDE[152] = "Hï¿½hle des Willens";   rNameEN[152] = "Cave Of Will";       --"willpower"
	rKey[153] = 55355555; rNameDE[153] = "Hï¿½hle der Sinne";     rNameEN[153] = "Cave Of Senses";     --"perception"
	rKey[154] = 55535555; rNameDE[154] = "Hï¿½hle des Wissens";   rNameEN[154] = "Cave Of Wit";        --"intelligence"
	rKey[155] = 55553555; rNameDE[155] = "Hï¿½hle des Fleisches"; rNameEN[155] = "Cave Of Endurance";  --"constitution"
	rKey[156] = 55555355; rNameDE[156] = "Hï¿½hle des Windes";    rNameEN[156] = "Cave Of The Wind";   --"agility"
	rKey[157] = 55555535; rNameDE[157] = "Hï¿½hle des Diebes";    rNameEN[157] = "Cave Of Thieves";    --"dexterity"
	rKey[158] = 55555553; rNameDE[158] = "Hï¿½hle des Geistes";   rNameEN[158] = "Cave Of Soul";       --"essence"
	...
	rKey[204] = 55565555; rNameDE[204] = "Quelle des Glï¿½cks";  rNameEN[204] = "Spring Of Luck";      --"luck"
	...
	rKey[207] = 55555565; rNameDE[207] = "Quelle des Fleiï¿½es"; rNameEN[207] = "Spring Of Diligence"; --"mental capacity"
	...
	rKey[214] = 55575555; rNameDE[214] = "Orden des Glï¿½cks";   rNameEN[214] = "Order Of Luck"; --"luck"
	...
	rKey[217] = 55555575; rNameDE[217] = "Orden des Fleiï¿½es";  rNameEN[217] = "Order Of Diligence"; --"mental capacity"
	...
	rKey[224] = 55585555; rNameDE[224] = "Tempel des Glï¿½cks";  rNameEN[224] = "Temple Of Luck"; --"luck"
	...
	rKey[227] = 55555585; rNameDE[227] = "Tempel des Fleiï¿½es"; rNameEN[227] = "Temple Of Diligence"; --"mental capacity"
	...
	rKey[234] = 55595555; rNameDE[234] = "Siegel des Glï¿½cks";  rNameEN[234] = "Sanctuary Of Luck"; --"luck"
	...
	rKey[237] = 55555595; rNameDE[237] = "Siegel des Fleiï¿½es"; rNameEN[237] = "Sanctuary Of Diligence"; --"mental capacity"
	...
	rKey[244] = 55545555; rNameDE[244] = "Kerker des Glï¿½cks";  rNameEN[244] = "Dungeon Of Luck"; --"luck"
	...
	rKey[247] = 55555545; rNameDE[247] = "Kerker des Fleiï¿½es"; rNameEN[247] = "Dungeon Of Diligence"; --"mental capacity"
	rKey[248] = 55555554; rNameDE[248] = "Kerker des Zaubers"; rNameEN[248] = "Dungeon Of Magic"; --"mana"
	rKey[249] = 35555555; rNameDE[249] = "Hï¿½hle des Lebens";   rNameEN[249] = "Cave Of Life"; --"hitpoints"
	rKey[250] = 53555555; rNameDE[250] = "Hï¿½hle des Riesen";   rNameEN[250] = "Cave Of Giants"; --"body_height"
	rKey[239] = 55355555; rNameDE[239] = "Hï¿½hle der Quellen";  rNameEN[239] = "Cave Of Sources"; --"foodlevel"
	rKey[240] = 55535555; rNameDE[240] = "Hï¿½hle des Glï¿½cks";   rNameEN[240] = "Cave Of Luck"; --"luck"
	rKey[229] = 55553555; rNameDE[229] = "Hï¿½hle der Qualen";   rNameEN[229] = "Cave Of Pain"; --"poisonvalue"
	rKey[230] = 55555355; rNameDE[230] = "Hï¿½hle des Ethos";    rNameEN[230] = "Cave Of Ethos"; --"attitude"
	rKey[219] = 55555535; rNameDE[219] = "Hï¿½hle des Fleiï¿½es";  rNameEN[219] = "Cave Of Diligence"; --"mental capacity"
	rKey[220] = 55555553; rNameDE[220] = "Hï¿½hle des Zaubers";  rNameEN[220] = "Cave Of Magic"; --"mana"
	...
	rKey[191] = 55525555; rNameDE[191] = "Hï¿½lle des Glï¿½cks";   rNameEN[191] = "Hell Of Luck"; --"luck"
	...
	rKey[194] = 55555525; rNameDE[194] = "Hï¿½lle des Fleiï¿½es";  rNameEN[194] = "Hell Of Diligence"; --"mental capacity"
	...
	rKey[199] = 55515555; rNameDE[199] = "Ende des Glï¿½cks";    rNameEN[199] = "Abyss Of Luck"; --"luck"
	...
	rKey[188] = 55555515; rNameDE[188] = "Ende des Fleiï¿½es";   rNameEN[188] = "Abyss Of Diligence"; --"mental capacity"
		...
		if Param==0 then
			...
			if Param > 3109 and Param < 3116 then
				...
				if User:getMagicType() == 3 then --and User:getSkill("library research") > math.random(130) then  
					...
					base.common.InformNLS(User,"Vorsicht, der Gebrauch dieser Pergamente ist nicht kostenlos. Du bezahlst Dein geheimes Wissen mit dem Verlust anderer Fï¿½higkeiten","Be careful! The usage of these parchments is not for free. You pay for that secret knowledge with the loss of other abilities!")
				else
					if User:getPlayerLanguage() == 0 then
