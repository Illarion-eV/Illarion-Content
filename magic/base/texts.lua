...
local M = {
    ...
    magicBookTexts = {
        ...
        type = {english = "Select what you want to do with the grimoire.", german = "Wähle, was du mit dem Grimoire tun möchtest."}, --Verification of chatGPT GERMAN TRANSLATION needed
