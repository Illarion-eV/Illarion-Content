--[[
    Icewall
    Rune 3 & 11 & 16 & 23 & 24
        HEPT IRA ANTH DUN QWAN

    Item-Spell

    SQL:    INSERT INTO spells VALUES (2^2+2^10+2^15+2^22+2^23,0,'m_03_11_16_23_24_icewall.lua');
]]

-- including the main script for item spells
require("magic.base.itemspell");
module("magic.spell_03_11_16_23_24_icewall.lua")
