--[[
    Firewall
    Rune 2 & 11 & 16 & 23 & 24
        RA IRA ANTH DUN QWAN

    Item-Spell

    SQL:    INSERT INTO spells VALUES (2^1+2^10+2^15+2^22+2^23,0,'m_02_11_16_23_24_firewall.lua');
]]

-- including the main script for item spells
require("magic.base.itemspell");
module("magic.spell_02_11_16_23_24_firewall", package.seeall)
-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
Script = "m_02_11_16_23_24_firewall.lua";
