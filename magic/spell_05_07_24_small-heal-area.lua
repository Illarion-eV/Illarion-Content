-- KLEINES FLÄCHENHEILEN
-- Rune 5 & 7 & 24 - MES PEN DUN
-- INSERT INTO spells VALUES (2^4+2^6+2^23,0,'m_05_07_24.lua');
-- Flächen Zauber
-- Effekt Zauber
...
--[[
    ...
    SQL:    INSERT INTO spells VALUES (2^4+2^6+2^23,0,'m_05_07_24_small-heal-area.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_05_07_24_small-heal-area.lua")
...
TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und {PP}n Händen beginnen in einem warmen Licht zu leuchten.",
