...
M.runeHintsBookTexts = {
    ...
    unwise = {
        english = "It hasn't been long enough since you last learned a rune, making it unwise to go searching for a new one. You may only learn two runes a week.",
        german = "Es ist noch nicht lange her, dass du nach einer Rune gesucht hast. Es wäre nicht klug jetzt schon wieder eine Neue zu suchen. Du kannst nur zwei Runen pro Woche lernen."},
    activated = {
