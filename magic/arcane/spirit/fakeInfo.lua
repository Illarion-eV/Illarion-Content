...
local healthScript = require("magic.arcane.spirit.health")
local magicResistance = require("magic.arcane.spirit.magicResistance")
local manaScript = require("magic.arcane.spirit.mana")
...
local function fakeGenderRace(user, targets, myTarget, spell)
    ...
    local englishGender
    local germanGender
    local raceList = creatures.raceList
    local racePrefixText = creatures.racePrefixText
    local genderTexts = creatures.genderTexts
...
local function fakeAttributes(user, targets, myTarget, spell)
    local statText = gatherInfo.statText
    local statValuesText = gatherInfo.statValuesText
    local callback = function(dialog)
...
local function fakeHealth(user, targets, myTarget, spell)
    local healthTexts = healthScript.healthTexts
...
local function fakePlayerMana(user, targets, myTarget, spell)
    local manaTexts = manaScript.manaTexts
