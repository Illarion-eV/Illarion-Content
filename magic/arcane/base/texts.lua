...
local M = {
    ...
    runeHintsBookTexts = {
        ...
        Kah = {rune = "Kah", hint = {english = "If a mortal were to require sustenance, much could be found here.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Kel = {rune = "Kel", hint = {english = "Where dark creatures of flight reside.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Lev = {rune = "Lev", hint = {english = "Once a glorious combat academy, now left in ruins. Oh the changes of time.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Lhor = {rune = "Lhor", hint = {english = "Trick you, fool you, lead you astray. Who am I?", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Luk = {rune = "Luk", hint = {english = "Among hostile elves, down down we go.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Mes = {rune = "Mes", hint = {english = "I light up the path for beings made of wood that have lost their way.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Orl = {rune = "Orl", hint = {english = "Created from an egg. Creepy, crawly, eight legged friends.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Pherc = {rune = "Pherc", hint = {english = "The pain of the desert heat is nigh as high as the pain of their axes.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Qwan = {rune = "Qwan", hint = {english = "On a mountain up high, where creatures of stone reside.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Sav = {rune = "Sav", hint = {english = "In a firey castle where dragons reside below.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Sih = {rune = "Sih", hint = {english = "Near water claimed by some to be capable of healing your very soul.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Sul = {rune = "Sul", hint = {english = "Rotten, smelly and cursed to be slow. Such is the fate of a civilization that met its demise.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Tah = {rune = "Tah", hint = {english = "Steal from the rich, give to the poor... as long as the poor are they themselves.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Taur = {rune = "Taur", hint = {english = "This secret is guarded by creatures that dwell in a cave. What do they look like, you ask? Do they have one head? Two? Are they ugly and deranged?", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Ura = {rune = "Ura", hint = {english = "Where the guardians of nature reside", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Yeg = {rune = "Yeg", hint = {english = "Muddy, grimey and full of despair. This place is not natural, of death beware.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
        Pera = {rune = "Pera", hint = {english = "Found in a place where a competition of speed is famously held.", german = ""}, name = { english = "", german = ""}, description = { english = "", german = ""}, location = position(0,0,0)},
