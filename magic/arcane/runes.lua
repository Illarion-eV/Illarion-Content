...
M.runes = {
    ...
    {id = 14, name = "KEL", cost = "Large", time = "Long", level = 50, active = true, auto = true},
    ...
    {id = 22, name = "SAV", cost = "Medium", time = "Medium", level = 40, active = true, auto = true},
    {id = 23, name = "SIH", cost = "Large", time = "Long", level = 80, active = true, auto = true},
    {id = 24, name = "SUL", cost = "Medium", time = "Medium", level = 50, active = true, auto = true},
    {id = 25, name = "TAH", cost = "Medium", time = "Medium", level = 50, active = true, auto = true},
