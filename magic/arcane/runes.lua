...
M.runes = {
    ...
    {id = 6, name = "BHONA", cost = "Small", time = "Short", level = 80, active = false},
    {id = 7, name = "Anth", cost = "Small", time = "Short", level = 10, active = false},
    {id = 8, name = "Dun", cost = "Large", time = "Long", level = 60, active = false},
    {id = 9, name = "Fhan", cost = "Large", time = "Long", level = 50, active = false},
    {id = 10, name = "Fhen", cost = "Small", time = "Short", level = 20, active = false},
    {id = 11, name = "Hept", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 12, name = "Ira", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 13, name = "Kah", cost = "Small", time = "Short", level = 20, active = false},
    {id = 14, name = "Kel", cost = "Large", time = "Long", level = 50, active = false},
    {id = 15, name = "Lev", cost = "Small", time = "Short", level = 10, active = false},
    {id = 16, name = "Lhor", cost = "Small", time = "Short", level = 30, active = false},
    {id = 17, name = "Luk", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 18, name = "Mes", cost = "Small", time = "Short", level = 20, active = false},
    {id = 19, name = "Orl", cost = "Large", time = "Long", level = 50, active = false},
    {id = 20, name = "Pherc", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 21, name = "Qwan", cost = "Large", time = "Long", level = 60, active = false},
    {id = 22, name = "Sav", cost = "Medium", time = "Medium", level = 40, active = false},
    {id = 23, name = "Sih", cost = "Large", time = "Long", level = 50, active = false},
    {id = 24, name = "Sul", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 25, name = "Tah", cost = "Medium", time = "Medium", level = 30, active = false},
    {id = 26, name = "Taur", cost = "Medium", time = "Medium", level = 40, active = false},
    {id = 27, name = "Ura", cost = "Medium", time = "Medium", level = 40, active = false},
    {id = 28, name = "Yeg", cost = "Medium", time = "Medium", level = 40, active = false},
