--[[
    Extinguish fireflame area
    Rune 2 & 4 & 24
        RA TAH DUN

    GFX-Spell

    SQL:    INSERT INTO spells VALUES (2^1+2^3+2^23,0,'m_02_04_24_extinguish-fire-area.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_02_04_24_extinguish-fire-area", package.seeall)
-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
Script = "m_02_04_24_extinguish-fire-area.lua";
...
TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und an {PP}n Händen bilden sich glitzernde Eiskristalle.",
