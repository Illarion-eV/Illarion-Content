--[[
    Extinguish poison cloud
    Rune 4 & 14
        YEG TAH

    GFX-Spell

    SQL:    INSERT INTO spells VALUES (2^3+2^13,0,'m_04_14_extinguish-poison.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_04_14_extinguish-poison", package.seeall)
-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
Script = "m_04_14_extinguish-poison.lua";
...
TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und um {PP} Füße beginnt Dreck und Staub vom Boden zu wirbeln.",
