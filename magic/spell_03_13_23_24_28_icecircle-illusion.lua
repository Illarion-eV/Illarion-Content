--[[
    Iceflame circle illusion
    Rune 3 & 13 & 23 & 24 & 28
        LHOR HEPT ANTH DUN SAV

    Item-Spell

    SQL:    INSERT INTO spells VALUES (2^2+2^12+2^22+2^23+2^27,0,'m_03_13_23_24_28_icecircle-illusion.lua');
]]

-- including the main script for item spells
require("magic.base.itemspell");
module("magic.spell_03_13_23_24_28_icecircle-illusion", package.seeall)
