--[[
    ...
    SQL:    INSERT INTO spells VALUES (2^2+2^23+2^27,0,'m_03_24_28_iceillusion-area.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_03_24_28_iceillusion-area", package.seeall)
-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
Script = "m_03_28_iceillusion.lua";
