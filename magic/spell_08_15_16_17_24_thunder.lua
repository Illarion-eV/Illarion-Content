--[[
    Thunderstorm
    Rune 8 & 15 & 16 & 17 & 24
        JUS SOLH DUN ORL QWAN

    GFX-Spell

    SQL:    INSERT INTO spells VALUES (2^7+2^14+2^15+2^16+2^23,0,'m_08_15_16_17_24_thunder.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_08_15_16_17_24_thunder", package.seeall)
-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
Script = "m_08_15_16_17_24_thunder.lua";
...
TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und in {PP}n Händen beginnen kleine Blitze zu zucken.",
