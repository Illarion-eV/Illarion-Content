...
function Init()
    ...
    AddPlant(134,{4},1,{6,1,5,10},0);          -- Vierbl�ttrige Einbeere
    AddPlant(135,{1},1,{10,6,3,0},0);          -- Gelbkraut
    AddPlant(136,{5},1,{4,3,10,7},0);          -- Wutbeere
    AddPlant(137,{3},1,{3,1,4,10},0);          -- Flammkelchbl�te
    AddPlant(138,{2,7},1,{2,2,9,5},0);         -- Nachtengelsbl�te
    ...
    AddPlant(145,{4},1,{10,6,3,0},0);          -- Heidebl�te
    AddPlant(146,{3},1,{6,5,10,5},0);          -- W�stenhimmelkapsel
    AddPlant(148,{5},1,{2,10,3,0},0);          -- Firnisbl�te
    ...
    AddPlant(133,{4},1,{8,10,6,0},9001); -- "Einbl�ttrige Vierbeere" / "oneleaved fourberry" 
    ...
    AddPlant(137,{4},1,{6,0,6,10},9005); -- "Wasserbl�te" / "water blossom"
    ...
    AddPlant(142,{3},1,{0,6,10,6},9009); -- "W�stenbeere" / "desert berry"
    ...
    AddPlant(148,{2},1,{6,10,6,0},9014); -- "Trugbl�te" / "con blossom" 
