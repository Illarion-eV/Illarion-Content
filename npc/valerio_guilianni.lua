...
talkEntry:addTrigger("Mordak al Kharud");
talkEntry:addResponse("#me nods and hands you an item silently.");
talkEntry:addConsequence(npc.base.consequence.item.item(284, 1, 999, {["magicalSapphire"] = "1"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(633, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addTrigger("Mordak al Kharud");
talkEntry:addResponse("#me nods and hands you an item silently.");
talkEntry:addConsequence(npc.base.consequence.item.item(283, 1, 999, {["magicalObsidian"] = "1"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(633, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
