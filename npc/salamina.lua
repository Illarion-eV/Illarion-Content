...
VALUES (0, 0, 0, 0, 4, 'Salamina', 'npc.salamina', 1, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
mainNPC:setLookat("Dieser NPC ist Salamina der <Beruf/Funktion>.", "This NPC is Salamina the Dirtsage.");
