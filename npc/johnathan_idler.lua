...
-- NPC Job:  Scolar                                                           --
--                                                                            --
-- NPC Race: human                      NPC Position:  909, 816, 1            --
...
VALUES (0, 909, 816, 1, 4, 'Johnathan Idler', 'npc.johnathan_idler', 0, 2, 5, 221, 199, 140, 255, 210, 204);
---]]
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Jonathan Idler the <profession/function>. Keywords: TRIGGER1, TRIGGER2, TRIGGER3, TRIGGER4, TRIGGER5."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist Jonathan Idler  der <Beruf/Funktion>. SchlÃ¼sselwÃ¶rter: TRIGGER1, TRIGGER2, TRIGGER3, TRIGGER4, TRIGGER5."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Ah, the lizzard lady Zaissa send you? I'm very buys with my studies right now, but i'll see her later. Can you tell her, please?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("Lizzard");
talkEntry:addTrigger("oil lamp");
talkEntry:addResponse("Ah, die Echsendame Zarissa schickt Euch? Ich bin zur Zeit sehr mit meinen Studien beschäftigt, bitte richtet ihr aus, dass ich sie später aufsuchen werde.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("I finally got the oil lamp.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addResponse("Ich hab nun endlich die Öllampe erhalten.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Um den Verstand zu schulen habe ich viele Bücher gelesen.");
...
talkEntry:addResponse("This place here is Runewick.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("The Queen is said to be very beautiful, I wonder if it's true...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Birth is more important than money in Albar.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("#me zupft an seinem Bart.", "ENGLISH.");
talkingNPC:addCycleText("#me liest in einem Buch.", "ENGLISH.");
talkingNPC:addCycleText("#me starrt versonnen vor sich hin.", "ENGLISH.");
talkingNPC:addCycleText("#me rückt seine Brille zurecht.", "ENGLISH.");
talkingNPC:addCycleText("#me murmelt leise ein paar Formlen.", "ENGLISH.");
talkingNPC:addCycleText("#me fährt mit dem Finger über den Tisch.", "ENGLISH.");
talkingNPC:addCycleText("#me blättert in einem Buch herum.", "ENGLISH.");
talkingNPC:addCycleText("#me macht sich Notizen in einem zerfledderten Büchlein.", "ENGLISH.");
talkingNPC:addCycleText("#me trinkt eine Tasse Tee.", "ENGLISH.");
talkingNPC:addCycleText("Ah ja... so macht das Sinn...", "ENGLISH.");
