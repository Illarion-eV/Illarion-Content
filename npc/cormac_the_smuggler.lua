--------------------------------------------------------------------------------
-- NPC Name: Cormac the Smuggler                                         None --
-- NPC Job:  none                                                             --
--                                                                            --
...
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(74, "=", 0));
...
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(74, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(74, "=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
