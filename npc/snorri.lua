...
-- Author:   Rincewind                                                        --
--                                                                            --
-- Last parsing: February 09, 2011                       easyNPC Parser v1.02 --
--------------------------------------------------------------------------------
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Snorri the fishmonger. Keyphrases: fish, orc, morri, nose, dwarf."));
