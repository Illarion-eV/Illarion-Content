...
VALUES (0, 0, 0, 0, 4, 'Skot', 'npc.skot', 0, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
module("npc.skot", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is <Skot> the <Skot>. Keyphrases: TRIGGER1, TRIGGER2, TRIGGER3, TRIGGER4, TRIGGER5."));
...
talkingNPC:addCycleText("GERMAN.", "...");
talkingNPC:addCycleText("GERMAN.", "...");
talkingNPC:addCycleText("GERMAN.", "...");
talkingNPC:addCycleText("GERMAN.", "...");
talkingNPC:addCycleText("GERMAN.", "...");
...
mainNPC:setLookat("Dieser NPC ist Skot der <...>.", "This NPC is Skot the <profession/function>.");
