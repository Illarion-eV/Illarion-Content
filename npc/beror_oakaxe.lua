...
talkEntry:addResponse("Time for some serious action! Please patrol the Candour Foundation, the Circle of Blood, the northern bridge over the Envy Creek and the eastern border. Make Cadomyr's homeland a safe place!");
...
talkEntry:addResponse("Zeit für wahre Heldentaten. Patroulliere bitte den Grundstein der Aufrichtigkeit, den Blutkreis, die nördliche Brücke über den Neidbach und die Ostgrenze. Sorge dafür, dass das Hinterland Cadomyrs sicher ist!");
talkEntry:addConsequence(npc.base.consequence.quest.quest(111, "=", 9));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addResponse("The Candour Foundation is a mine to the south, the Circle of Blood is the arena of these lands, the northern bridge over the Envy Creek is in the north and your patrol should also lead you to the eastern border.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.quest.quest(111, "=", 9));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addResponse("Der Grundstein der Aufrichtigkeit ist eine Mine im Süden, der Blutkreis die Arena dieses Landes, die nördliche Brücker über den Neidbach ist im Norden und deine Patroullie sollte dich auch an die Ostgrenze führen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
