...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("I have heard that there are portals all over Gobaith. They seem to be linked with each other somehow. You step inside, announce where you want to go and in a blink of an eye you are there. I would never use such a magic device.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Portal");
talkEntry:addCondition(npc.base.condition.language.language("german"));
talkEntry:addResponse("Ich habe gehört, das es überall auf Gobaith Portale gibt. Sie scheinen irgendwie miteinander verbunden zu sein. Man betritt sie, sagt wohin man will und im nächten Augenblick ist man dort. Ich würde nie ein solches magisches Gerät benutzen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(72, "=", 1));
talkEntry:addCondition(npc.base.condition.item.item(1840, "all", "<", 5));
talkEntry:addCondition(npc.base.condition.language.language("german"));
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(72, "=", 3));
talkEntry:addCondition(npc.base.condition.item.item(2390, "all", "<", 2));
talkEntry:addCondition(npc.base.condition.language.language("german"));
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(72, "=", 5));
talkEntry:addCondition(npc.base.condition.item.item(2420, "all", "<", 5));
talkEntry:addCondition(npc.base.condition.language.language("german"));
talkEntry:addResponse("Ich weiss, dass fünf schwarze Priesterroben nicht leicht zu bekommen sind, aber mit Ronagans Segen wird es Euch sicher gelingen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.item.item(2420, "all", "<", 5));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("I know that five black priest robes are not easy to get but with Ronagan's blessing you will succeed.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(72, "=", 7));
talkEntry:addCondition(npc.base.condition.item.item(2785, "all", "<", 1));
talkEntry:addCondition(npc.base.condition.language.language("german"));
