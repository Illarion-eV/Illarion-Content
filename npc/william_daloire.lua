...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help]This NPC is William Daloire the herbalist. Keywords: buy, sell, greetings, profession, tell something."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist William Daloire der Kräuterkundige. Schlüsselwörter: kaufe, verkaufe, Grüße, Beruf, erzähl was."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
