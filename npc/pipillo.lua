...
talkEntry:addResponse("Pipillo, portal book merchant. That's me.");
talkEntry:addResponse("I am the merchant Pipillo.");
talkEntry:addResponse("Pipillo is my name, I trade portal books.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch nach Runewick","portal book to Runewick",2000,1,333,{["destinationCoordsY"] = "813", ["destinationCoordsX"] = "836", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to Runewick", ["descriptionDe"] = "Portal nach Runewick"}));
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch zum Hemp Necktie Inn","portal book to the Hemp Necktie Inn",2000,1,333,{["destinationCoordsY"] = "308", ["destinationCoordsX"] = "683", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to the Hemp Necktie Inn", ["descriptionDe"] = "Portal zum Hemp Necktie Inn"}));
...
mainNPC:setLookat("Dieser NPC ist Pipillo der Portalbuchhändler.", "This NPC is Pipillo the portal book merchant");
