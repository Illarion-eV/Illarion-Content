...
-- NPC Job:  trader                                                           --
--                                                                            --
-- NPC Race: human                      NPC Position:  366, 275, 0            --
...
VALUES (0, 366, 275, 0, 6, 'Nik Nilo', 'npc.nik_nilo', 0, 1, 1, 193, 96, 28, 217, 154, 123);
---]]
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This is 'Big Nik', he is a tool and supply trader. Keywords: sell, buy, trade, Hello, profession, laws."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1062,"sell"));
...
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1062,"buyPrimary"));
