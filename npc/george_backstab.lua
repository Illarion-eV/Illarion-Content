...
VALUES (0, 354, 872, 0, 4, 'George Backstab', 'npc.george_backstab', 0, 0, 5, 28, 28, 28, 255, 99, 71);
---]]
...
module("npc.george_backstab", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist George Backstab der Gefangene. Schlüsselwörter: Gefängnis, befreien, Tür, Flucht."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Bitte befreit mich aus diesem Gefängnis durch das öffnen der Tür. Die halten mich gefangen, obwohl nichts getan habe.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Hilf mir bei der Flucht durch das öffnen dieser Tür und ich werde dir auch helfen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Runewick");
talkEntry:addResponse("Von mir zu dir, die sind dummer als es erlaubt ist.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("George");
talkEntry:addTrigger("Backstab");
talkEntry:addResponse("Oh, du kennest meinen Namen. Kannst du die Tür bitte öffnen?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Yes");
talkEntry:addResponse("I don't care. Open this damn door!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Ja");
talkEntry:addResponse("Mir egal. Mach diese verdammte Tür auf!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Damn! Open this door. We can talk afterwards.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.chance.chance(20.0));
talkEntry:addTrigger(".*");
talkEntry:addResponse("Die Tür sollst du aufmachen, verdammt! Den Rest können wir später bereden.");
talkingNPC:addTalkingEntry(talkEntry);
end;
talkingNPC:addCycleText("#s Die kommen, die kommen! Öffne meine Tür und helfe dir beim Überleben!", "#s They are coming, they are coming. Open the door and I will help you to survive!");
