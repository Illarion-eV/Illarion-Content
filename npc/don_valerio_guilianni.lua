...
function initializeNpc()
    ...
    AddAdditionalText("Hm? Tragt eure Sache dem Don vor aber fasst es kurz oder ich mache euch ein Angebot dass ihr nicht ablehnen könnt.");
    ...
    AddAdditionalText("#me gives a brief nod and then turns away 'Hm. An interresting person, gonna go far one day, too far.  should administer his observation.");
    ...
    AddAdditionalText("#me nickt nur knapp und wendet sich dann ab 'Hm. Eine interessante Person, könnte es weit bringen, zu weit.  soll ihn beschatten lassen.'");
    ...
    AddTraderTrigger("your name","#me makes a broad welcoming gesture with his hands 'Ah forgive my manners. Valerio Guilianni is my name but call me Don.'");
    ...
    AddTraderTrigger("dein name","#me macht eine ausladende willkommende Geste 'Ah meine Manieren. Valerio Guilianni ist mein Name aber nennt mich Don.'");
    ...
    AddTraderTrigger("what sell","I don't sell anything, I grant favors.");
    ...
    AddCondition("lang","english");
    AddAdditionalText("As far as I heard, Trollsbane could easily compete with Galmair in terms of security, quality of life and civil rights.");
    AddTraderTrigger("Gobaith","Ja, eine Schande. Tragisch, furchtbar. Und dabei herrschten ideale Bedingungen um ein zweites Galmair zu errichten.");
    AddCondition("lang","german");
    AddAdditionalText("Soweit ich gehört habe stand Trollsbane Galmair in Sicherheit, Lebensqualität und politischer Mitsprache um nichts nach.");
    ...
    AddCondition("lang","english");
    AddAdditionalText("Believe me, it is my priviledge alone to call her that way. Don't you even try.");
    AddTraderTrigger("Rosie","Sie mag den Namen nicht, ihr werdet sie eher als Königin Rosaline kennen.");
    AddCondition("lang","german");
    AddAdditionalText("Glaubt mir, das Privileg sie so zu nennen ist allein mir vorbestimmt. Versucht es erst garnicht.");
    -- Faction stuff
    ...
    AddCondition("lang","english");
    AddAdditionalText("You've heard from me I see. Very good, very good. Ask and the Don will help you.");
    ...
    AddAdditionalTrigger("Don");
    AddCondition("lang","german");
    AddAdditionalText("Ihr habt also von mir gehört. Sehr schön, sehr schön. Fragt und der Don wird euch helfen.");
    ...
    AddCondition("lang","english");
    AddAdditionalText("Manchmal, wenn ich früh aufstehe und von den Zinnen hinabblicke kann ich den Erfolg und Profit von Galmair fast riechen.");
    AddTraderTrigger("Galmair","Galmair ist eine wilde Gebirgsblume, die jeden Wanderer mit ihrer Schönheit in ihren Bann zieht.");
    AddCondition("lang","german");
    AddAdditionalText("Sometimes, if I am up early and look down from the battlement I can nearly smell the sucess and profit of Galmair.");
    ...
    AddCondition("lang","german");
    AddTraderTrigger("gynk","");
    AddAdditionalTrigger("gync");
    AddCondition("lang","english");
    PARSER_ERRORAddTraderTrigger("gync","Ehrenwerte ehemalige 'Geschäftspartner' meines Vaters wohnten dort. Wir mussten sie leider terminieren. Die Geschäftsbeziehungen meine ich.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("salkama","Auch wenn sie sich gerne als nobel geben, viele kommen zu uns nach Galmair um sich zu amüsieren. Ihr Laster bringt uns Zaster, hehe.");
    AddCondition("lang","german");
    -- Gods; gods are relevant, so the faction leader has to have an opinion on ALL gods
    AddTraderTrigger("Adron","Ahh, what would a tavern be without him? How could tempers run high over a game of cards if not due to Adrons gifts?");
    AddCondition("lang","english");
    ...
    AddTraderTrigger("Bragon","I wonder if he takes offence in my dragonleather boots. But didn't he leave this world already? If you can't stand the heat, get out of the kitchen, hehe.");
    AddAdditionalTrigger("Brágon");
    AddCondition("lang","english");
    PARSER_ERRORAddTraderTrigger("Bragon","Ich frage mich ob er meine Stiefel aus Drachenleder anstößig findet. Aber hat er diese Welt nicht schon verlassen? Und was er nicht weiß macht ihn nicht heiß.");
    AddAdditionalTrigger("Brágon");
    ...
    AddTraderTrigger("Irmorom","As Galmairs wealth comes from mining and processing ores it would be foolish not to drink a mug of beer regularly in honor of the great craftsman, right?");
    AddCondition("lang","english");
    AddTraderTrigger("Irmorom","Da Galmair vorallem vom Bergbau und dessen Weiterverarbeitung lebt wäre es töricht nicht regelmäßig einen Krug Bier für den großen Handwerker mitzutrinken, nicht?");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Malachin","Hah, ehrenhaft wer einen Pfeil dafür empfängt seinen Kameraden in der Schlacht zu retten. Weiß er nicht wie weh sowas tut!?");
    AddAdditionalTrigger("Malachín");
    ...
    AddAdditionalTrigger("Nargún");
    AddTraderTrigger("Oldra","You're kidding, right?");
    AddCondition("lang","english");
    AddTraderTrigger("Oldra","Wir leben inmitten eines kargen Gebirges, und da soll ich Oldra respekt erweisen? Pfft... also bitte.");
    AddTraderTrigger("Ronagan","");
    AddCondition("lang","english");
    PARSER_ERRORAddTraderTrigger("Ronagan","Kein Geldstück, keine Ware verlässt meinen Besitz bevor sie nicht in Gebete zu Ronagan mit eingeschlossen wurde. Spekulationen warum ich das mache seien euch selbst überlassen.");
    ...
    AddTraderTrigger("Tanora","");
    AddCondition("lang","english");
    PARSER_ERRORAddTraderTrigger("Tanora","Nach der Schneeschmelze im Frühling glaube ich manchmal dass wir Tanora nicht genug huldigen. Wenn die Überschwemmungen aber beseitigt sind verdränge ich diese Gedanken wieder.");
    AddTraderTrigger("Ushara","Some of the dwarves pray towards her. They say if we don't, the mountain will collapse upon us. Whatever.");
    AddCondition("lang","english");
    ...
    AddTraderTrigger("quest","The day will come, when the Don will ask you for a favor. Ask my advisor if that day is today.");
    AddCondition("lang","english");
    AddTraderTrigger("quest","Es wird der Tag kommen, an dem dich der Don um einen Gefallen bittet. Frage meinen Berater ob heute dieser Tag ist.");
    AddCondition("lang","german");
    AddTraderTrigger("task","You know, the Don starts to like you. And he'll get you a task to do. Ask my advisor for how you can earn the Dons favor.");
    AddAdditionalTrigger("adventure");
    AddTraderTrigger("Auftrag","Weißt du, der Don mag dich. Und der Don wird dir auch eine Arbeit verschaffen. Frag meinen Berater wie du in der Gunst des Don steigen kannst.");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    -- Easter egg
    AddTraderTrigger("Corleone","Ach, a dazzler from Gynka, no honor. And throaty all the time, gods know why.");
    AddCondition("lang","english");
