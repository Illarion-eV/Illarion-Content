...
VALUES (0, 1000, 779, -3, 5, 'Manuel Salan', 'npc.manuel_salan', 0, 1, 2, 180, 114, 69, 217, 154, 123);
---]]
...
module("npc.manuel_salan", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is the arena master Manuel Salan Keywords: Hello, monster, fight, ranklist, points."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist der Arenameister Manuel Salan. Schlüsselwörter: Hallo, Monster, Kämpfen, Rangliste, Punkte."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
