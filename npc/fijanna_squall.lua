...
talkEntry:addResponse("Come back, anytime you want to hear bout your fortune.");
...
talkEntry:addResponse("Komm einfach wieder vorbei wenn dfu etwas über deine Zukunft erfahren möchtest.");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addResponse("Do you want to hear your Fortune in exange for ten silver coins? Say yes or no.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Stray away from trouble as far as possible.");
...
talkEntry:addResponse("Fordere das Glück nicht herraus.");
...
talkEntry:addResponse("Sei fleißig und du wirst es nicht bereuhen.");
...
talkEntry:addResponse("You will make a positive experience.");
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Findari");
talkEntry:addResponse("Oh, die Göittin der Luft. All meine Gebete gelten ihr.");
