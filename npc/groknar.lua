...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] You can attack other creatures with a click of the right mouse button."));
...
talkEntry:addCondition(npc.base.condition.quest.quest(311, "<", 2));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] Du kannst andere Kreaturen angreifen, indem du sie mit der rechten Maustaste anklickst."));
