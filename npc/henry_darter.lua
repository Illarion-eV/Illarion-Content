...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.skill.skill(Character.cooking, "<", 90));
...
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cooking, "+", 1));
