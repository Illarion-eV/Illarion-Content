...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", "<", 90));
...
talkEntry:addConsequence(npc.base.consequence.skill.skill(2, "cookingAndBaking", "+", 1));
