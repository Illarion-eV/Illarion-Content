...
VALUES (2, 1000, 6, 0, 4, 'Fosco Goodbarrel', 'npc.fosco_goodbarrel', 0, 5, 1, 123, 62, 9, 245, 180, 137);
---]]
...
talkEntry:addConsequence(npc.base.consequence.item.item(354, 1, 599, 0));
