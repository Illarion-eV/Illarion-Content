...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 500 copper coins, a magical bluestone and a steel tower shield. You advance in Queen Rosaline Edwards's favour."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 500 copper coins, a magical bluestone and a steel tower shield."));
talkEntry:addResponse("Great! How much I love it when evil falls! I give you my shield; bear it with honour. But I give it to you for a reason; to complete my mission.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 500));
talkEntry:addConsequence(npc.base.consequence.item.item(96, 1, 888, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(284, 1, 333, {["magicalBluestone"] = "1"}));
...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 2000 copper coins, a magical topaz and an albarian noble's armour. You advance in Queen Rosaline Edwards's favour."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 2000 copper coins, a magical topaz and an albarian noble's armour."));
talkEntry:addResponse("You did what! You ended the life of one of the most noble creatures of Illarion? How you dare! How... did I dare to send you on this mission. I have to resign as knight of the Order of the Silver Dragon - I surrender my armour and my belongings to you.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 2000));
talkEntry:addConsequence(npc.base.consequence.item.item(2367, 1, 988, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(198, 1, 333, {["magicalTopaz"] = "2"}));
