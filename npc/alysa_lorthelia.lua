...
function initializeNpc()
    ...
    npc.base.autonpcfunctions.AddConsequence("inform","[Game Help] This is NPC is the cook Alysa Lorthelia. Keyphrases: Hello, cook, YOURTRIGGER1, YOURTRIGGER2.");
    npc.base.autonpcfunctions.AddTraderTrigger("Hilfe","");
    npc.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist die Köchin Alysa Lorthelia. Schlüsselwörter: Hallo, Köchin, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
