...
talkEntry:addCondition(npc.base.condition.item.item(463, "all", "<", 5));
talkEntry:addCondition(npc.base.condition.language.language("english"));
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 1));
talkEntry:addCondition(npc.base.condition.item.item(463, "all", ">", 4));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 200 copper coins. You advance in Queen Rosaline Edwards' favour."));
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(463, 5));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 50 copper coins and a large metal shield. You advance in Queen Rosaline Edwards' favour."));
...
talkEntry:addConsequence(npc.base.consequence.item.item(20, 1, 599, 0));
...
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 4));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 50 copper coins and a large metal shield."));
talkEntry:addResponse("Very good, now Robertus has the sketch the queen drew. As messenger of the queen, you deserve this shield with her crest.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 50));
talkEntry:addConsequence(npc.base.consequence.item.item(20, 1, 599, 0));
talkEntry:addConsequence(npc.base.consequence.quest.quest(108, "=", 5));
...
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 4));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 50 Kupferstücke und einen großen Metallschild. Dein Ansehen bei Königin Rosaline Edwards steigt."));
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 4));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 50 Kupferstücke und einen großen Metallschild."));
talkEntry:addResponse("Sehr gut, nun hat Robertus die Skizze der Königin. Als Bote der Königin verdient ihr diesen Schild mit ihrem Wappen.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 50));
talkEntry:addConsequence(npc.base.consequence.item.item(20, 1, 599, 0));
talkEntry:addConsequence(npc.base.consequence.quest.quest(108, "=", 5));
...
talkEntry:addConsequence(npc.base.consequence.item.item(444, 1, 699, 0));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 400 copper coins. You advance in Queen Rosaline Edwards' favour."));
...
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 10));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 400 Kupferstücke. Dein Ansehen bei Königin Rosaline Edwards steigt."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded a magical topaz ring. You advance in Queen Rosaline Edwards' favour."));
...
talkEntry:addConsequence(npc.base.consequence.item.item(282, 1, 999, 71));
...
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 13));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded a magical topaz ring."));
talkEntry:addResponse("You helped her majesty a lot. Please maintain silence about your journey. Your silence is worth your life and for me, it is worth this ring.");
talkEntry:addConsequence(npc.base.consequence.item.item(282, 1, 999, 71));
talkEntry:addConsequence(npc.base.consequence.quest.quest(108, "=", 14));
talkingNPC:addTalkingEntry(talkEntry);
...
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 13));
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst einen magischen Topasring. Dein Ansehen bei Königin Rosaline Edwards steigt."));
...
talkEntry:addTrigger(".+");
talkEntry:addCondition(npc.base.condition.quest.quest(108, "=", 13));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst einen magischen Topasring."));
talkEntry:addResponse("Ihr habt ihrer Majestät sehr geholfen. Bitte bewahrt Stillschweigen über eure Reise. Euer Schweigen ist euch euer Leben und mir diesen Ring wert.");
talkEntry:addConsequence(npc.base.consequence.item.item(282, 1, 999, 71));
talkEntry:addConsequence(npc.base.consequence.quest.quest(108, "=", 14));
talkingNPC:addTalkingEntry(talkEntry);
