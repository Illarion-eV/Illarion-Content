...
VALUES (0, 0, 0, 0, 4, 'Foduhrah', 'npc.foduhrah', 0, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
module("npc.foduhrah", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Foduhrah the <Flamesage>. Keyphrases: Waresage, Fire, Apling, Gods."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist Foduhrah der <Beruf/Funktion>. Schlüsselwörter: TRIGGER1, TRIGGER2, TRIGGER3, TRIGGER4, TRIGGER5."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("I live in the service of Archmage Elvaine by the grace of Apling the Lifesage.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("My kin has only ever known about thirty others in our lifetime, so we do not know how to talk so much, unlike the elves.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Apling.");
talkEntry:addResponse("He saved me from a life of servatude.");
talkEntry:addResponse("He rescued me from the circus.");
talkEntry:addResponse("Sir Apling saw that I was pristine in my use of flame. He spent years working with me until my physical ability to defend myself was up to par.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
mainNPC:setLookat("Dieser NPC ist Foduhrah der <--->.", "This NPC is Foduhrah the <Flamesage>.");
