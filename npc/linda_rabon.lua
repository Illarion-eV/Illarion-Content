...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Linda Rabon the Cook. Keyphrases: Hello, Good day."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist Linda Rabon die Khin. Schl・selwter: TRIGGER1, TRIGGER2, TRIGGER3, TRIGGER4, TRIGGER5."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("Wie f・lst");
...
talkEntry:addTrigger("wie heiﾟt");
talkEntry:addResponse("GERMAN1.");
talkEntry:addResponse("GERMAN2.");
talkEntry:addResponse("GERMAN3.");
talkingNPC:addTalkingEntry(talkEntry);
...
talkEntry:addTrigger("Narg佖");
talkEntry:addTrigger("Narg");
talkEntry:addCondition(npc.base.condition.language.language("english"));
