...
--           Estralis Seborian                                                --
--                                                                            --
-- Last parsing: September 11, 2012                       easyNPC Parser v1.2 --
--------------------------------------------------------------------------------
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2952, 5));
talkEntry:addConsequence(npc.base.consequence.item.item(67, 1, 677, 0));
