--------------------------------------------------------------------------------
-- NPC Name: Chalpal                                                     None --
-- NPC Job:  Aqua Warsage                                                     --
--                                                                            --
...
VALUES (0, 0, 0, 0, 4, 'Chalpal', 'npc.chalpal', 1, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
module("npc.chalpal", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is <Chal Pal> the <Aquasage>. Keyphrases: Waresage, Aqua, Hero, Gods."));
...
talkingNPC:addCycleText("GERMAN.", "Haha.");
...
talkingNPC:addCycleText("GERMAN.", "Fo needs to be more social. He gives orcs a bad name, haha.");
talkingNPC:addCycleText("GERMAN.", "I'm going to die soon. I'm just kidding I'm not human, haha.");
mainNPC:addLanguage(0);
mainNPC:addLanguage(1);
mainNPC:setDefaultLanguage(0);
mainNPC:setLookat("Dieser NPC ist <> der <>.", "This NPC is <Chalpal> the <Aquasage>.");
