...
talkEntry:addResponse("Well done, thank you. You can keep it for your next task.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(704, "=", 2));
talkEntry:addResponse("Gut gemacht, danke. Behaltet sie für die nächste Aufgabe.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
