...
talkEntry:addResponse("They have a very honourable chief.");
...
talkEntry:addResponse("Hmm... are you sure? However, find out, in which age did Bragon help to create the orks? I think it was the fourth. However, I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 11));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, in welchem Zeitalter Bragon half die Orks zu schaffen! Ich denke es war das vierte. Wie auch immer, ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 11));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: In which age did Bragon help to create the orks? I think it was the fourth. Now, go, find a priest for the information and don't waste my time until you have it!");
...
talkEntry:addCondition(npc.base.condition.state.state("=", 1));
talkEntry:addCondition(npc.base.condition.quest.quest(600, "=", 11));
talkEntry:addResponse("Ich habe euch gefragt: In welchem Zeitalter Bragon half die Orks zu schaffen! Ich denke es war das vierte. Geht nun, findet einen Priester für die Information und verschwendet meine Zeit nicht bis ihr sie habt!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 3));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what was the reason for Bragons to support the Bloodgod in the creation of the orcs! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 12));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(11));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, was der Grund für Bragons Unterstützung für den Blutgott in der Erschaffung der Orks war! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 12));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What was the reason for Bragons to support the Bloodgod in the creation of the orcs? Now, go, find a priest for the information and don't waste my time until you have it!");
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what is Bragon for the orcs... something with like a purge or similar, but i cannot remember! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 13));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(13));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, was Bragon für die Orks ist... etwas mit Vernichter oder ähnlichem, aber ich kann mich nicht mehr recht erinnern! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 13));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What is Bragon for the orcs... something with like a purge or similar, but i cannot remember! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, in which age did Bragon realize that the creation of the orcs could not change the Bloodgod! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 14));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(14));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, in welchem Zeitalter Bragon bemerkt hat, dass die Erschaffung der Orks den Blutgott besänftigen konnte! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 14));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: In which age did Bragon realize that the creation of the orcs could not change the Bloodgod! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what do the orcs use as name for Bragon... something with sun! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 15));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What do the orcs use as name for Bragon... something with sun! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what did Bragon in order to remedy his mistake of helping to create the orcs! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 16));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(20));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, was Bragon in Bezug auf die Wiedergutmachung seines Fehlers durch die Erschaffung der Orks tat! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 16));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What did Bragon in order to remedy his mistake of helping to create the orcs! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what kind of relationship was it between Bragon and the Bloodgod! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 17));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(25));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, was verbindet Bragon und dem Blutgott! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 17));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What kind of relationship was it between Bragon and the Bloodgod! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, Hmm... are you sure? However, find out, what do the orcs use as name for Bragon... something with summer! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 18));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What do the orcs use as name for Bragon... something with summer! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, why are orcs praying to Bragon! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 19));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: Why are orcs praying to Bragon! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... are you sure? However, find out, what has it to do with the so called 'Tribunal of Eternity'! I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 20));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.chance.chance(100));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos"));
talkEntry:addResponse("Hmm... seid ihr sicher? Naja egal, findet heraus, findet raus was es mit dem so genannten 'Tribunal der Ewigkeit' auf sich hat! Ich denke ihr solltet hierfür einen Priester fragen. Es sollte einer am Altar der Fünf zu finden sein. Viel Glück und seid vorsichtig!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 20));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addResponse("I asked you: What has it to do with the so called 'Tribunal of Eternity'! Now, go, find a priest for the information and don't waste my time until you have it!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addResponse("Hmm... it seems you have forgotten what I asked you! Well, then you are not worth to work for me.");
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 40));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Igruk");
talkEntry:addResponse("Ein sehr mächtiger Schamane. Geh nicht alleine zu seiner Höhle. Ansonsten wirst du sterben wie viele vor beinahe 100 Jahren als diese Orks in diesen Teil eindrangen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Orks drangen in diesen Teil vor hundert Jahren ein und töteten beinahe jeden den sie getroffen haben. Aber wir konnten ihren Angriff abwehren, obwohl sie Unterstützung aus Galmair bekamen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
