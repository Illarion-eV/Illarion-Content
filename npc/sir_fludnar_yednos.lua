...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest] Find the information for Sir Fludnar Yednos. Hint: The answer can be found at the Chapel of Five."));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Finde die Information für Sir Fludnar Yednos. Hinweis: Die Antwort kann bei der Kapelle der Fünf gefunden werden."));
...
talkEntry:addTrigger("adventure");
talkEntry:addTrigger("can I do");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Hint] The answer can be found at the Chapel of Five."));
...
talkEntry:addTrigger("Abenteuer");
talkEntry:addTrigger("was tun");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Hinweis] Die Antwort kann bei der Kapelle der Fünf gefunden werden."));
...
talkEntry:addTrigger("can I do");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Hint] The answer can be found at the Chapel of Five."));
talkEntry:addResponse("I asked you to find out the meaning of the 'Tribunal of Eternity'! Now, go ask a priest for the information and don't waste my time until you have it!!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addTrigger("adventure");
talkEntry:addTrigger("can I do");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Attention] You should not use following words again: task, adventure, quest, or mission. Otherwise the quest is over!"));
...
talkEntry:addTrigger("Abenteuer");
talkEntry:addTrigger("was tun");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Achtung] Du solltest folgende Wörter nun nicht mehr sagen: Auftrag, Aufgabe, Abenteuer, Quest oder Mission. Ansonsten ist die Quest beendet."));
...
talkEntry:addConsequence(npc.base.consequence.item.item(46, 1, 999, {["magicalRuby"] = "1"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 40));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
