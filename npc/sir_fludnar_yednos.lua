...
talkEntry:addResponse("Hmm... are you sure? However, find out, in which age did Bragon help to create the orks? I think it was the fourth, but the name...However, I think you can ask a priest. There should be one at the altar of the five. Good luck and be careful!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 11));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.quest.quest(600, ">", 0));
talkEntry:addCondition(npc.base.condition.quest.quest(600, "<", 21));
talkEntry:addResponse("Geht, findet einen Priester für die Information und verschwendet meine Zeit nicht bis ihr sie habt!");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 2));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
