...
function initializeNpc()
    ...
    AddConsequence("inform","[Spielhilfe] Dieser NPC ist Bippi der Bauer. Schlüsselwörter: Milch,Kuh,Helfer,Aufgabe,'Was ist meine Aufgabe?'.");
    ...
    AddCondition("qpg","=",0);
    AddAdditionalText("Hallo da! Oh ihr seht aber müde aus. Darf ich euch eine Schale Milch aufwarten, als Stärkung?");
    AddAdditionalText("Hiho! Da habt ihr also zum alten Bippi gefunden. Ihr kommt bestimmt um meine berühmte Milch zu probieren.");
    ...
    AddTraderTrigger("Grüße","Oh wie schön, dass ihr zurück seid! Ich glaube es wartet eine neue Aufgabe auf euch, ich kann mich aber auch irren.");
    AddAdditionalTrigger("Gruß");
    AddAdditionalTrigger("Seid gegrüßt");
    AddAdditionalTrigger("Guten Tag");
    AddAdditionalTrigger("Guten Abend");
    ...
    AddAdditionalText("Willkommen, die Kühe haben schon nach euch gefragt.");
    ...
    AddAdditionalText("Good to see you again! Let's check if there's something to do for you.");
    AddAdditionalText("Welcome, the cows have already inquired about you.");
    AddTraderTrigger("Hiho","Oh wie schön, dass ihr zurück seid! Ich glaube es wartet eine neue Aufgabe auf euch, ich kann mich aber auch irren.");
    AddAdditionalTrigger("Hallo");
    AddAdditionalTrigger("Hey");
    AddAdditionalTrigger("Greebas");
    AddAdditionalTrigger("Greebs");
    ...
    AddTraderTrigger("Tschüß","Gehabt euch wohl und kommt bald mal wieder vorbei!");
    AddAdditionalTrigger("Tschüss");
    AddAdditionalTrigger("Wiedersehen");
    AddAdditionalTrigger("Gehabt euch wohl");
    AddAdditionalText("Auf bald! Erzählt euren Freunden vom alten Bippi und seiner Milch.");
    ...
    AddTraderTrigger("Wie geht","Ach, ich spüre das Alter in meinen Knochen. Hätte ich doch nur jemanden der im Stall aushilft.");
    AddAdditionalTrigger("Wie fühlst");
    AddAdditionalTrigger("Wie ist es ergangen");
    AddAdditionalTrigger("Wie Befinden");
    AddAdditionalText("Ah mein Bein wird von Woche zu Woche steifer. Ich sorge mich schon wer sich um meine Kühe kümmern wird wenn ich einmal...");
    AddAdditionalText("Die Arbeit ist hart und ich werde nicht jünger. Ich glaube ich brauche jemanden der mir meine Aufgaben abnimmt.");
    ...
    AddTraderTrigger("dein name","Ich bin der alte Bippi und meine Kühe geben die beste Milch weit und breit.");
    AddAdditionalTrigger("wer bist du");
    AddAdditionalTrigger("wer seid ihr");
    AddAdditionalTrigger("wie heißt");
    AddAdditionalText("Nennt mich Bippi, ich bin Bauer und kümmere mich hier um meine Kühe.");
    AddAdditionalText("Mein Name? Ich bin der Bippi und ich verkaufe meine Milch nach überall hin, sogar nach Cadomyr!");
    ...
    AddTraderTrigger("was verkauf","Ich verkaufe die Milch meiner Kühe, aber ich habe so viele Bestellungen, euch kann ich nichts abgeben. Außer ihr macht euch nützlich.");
    AddAdditionalTrigger("was kauf");
    AddAdditionalTrigger("warenliste");
    AddAdditionalTrigger("preis von");
    AddAdditionalText("Meine Milch verkauf ich! Die geht schneller weg als ich sie abfüllen kann, ihr könnt leider nichts davon haben.");
    AddAdditionalText("Milch Milch Milch! Milch ist gesund und wohlschmeckend. Und sie füllt meine Taschen mit Kupfer.");
    ...
    AddTraderTrigger("erzähl was","Nun, ihr seht nicht aus wie ein Viehzüchter, sonst würde ich über die Arbeit sprechen.");
    AddAdditionalTrigger("erzähl etwas");
    AddAdditionalText("Mein Großgroßvater hat angefangen sein Wissen über Milchkühe weiterzugeben, heute bin ich der, der alle Geheimnisse kennt.");
    AddAdditionalText("Nun, wenn ihr so bittet. Ich glaube ich brauche Helfer um die Arbeit zu bewältigen, wie wäre es mit euch?");
    ...
    AddAdditionalText("I'm a peasant and I specialized in tending dairy cows.");
    AddAdditionalText("I live and work here as a cattle breeder. I sell the milk I've milked.");
    AddTraderTrigger("job","Ich ziehe Kühe groß um dann deren Milch zu verkaufen.");
    AddAdditionalText("Ich bin Bauer und habe mich auf Milchkuh Haltung spezialisiert.");
    AddAdditionalText("Ich lebe und arbeite hier als Kuhzüchter. Die gemolkene Milch verkaufe ich.");
    ...
    AddTraderTrigger("Gobaith","Davon hab ich noch nie gehört. Gibt es dort Kühe?");
    AddAdditionalTrigger("Gobiath");
    AddAdditionalText("Gobaith klingt irgendwie sehr saftig. Wie eine grüne Wiese besten Grases für die Kühe.");
    AddAdditionalText("Ah ich habs gehört. Ich glaube dort sieht es jetzt so aus wie auf dem Donnerbalken wenn man zu viel Milch getrunken hat.");
    ...
    AddTraderTrigger("Ich bin","Schön dich kennenzulernen! Lass uns darauf anstoßen mit einem Glas Milch.");
    AddAdditionalTrigger("mein Name");
    AddAdditionalText("Das ist aber ein hübscher Name. Zergeht auf der Zunge wie ein kräftiger Schluck Milch.");
    AddAdditionalText("Sehr erfreut. Ihr seht wie jemand aus der ein Glas bester Milch zu schätzen weiß.");
    ...
    AddTraderTrigger("Milch","Aber bitte nehmt nur und bedient euch! Schmeckts? Meine 'Kühe' geben eine besonders wohlschmeckende Milch.");
    AddCondition("qpg","=",0);
    ...
    AddTraderTrigger("Stall","Ja, im Stall stehen meine Kühe, wenn sie nicht gerade weiden.");
    AddAdditionalText("Mein Stall ist das große Gebäude rechts von uns.");
    AddAdditionalText("Drei Kühe passen in meinen Stall, toll oder?");
    AddTraderTrigger("Arbeit","Wenn ihr euch um meine Kühe kümmert, könnt ihr auch etwas Milch haben. Helft ihr mir?");
    AddAdditionalTrigger("helfer");
    AddCondition("qpg","=",0);
    AddAdditionalText("Nun, ich könnte Hände die zupacken können gebrauchen. Wollt ihr mir helfen?");
    AddAdditionalText("Könntet ihr mir helfen? Ich kann euch nicht viel dafür geben aber es würde mir viel bedeuten und mir einige Sorgen abnehmen.");
    AddConsequence("state","=",1);
    ...
    AddTraderTrigger("Elvaine","Ich bin stolz sagen zu können, dass Erzmagier Morgan keinen Tag ohne ein Glas meiner Milch beginnt!");
    AddAdditionalTrigger("Morgan");
    AddAdditionalTrigger("archmage");
    AddAdditionalTrigger("Erzmagier");
    AddAdditionalText("Es heißt die einzigen Lebenszeichen des Erzmagiers über Wochen hinweg wären die leeren Milchflaschen und anderes Geschirr das er vor die Tür seiner Gemächer zaubert.");
    ...
    AddTraderTrigger("Runewick","Wie würdet ihr eine Stadt voller kränklicher Magier mit schwachem Knochenbau nennen? Ich nenne es Paradies!");
    AddAdditionalText("Runewick, da befindet sich mit Abstand mein größter Kundenstock.");
    AddAdditionalText("Ein beeindruckender Ort. Ich würde gerne dort leben aber die Kühe vertragen die Seeluft nicht so gut.");
    ...
    AddAdditionalTrigger("Guilianni");
    AddAdditionalTrigger("Don");
    AddAdditionalText("Wenn man sich den Don so ansieht möchte man meinen er tränke nichts anderes als Milch.");
    ...
    AddTraderTrigger("Galmair","Man hat mich einmal gezwungen meine besten Milchkühe der Stadt zu überlassen. Natürlich gaben sie bei dem kargen Gras dort keine gute Milch.");
    AddAdditionalText("Obwohl sie bei den harten Bedingungen dort oben in den Bergen die Kraft aus Milch gut brauchen könnten, sprechen sie doch lieber dem Alkohol zu.");
    ...
    AddTraderTrigger("rosaline","Leider schwört die Königin auf Eselsmilch um ihr Bad zu nehmen.");
    AddAdditionalTrigger("königin");
    AddAdditionalTrigger("queen");
    AddAdditionalTrigger("edwards");
    AddAdditionalText("Wären meine Kühe Esel, ich bräuchte nur für das Bad der Königin zu arbeiten und hätte ausgesorgt.");
    ...
    AddTraderTrigger("Cadomyr","Wegen der Hitze dort wird leider nicht viel Milch getrunken. Nur wenige wissen meine Milch dort zu schätzen.");
    ...
    AddTraderTrigger("albar","Ich habe gehört die Kühe werden dort besser behandelt als die Bauern, schauerlich.");
    AddCondition("lang","german");
    AddAdditionalText("In Albar sollen Kinder sehr früh der Muttermilch entwöhnt werden. Milch wird mit Schwäche assoziert heißt es.");
    AddAdditionalText("Viel Milch in Albar wird vergeudet um sie zu stinkendem Käse zu verarbeiten. Schrecklich!");
    ...
    AddAdditionalText("Ich hörte viele Kühe dort werden krank wegen den Sümpfen in der Nähe.");
    ...
    AddCondition("lang","german");
    AddAdditionalText("Es soll Leute dort geben die mischen ihre Milch mit heißem Wasser und Kräutern. Verrückt, nicht?");
    ...
    AddTraderTrigger("Adron","Nach einem langen Fest gibt es nichts besseres um wieder zu Kräften zu kommen als ein Glas Milch, das weiß auch Adron.");
    AddAdditionalText("Adron liebt Getränke. Milch ist ein Getränk. Ich liebe Milch. Also teilen wir eine Liebe zur Milch.");
    ...
    AddAdditionalTrigger("Brágon");
    AddAdditionalText("Ich lege meinen Hof und meinen Erfolg in die Hände Adrons und Oldras, andere Götter sind mir nicht so vertraut.");
    AddAdditionalText("Hmm. Leider kann ich nicht viel darüber sagen. Ich bete eher zu Adron und Oldra.");
    ...
    AddTraderTrigger("Moshran","Hört mir bloß auf von dem! Sonst wird noch die Milch sauer.");
    AddAdditionalText("Kaum jemand hat so boshaft so viel Milch verschüttet wie er.");
    AddAdditionalText("Ich bin gastfreundlich. Aber um nichts in der Welt würde er ein Glas Milch von mir bekommen!");
    ...
    AddTraderTrigger("Oldra","Wegen ihr gedeihen die Pflanzen, und diese wiederum ermöglichen es dass meine Kühe Milch geben!");
    AddAdditionalText("Oldra, ja. Ihr haben wir doch alles zu verdanken. Ohne die Früchte der Erde würden wir alle verhungern.");
    AddAdditionalText("Sie ist die höchste Gottheit von allen, ohne ihre Schöpfung würde alles andere vor Hunger umkommen.");
    ...
    AddConsequence("state","=",1);
    AddConsequence("inform","Say 'I help you' if you want to help him.");
    AddTraderTrigger("quest","Wenn ihr euch um meine Kühe kümmert, könnt ihr auch etwas Milch haben. Helft ihr mir?");
    AddCondition("lang","german");
    AddAdditionalText("Nun, ich könnte Hände die zupacken können gebrauchen. Wollt ihr mir helfen?");
    AddAdditionalText("Könntet ihr mir helfen? Ich kann euch nicht viel dafür geben aber es würde mir viel bedeuten und mir einige Sorgen abnehmen.");
    AddConsequence("state","=",1);
    ...
    AddConsequence("state","=",1);
    AddConsequence("inform","Say 'I help you' if you want to help him.");
    AddTraderTrigger("Auftrag","Wenn ihr euch um meine Kühe kümmert, könnt ihr auch etwas Milch haben. Helft ihr mir?");
    ...
    AddAdditionalText("Absolut! Sogar meine Kühe verstehen das.");
    AddAdditionalText("#me nickt müßig: 'Mein Großvater sagte das auch immer.'");
    ...
    -- ".*",german,chance(20)->"Tut mir leid. Ich bete zu dieser Gottheit eigentlich kaum, kann also nichts dazu sagen.","Ich lege meinen Hof und meinen Erfolg in die Hände Adrons und Oldras, andere Götter sind mir nicht so vertraut.","Hmm. Leider kann ich nicht viel darüber sagen. Ich bete eher zu Adron und Oldra."
