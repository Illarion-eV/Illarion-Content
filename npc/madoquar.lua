...
talkEntry:addResponse("Today I just gazed upon a sunset that took my breath away. I've seen that sun set behind that mountain more a thousand, ten thousand, one hundred thousand times maybe. Every time I see the last light of the morning star fall between the fingers of the earth. I learn something new about Illarion, and myself.");
...
talkEntry:addResponse("I can't tell you what is wrong with the tree, but I want it cut down. Be a dear and go cut it for me please.");
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("Oh you have not cut down the tree yet? Do you need to know where it is? It's NAME LOCATION.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 80 copper coins. You advance in Don Valerio Guilianni's favour."));
talkEntry:addResponse("So you tried to cut down the tree.");
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 80 Kupferstücke. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addResponse("GERMAN.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 80));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(391, 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(1337, "=", 2));
