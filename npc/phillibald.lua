...
talkEntry:addResponse("Phillibald is my name, I trade portal books.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
mainNPC:setLookat("Dieser NPC ist Phillibald der Portalbuchhändler.", "This NPC is Phillibald the portal book merchant");
