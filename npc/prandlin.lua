...
-- NPC Job:  none                                                             --
--                                                                            --
-- NPC Race: halfling                   NPC Position:  774, 761, 0            --
...
VALUES (2, 774, 761, 0, 1, 'Prandlin', 'npc.prandlin', 0, 1, 0, 189, 182, 164, 217, 154, 123);
---]]
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("'Dort! Prandlins Gehstock... er sieht aus als wäre er früher ein Holzbein gewesen! Das muss das Holzbein von Holzbein-Jack sein! Aber wie kann ich es nehmen ohne das der alte Halbling aufwacht?'"));
...
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(304, "=", 2));
...
talkEntry:addResponse("#me brabbelt zufreiden lächelnd und sabbert schmatzend auf seine Wolldecke. ");
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(304, "=", 3));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("#me bemerkt nicht wie der verzierte Stab gegen seinen Gehstock ausgetauscht wird und schläft seelig weiter.");
...
talkEntry:addConsequence(npc.base.consequence.queststatus.queststatus(304, "=", 4));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("#me schmazt ein wenig.", "#me xxx");
...
talkingNPC:addCycleText("#me sitzt regungsloß vor dem knisternden Kamin, der wohlige wärme im Raum verbreitet.", "#me xxx");
...
talkingNPC:addCycleText("#me beginnt leise und gackernd zu lachen, trozdem scheint er weiter zu schlafen.", "#me xxx");
talkingNPC:addCycleText("#me murmelt im Schlaf: 'Ich muss den Erzmagier sprech...'", "#me xxx");
mainNPC:addLanguage(0);
mainNPC:addLanguage(5);
mainNPC:setDefaultLanguage(0);
mainNPC:setLookat("Ein Stein alter Halbling, der friedlich in seine Decke gekuschelt vor sich hin schlummert.", "ENGLISH1");
