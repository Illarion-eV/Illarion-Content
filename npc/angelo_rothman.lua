...
--                                                                            --
-- NPC Race: human                      NPC Position:  338, 154, -6            --
...
module("npc.angelo_rothman", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is the arena master Angelo Rothman Keywords: Hello, monster, fight, ranklist, points."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist der Arenameister Angelo Rothman. Schlüsselwörter: Hallo, Monster, Kämpfen, Rangliste, Punkte."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
