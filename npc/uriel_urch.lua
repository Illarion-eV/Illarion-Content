...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Uriel Urch the retired soldier. Keyphrases: tell something, Serinjah, Orcs, lizardman, elv."));
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(1909, 1));
talkEntry:addConsequence(npc.base.consequence.item.item(2701, 1, 655, 0));
...
talkEntry:addResponse("Irmorom is the God of trade and craftsmanship.  Honorable, good natured... He likes law and rarely refuses a good beer.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
