...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Tournament Champion'] You found Tronuk. Now, choose one of his two stories. Listen the whole story. You will receive an information as soon as you are done. You might also have to listen to the second story if you chose the wrong one."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(607, "=", 2));
talkEntry:addResponse("Grebbas! Whub old story from old Gobaith yoo want hear? 'Da Day of da Hammer' or 'Day of Green Growl'?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(607, "=", 1));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Turniergewinner'] Du hast Tronuk gefunden. Nun wähle eine seiner beiden Geschichten. Höre dir die ganze Geschichte an. Du wirst eine Information erhalten sobald du fertig bist. Falls du die falsche Geschichte gewählt hast wirst du dir die andere auch anhören müssen."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(607, "=", 2));
talkEntry:addResponse("Grebbha! Welche alt Geschichte von alt Gobaith du wollen hören? 'Der Tag des Hammer' oder 'Tag des Grünen Knurren'?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Beer for Tronuk' started] Take Tronuk a full bottle beer."));
...
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Bier für Tronuk' gestartet] Bringe Tronuk eine volle Flasche Bier."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(602, "=", 1));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest end 'Beer for Tronuk'] You received 10 silvercoins."));
...
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Ende 'Bier für Tronuk'] Du hast 10 Silbermünzen erhalten."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2501, 1, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(602, "=", 2));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("Take Tronuk a full bottle beer."));
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(607, "=", 2));
talkEntry:addCondition(npc.base.condition.quest.quest(601, "=", 30));
talkEntry:addTrigger("Sure");
talkEntry:addTrigger("Of course");
talkEntry:addTrigger("more");
talkEntry:addTrigger("continue");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Tournament Champion'] You know the name now. When you are back at Hummi, tell him the name of the ork who won. The name starts with a 'J'. ;) If you like to listen to the rest of the story, use 'yubba' or 'more'. Use 'stop' in order to break up the story."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(601, "+", 1));
