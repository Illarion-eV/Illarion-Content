...
talkEntry:addCondition(npc.base.condition.item.item(2699, "all", ">", 1, nil));
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2699, 1, nil));
...
talkEntry:addCondition(npc.base.condition.item.item(2699, "all", "=", 0, nil));
