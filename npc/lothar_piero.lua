...
function initializeNpc()
    ...
    npc.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist der Schreiner Lothar Piero. Schlüsselwörter: Hallo, Schreiner, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
