...
talkEntry:addResponse("Ich bin der Grijas und wer bist du?");
...
talkEntry:addTrigger("adventure");
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 4));
talkEntry:addResponse("Aye, hab wat für dich zu tun, wenn du willst. 15 Zwiebeln, einen neuen Kochlöffel, eine hölzerne Schaufe für die Mühle und fünf Steaks mit wenig Fett brauch ich!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.item.item(537, "all", "<", 15, nil));
talkEntry:addTrigger(".+");
talkEntry:addResponse("Du sollst mir 15 Zwiebeln, einen neuen Kochlöffel, eine hölzerne Schaufe für die Mühle und fünf Steaks bringen. Is das so schwer zu merken, eh?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("adventure");
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 10));
talkEntry:addResponse("Arr, du willst ne Aufgabe? Aye, damit kann ich helfen! Ick brauche 15 Brötchen, zehn Zwiebelsuppe, zehn Fischgerichte und zwei Apfelkuchen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.item.item(191, "all", "<", 15, nil));
talkEntry:addTrigger(".+");
talkEntry:addResponse("Die Sachen die du mir bringen solltest waren 15 Brötchen, zehn Zwiebelsuppe, zehn Fischgerichte und zwei Apfelkuchen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Wart bis morgen. Dann kannste ihn wieder zu fressen bringen.");
...
talkEntry:addResponse("Wart bis morgen. Dann kannste ihn zu fressen bringen.");
...
talkEntry:addResponse("Aye. Freut mich Bekanntschaft zu machn.");
...
talkEntry:addResponse("Aye, dann mach dich auf dem Weg und sammle, was ich von dir wollte!");
