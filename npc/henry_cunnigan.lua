...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] To shout, please hit return to activate the chatbox. Do THIS AND THAT, type some words and hit return again to make your character shout the words."));
talkEntry:addResponse("You already know how to talk - shouting can help you to find your friends in lonely woods or dark dungeons. Please shout some words at will.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Sometimes, silence is golden, I see you learned how to whisper. To show others the actions of your character you can do emotes. ");
...
talkEntry:addResponse("Emoting is ");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
