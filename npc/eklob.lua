...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest  erfüllt!]"));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(15, 5, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 3));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest  erfüllt!] Du hast das Gefühl als hättest du etwas dazu gelernt."));
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 2));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(15, 5, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 3));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addCondition(npc.base.condition.item.item(49, "all", "<", 1, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest ] Du sollst den Bären mit einem Brot und einer Wurst füttern."));
...
talkEntry:addCondition(npc.base.condition.item.item(353, "all", "<", 1, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest ] Du sollst den Bären mit einem Apfelkuchen füttern."));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest ] Du bist zu spät! Grijas Kokotte kann dir erklären warum."));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest ] Gefüttert!"));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(355, 1, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 12));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Bären Quest ] Besucht!"));
talkEntry:addConsequence(npc.base.consequence.quest.quest(671, "=", 12));
