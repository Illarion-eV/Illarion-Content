...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded twenty silver coins and your fishing skill increases. You advance in Queen Rosaline Edwards's favour."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded twenty silver coins and your fishing skill increases."));
talkEntry:addResponse("Zerarisa thanksss you, here'ss money for your troubless.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.fishing, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 2000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2547, 10, nil));
