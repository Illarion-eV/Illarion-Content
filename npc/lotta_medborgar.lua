...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest End  'Find Lotta 2'] You receive 10 silver coins."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(155, 10, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(634, "=", 2));
...
talkEntry:addCondition(npc.base.condition.quest.quest(634, "=", 1));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Ende 'Find Lotta 2'] Du hast 10 Silberstücke erhalten."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(155, 10, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(634, "=", 2));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest End 'Find Lotta'] You receive 10 silver coins."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Ende 'Finde Lotta'] Du hast 10 Silberstücke erhalten."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.quest.quest(630, "=", 2));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addResponse("I know following places: Shadowland, Wight Canal, Sentry Forest, Great Ocean, Border Mountains, Katanbi Desert, Katanbi Delta, Western Katanbi Desert, but for more detailed information ask Ruzusss in Cadomyr.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest 'Find Numila 2' started] Try to find Numila and take her the sibanac leaves to get your reward."));
talkEntry:addConsequence(npc.base.consequence.item.item(155, 10, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(624, "=", 1));
...
talkEntry:addTrigger("Numila");
talkEntry:addTrigger("Irunnleh");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest 'Finde Numila 2' gestartet] Finde Numila und bringe ihr die Sibanacblätter um deine Belohnung zur erhalten."));
talkEntry:addConsequence(npc.base.consequence.item.item(155, 10, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(624, "=", 1));
...
talkEntry:addResponse("Well, as I said, it is in the southwest and you would be better asking someone who lives there, for example, Ruzusss in Cadomyr.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Well, as I said, they are in the southwest and you would be better asking someone who lives there, for example, Ruzusss in Cadomyr.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("The Chapel of the Five is at the southern end of the Border Mountains, at the eastern border of the Katanbi Desert. Ask Ruzuss in Cadomyr if you cannot find it.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New Quest 'Find Don Valerio Guilianni' started] Find Don Valerio Guilianni and take him your gift."));
...
talkEntry:addResponse("Primarily, we pray to three gods here in Galmair. They are Irmorom, Nargun, and Ronagan of course, my favorite god.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger(".*");
talkEntry:addResponse("Huh, what places should I give you information about? Do you mind just asking for help as a first step?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
