...
function initializeNpc()
    ...
    npc.base.autonpcfunctions.AddConsequence("inform","[Game Help] This NPC is Queen Rosaline Edwards of Cadomyr. Keyphrases: TRIGGERS.");
    npc.base.autonpcfunctions.AddTraderTrigger("Hilfe","");
    npc.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist Königin Rosaline Edwards von Cadomyr. Schlüsselwörter: TRIGGERS.");
    -- General speech
