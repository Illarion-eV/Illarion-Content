...
talkEntry:addResponse("Ja Ebene. Andere nennen sie auch Welt. Wie dem auch sei, Illarion is unsere Ebene. Für mehr Information fragt jemand anderen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("They are looking for honor, and it seems it can be find in the east, due to I have seen troups coming from this town and passing this temple here.");
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("On of the big empires, but I have never been there.");
...
talkEntry:addResponse("That's one of the younger gods. Therfore nothing compared to Bragon.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Er ist einer der alten Götter und steht für eine weise, starke, noble und ansehliche Persönlichkeit.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Hmm, ihr möchtet etwas von mir wissen? Nun, was ist euere Frage?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Nun, ich weiß die Antwort, aber ihr müsst mir erst drei Dinge bringen. Aber bringt mir erstmal ein reines Feuer. So, geht und findet es!");
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addCondition(npc.base.condition.item.item(2553, "all", ">", 0));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'pure fire' gelöst, Quest 'red priest robe' solved] Bring him a red priest robe"));
talkEntry:addResponse("Well done, you are ready for the next task. Well, look at my red priest robe... It looks old. Please bring me a new one.");
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2553, 1));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 6));
talkingNPC:addTalkingEntry(talkEntry);
...
talkEntry:addTrigger("Zeitalter");
talkEntry:addCondition(npc.base.condition.quest.quest(600, "=", 8));
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Anwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos"));
