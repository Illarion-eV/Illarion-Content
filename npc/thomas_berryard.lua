...
talkEntry:addResponse("ich geb dir jetzt so viele kohle wie du abgezählt hast gesagt hast. Aber nur wenn du mind. genau so viel steine hast.");
...
talkEntry:addResponse("#me seufzt tief und steckt die erhaltene Silbermünze in seine Hosentasche, nach einer weile Arbeit hat er die Steine in schöne Quader gehauen.");
talkEntry:addConsequence(npc.base.consequence.money.money("-", 100));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(21, 1));
...
talkEntry:addConsequence(npc.base.consequence.money.money("-", 100));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(51, 1));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(290, 1));
...
talkEntry:addConsequence(npc.base.consequence.money.money("-", 100));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(51, 1));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(147, 1));
...
talkEntry:addConsequence(npc.base.consequence.money.money("-", 100));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(51, 1));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(147, 3));
talkEntry:addConsequence(npc.base.consequence.item.item(2680, 1, 333, 0));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addResponse("Da hast du deine Farbe.");
talkEntry:addConsequence(npc.base.consequence.money.money("-", 100));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(51, 2));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(302, 2));
