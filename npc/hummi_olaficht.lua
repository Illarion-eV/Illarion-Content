...
talkEntry:addCondition(npc.base.condition.quest.quest(701, "=<", 20));
talkEntry:addCondition(npc.base.condition.number.number(">", 10));
talkEntry:addResponse("#wSag mal, du bist ja unersättlich! Mehr als 10 Zweige würden auffallen.");
...
talkEntry:addTrigger("(%d+) Zweig kaufen");
talkEntry:addCondition(npc.base.condition.quest.quest(701, ">", 20));
talkEntry:addResponse("Ja, Zweige wachsen üblicherweise auf Kirschbäumen. Aber du könntest auch einen Holzfäller fragen. Vielleicht verkauft der dir %NUMBER Zweige");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.quest.quest(701, "=<", 20));
talkEntry:addCondition(npc.base.condition.chance.chance(50));
talkEntry:addResponse("#wDir hab ich doch schon mal Zweige gegeben. Na gut ein paar noch, höchstens 10, aber dann ist Schluss.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Zweig");
talkEntry:addResponse("Zweige ... wachsen auf Baümen und sind zu vielen Sachen zu gebrauchen, ja, ja");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.quest.quest(701, "=<", 10));
talkEntry:addCondition(npc.base.condition.chance.chance(50));
talkEntry:addResponse("#wIch hab nichts ... wobei 20 Zweige könnte ich Dir unter der Hand geben.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.quest.quest(701, "=<", 20));
talkEntry:addCondition(npc.base.condition.chance.chance(50));
talkEntry:addResponse("#wIch hab nur noch 10 Zweige, sonst fällt es auf.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("verkauf");
talkEntry:addResponse("Ich darf nichts verkaufen. Das gehört mir doch gar nicht. Mein Boss schmeißt mich raus und dann ist das ruhige Leben zu Ende, ehrlich.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("#wUnter der Hand ... 4 Kupfer für einen Zweig");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Bretter");
talkEntry:addResponse("Die Bretter hier die sind leider alle gezählt.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Holzfäller");
talkEntry:addTrigger("Waldarbeiter");
talkEntry:addResponse("Ich kenne keinen persönich. Aber du erkennst die Gesellen meist schnell. Frag einfach rum.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Mal ehrlich, so was ist nichts für mich. Ich bleib lieber hier.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("#me zwinkert 'Nicht schlecht die Mädels hier in Trollsbane, oder? Und Zwergenbier gibt es auch.'");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.language.language("german"));
talkEntry:addResponse("Nach Varshikar? Gleich durch das Tor hier dann nach Nordosten. Hinter der Wüste. Ist ein langer Weg dort hin.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Ich mach hier sauber, sortier die Bretter ... was eben im Lager anfällt.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("#wDer Banduk, der Händler der ist mein Chef");
...
talkEntry:addTrigger("Chef");
talkEntry:addTrigger("Boss");
talkEntry:addResponse("Schön, du denkst doch nicht etwa, dass ich dir verrate wer mein Boss ist? Nacher willst du bloß meinen Job");
...
talkEntry:addTrigger("R[äae]+uber");
...
talkEntry:addCondition(npc.base.condition.sex.sex(1));
talkEntry:addResponse("#wVielleicht können wir uns ja mal zusammen draußem am Fluss spazierengehen wenn ich grade nicht hier stehen muss? Nur wir zwei?*zwinkert");
...
talkEntry:addCondition(npc.base.condition.sex.sex(1));
talkEntry:addResponse("#wUnd? Wann kann ich Dich ausführen?*zwinkert");
...
talkEntry:addCondition(npc.base.condition.chance.chance(5));
talkEntry:addCondition(npc.base.condition.sex.sex(0));
talkEntry:addResponse("Hey, wir könnten uns mal gemeinsam beim Bogate so richtig besaufen nach der Arbeit. Was sagste dazu?");
talkEntry:addConsequence(npc.base.consequence.quest.quest(700, "=", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addResponse("Du bist neu hier? Geh am besten in die Stadt hier herum und suche nach Leuten, die dir helfen können.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
