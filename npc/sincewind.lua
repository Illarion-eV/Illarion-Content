--------------------------------------------------------------------------------
-- NPC Name: Sincewind                                                   None --
-- NPC Job:  Tutor                                                            --
--                                                                            --
-- NPC Race: lizardman                  NPC Position:  46, 21, 100            --
...
VALUES (5, 46, 21, 100, 6, 'Sincewind', 'npc.sincewind', 0, 3, 0, 104, 128, 52, 103, 17, 2);
---]]
...
module("npc.sincewind", package.seeall)
...
talkingNPC:addCycleText("#me winkt dir freundlich zu und zischelt. 'Sss, komm näher Fremdling. Ich kann dir helfen. Ss.'", "#me waves to you and hisses friendly: 'Sss, come closer. I may help you. Ss.'");
mainNPC:addLanguage(0);
mainNPC:addLanguage(4);
mainNPC:setDefaultLanguage(0);
mainNPC:setLookat("This is your tutorial guide Sincewind the friendly lizardman.", "Das ist dein Tutor Sincewind, der freundliche Echsenmann.");
