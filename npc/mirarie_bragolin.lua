...
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 3 silver coins. You advance in Queen Rosaline's favour."));
...
talkEntry:addCondition(npc.base.condition.item.item(2496, "all", ">", 4, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 3 Silberstücke."));
talkEntry:addResponse("Danke. Du hast mich gerettet. Ich werde dich in meinem Buch erwähnen. Ich verspreche es!");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 300));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2496, 5, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(317, "=", 2));
...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 400 Kupferstücke. Dein Ansehen bei Königin Rosaline steigt."));
