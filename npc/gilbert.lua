...
-- NPC Job:  none                                                             --
--                                                                            --
-- NPC Race: orc                        NPC Position:  87, 609, 0             --
...
VALUES (4, 87, 609, 0, 3, 'Gilbert', 'npc.gilbert', 0, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
talkEntry:addConsequence(npc.base.consequence.item.item(79, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(303, "=", 3));
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(303, "=", 7));
...
talkEntry:addTrigger("necklet");
talkEntry:addTrigger("necklace");
talkEntry:addResponse("I'm so happy that I found the necklace but also a litte sad, because now Rose has another chance to get it.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Oh my! These halfers are rather uncaring...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("#me schnieft bekümmert.", "#me sniffles sadly..");
talkingNPC:addCycleText("#me klammert seine Tasche an sich.", "#me hugs his bag in a protective way.");
talkingNPC:addCycleText("#me scharrt mit der Schuspitze lustlos im Sand.", "#me pokes at the ground dejectedly with his foot.");
talkingNPC:addCycleText("#me macht ein unglückliches Gesicht.", "#me makes a sad face.");
talkingNPC:addCycleText("#me schnäuzt sich lautstark in den Ärmel seines Hemdes.", " #me blows his nose into the sleeve of his shirt.");
