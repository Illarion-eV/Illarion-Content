...
local function BW_intern_MoveY(Character,YOff,forced)
...
local function BW_intern_IDinList( id , lower, upper, list )
    if lower > upper then
        return false;
    end;
...
local function BW_intern_pos_okay( posi )
...
local function BW_OneStepToPosition( Character, TargetPos )
...
local function BW_StepAlongRoad( Character )
