...
rankpoints = class(npc.base.consequence.consequence.consequence,
...
function _rankpoints_helper_cadomyr_set(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
    rankpoints.rankpointsC = value;
    base.factions.BF_put_Rankpoints(player,rankpoints);
end;

function _rankpoints_helper_cadomyr_add(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
...
function _rankpoints_helper_cadomyr_sub(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
    rankpoints.rankpointsC = rankpoints.rankpointsC - value;
    base.factions.BF_put_Rankpoints(player,rankpoints);
...
function _rankpoints_helper_runewick_set(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
...
function _rankpoints_helper_runewick_add(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
...
function _rankpoints_helper_runewick_sub(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
    rankpoints.rankpointsR = rankpoints.rankpointsR - value;
    base.factions.BF_put_Rankpoints(player,rankpoints);
...
function _rankpoints_helper_galmair_set(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
...
function _rankpoints_helper_galmair_add(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
...
function _rankpoints_helper_galmair_sub(self, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    local rankpoints = base.factions.BF_get_Rankpoints(player);
    rankpoints.rankpointsG = rankpoints.rankpointsG - value;
    base.factions.BF_put_Rankpoints(player,rankpoints);
