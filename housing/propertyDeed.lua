...
function M.UseItem(user, SourceItem)
    for i = 1, #propertyList.propertyTable do
        if (SourceItem.pos == propertyList.propertyTable[i][3]) then
            ...
            if utility.isAutomaticRentEnabled(property) then
                dialogOwnedByuser:addOption(0, utility.getText(user, "GERMAN TRANSLATION HERE", "Pay to extend rent duration"))
            end
            ...
            dialogOwnedByuser:addOption(0, utility.getText(user,"","Remove Builder Permission"))
            ...
            if utility.checkIfEstateViaName(property) then --Renters are allowed to set guests themselves on estate properties
            ...
            if utility.checkIfLeaderOfTown(user, town) or user:isAdmin() then
                dialogUnowned:addOption(0, utility.getText(user,"Mieter eintragen","Set Renter"))
                ...
                dialogOwnedByuser:addOption(0, utility.getText(user,"Mieter eintragen","Set Renter"))
                dialogOwnedByuser:addOption(0, utility.getText(user,"Mieter entfernen","Remove Renter"))
                ...
                dialogOwnedByuser:addOption(0, utility.getText(user,"GERMAN TRANSLATION HERE","Manage rent-free living"))
                dialogOwnedByuser:addOption(0, utility.getText(user,"GERMAN TRANSLATION HERE","(Dis)Allow Unsupervised Rent Extension"))
                ...
                dialogOwnedNotByuser:addOption(0, utility.getText(user,"Mieter eintragen","Set Renter"))
                dialogOwnedNotByuser:addOption(0, utility.getText(user,"Mieter entfernen","Remove Renter"))
                ...
                dialogOwnedNotByuser:addOption(0, utility.getText(user,"GERMAN TRANSLATION HERE","Manage rent-free living"))
                dialogOwnedNotByuser:addOption(0, utility.getText(user,"GERMAN TRANSLATION HERE","(Dis)Allow Unsupervised Rent Extension"))
            end
