...
-- UPDATE common SET com_script='I_2607_blaues_buch.lua' WHERE com_itemid=2607;
-- UPDATE itemname SET itn_german='blaues Buch', itn_english='blue book' WHERE itn_itemid=2607;
require("base.books")
