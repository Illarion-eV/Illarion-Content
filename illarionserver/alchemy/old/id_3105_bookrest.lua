...
--        base.books.AddEnglishBookText("The book about glassworks reads: 'You need quartz sand, potash, a glass blow pipe, a wooden shovel and a glass oven to create glass items.",0,0,0);
