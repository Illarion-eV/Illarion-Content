...
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] Flüstern funktioniert fast wie Schreien. Aktiviere erneut deine Chatbox und schreibe '#w' vor die zu flüsternden Worte."));
talkEntry:addResponse("Nicht jedes Mitglied der Stadtwache sollte deine krummen Pläne hören. Auch sollte der ortansässige Strolch dich nicht über deinen Reichtum reden hören. Bitte versuch nochmals zu flüstern.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("Komm näher und sag doch 'Hallo' zu mir.", "Come a little closer and say 'hello'.");
