...
VALUES (0, 684, 307, 0, 0, 'Teleporter (Wilderland)', 'npc.teleporter_(wilderland)', 0, 0, 0, 255, 255, 255, 255, 255, 255);
---]]
...
module("npc.teleporter_(wilderland)", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This is the teleporter of Wilderland. A journey costs ten silver coins. Destinations: Runewick, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dies ist der Teleporter Wilderlands. Die Reise kostet zehn Silberstücke. Ziele: Runewick, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Cadomyr");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Teleporter] Ihr lasst den Teleporter ein Tor nach Cadomyr zu einem Preis von zehn Silberstücken öffnen."));
talkEntry:addConsequence(npc.base.consequence.money.money("-", 1000));
talkEntry:addConsequence(npc.base.consequence.warp.warp(127, 647, 0));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Teleporter] Say the name of the realm you want to travel to: Runewick, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Runewick, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
mainNPC:setLookat("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Runewick, Galmair, Cadomyr.", "[Teleporter] Say the name of the realm you want to travel to: Runewick, Galmair, Cadomyr.");
mainNPC:setUseMessage("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Runewick, Galmair, Cadomyr.", "[Teleporter] Say the name of the realm you want to travel to: Runewick, Galmair, Cadomyr.");
mainNPC:setConfusedMessage("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Runewick, Galmair, Cadomyr.", "[Teleporter] Say the name of the realm you want to travel to: Runewick, Galmair, Cadomyr.");
