...
talkingNPC:addCycleText("#me wischt sich den Schweiß von der Stirn.", "#me wipes the sweat off his forhead.");
...
talkingNPC:addCycleText("#me hält ein Amulett gegen das Licht, um es besser zu betrachten.", "#me holds an amulet against the light to have a better look at it.");
