...
VALUES (0, 788, 826, 0, 0, 'Teleporter (Runewick)', 'npc.teleporter_(runewick)', 0, 0, 0, 255, 255, 255, 255, 255, 255);
---]]
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dies ist der Teleporter Runewicks. Die Reise kostet ein Silberstück. Ziele: Wilderland, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Wilderland");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Teleporter] Ihr lasst den Teleporter ein Tor nach Wilderland zu einem Preis von zehn Silberstücken öffnen."));
talkEntry:addConsequence(npc.base.consequence.money.money("-", 1000));
talkEntry:addConsequence(npc.base.consequence.warp.warp(684, 307, 0));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Wilderland, Cadomyr, Galmair."));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
mainNPC:setConfusedMessage("[Teleporter] Sagt den Namen der Gegend, in die ihr reisen möchtet: Wilderland, Galmair, Cadomyr.", "[Teleporter] Say the name of the realm you want to travel to: Wilderland, Galmair, Cadomyr.");
