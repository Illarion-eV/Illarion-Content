...
talkEntry:addCondition(npc.base.condition.item.item(1840, "all", ">", 4, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 50 silver coins."));
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(1840, 5, nil));
...
talkEntry:addCondition(npc.base.condition.item.item(1840, "all", ">", 4, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 50 Silberstücke."));
...
talkEntry:addResponse("I got a new order from abroad. A dwarven sovereign ordered two dwarven state armours. But I cannot get to Galmair to get them due to... personal reasons. Please help me for a reward.");
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded five gold coins."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded an obsidian ring and a magical obsidian."));
...
talkEntry:addCondition(npc.base.condition.item.item(2785, "all", ">", 0, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
...
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2785, 1, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(206, 1, 999, nil));
