...
module("questsystem.Gravestone.trigger13", package.seeall)

local QUEST_NUMBER = 10000
local PRECONDITION_QUESTSTATE = 99
local POSTCONDITION_QUESTSTATE = 104

local NPC_TRIGGER_DE = "[Ff]ertig"
local NPC_TRIGGER_EN = "[Dd]one"
local NPC_REPLY_DE = "Ich danke euch vielmals. Ich gebe euch einen Rubinring, ein Symbol der Ewigkeit. Ein Geschenkt für eure wahre Liebe."
