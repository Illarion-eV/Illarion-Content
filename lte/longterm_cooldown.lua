...
function callEffect( Effect, Char ) -- Effect is called
	...
	if theQuestStatus == 1 then --Time over!
        ...
        base.common.InformNLS(Char,"[Information Status] Sie waren zu langsam Sammeldaten, können Sie Ihre Gebühr verloren.","[Information status] You were too slow collecting data, you have lost your fee."); -- Feedback!
	...
	if theQuestStatus == 3 then --Ten minutes left!
        ...
        base.common.InformNLS(Char,"[Information status] In zehn Minuten ist Ihre Chance, um Informationen zu sammeln für Bula Glasha vorbei sein.","[Information status] In ten minutes, your chance to collect information for Bula Glasha will be over."); -- Feedback!
		
	end
	
	if theQuestStatus == 13 then --One hour left
	
	    base.common.InformNLS(Char,"[Information status] Eine Stunde für das Sammeln von links die Informationen Gebühr von Bula Glasha.","[Information status] One hour left for earning the information fee of Bula Glasha."); -- Feedback!
