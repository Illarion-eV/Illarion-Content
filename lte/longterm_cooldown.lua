...
function M.callEffect( Effect, Char ) -- Effect is called
    ...
    if Char:idleTime() < 300 then --absolutely no regeneration effect if the player is afk for more than five minutes
        ...
        if theQuestStatus > 0 then --Is there a cooldown? Will only be reduced if the player isn't AFK/idle
            ...
            if theQuestStatus == 1 then --only for this quest. the player should know when he can do it again.
                common.InformNLS(Char,"[Info] Die Zeit scheint reif, um dein Glück auf der Insel 'Böser Fels' erneut zu versuchen.","[Info] It seems it is time to try your luck again on the island 'Evilrock'.")
            end
        end
        --Addition end
        ...
        if theQuestStatus > 0 then --Is there a cooldown? Will only be reduced if the player isn't AFK/idle
            ...
            if theQuestStatus == 1 then --only for this quest. the player should know when he can do it again.
                common.InformNLS(Char,"Eine Taube wirft ein Pergamentstück neben dir ab. Du liest: 'Ich sollte morgen wieder eine Schatzkarte für dich haben. -Paula Bronzeblatt'","A dove drops a parchment next to you. You read: 'I should have another treasure map for you tomorrow. -Paula Bronzeblatt'")
            end
        end
        --Addition end
        ...
        if theQuestStatus > 0 then --Is there a cooldown? Will only be reduced if the player isn't AFK/idle
            ...
            if theQuestStatus == 1 then --only for this quest. the player should know when he can do it again.
                common.InformNLS(Char,"Eine Taube wirft ein Pergamentstück neben dir ab. Du liest: 'Morgen können wir wieder etwas drehen. Kommt vorbei! -Arno Unterland'","A dove drops a parchment next to you. You read: 'Tomorrow, we can do it again. Visit me! -Arno Unterland'")
            end
        end
        --Addition end
    ...
    if theQuestStatus == 3 then --Ten minutes left!
        ...
        common.InformNLS(Char,"[Kopfgeldstatus] In zehn Minuten läuft dein Kopfgeldvertrag mit Palis Nestros aus.","[Bounty status] In ten minutes, your bounty contract with Palis Nestros will expire.") -- Feedback!
    ...
    if theQuestStatus == 3 then --Ten minutes left!
        ...
        common.InformNLS(Char,"[Informanten Status] In zehn Minuten ist deine Chance vestrichen, um Informationen für Bula Glasha zu sammeln.","[Information status] In ten minutes, your chance to collect information for Bula Glasha will be over.") -- Feedback!

    end

    if theQuestStatus == 13 then --One hour left

        common.InformNLS(Char,"[Informanten Status] Eine Stunde verbleibt um Informationen für Bula Glasha zu sammeln.","[Information status] One hour left for earning the information fee of Bula Glasha.") -- Feedback!
    ...
    if theQuestStatus == 3 then --Ten minutes left!
        ...
        common.InformNLS(Char,"[Forschung Status] In zehn Minuten ist deine Chance vestrichen, um Informationen für Maelyrra Umrielyth zu sammeln.","[Research status] In ten minutes, your chance to collect information for Maelyrra Umrielyth will be over.") -- Feedback!

    end

    if theQuestStatus == 13 then --One hour left

        common.InformNLS(Char,"[Forschung Status] Eine Stunde verbleibt um Forschung für Maelyrra Umrielyth zu sammeln.","[Research status] One hour left for earning the research fee of Maelyrra Umrielyth.") -- Feedback!
