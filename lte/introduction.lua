...
function M.initText(User)
    ...
    if factions.isCadomyrCitizen(User) then
        ...
        "Ein Teleporter findet sich außerhalb des Eingangs zu jeder Stadt und dem neutralen Gasthof zur Hanfschlinge. Doppelklicke auf das Podium, um es zu benutzen und für fünf Silberstücke in ein anderes Reich zu reisen. Es gibt auch Portalbücher, die dich von jedem Ort auf der Karte zu den Reichsteleportern bringen können. Lobely in Troll's Haven verkauft sie für 50 Silber, aber du könntest sie bei Magiern günstiger bekommen. Die von Magiern verkauften Bücher könnten sogar zu Zielen führen, die über die Teleporter hinausgehen.",
        ...
        "A teleporter can be found outside the entrance to each town and the neutral Hemp Necktie Inn. Double click on the podium to use it and for five silver you will be able to travel to another realm. There are also portal books that can take you to the realm teleporters from anywhere on the map. Lobely in Troll's Haven sells them for 50 silver, though you may be able to get them cheaper from mages. Those sold by mages may even lead to destinations beyond the teleporters.",
