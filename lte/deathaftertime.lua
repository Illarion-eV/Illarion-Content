...
function callEffect(Effect, Character) 
   ...
   User:talkLanguage(Character.say, Player.german, "#me zerfällt zu einer blauen Pfütze.");
   User:talkLanguage(Character.say, Player.english, "#me collapses into a blue puddle.");
