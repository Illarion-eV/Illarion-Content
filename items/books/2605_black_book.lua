...
function UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base.books.InitBook() then
            ...
            base.books.AddGermanBookText("Das Zeitalter des Kampfes ist vorüber. Die alten Götter verlassen uns. Sie gehen über das Meer. Ich bin die letzte hohe Priesterin Eldan's. Dies ist meine Geschichte.",0,0,0);
            base.books.AddGermanBookText("Möge dieses Vermächtnis die Zeiten überdauern, mögen die versiegelten Altäre in Vergessenheit geraten: Eines Tages werden die Erben kommen.",0,0,0);
            base.books.AddGermanBookText("Die alten Bücher werden gefunden werden und alte Lehre wird sich mit neuer vermengen, denn das Wissen stirbt nicht solange wir leben, es schläft nur. Und der Schlaf mag lange andauern. Sehr lange.",0,0,0);
            base.books.AddGermanBookText("Kapitel I: Auf der Suche nach Eldan:",0,0,0);
            base.books.AddGermanBookText("Heute begegnete ich einem Jünger Findaris. Er riet mir meine Wanderung nach Murinaa zu dokumentieren. Als Erinnerung.",0,0,0);
            base.books.AddGermanBookText("Murinaa: Noch liegt es wenige Tagesmärsche entfernt und doch ist die glanzvolle Stadt schon in der Ferne über dem glitzernden Sand zu erkennen.",0,0,0);
            base.books.AddGermanBookText("Wie viele Anwärter auf die Priesterschaft zieht es mich nach Murinaa, die nächste größere Stadt in der sich Heiligtümer aller Götter befinden.",0,0,0);
            base.books.AddGermanBookText("Je näher ich Murinaa komme desto mehr Anhänger Bragons, Usharas, Eldans, Tanoras und Findaris kreuzen meinen Weg. Es sind ihrer nicht hunderte aber dennoch einige Dutzend.",0,0,0);
            base.books.AddGermanBookText("Endlich in Murinaa: Die Bibliothek ist gigantisch. Ich habe das Buch der Priester Eldans gefunden und gelesen. Sehr rätselhaft.",0,0,0);
            ...
            base.books.AddGermanBookText("Dieses Buch ist mir ein Rätsel. Und die Weihen rücken näher. Unaufhaltsam. Wie soll ich es nur deuten?!",0,0,0);
            base.books.AddGermanBookText("Einer der Novizen bemerkte heute meine Mühen in der Bibliothek. Er hat gesagt dass es genau fünf Götter seien - Als ob ich das nicht wüsste.",0,0,0);
            base.books.AddGermanBookText("Außerdem sprach er von einem Zyklus des Erschaffens. Offensichtlich wollte er mir einen Hinweis zukommen lassen. Was er wohl meinte?",0,0,0);
            base.books.AddGermanBookText("Ich habe eine interessante Beobachtung gemacht: Alle fünf Tage fällt das Licht durch einen Spalt in der Decke genau auf das Buch der Priester Eldans.",0,0,0);
            base.books.AddGermanBookText("Wie ich beobachten konnte gilt dies auch für die Bücher der anderen Priester der Fünf.",0,0,0);
            base.books.AddGermanBookText("Endlich konnte ich dem Text innerhalb des Buches das Gebet entreißen.",0,0,0);
            ...
            base.books.AddGermanBookText("Daraufhin erfasste mich ein gewaltigiger Sog und es zog mich weit in die Ferne. Ein unglaubliches Gefühl. Dort angekommen sah ich einen großen Altarraum vor mir.",0,0,0);
            ...
            base.books.AddGermanBookText("Dort sprach ich, am Altar knieend, das Gebet und ich konnte Eldans Blick auf mir spüren als er mich zur Novizin berief.",0,0,0);
            ...
            base.books.AddGermanBookText("Mit diesen Waffen lassen sich heftige Angriffe ausführen und geschickt geführt ersetzen sie jedes Schild.",0,0,1);
            ...
            base.books.AddGermanBookText("Kraft, mit der Zwergenaxt können verheerende Angriffe ausgeführt werden.",0,0,1);
            base.books.AddGermanBookText("Schnelligkeit, durch ihre ausbalancierte Fertigung lässt sie sich leicht und schnell führen.",0,0,1);
            ...
            base.books.AddGermanBookText("Legenden zufolge soll es sogar magische Zwergenäxte geben.",0,0,1);
            base.books.AddGermanBookText("Kriegsaxt",383,0,1); -- ### waraxe ###
            base.books.AddGermanBookText("Die Kriegsaxt eignet sich gut zum kämpfen auch sie vereint die wichtigen Werte einer Axt. ",0,0,1);
            ...
            base.books.AddGermanBookText("Legenden zufolge soll es auch magische und Feuer-Kriegsäxte geben.",0,0,1);
            ...
            base.books.AddGermanBookText("Durch Größe und Masse überzeugt die Doppelaxt, Treffer die mit dieser Axt angerichtet werden beenden unweigerlich Leben.",0,0,1);
            base.books.AddGermanBookText("Doch sind nur wenige in der Lage solch eine wuchtige Waffe, auch nach jahrelangem Training, richtig zu führen.",0,0,1);
			...
			base.books.AddGermanBookText("Einführung\nEin paar Worte der Warnung: Kochen macht Spaß, aber es dauert, eh' man ein guter Koch wird.",0,0,3);
			base.books.AddGermanBookText("Kochen und Feldarbeit passen gut zusammen. Wenn Du dein eigenes Gemüse anbaust und selbst jagst, kannst Du gut zu Geld kommen.",0,0,3);
			...
			base.books.AddGermanBookText("Nimm auch keine Großbestellungen an, da Du sonst schuften mußt, während die anderen Spaß haben, auf Abenteuer gehen und leicht verdiente Silberlinge einstecken.",0,0,3);
			...
			base.books.AddGermanBookText("Hacke zwei Handvoll Kohl klein und koche ihn mit einem Glas Weißwein. ",0,0,3);
			base.books.AddGermanBookText("Würfel zwei Tomaten und füge sie zum Kohl hinzu. Verfeinere es noch mit Kräutern; ich liebe Sandbeeren mit Forelle! Lass es köcheln, bis der Kohl gar ist.",2459,0,3); -- ### fish filet dish ###
			base.books.AddGermanBookText("Nimm nun eine gute, frische Forelle und filetier sie sorgsam. Leg die Filets mit der Haut nach oben zeigend auf das köchelnde Gemüse.",0,0,3);
			base.books.AddGermanBookText("Bedecke es nun und lass es ein paar Minuten kochen, bis sich die Haut vom Filet zu lösen beginnt. ",73,0,3); -- ### trout ###
			base.books.AddGermanBookText("Sofort servieren. Begleitend zu diesem Gericht passt ein Kelch 'Banes Claret' oder ein leicht gekühlter greenbriarscher Met.",2497,0,3); -- ### bottle of mead ###
			...
			base.books.AddGermanBookText("Zerkleinere 2 Zwiebeln sehr fein und bräune sie in einem leichten Öl an. Füge 2 gewürfelte Tomaten und ein paar Champignonscheiben hinzu. Stell es zum Warmhalten beiseite. ",2952,0,3); -- ### plate ###
			base.books.AddGermanBookText("Nimm ein paar dicke Lachssteaks und röste sie auf beiden seiten für ein paar Minuten, bis sie zart sind. Du könntest sie auch in einer Gemüsebrühe pochieren.",355,0,3); -- ### salmon ###
			base.books.AddGermanBookText("Serviere mit der Gemüsesoße und etwas Toast mit Butter. Passend zu diesem nahrhaften Gericht wäre ein süßer Weißwein aus den Trauben der Drei Schwestern Siranis.",2500,0,3); -- ### bottle of wine ###
			...
			base.books.AddGermanBookText("Bereite aus zwei kleinen Zwiebeln, zwei Karotten und etwas Geburtspilz ein Duxelles. Füge etwas Sahne hinzu und reduziere es zu einer Paste.",162,0,3); -- ### birth mushroom ###
			base.books.AddGermanBookText("Brate dünne Scheiben Steak in Butter. Steak aus der Flanke ist das Beste. Lass es nicht anbrennen!",2940,0,3); -- ### steak ###
			base.books.AddGermanBookText("Serviere die Steaks mit einer großzügigen Menge Duxelles darauf. Zu diesem pikanten Gericht passt ein Krug silverbrandsches Schwarzbier.",2501,0,3); -- ### bottle of dark beer ###
			...
			base.books.AddGermanBookText("Schneide oder hacke etwa 2 Karotten und den Kohl in Streifen. Füge schwarze Vogelbeeren, einen Spritzer Weinessig und Meersalz hinzu. Mixe es sehr gut und stell es für circa zwei Stunden an einen kühlen Platz.",753,0,3); -- ### blue birdsberry ###
			base.books.AddGermanBookText("Röste einige Würste aus Schweinefleisch. Varshikarisches Schweinefleisch ist das magerste und wohlschmeckendste.",3051,0,3); -- ### sausage ###
			base.books.AddGermanBookText("Serviere die heißen würste in einem aufgeschnittenem Brötchen, belege es mit ein wenig des Gemüsesalates. Passend zu diesem beliebten Gericht ist ein Krug leichten Bieres oder Rootbeer aus Tol Vanima.",2501,0,3); -- ### bottle of dark beer ###
			...
			base.books.AddGermanBookText("Mach aus je zwei Handvoll Tomaten, Karotten und Kohl einen Eintopf. Lass dann ein gutes Stück Hasenrücken in dem Eintopf köcheln, bis die Knochen vom Hasenfleisch abfallen und zum Topfboden sinken.",553,0,3); -- ### rabbit meat###
			base.books.AddGermanBookText("Leg nun Fleisch, Gemüse und ein Teil der Flüssigkeit auf ein Kuchenblech, ummantele es mit etwas Teig und lass es in einem heißen Ofen backen, bis die Flüssigkeit verdampft ist.",555,0,3); -- ### rabbit dish ###
			base.books.AddGermanBookText("Serviere dieses Gericht mit einem Wiesenrhabarbersalat. Cidre aus den Fässern der Bauernunion passt zu diesem ländlichen Gericht ausgezeichnet.",2499,0,3); -- ### bottle of cider ###
			...
			base.books.AddGermanBookText("Koche etwa je zwei Handvoll gewürfelte Tomaten, Karotten und Zwiebeln mit einem Schluck Rotwein und einer Prise Lebenswurzpulver und stell es dann zur Seite.",0,0,3);
			base.books.AddGermanBookText("Grill die Lammkoteletts über Flammen bis sie braun und saftig sind. Serviere sie mit dem Gemüse und einem Muffin als Nachtisch.",2934,0,3); -- ### lamb meat ###
			...
			base.books.AddGermanBookText("Als Randnotiz: Lammgerichte stellen möglicherweise das beste Preis / Leistungsverhältnis dar.",559,0,3); -- ### lamb dish ###
			...
			base.books.AddGermanBookText("Wende die dick geschnittenen Zwiebeln und den Kohl in einer Marinade aus einem Teil Meersalz, einem Teil Weinessig und einem Teil süßen Met. Füge dann die Waldbeeren hinzu. Nach etwa zehn Tagen ruhig stehend ist es gut durchgezogen.",81,0,3); -- ### berries ###
			base.books.AddGermanBookText("Persönlich verfeinere ich noch mit ein paar geheimen Zutaten, wie etwa Nachtengelsblüten...!",138,0,3); -- ### night angels blossom ###
			base.books.AddGermanBookText("Das Rehfleisch sollte gut abgehangen sein, damit es wohlschmeckend ist. Es gibt hierbei keine festen Regeln aber es sollte an einem kühlen, luftigen Platz für mindestens zehn Tage hängen.",552,0,3);
			base.books.AddGermanBookText("Das Rehfleisch sollte immer über einem heißen Feuer oder in einem heißen Ofen zubereitet werden. Koch es aber nicht 'zu' lange! Servier das Fleisch mit dem 'Sauerkraut'.",552,0,3); -- ### deer meat ###
			base.books.AddGermanBookText("Dieses herzhafte Mahl geht am besten mit einem alten Wein oder Met, oder sogar einem Likör. ",2502,0,3); -- ### gynkese fire ###
			...
			base.books.AddGermanBookText("Weiterführende Bände der selben Autorin liegen unter den Titeln: 'Kochen herzhafter Suppen' und 'Der Compleat Bäcker' vor.",0,0,3);
