...
items.base.music.addTalkText("#me plays the harp with a horrible crash","#me macht ein furchtbares Ger�usch mit der Harfe");
...
items.base.music.addTalkText("#me plays a beautiful melody on the harp","#me spielt eine wundersch�ne Melodie auf der Harfe");
