...
-- UPDATE common SET com_script='items.paintings' WHERE com_itemid (748, 749, 750, 751, 1914, 1915);
...
"Du siehst wie ein Elf in den Wald hineinstarrt, du erkennst, dass sich im Wald etwas versteckt, das Ausschau nach dem Elfen hält.",
