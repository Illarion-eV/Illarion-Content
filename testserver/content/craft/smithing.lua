...
if isTestserver() then
	...
	product = smithing:addProduct(catId, 189, 0, 40, 1, 1, 1,{RareWeapon="1",nameEn="Dagger of Whatever",nameDe="Hilfe der Kampf",descriptionEn="This is a dagger",descriptionDe="Stuff"})
