...
--Carving Tools
local product = carving:addProduct(catId, 2752, 0, 20, 5, 10)
product:addIngredient(2535) -- Iron Ingot: 1x1
product:addIngredient(2570) -- Sickle Handle: 1x1

--Pins and Cotters
product = carving:addProduct(catId, 2717, 0, 20, 5, 10, 5)
...
--Rolling Pin
product = carving:addProduct(catId, 118, 12, 32, 8, 16)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2716) -- Apple Wooden Boards: 1x1

--Brick Mould
product = carving:addProduct(catId, 734, 16, 36, 9, 18)
product:addIngredient(2716, 2) -- Apple Wooden Boards: 2x1

--Flail
product = carving:addProduct(catId, 258, 20, 40, 10, 20)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2716) -- Apple Wooden Boards: 1x1
...
--Fishing rod
product = carving:addProduct(catId, 72, 28, 48, 12, 24)
product:addIngredient(56) -- Bough: 1x1
...
--Shovel Handle
product = carving:addProduct(catId, 2567, 12, 32, 8, 16)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1

--Saw Handle
product = carving:addProduct(catId, 2561, 15, 35, 9, 18)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1
...
--Long Staff Handle
product = carving:addProduct(catId, 2573, 10, 50, 7, 14)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1
...
--Sword Handle
product = carving:addProduct(catId, 2584, 29, 69, 12, 24)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1

--Mace Handle
product = carving:addProduct(catId, 2548, 32, 72, 13, 26)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1

--Large Ornate handle
product = carving:addProduct(catId, 2527, 35, 75, 14, 28)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1

--Morning Star Handle
product = carving:addProduct(catId, 2549, 40, 80, 15, 30)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(2543) -- Conifer Wooden Boards: 1x1
...
--Wooden Sword
product = carving:addProduct(catId, 445, 0, 20, 5, 10)
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2584) -- Sword Handle: 1x1

--Club
product = carving:addProduct(catId, 2664, 6, 26, 6, 12)
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2548) -- Mace Handle: 1x1

--Skull Staff
product = carving:addProduct(catId, 39, 12, 32, 8, 16)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Cleric's Staff
product = carving:addProduct(catId, 40, 24, 44, 11, 22)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Simple Mage Staff
product = carving:addProduct(catId, 57, 30, 50, 12, 24)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Mage's Staff
product = carving:addProduct(catId, 76, 42, 62, 15, 30)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 3) -- Naldor Wooden Boards: 3x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Elven Mage's Staff
product = carving:addProduct(catId, 209, 54, 74, 18, 36)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 3) -- Naldor Wooden Boards: 3x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Ornate Mage's Staff
product = carving:addProduct(catId, 208, 60, 80, 20, 40)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 3) -- Naldor Wooden Boards: 3x1
product:addIngredient(2573) -- Large Staff Handle: 1x1

--Battle Staff
product = carving:addProduct(catId, 207, 66, 86, 21, 42)
product:addIngredient(56) -- Bough: 1x1
product:addIngredient(546, 2) -- Naldor Wooden Boards: 2x1
product:addIngredient(2573) -- Large Staff Handle: 1x1
...
--Throwing Spear
product = carving:addProduct(catId, 293, 30, 50, 12, 24, 10)
...
--Wind Arrows
product = carving:addProduct(catId, 322, 90, 110, 27, 54, 10)
product:addIngredient(56) -- Bough: 1x1
...
--Wand
product = carving:addProduct(catId, 323, 40, 60, 15, 30)
product:addIngredient(56) -- Bough: 1x1
...
--Wand of Earth
product = carving:addProduct(catId, 2782, 60, 80, 20, 40)
product:addIngredient(56) -- Bough: 1x1
...
--Wand of Fire
product = carving:addProduct(catId, 2783, 70, 90, 22, 44)
product:addIngredient(56) -- Bough: 1x1
...
--Wand of Water
product = carving:addProduct(catId, 2784, 80, 100, 25, 50)
product:addIngredient(56) -- Bough: 1x1
...
--Wand of Wind
product = carving:addProduct(catId, 2785, 90, 110, 27, 54)
product:addIngredient(56) -- Bough: 1x1
