...
function InitTree()
    ...
    AddTree({842,850,0},"Ein sehr alt wirkender Baum, welcher alle Art von Früchten trägt, und dessen Zweige bis zur Sonne reichen.","A very old looking tree carries all kinds of fruit and leaves and almost reaches the sun with it's branches.", 9,0); --Oldra's Column
