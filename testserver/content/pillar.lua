...
-------------------- Sï¿½ulen/Statuen  ----------------
    ...
    AddPillar({495,193,0},"Eine Notiz an der Kupferstatue besagt: 'Beschützer der Kupferbrücke'.","A note on the copper figure says: 'Protector of the Blackbridge'.", 5,0); --Blackbridge
