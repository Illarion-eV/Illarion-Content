...
--[[    AddPillar({804,549,0},"","", 5, 5);
	...
	AddPillar({415,273,-6},"An einer Seite der Säule entdeckst du einen Schlitz über dem eine silberne Münze eingelassen wurde", "On one side of the pillar you see a slit with a silver coin inserted above it.")
