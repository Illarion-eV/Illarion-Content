...
function InitPennant()
    ...
    AddPennant({678,346,0},"Hoheitsgebiet des Igruk","Igruk's territory", 6,0);
   	--Death Marsh
	AddPennant({795,361,0},"Hexen H¸tte","Witch's Cottage", 7,0);--Witch's Cottage
    AddPennant({797,361,0},"Hexen H¸tte","Witch's Cottage", 7,0);--Witch's Cottage
	AddPennant({795,356,0},"Hexen H¸tte","Witch's Cottage", 7,0);--Witch's Cottage
    AddPennant({797,356,0},"Hexen H¸tte","Witch's Cottage", 7,0);--Witch's Cottage
	--Dewy Swamp
  ...
  --[[   --Dragon lair
    ...
    --Elstree Plain
    AddPennant({721,426,0},"Des Jarls Langhaus - f¸r immer verloren!","The Jarl's Longhouse - lost forever!", 6,0); --The Jarl's Longhouse
--[[	--Firelimes
	...
	--Northern Outpost
    AddPennant({818,750,0},"Nˆrdlicher Auﬂenposten","Northern Outpost", 7,0);
	--[[--Lost Building (2)
