...
Description[ENGLISH][1] = "Collect 30 clumps of clay at the lake on the west side of the city for Seleseth. You can collect the clay if you take the shovel in your hand and use it on a spot where there is dirt next to the water."
Description[GERMAN][2] = "Geh zu Seleseth, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go to Seleseth, he has for sure another task for you."
...
Description[ENGLISH][3] = "Produce 15 bricks in the glass melting oven for Seleseth in Galmair. To produce the bricks, you have to take the brick mould in your hand and use the oven. First of all you will produce unfired bricks, then you repeat the action again to produce fired bricks."
Description[GERMAN][4] = "Geh zu Seleseth, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go to Seleseth, he has for sure another task for you."
...
Description[ENGLISH][5] = "Grinde ten amethysts for Seleseth with the tongs he gave you at the gem grinder. You can use the gem grinder if you have raw gems and the tongs in your hand. You can find raw gems in mines while mining."
Description[GERMAN][6] = "Geh zu Seleseth, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][6] = "Go to Seleseth, he has for sure another task for you."
...
Description[ENGLISH][7] = "Go once again to the gem grinder and produce two bags with amethyst powder with the eight grinded amethysts."
Description[GERMAN][8] = "Geh zu Seleseth, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][8] = "Go to Seleseth, he has for sure another task for you."
Description[GERMAN][9] = "Stell für Seleseth aus den zehn rohen Steinen, 20 kleine Steine her. Um kleine Steine herzustellen musst du den Meisel in die Hand nehmen und rohe Steine haben, anschließend benutz du den Meisel um aus den rohen Steinen Steinquader zu machen. Aus den gewonnen Steinquadarn lassen sich kleine Steine herstellen wenn man die Prozedur wiederholt. Rohe Steine lassen sich in der Mine als Nebenprodukt beim abbau finden. Die kleinen Steine können mit einer Schleuder in der Hand als Waffe genutzt werden."
Description[ENGLISH][9] = "Produce with the ten raw stones 20 small stones for Seleseth. To produce the small stones you need the take the chisel in your hand and use it while having raw stones in your inventory. Once you have made stone blocks you repeat the work again and make small stones. You can find raw stones while mining. Furthermore you can use the small stones together with a sling as a weapon."
