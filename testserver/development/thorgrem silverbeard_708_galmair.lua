...
Description[ENGLISH][1] = "Collect twenty lumps of coal and twenty pieces of iron ore and take them to Thorgrem Silverbeard. You can find Malachitmine if you leave the workshop through the south door, then you follow the street south until you reach a bridge, after the bridge you follow the street in south east direcition and then you are there. To find the dark hole mine you have to leave the city in the east, then you follow the street until you reach a golden bridge. After the bridge you follow the street to the north, again you go over the bridge and follow the street to the west. Now you are nearly there, just need to go over the wooden bridge in the west and you will be there." 
Description[GERMAN][2] = "Geh zu Thorgrem Silverbeard, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go to Thorgrem Silverbeard, he has for sure another task for you."
...
Description[ENGLISH][3] = "Smelt ten iron ingots for Thorgrem Silverbeard at the furnace. To smelt the ingots you have to take the crucible-pincers in your hand and use them in front of the furnace."
Description[GERMAN][4] = "Geh zu Thorgrem Silverbeard, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go to Thorgrem Silverbeard, he has for sure another task for you."
