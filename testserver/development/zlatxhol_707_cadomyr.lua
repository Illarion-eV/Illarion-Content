...
Description[GERMAN][7] = "Mach ein Feuer mit den Holzscheiten die dir Zlatxhol gegeben hat und mach dann zusammen mit dem Quarzsand am Glassschmelzofen zehn Glasbblöcke daraus. Ein Lagerfeuer lässt sich entzünden, wenn du Holzscheite auf den Boden legst und diese benutzt. Hast du weiteres Holz im Gürtel kannst du das Feuer benutzen und stellst dadurch dann Asche her."
Description[ENGLISH][7] = "Make a fire with the wood and the hatchet which Zlatxhol gave you. Together with the quartz sand at the glass melting oven, make ten glass ingots. You can light a fire if you place some wood on the ground and use the wood. If you have wood left in your belt you can use the camp fire to produce ash."
