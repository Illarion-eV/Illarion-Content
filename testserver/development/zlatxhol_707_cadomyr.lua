...
Description[ENGLISH][1] = "Collect thirty clumps of clay at the river on the west side of the city for Zlatxhol. You can collect the clay if you take the shovel in your hand and use it on a spot where there is dirt next to the water."
...
Description[ENGLISH][3] = "Produce fifteen bricks in the glass melting oven for Zlatxhol in Cadomyr. To produce the bricks, you have to take the brick mould in your hand and use the oven. First of all you will produce unfired bricks, then you repeat the action again to produce fired bricks."
...
Description[ENGLISH][5] = "Collect ten piles coarse sand and go to the sieve in the workshop to turn these to quartz sand, and show the result to Zlatxhol. You can dig coarse sand with the shovel in the desert around stones. Once you have enough coarse sand, you can use the wooden shovel to sieve the quartz sand. Once you have the quartz sand and ash, you can make glass ingots with the glass blowing pipe in your hand and a glass melting oven in front."
Description[GERMAN][7] = "Mach ein Feuer mit dem Holz und dem Beil das dir Zlatxhol gegeben hat und mach dann zusammen mit dem Quarzsand am Glassschmelzofen zehn Glasbblöcke daraus. Ein Lagerfeuer lässt sich entzünden, wenn du Holz auf den Boden legst und es dann mit der Axt in der Hand benutzt. Sobald es ausgebrand ist, kannst du die Asche sammeln."
Description[ENGLISH][7] = "Make a fire with the wood and the hatchet which Zlatxhol gave you. Together with the quartz sand at the glass melting oven, make ten glass ingots. You can light a fire if you place some wood on the ground and use the wood while holding the hatchet in your hand. Once the fire is out you can collect the ash."
Description[GERMAN][9] = "Stell fünf leere Flaschen mit dem Glasblasrohr für Zlatxhol her und zeig ihm die Flaschen."
Description[ENGLISH][9] = "Produce five empty bottles using the glass blowing pipe and show them to Zlatxhol."
