...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel zehn Klumpen Lehm beim Fluss im Westen der Stadt für Zlatxhol in der Werkstatt von Cadomyr. Um den Lehm zu sammeln, musst du die Schauefel in die Hand nehmen und an einer Stelle, wo es Dreck nahe am Wasser gibt, graben."
...
Description[GERMAN][2] = "Geh zu Zlatxhol in die Werkstatt von Cadomyr, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go to Zlatxhol in the workshop of Cadomyr, he is sure to have another task for you."
Description[GERMAN][3] = "Stell zehn Ziegel am Glassschmelzofen für Zlatxhol in Cadomyr her. Um die Ziegel herzustellen, musst du die Ziegelform in die Hand nehmen und den Ofen benutzen. Dann stellst du ungebrannte Ziegel her. Anschließend wiederholst du das ganze und hast gebrannte Ziegel."
...
Description[GERMAN][4] = "Geh zu Zlatxhol in die Werkstatt von Cadomyr, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go to Zlatxhol in the workshop of Cadomyr, he is sure to have another task for you."
Description[GERMAN][5] = "Sammel zehn Haufen groben Sand. Geh zum Sieb in der Werkstatt und mach daraus Quarzsand und zeig anschließend den Sand Zlatxhol in der Werkstatt von Cadomyr. Groben Sand findet man unter Steinen in der Wüste, wenn man mit der großen Schaufel gräbt. Hat man erst etwas groben Sand, kann man mit der Holzkelle am Sieb Quarzsand damit herstellen. Dazu musst du das Sieb benutzen während du die Kelle in der Hand hälst. Der gewonnene Quarzsand lässt sich zusammen mit Asche bei einem Glasschmelzofen mit dem Glasblasrohr in der Hand zu Glasblöcken formen."
Description[ENGLISH][5] = "Collect ten piles coarse sand and go to the sieve in the workshop to turn these to quartz sand, and show the result to Zlatxhol in the workshop of Cadomyr. You can dig coarse sand in the desert around stones with the big shovel Zlatxhol gave you before. Once you have enough coarse sand, you can use the wooden shovel to sieve the quartz sand. To produce quartz sand take the wooden shovel in your hand and use the sieve while staying in front of it. You will need quartz sand, together with ash, to make glass."
Description[GERMAN][6] = "Geh zu Zlatxhol in die Werkstatt von Cadomyr, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][6] = "Go to Zlatxhol in the workshop of Cadomyr, he is sure to have another task for you."
Description[GERMAN][7] = "Stell zehn Glasblöcke für Zlatxhol in der Werkstatt von Cadomyr her. Um Glasblöcke herzustellen brauchst du Quarzsand, hast du diesen brauchst du noch Asche. Asche lässt sich produzieren, wenn du Holzscheite an einem Feuer verbrennst. Zuerst leg einen Holzscheit auf den Boden, anschließend benutzt du diesen einmal. Daraufhin benutzt du das Feuer um mit den restlichen Scheiten in deinem Inventar Asche herzustellen. Hast du die Asche und den Sand, musst du zum Glasschmelzofen. Dort angekommen nimmst du das Glasblasrohr in die Hand und benutzt den Ofen um Glasblöcke herzustellen." 
...
Description[GERMAN][8] = "Geh zu Zlatxhol in die Werkstatt von Cadomyr, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][8] = "Go to Zlatxhol in the workshop of Cadomyr, he is sure to have another task for you."
Description[GERMAN][9] = "Stell fünf leere Flaschen mit den Glasblöcken für Zlatxhol her und zeig ihm die Flaschen. Um die Flaschen herzustellen nimmst du das Glasblasrohr in die Hand und benutzt dieses während du vor dem Glassschmelzofen stehst."
