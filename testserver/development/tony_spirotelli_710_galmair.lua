...
Description[GERMAN][2] = "Geh zu Tony Spirotelli in die Werkstatt von Galmair. Er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go back to Tony Spirotelli in the workshop of Galmair, he is sure to have another task for you."
Description[GERMAN][3] = "Stell zehn Holzbecher für Tony Spirotelli in der Werkstatt von Galmair her. Um die Holzbecher herzustellen, brauchst du Laubholzbretter. Hast du diese, nimmst du den Hobel in die Hand und benutzt ihn, während du vor einer Werkbank stehst."
...
Description[GERMAN][4] = "Geh zu Tony Spirotelli in die Werkstatt von Galmair. Er hat bestimmt noch eine Aufgabe für dich."
