...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel zehn Laubholzbretter und zeig diese Tony Spirotelli in der Werkstatt von Galmair. Sammel erstmal mit dem Beil an einem Apfelbaum zehn Laubholzscheite. Dazu nimmst du das Beil in die Hand und benutzt es, während du vor einem Apfelbaum stehst. Hast du das erstmal gemacht, geh zurück zur Werkstatt und säge die Scheite mit der Säge in der Hand bei der Werkbank neben Tony zu Brettern."
...
Description[GERMAN][5] = "Stell fünf Nägel und Keile für Tony Spirotelli in der Werkstatt von Galmair her. Um die Nägel und Keile herzustellen, brauchst du Äste und Nägel. Nägel können Schmied herstellen. Äste findest du manchmal beim Fällen von Apfelbäumen. Hast du erstmal fünf Äste gefunden, kehr zur Werkstatt zurück und fertige mit dem Schnitzmesser in der Hand bei der Werkbank fünf Nägel und Keile."
Description[ENGLISH][5] = "Produce five pins and cotters for Tony Spirotelli in the workshop of Galmair. To produce the pins and cotters you need five boughs and pins first of all, you can get boughs while chopping down an apple tree. Pins can be made by a smith. Once you have the boughs return to the workshop and produce five pins and cotters using the carving tools in your hand whilst at the workbench."
