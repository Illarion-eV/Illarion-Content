-- INSERT INTO "quests" ("qst_id", "qst_script") VALUES (703, 'quest.joey_licavoli_712_galmair');
...
Description[ENGLISH][1] = "Take Joey Licavoli's letter to Hannah Shepard at the fields of Galmair. Then return back to Joey if you want more tasks from him. The fields are a few steps to the east of Joeys position."
...
Description[ENGLISH][4] = "Find Charwis Irongate and ask him if he has a task for you. Charwis Irongate can be found at the market place of Galmair. The market place is south of the palace."
...
Description[ENGLISH][5] = "Bruno Blackhole has a task for you, go and search for him at the Malachitmine. The Malachitmine can be found if you follow the street to the south from the workshop."
...
Description[ENGLISH][7] = "Groktan Flintsplit has probably a task for you. Search for him in Galmair and ask him for a task. Groktan Flintsplit can be found at the building with the red roof east of the palace."
