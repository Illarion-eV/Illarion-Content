...
Description[GERMAN][3] = "Such Thorgrem Silverbeard den Zwergen in der Werkstatt von Galmair und fragt ihn nach einer Aufgabe. Die Werkstatt findest du wenn du die Stadt im Westen betrittst, dann folgst du der Straße nach Südwesten bist du ein Haus mit einem gelblich-braunem Dach findest. Das ist die Werkstatt."
...
Description[GERMAN][5] = "Such den Zwergen Miggs in 'Galmairs Krone', den Palast von Galmair. Den Palast findest du, wenn du die Stadt betrittst und der Straße nach Westen folgst. Miggs hält sich in der Bibliothek im Palast auf."
