...
Description[ENGLISH][1] = "Collect five bundles of grain for Francine Leonard. To get the bundles of grain you have to seed the grain which Francine gave you on the fields in Yewdale. To do this just use the grain while standing on the field. Once the crop is ready, harvest the ripened grain using the scythe you got from Hannah."
...
Description[ENGLISH][3] = "Produce five sacks of flour for Francine Leonard. To produce flour you have to use the flail in your hand with the bundles of grain in your inventory. Once you've produced grain from the bundles of grain go to the millstone on the left-hand side of Francine. To make flour you have to take the wooden shovel in your hand and use the millstone."
...
Description[ENGLISH][5] = "Bake five bread rolls for Francine Leonard. To bake bread rolls you need buckets of water and flour. In the other room, north of your current position is a baking oven. Go there and take the peel in your hand while staying in front of the baking oven to bake bread rolls."
...
Description[GERMAN][7] = "Koch fünf Würstchen für Francine Leonard am Kessel neben ihr. Um Würstchen herzustellen brauchst Schweinefleisch und Eingeweide, beide findest du wenn du Schweine erlegst. Hast du die Zutaten erst kannst du mit dem Kochlöffel in der Hand bei einem Kessel Würstchen daraus machen."
Description[ENGLISH][7] = "Cook five sausages for Francine Leonard at the kettle next her. To produce sausages you need pork and entrails, both can be obtained if you kill pigs. Once you have the ingredients, you have to take the cooking spoon in your hand and use it while standing in front of a kettle."
