...
Description[ENGLISH][2] = "Search for Grakamesh the orc at Sir Reginald's Tomb and ask him for a task. The tomb is right behind me at the little entrace."
...
Description[ENGLISH][4] = "Find Hassan, the royal fan-waver and ask him if he has a task for you. Hassan can be often found in the tavern in Cadomyr north of the market place."
...
Description[ENGLISH][7] = "Reret Odohir, the notary of Cadomyr has a task for you, search for her. You can find her in the building northwest of the tavern, it's the house with the colourful pillar."
