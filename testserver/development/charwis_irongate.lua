...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[New quest] Nachrichten Überbringen I"));
talkEntry:addConsequence(npc.base.consequence.quest.quest(702, "=", 1));
talkEntry:addResponse("Could you help me? Nik Nilo asked me for an ruby some time ago.I found one while mining the other day. Could you tell him that he should talk to me?");
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst und erhälst zum Dank etwas Geld, einen Säbel und ein Paar neue Stiefel von Charwis. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 600));
talkEntry:addConsequence(npc.base.consequence.item.item(25, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(53, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(702, "=", 3));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 10 Silbermünzen und einem alten Schlapphut belohnt. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(356, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(702, "=", 6));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 4));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 12 Silbermünzen und eine neue Robe belohnt. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1200));
talkEntry:addConsequence(npc.base.consequence.item.item(195, 1, 333, {["descriptionEn"] = "This robe has the colour of the Galmairian flag.", ["descriptionDe"] = "Diese Robe hat die Farbe der Galmairischen Flagge."}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(702, "=", 9));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addConsequence(npc.base.consequence.item.item(234, 1, 440, {["nameDe"] = "Echt großer Goldnugget", ["nameEn"] = "Really big gold nugget", ["descriptionEn"] = "This gold nugget is as big as an apple.", ["rareness"] = "2", ["descriptionDe"] = "Dieser Goldnugget ist so groß wie ein Apfel."}));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit Münzen und Schmuck belohnt. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(62, 1, 877, {["rareness"] = "1", ["craftedBy"] = "Charwis Irongate"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(702, "=", 12));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 9));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit einem versilberten Langschwert und ein paar Silbermünzen belohnt. Dein Ansehen bei Don Valerio Guilianni steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 500));
...
talkingNPC:addCycleText("#me räuspert sich geräuschvoll.", "#me clears his throut noisily.");
talkingNPC:addCycleText("So, so...", "There, there...");
mainNPC:addLanguage(0);
mainNPC:addLanguage(1);
mainNPC:setDefaultLanguage(0);
mainNPC:setLookat("", "");
mainNPC:setUseMessage("#me schaut verärgert.", "#me looks angrily.");
