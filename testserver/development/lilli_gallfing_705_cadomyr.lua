...
Description[GERMAN][3] = "Bring Lilli Gallfing fünf Garnrollen und zwei Rollen grauen Stoff. Den Stoff kannst du am Webstuhl herstellen und die Garnrollen am Spinnrad. Für beides brauchst du unterschiedliche Mengen an Wolle."
...
Description[GERMAN][5] = "Schneidere ein graues Gewand am Schneidertisch für Lilli Gallfing in Cadomyr. Um das Gewand herzustellen musst du die Nadel in die Hand nehmen und diese benutzen wenn du vor einem Schneidertisch stehst."
Description[ENGLISH][5] = "Tailor one grey dress at the tailoring table for Lilli Gallfing in Cadomyr. To produce the dress you have to take the needle in your hand and use it, while staying in front of the tailoring table."
...
Description[GERMAN][9] = "Färbe fünf Rollen roten Stoff bei dem schwarzen Fass in der Schneiderei von Cadomyr für Lilli Gallfing. Um die Stoffe herzustellen musst du den Färberstab in die Hand nehmen, anschließend benutz du das schwarze Fass während du die Eimer mit Farbe und den weißen Stoff in deinem Inventar hast."
Description[ENGLISH][9] = "Dye five cloths red for Lilli Gallfing, using the black barrel in the workshop of Cadomyr. To produce the cloth you have to take the dyeing rod in your hand and use the black barrel while having red dye and white cloth in your inventory."
