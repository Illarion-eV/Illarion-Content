...
Description[ENGLISH][3] = "Bring Lilli Gallfing five spools of thread and two grey cloth. You can produce the cloth with the loom. The thread can be produced at the spinning wheel, you'll need for both of them different amounts of wool."
...
Description[GERMAN][7] = "Mach ein kleines Lagerfeuer und stell fünf Eimer mit roter Farbe für Lilli Gallfing her. Ein Lagerfeuer lässt sich entzünden wenn du Holz auf den Boden legst und es dann mit der Axt in der Hand benutzt. Sobald es ausgebrand ist, kannst du die Asche sammeln. Eimer können Schreiner herstellen, wenn du welche brauchst."
Description[ENGLISH][7] = "Make a little camp fire and produce five buckets with red dye for Lilli Gallfing. You can light a fire if you place some wood on the ground and use the wood while holding the hatchet in your hand. Once the fire is out you can collect the ash. If you need buckets, ask a carpenter if he can make you some."
