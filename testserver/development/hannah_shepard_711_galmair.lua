...
Description[ENGLISH][1] = "Collect five bundles of grain for Hannah Shepard. To get the bundles of grain you have to seed the grain which Hannah gave you on the fields. To do this just use the grain while standing on the field. Once the crop is ready, harvest the ripened grain using the scythe you got from Hannah."
Description[GERMAN][2] = "Geh zu Hannah Shepard. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go back to Hannah Shepard, she is sure to have another task for you."
Description[GERMAN][3] = "Produzier fünf Säcke Mehl für Hannah Shepard. Um Mehl zu produzieren, musst du die Getreidebündel mit dem Dreschflegel in der Hand zu Getreide schlagen. Hast du erst einmal Getreide, musst du zum Mühlstein im Palast von Galmair, welcher im Westen liegt. Beim Palast angekommen, ist der Mühlstein gleich im ersten Raum auf der rechten Seite. Dort angekommen, machst du beim Mühlstein mit der Holzkelle in der Hand Mehl aus dem Getreide."
Description[ENGLISH][3] = "Produce five sacks of flour for Hannah Shepard. To produce flour you have to use the flail in your hand with the bundles of grain in your inventory. Once you've produced grain from the bundles of grain go to the millstone in the Palace of Galmair. You can find the palace if you follow the street to the west, once you have entered the city. On arrival at the palace, the millstone can be found in the first room at the right-hand side. To make flour you have to take the wooden shovel in your hand and use the millstone."
Description[GERMAN][4] = "Geh zu Hannah Shepard. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go back to Hannah Shepard, she is sure to have another task for you."
...
Description[ENGLISH][5] = "Bake five bread rolls for Hannah Shepard. To bake bread rolls you need buckets of water and flour. In the Palace of Galmair there is a baking oven. Once you find it, take the peel in your hand and use it while standing in front of the baking oven."
Description[GERMAN][6] = "Geh zu Hannah Shepard. Sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][6] = "Go back to Hannah Shepard, she is sure to have another task for you."
Description[GERMAN][7] = "Koch fünf Würstchen für Hannah Shepard am Kessel neben ihr. Um Würstchen herzustellen, brauchst Schweinefleisch und Eingeweide. Beides findest du, wenn du Schweine erlegst. Hast du die Zutaten besorgt, kannst du mit dem Kochlöffel in der Hand bei einem Kessel Würstchen daraus machen."
Description[ENGLISH][7] = "Cook five sausages for Hannah Shepard at the kettle next her. To produce sausages you need pork and entrails, both can be obtained if you kill pigs. Once you have the ingredients, you have to take the cooking spoon in your hand and use it while standing in front of a kettle."
