...
talkEntry:addResponse("Be greeted. I am sure you came to me for trading artifacts.");
talkEntry:addResponse("Let's get straight to business.");
talkEntry:addResponse("Did you find any artifacts?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Seid mir gegrüßt. Ich bin mir sicher, Ihr wollt Artefakte mit mir handeln.");
talkEntry:addResponse("Lasst uns direkt zum Geschäft kommen.");
talkEntry:addResponse("Habt Ihr eine Artefakt gefunden?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("See you around.");
talkEntry:addResponse("Don't come back without artifacts!");
...
talkEntry:addResponse("Kommt mir ja nicht ohne Artefakte wieder!");
...
talkEntry:addResponse("Das geht euch nicht allzuviel an.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("I am Palis Nestros, the artifact trader of Cadomyr.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Ich bin Palis Nestros, der Artefakthändler Cadomyrs.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addResponse("Ich vergebe keine Aufträge.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Solltet Ihr bei euren Abenteuern ein Artefakt finden, so werde ich euch eine nette Summe dafür zahlen.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
