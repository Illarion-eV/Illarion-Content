...
talkingNPC:addCycleText("GERMAN.", "ENGLISH.");
talkingNPC:addCycleText("GERMAN.", "ENGLISH.");
talkingNPC:addCycleText("Ich suche nach seltenen Dingen. Wirklich selten, nicht einfach irgendwelchen Schrott.", "I am interested in rare items. Not some ordinary scrap but really rare items.");
