...
VALUES (0, 434, 257, 0, 6, 'Hannah Shepard', 'npc.hannah_shepard', 1, 7, 0, 180, 177, 165, 245, 200, 145);
---]]
...
module("development.hannah_shepard", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is Hannah Shepard the cook and farmer. Keywords: quest, letter"));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist Hannah Shepard die Köchin und Bäuerin. Schlüsselwörter: Quest, Brief"));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Nice to meet you, I'm Hannah Shepard.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Freut mich, Euch zu treffen. Ich bin Hannah Shepard.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("I'm Hannah Shepard, who are you?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Ich bin Hannah Shepard, wer bist du?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(712, "=", 2));
talkEntry:addResponse("Ah, thank you. If you need help with cooking, baking or farming, ask me for a task.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(712, "=", 2));
talkEntry:addResponse("Ah, vielen Dank. Wenn Ihr Hilfe beim Kochen, Backen oder bei Ackerbau braucht, fragt mich nach einer Aufgabe.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 0));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 1));
talkEntry:addResponse("Oh, you want a task? Very well, let's start with something simple. Sow some grain on the fields over there with the grain I'll give you. Once you've done that harvest the finished grain with a scythe which you will get from me and show me five bundles of grain.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 1));
talkEntry:addCondition(npc.base.condition.item.item(249, "all", ">", 4, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(249, 5, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 2));
...
talkEntry:addResponse("That aren't five bundles of grain yet, please come back once you've finished this task.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 2));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 3));
talkEntry:addResponse("You want another task? Alright, make with bundles of grain and a flail which I'll give you grain. Once you have done that, go into the city, then go to the palace and enter the first room on the right side. Once you are there, make five sacks with flour on the millstone with the wooden shovel which you will get from me. Then return and show me the result.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 3));
talkEntry:addCondition(npc.base.condition.item.item(2, "all", ">", 4, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 4));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addResponse("I wanted five sacks of flour, come again once you have fulfilled this task.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 4));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 5));
talkEntry:addResponse("Alright, now we will make some bread rolls. You will need a peel, the flour and of course some buckets with water to make the bread rolls. I'll give you my old peel and five buckets so you can practise a little bit. Now go back to the palace and bake five bread rolls for me at the baking oven. Show me the result once you are done.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.item.item(52, 5, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 5));
talkEntry:addResponse("Gut, nun machen wir einige Brötchen. Dafür braucht Ihr einen Brotschieber, den Mehl den Ihr bereits habt und natürlich Eimer mit Wasser. Ich gebe Euch meinen alten Backofenschieber und fünf Eimer damit Ihr etwas üben könnt. Nun geht zum Palast zurück und backt mir am Backofen fünf Brötchen und bringt mir diese.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 5));
talkEntry:addCondition(npc.base.condition.item.item(191, "all", ">", 4, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 6));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addResponse("You haven't solved the task yet. Come again once you've the five bread rolls I'm looking for.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 6));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger("quest");
talkEntry:addTrigger("mission");
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 7));
talkEntry:addResponse("Enough with baking, now we will cook something nice! Let's start with sausages, you will need pork and entrails to produce sausages. You can get the pork and the entrails if you kill pigs. Once you have that you will need a cooking spoon and a kettle like this one in front of me to cook. I'll give you five pieces of pork, five pieces of entrails and one cooking spoon to practise a little bit. Bring me five sausages once you are done.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 7));
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 8));
...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addResponse("You haven't solved the task yet. Come again once you have five sausages for me.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.quest.quest(711, "=", 10));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".*");
