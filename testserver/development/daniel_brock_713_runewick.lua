...
Description[ENGLISH][5] = "Produce for Daniel Brock at the basement of the windtower 25 pins and cotters. To produce the pins and cotters you need five boughs and pins first of all, you can get boughs while chopping down an apple tree. Pins can be made by a smith. Once you have the boughs return to the workshop and produce 25 pins and cotters using the carving tools in your hand whilst at the workbench."
