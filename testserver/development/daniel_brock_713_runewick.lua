...
Description[ENGLISH][1] = "Collect 20 deciduous wood boards for Daniel Brock. You should start by collecting 20 deciduous wood using the hatchet in your hand whilst standing in front of an apple tree. Once you have the deciduous wood you can saw it into boards in the wind tower by using the workbench as you stand in front of it, with the saw in your hand."
...
Description[ENGLISH][3] = "Produce five wooden cups for Daniel Brock. To produce the wooden cups you need deciduous wood boards. Once you have them take the plane in your hand and use it while standing in front of the workbench."
...
Description[ENGLISH][5] = "Produce five hammer handles for Daniel Brock. To produce the hammer handles you need five boughs first of all, you can get them while chopping down an apple tree. Once you have the boughs return to the wind tower and produce five hammer handles using the carving tools in your hand whilst at the workbench."
