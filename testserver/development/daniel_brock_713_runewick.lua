...
Description[ENGLISH][1] = "Collect ten deciduous wood boards for Daniel Brock in the basement of the Wind Tower. You should start by collecting ten deciduous wood in Yewdale by using the hatchet in your hand, whilst standing in front of an apple tree. Once you have the deciduous wood you can saw it into boards in the workshop by using the workbench as you stand in front of it, with the saw in your hand. Yewdale is at the golden bridge north of the teleporter."
