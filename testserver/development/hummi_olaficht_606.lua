-- INSERT INTO quests SET qst_script = 'quest.hummi_olaficht_606' WHERE qst_id = 606;

require("base.common")
module("development.hummi_olaficht_606", package.seeall)
...
QuestTarget[2] = {position(428, 248, 0)} -- Iradona
