...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel 20 Klumpen Kohle und 20 Brocken Eisenerz und bring diese zu Berri Firegold. Wenn du die Stadt verlässt und nach Süden der Straße folgst, erreichst du den 'Grundstein der Aufrichtigkeit'. Dort kannst du Kohle finden. Wenn du die Stadt verlässt und nach Nordosten gehst, erreichst du den 'Freiheitsbruch'. Dort findest du Eisen- und Kupfererz und manchmal sogar Goldnuggets. Mit der Spitzhacke kannst du das Erz von den Steinen abbauen."
...
Description[GERMAN][2] = "Geh zu Berri Firegold, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go to Berri Firegold, he has for sure another task for you."
...
Description[GERMAN][4] = "Geh zu Berri Firegold, er hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go to Berri Firegold, he has for sure another task for you."
