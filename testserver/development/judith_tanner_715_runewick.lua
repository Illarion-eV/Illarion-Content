...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel 20 Wollknäule für Judith Tanner bei den Schafen im Wald außerhalb der Stadt."
Description[ENGLISH][1] = "Collect 20 bales of wool for Judith Tanner from the sheeps at the forest outside of Runewick."
Description[GERMAN][2] = "Geh zu Judith Tanner, sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][2] = "Go to Judith Tanner, she has for sure another task for you."
...
Description[ENGLISH][3] = "Take Judith Tanner five spools of thread and two grey cloth. You can produce the cloth at the loom. The thread can be produced at the spinning wheel, you'll need different amounts of wool to produce them both."
Description[GERMAN][4] = "Geh zu Judith Tanner, sie hat bestimmt noch eine Aufgabe für dich."
Description[ENGLISH][4] = "Go to Judith Tanner, she has for sure another task for you."
...
Description[ENGLISH][6] = "Go to Judith Tanner, she has for sure another task for you."
