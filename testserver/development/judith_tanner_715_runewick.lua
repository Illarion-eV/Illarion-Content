...
Description[GERMAN][7] = "Stell fünf Eimer mit roter Farbe für Judith Tanner im Untergeschoss des Feuerturms her. Um die rote Farbe herzustellen, musst du ein Feuer machen. Dafür plazierst du das Holz vor dir auf dem Boden und benutzt dieses. Anschließend nimmst du den Mörser in die Hand und benutzt diesen."
Description[ENGLISH][7] = "Produce five buckets of red dye for Judith Tanner in the basement of the Fire Tower. To produce red dye you have to make a fire by placing wood on the ground and using it. Once you have done that take the mortar in your hand and use it, whilst standing in front of the fire."
...
Description[GERMAN][9] = "Färbe fünf Rollen roten Stoff bei dem schwarzen Fass in der Schneiderei von Runewick für Judith Tanner, die sich im Untergeschoss des Feuerturms aufhält. Um die Stoffe herzustellen, musst du den Färberstab in die Hand nehmen. Anschließend benutzt du das schwarze Fass, während du die Eimer mit Farbe und den weißen Stoff in deinem Inventar hast."
Description[ENGLISH][9] = "Dye five bolts of cloth red for Judith Tanner in the basement of the Fire Tower, using the black barrel. To dye the cloth you have to take the dyeing rod in your hand and use the black barrel whilst having red dye and white cloth in your inventory."
