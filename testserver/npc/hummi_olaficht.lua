...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Find Elesil'end] You gained some coins. Have you already asked for and visited the two other NPCs that Hummi mentions?"));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Find Frizza' end] You gained some coins. Have you already asked for and visited the two other NPCs that Hummi mentions?"));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 3000));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Find Iradona' end] You gained some coins. Have you already asked for and visited the two other NPCs that Hummi mentions?"));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 3000));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Winner's name' end] You gained some coins. Hummi does not have any other quests for you, just more information, but look for other quests with other NPCs."));
