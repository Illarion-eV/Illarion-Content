...
function _skill_helper_equal(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value == player:getSkill(self.skill))
end;

function _skill_helper_notequal(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value ~= player:getSkill(self.skill))
end;

function _skill_helper_lesserequal(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value <= player:getSkill(self.skill))
end;

function _skill_helper_greaterequal(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value >= player:getSkill(self.skill))
end;

function _skill_helper_lesser(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value < player:getSkill(self.skill))
end;

function _skill_helper_greater(self, npcChar, player)
    local value = npc.base.talk._get_value(self.npc, self.value, self.valuetype);
    return (value > player:getSkill(self.skill))
end;
