...
VALUES (2, 412, 291, 0, 4, 'Pipillo', 'npc.pipillo', 0, 1, 1, 123, 62, 9, 245, 180, 137);
---]]
...
module("npc.pipillo", package.seeall)
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Game Help] This NPC is the portal merchant Pipillo. Keywords: Hello, portal, trade."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("Hilfe");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Spielhilfe] Dieser NPC ist der Portalbuchhändler Pipillo. Schlüsselwörter: Hallo, Portal, Handel."));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Pipillo, portalbook merchant. That's me.");
talkEntry:addResponse("I am the merchant Pipillo.");
talkEntry:addResponse("Pipillo is my name, I trade portalbooks.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Pipillo, Portalbuch Händler. Das bin ich.");
talkEntry:addResponse("Ich bin der Händler Pipillo");
talkEntry:addResponse("Pipillo mein Name, ich handle mit Portalbüchern");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch nach Cadomyr","portal book to Cadomyr",20000,1,333,{["destinationCoordsY"] = "647", ["destinationCoordsX"] = "127", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to Cadomyr", ["descriptionDe"] = "Portal nach Cadomyr"}));
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch nach Galmair","portal book to Galmair",20000,1,333,{["destinationCoordsY"] = "245", ["destinationCoordsX"] = "424", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to Galmair", ["descriptionDe"] = "Portal nach Galmair"}));
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch nach Runewick","portal book to Runewick",20000,1,333,{["destinationCoordsY"] = "826", ["destinationCoordsX"] = "788", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to Runewick", ["descriptionDe"] = "Portal nach Runewick"}));
tradingNPC:addItem(npc.base.trade.tradeNPCItem(1061,"sell","Portalbuch zum Hemp Necktie Inn","portal book to the Hemp Necktie Inn",20000,1,333,{["destinationCoordsY"] = "308", ["destinationCoordsX"] = "648", ["destinationCoordsZ"] = "0", ["descriptionEn"] = "Portal to the Hemp Necktie Inn", ["descriptionDe"] = "Portal zum Hemp Necktie Inn"}));
...
mainNPC:setLookat("Dieser NPC ist Pipillo der Portalbuchhändler.", "This NPC is Pipillo the portalbook merchant");
