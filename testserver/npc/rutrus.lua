...
talkEntry:addResponse("Oh! Du willst mir helfen? Nehme diese Schaufel hier und beschaffe mir zehn Haufen groben Sand. Grabe neben Steinen in der Wüste. Dein Lohn sollen fünf Silberstücke sein.");
talkEntry:addConsequence(npc.base.consequence.item.item(24, 1, 399, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(67, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Neues Quest] Sternenoase I"));
talkEntry:addResponse("Du willst mir helfen? Nimm diese Schaufel hier und beschaffe mir zehn Haufen groben Sand. Grabe neben Steinen in der Wüste. Dein Lohn sollen fünf Silberstücke sein.");
talkEntry:addConsequence(npc.base.consequence.item.item(24, 1, 399, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(67, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst fünf Silberstücke und deine Bergbaufertigkeit steigt. Dein Ansehen bei Königin Rosaline Edwards steigt."));
...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst zehn Silberstücke und deine Bergbaufertigkeit steigt. Dein Ansehen bei Königin Rosaline Edwards steigt."));
...
talkEntry:addCondition(npc.base.condition.town.town(1));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 20 Silberstücke und deine Bergbaufertigkeit steigt. Dein Ansehen bei Königin Rosaline Edwards steigt."));
