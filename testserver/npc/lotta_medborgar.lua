...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest End 'Find Lotta'] You received 10 silvercoins and 5 rankpoints."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest End 'Find Lotta'] You received 10 silvercoins."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.quest.quest(630, "=", 2));
talkEntry:addResponse("Good day. Finally you found me! Iradona has already informed me about your visit. There you have some silvercoins for that you found me.");
talkingNPC:addTalkingEntry(talkEntry);
