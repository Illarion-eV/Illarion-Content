...
talkEntry:addConsequence(npc.base.consequence.item.item(189, 1, 399, nil));
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.skill.skill(Character.cookingAndBaking, "<", 90));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded five silver coins and your cooking skill increases. You advance in Archmage Elvaine Morgan's favour."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst fünf Silberstücke und deine Kochfertigkeit steigt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
...
talkEntry:addCondition(npc.base.condition.item.item(307, "all", ">", 9, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst fünf Silberstücke und deine Kochfertigkeit steigt."));
talkEntry:addResponse("Ah, wunderbar. Ich nehme das Fleisch und du bekommst deinen Lohn. Sag bescheid, wenn du noch einen Auftrag willst.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 500));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(307, 10, nil));
...
talkEntry:addCondition(npc.base.condition.item.item(69, "all", ">", 19, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded ten silver coins and your cooking skill increases. You advance in Archmage Elvaine Morgan's favour."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst zehn Silberstücke und deine Kochfertigkeit steigt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded ten silver coins and your cooking skill increases."));
talkEntry:addResponse("Very good pieces of leather. Here is your money and tell me, if you want an other task.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(69, 20, nil));
...
talkEntry:addCondition(npc.base.condition.item.item(69, "all", ">", 19, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst zehn Silberstücke und deine Kochfertigkeit steigt."));
talkEntry:addResponse("Das sind doch mal ein paar ordentlichen Häute! Hier dein Geld und sag bescheid, wenn du wieder eine Aufgabe brauchst.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(69, 20, nil));
...
talkEntry:addResponse("You want another task? Well, bring me five pieces of deer meat and you will earn ten silver coins.");
...
talkEntry:addResponse("Du willst noch eine Aufgabe? Dann bring mir mal fünf Rehrücken und du erhältst zehn Silberstücke.");
talkEntry:addConsequence(npc.base.consequence.quest.quest(64, "=", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addCondition(npc.base.condition.item.item(552, "all", ">", 4, nil));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded ten silver coins and your cooking skill increases. You advance in Archmage Elvaine Morgan's favour."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded 20 silver coins and your cooking skill increases. You advance in Archmage Elvaine Morgan's favour."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 20 Silberstücke und deine Kochfertigkeit steigt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You are awarded twenty silver coins and your cooking skill increases."));
talkEntry:addResponse("Hmmm, good coal. You really deserve the coins.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 2000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(21, 10, nil));
...
talkEntry:addCondition(npc.base.condition.item.item(21, "all", ">", 9, nil));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelöst] Du erhältst 20 Silberstücke und deine Kochfertigkeit steigt."));
talkEntry:addResponse("Das ist wirklich gute Kohle. Da hast du dir diese Münzen wirklich verdient.");
talkEntry:addConsequence(npc.base.consequence.skill.skill(Character.cookingAndBaking, "+", 1));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 2000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(21, 10, nil));
