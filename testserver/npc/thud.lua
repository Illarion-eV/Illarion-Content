...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.skill.skill(Character.distanceWeapons, "=>", 40));
...
talkEntry:addTrigger("troph");
talkEntry:addResponse("Hurr, Thud like you. Take this stuff here!");
talkEntry:addConsequence(npc.base.consequence.item.item(2445, 1, 999, {["gravur"] = "1073741826"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(301, "+", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.skill.skill(Character.slashingWeapons, "=>", 40));
talkEntry:addCondition(npc.base.condition.quest.quest(301, "=>", 9));
talkEntry:addCondition(npc.base.condition.quest.quest(301, "=<", 13));
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger("troph");
...
talkEntry:addTrigger("troph");
talkEntry:addResponse("Hurr, Thud like you. Take this stuff here!");
talkEntry:addConsequence(npc.base.consequence.item.item(2448, 1, 999, {["gravur"] = "1073741826"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(301, "+", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addTrigger("troph");
talkEntry:addResponse("Hurr, Thud like you. Take this stuff here!");
talkEntry:addConsequence(npc.base.consequence.item.item(95, 1, 999, {["gravur"] = "1073741826"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(301, "+", 5));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
...
talkEntry:addResponse("Thud be proud orc! Honour! Mes not talk with Snaga! Dirty scheschnak-monkeys!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("#me wischt seine Nase am Hemdärmel ab.", "#me sneezes into his shirt sleeve.");
