...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Eintracht'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 21));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'trösten'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 22));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Vernichter'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 23));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Zwietracht'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 24));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Sonnenmacher'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 25));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Drachen'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 26));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Feuer'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 27));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest answer is imparted] Deliver the answer to Sir Fludnar Yednos. Your keyword is 'summer'."));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Sommer'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 28));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'leben'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 29));
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest Antwort erhalten] Überbringe nun die Antwort zu Sir Fludnar Yednos. Dein Stichwort ist 'Flamme'."));
talkEntry:addConsequence(npc.base.consequence.quest.quest(600, "=", 30));
...
talkEntry:addCondition(npc.base.condition.item.item(224, "all", ">", 0, nil));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest 'Bringe Nobarg seine erwünschten Gegenstände' gelöst] Frage ihn nun deine Frage von Sir Fludnar Yednos"));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2553, 1, nil));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(2553, 1, nil));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(224, 1, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(603, "=", 8));
...
talkEntry:addResponse("Please, do not interrupt me until you've gotten the pure fire! As I said, I need a pure fire, a red priest robe and a golden goblet. Please bring them all together.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.inform.inform("Du hast nicht alle drei erforderlichen Gegenstände."));
...
talkEntry:addResponse("Well, I know the answer but you have to bring me three things first: A pure element of fire in order to praise Bragon, a red priest robe in order to replace my old one and a golden goblet for a ritual. Brágon show you the path to righteousness!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
