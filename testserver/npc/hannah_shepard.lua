...
talkEntry:addCondition(npc.base.condition.town.town(3));
talkEntry:addTrigger(".+");
talkEntry:addResponse("Das sind noch keine fünf Getreidebündel. Kommt wieder wenn Ihr die Aufgabe erledigt habt.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("You want another task? Alright, thresh the bundles of grain using this flail I give you, to produce grain. Once you have done that, go into the city, make your way to the palace and enter the first room on the right-hand side. Once you are there, make five sacks of flour at the millstone with the wooden shovel I give you. Then return and show me the result.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(711, "=", 4));
talkEntry:addResponse("Gut gemacht. Bitte behaltet das Mehl für Eure nächste Aufgabe.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkingNPC:addCycleText("Wenn Ihr Hilfe beim Kochen und Backen braucht dann fragt mich nur!", "If you need any help with baking and cooking, just ask me!");
