...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] Move the mouse cursor over the pick-axe in your inventory in order to examine it."));
...
talkEntry:addCondition(npc.base.condition.quest.quest(310, "=", 3));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] Bewege den Mauszeiger über die Spitzhacke in deinem Inventar um sie zu untersuchen."));
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] You can perform a double click on an item to use it. Double click the torch in your inventory to ignite it."));
...
talkEntry:addCondition(npc.base.condition.quest.quest(310, "=", 4));
talkEntry:addTrigger(".*");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Tutorial] Du kannst einen Gegenstand mit einem Doppelklick benutzen. Doppelklicke die Fackel in deinem Inventar, um sie zu entzünden."));
