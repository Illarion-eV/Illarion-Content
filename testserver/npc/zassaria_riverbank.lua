...
talkEntry:addConsequence(npc.base.consequence.item.item(55, 1, 333, {["descriptionEn"] = "This robe has the colour of the sea.", ["descriptionDe"] = "Diese Robe hat die Farbe des Meers."}));
...
talkEntry:addConsequence(npc.base.consequence.item.item(71, 1, 333, {["rareness"] = "1"}));
