...
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You solved the Quest and are rewarded by Zarissa with some coins, an old sabre found at the bottom of the sea and a pair of new boots."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst und erhälst zum Dank etwas Geld, einen Säbel den Zarissa auf dem Grund des Meeres gefunden hat und ein Paar neue Stiefel."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 600));
talkEntry:addConsequence(npc.base.consequence.item.item(25, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(53, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 3));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 10 Silbermünzen und einem alten Zauberhut belohnt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(357, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 6));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 4));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You solved the quest. You are awarded 12 silver coins and a new robe in the colour of the ocean."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 12 Silbermünzen und eine neue Robe in der Farbe des Ozeans belohnt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1200));
talkEntry:addConsequence(npc.base.consequence.item.item(193, 1, 333, {["descriptionEn"] = "This robe has the colour of the sea.", ["descriptionDe"] = "Diese Robe hat die Farbe des Meers."}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 9));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You solved the quest. You are awarded with some coins and jewellery."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit Münzen und Schmuck belohnt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(62, 1, 877, {["rareness"] = "1", ["craftedBy"] = "Zassaria Riverbank"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 12));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 9));
...
talkEntry:addConsequence(npc.base.consequence.item.item(225, 1, 999, {["descriptionEn"] = "This crown belongs to Rosaline Edwards.", ["descriptionDe"] = "Diese Krone gehört Rosaline Edwarts."}));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest solved] You solved the quest. You are awarded a silvered longsword and some coins."));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit einem versilberten Langschwert und ein paar Silbermünzen belohnt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 500));
