...
talkEntry:addResponse("Ah Florain sssend you but you already ask me for something to do.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("dreyndel");
talkEntry:addConsequence(npc.base.consequence.quest.quest(820, "=", 6));
talkEntry:addResponse("Ah Florain hat Euch gessschickt aber Ihr habt mich bereits nach einer Aufgabe gefragt.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst und erhälst zum Dank etwas Geld, einen Säbel den Zarissa auf dem Grund des Meeres gefunden hat und ein Paar neue Stiefel. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 600));
talkEntry:addConsequence(npc.base.consequence.item.item(25, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.item.item(53, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 3));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 10 Silbermünzen und einem alten Zauberhut belohnt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(357, 1, 333, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 6));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 4));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit 12 Silbermünzen und eine neue Robe in der Farbe des Ozeans belohnt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1200));
talkEntry:addConsequence(npc.base.consequence.item.item(193, 1, 333, {["descriptionEn"] = "This robe has the colour of the sea.", ["descriptionDe"] = "Diese Robe hat die Farbe des Meers."}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 9));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 5));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit Münzen und Schmuck belohnt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.item.item(62, 1, 877, {["rareness"] = "1", ["craftedBy"] = "Zassaria Riverbank"}));
talkEntry:addConsequence(npc.base.consequence.quest.quest(701, "=", 12));
talkEntry:addConsequence(npc.base.consequence.rankpoints.rankpoints("+", 9));
...
talkEntry:addConsequence(npc.base.consequence.item.item(225, 1, 999, {["descriptionEn"] = "This crown belongs to Rosaline Edwards.", ["descriptionDe"] = "Diese Krone gehört Rosaline Edwards."}));
...
talkEntry:addCondition(npc.base.condition.town.town(2));
talkEntry:addTrigger(".+");
talkEntry:addConsequence(npc.base.consequence.inform.inform("[Quest gelößt] Du hast das Quest gelöst. Du wirst mit einem versilberten Langschwert und ein paar Silbermünzen belohnt. Dein Ansehen bei Erzmagier Elvaine Morgan steigt."));
talkEntry:addConsequence(npc.base.consequence.money.money("+", 500));
