...
if (MonID==881) then --Bloodhunter, Level: 2, Armourtype: cloth, Weapontype: concussion
        ...
        if not done then done=monster.base.drop.AddDropItem(283,1,1,(100*math.random(1,2)+math.random(11,22)),0,1); end --obsidian
        ...
        local done=monster.base.drop.AddDropItem(284,1,20,(100*math.random(1,2)+math.random(11,22)),0,3); --sapphire
    ...
    elseif (MonID==882) then --Monstrosity, Level: 3, Armourtype: light, Weapontype: puncture
        ...
        if not done then done=monster.base.drop.AddDropItem(284,1,10,(100*math.random(2,3)+math.random(22,33)),0,3); end --sapphire
