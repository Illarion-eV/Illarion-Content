	...
	if find then --Is this even a noob?
	    ...
	    if (value == 0) then --Didn't visit the triggerfield yet
	        ...
	        if Character:getPlayerLanguage() == 0 then
		        dialogNewbie = MessageDialog("Tutorial","An dieser Station wird dir die Elfe Aldania erkläre, wie man Gegenstände anlegt, sie benutzt und sie untersucht. Begrüße sie einfach so, wie du es von Henry Cunnigan gelernt hast!", callbackNewbie)
	        else	
		        dialogNewbie = MessageDialog("Tutorial", "At this station, the elfess Aldania will explain to you how to equip, use and examine items. Greet her as you learned from Henry Cunnigan!", callbackNewbie)
	        end	
