...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.money.money("=>", 2500));
talkEntry:addCondition(npc.base.condition.quest.quest(316, "=", 4));
talkEntry:addTrigger("ja");
...
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addCondition(npc.base.condition.money.money("=>", 2000));
talkEntry:addCondition(npc.base.condition.quest.quest(316, "=", 5));
talkEntry:addTrigger("yes");
...
talkEntry:addTrigger("job");
talkEntry:addTrigger("quest");
talkEntry:addConsequence(npc.base.consequence.inform.inform("She pays you ten silver coins. It feels good, doesn't it?"));
...
talkEntry:addTrigger("adventure");
talkEntry:addTrigger("mission");
talkEntry:addConsequence(npc.base.consequence.inform.inform("She pays you ten silver coins. It feels good, right?"));
talkEntry:addResponse("Oh, that's amazing! You really found it! This to compensate you for your effort.");
talkEntry:addConsequence(npc.base.consequence.money.money("+", 1000));
talkEntry:addConsequence(npc.base.consequence.deleteitem.deleteitem(79, 1, nil));
talkEntry:addConsequence(npc.base.consequence.quest.quest(303, "=", 4));
...
talkEntry:addTrigger("job");
talkEntry:addTrigger("quest");
talkEntry:addConsequence(npc.base.consequence.inform.inform("She pays you ten silver coins again. It feels also feels good, right?"));
