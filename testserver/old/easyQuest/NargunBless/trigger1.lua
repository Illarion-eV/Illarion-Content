...
local RADIUS = 10
local LOOKAT_TEXT_DE = "Für einen Moment kam es dir so vor  als ob du einen Raben, der dich gerade noch angestarrt hatte, auf Nargun`s Altar sitzen gesehen hättest. Du bekommst eine Gänsehaut."
