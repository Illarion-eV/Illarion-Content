--------------------------------------------------------------------------------
-- NPC Name: Rose Rabon                                               Cadomyr --
-- NPC Job:  Cook                                                             --
--                                                                            --
-- NPC Race: human                      NPC Position:  116, 582, 0            --
...
VALUES (0, 116, 582, 0, 6, 'Rose Rabon', 'npc.rose_rabon', 1, 1, 0, 238, 118, 33, 139, 90, 43);
---]]
...
module("npc.rose_rabon", package.seeall)
...
talkEntry:addCondition(npc.base.condition.language.language("english"));
talkEntry:addResponse("What opinion can I have on the entire world?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("My beautiful little girl. She takes so much after her father. Linda even followed him and became a cook");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Olddra has to be the favorite god of any mother.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("My husband put up an alter to Adron In this tavern. I see it everyday. He has given us plenty.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Hello. I am Rose Darknight. I would be glad to help you with anything that you need.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
