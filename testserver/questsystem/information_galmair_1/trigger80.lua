...
module("questsystem.information_galmair_1.trigger80", package.seeall)

local QUEST_NUMBER = 631
local PRECONDITION_QUESTSTATE = 31
local POSTCONDITION_QUESTSTATE = 31

local NPC_TRIGGER_DE = "[Kk]önigin|[Rr]osaline|[Ee]dwards|[Ee]rzmagier|[Ee]lvaine|[Mm]organ"
local NPC_TRIGGER_EN = "|[Qq]ueen|[Rr]osaline|[Ee]dwards|[Aa]rchmage|[Ee]lvaine|[Mm]organ"
