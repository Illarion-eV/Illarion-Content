...
function HANDLER(PLAYER)
    ...
    handler.sendmessagetoplayer.sendMessageToPlayer(PLAYER, "[Quest Hinweis] Du hast ein Schwert erhalten. Gehe nach Eibental und zähle die Reiterstatuen an der Spitze des Leuchturms am Hafen.", "[Quest Hint] You have received a sword. Go to Yewdale and count the riderstatues on the top of the lighttower at the harbour."):execute()
end
