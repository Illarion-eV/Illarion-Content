...
module("questsystem.information_runewick_622.trigger2", package.seeall)
...
local NPC_REPLY_EN = "I see you have the pell. Good, give it to me. *takes it and writes some lines before she hands it back*"
