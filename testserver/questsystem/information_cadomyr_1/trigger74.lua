...
module("questsystem.information_cadomyr_1.trigger74", package.seeall)
...
local NPC_REPLY_DE = "Wie ich sehe, wurde die Notiz gefunden und auch einen Fisch gebracht. Man darf ihn behalten. Nun ab in den Einh�rnigen L�wen. Was wird auf dem Bild dort gebaut?"
