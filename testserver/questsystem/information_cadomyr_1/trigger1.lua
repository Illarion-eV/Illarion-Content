...
module("questsystem.information_cadomyr_1.trigger1", package.seeall)
...
local NPC_REPLY_DE = "Ich habe die eine oder andere Aufgabe zu vergeben. Daf�r muss man aber erst einen kleinen Test bestehen. In welcher Fraktion befindest wir uns?"
