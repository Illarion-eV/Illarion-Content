...
module("questsystem.information_cadomyr_1.trigger34", package.seeall)
...
local NPC_REPLY_DE = "Welche Fraktion wird von Erzmagier Elvaine Morgan beherrscht?"
local NPC_REPLY_EN = "Which faction is ruled by Archmage Elvaine Morgan?"
