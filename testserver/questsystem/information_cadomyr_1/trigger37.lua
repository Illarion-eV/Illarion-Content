...
module("questsystem.information_cadomyr_1.trigger37", package.seeall)
...
local NPC_REPLY_DE = "Wer kann dir hier mit Orten um Cadomyr behilflich sein? "
local NPC_REPLY_EN = "Whom can you ask if you want to know more about places around Cadomyr?"
