...
Description[GERMAN][1] = "Sammel zehn Getreidebündel für Francine Leonard im Untergeschoss des Luftturms. Um Getreidebündel zu kriegen, musst du das Getreide von Francine auf den Feldern in Yewdale säen. Dazu benutzt du das Getreide, während du auf dem Feld stehst. Anschließend musst du warten, bis es reif ist. Sobald es reif ist, nimmst du die Sense in die Hand und benutzt diese um das Getreide zu Getreidebündeln zu schneiden. Yewdale ist bei der goldenen Brücke nördlich des Teleporters."
Description[ENGLISH][1] = "Collect ten bundles of grain for Francine Leonard in the basement of the Wind Tower. To get the bundles of grain you have to seed the grain which Francine gave you on the fields in Yewdale. To do this just hold the grain in your hand and use it, whilst standing on the field. Once the crop is ready, harvest the ripened grain by holding the scythe you got from Francine in your hand and using it. Yewdale is at the golden bridge north of the teleporter."
