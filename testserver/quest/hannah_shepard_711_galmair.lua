...
Description[GERMAN] = {}
Description[ENGLISH] = {}
Description[GERMAN][1] = "Sammel fünf Getreidebündel für Hannah Shepard bei den Feldern von Galmair. Um Getreidebündel zu kriegen, musst du das Getreide von Hannah auf den Feldern säen. Dazu benutzt du das Getreide, während du auf dem Feld stehst. Anschließend musst du warten, bis es reif ist. Sobald es reif ist, nimmst du die Sense in die Hand und benutzt diese, um das Getreide zu Getreidebündeln zu schneiden."
Description[ENGLISH][1] = "Collect five bundles of grain for Hannah Shepard at the fields outside Galmair. To get the bundles of grain you have to seed the grain which Hannah gave you on the fields. To do this just hold the grain in your hand and use it whilst standing on the field. Once the crop is ready, harvest the ripened grain using the scythe you got from Hannah."
