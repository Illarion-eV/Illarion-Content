--[[
    Create living aggressive creature
    Rune 6 & 9 & 10
        URA TAUR LUK

    Creature-Spell

    SQL:    INSERT INTO spells VALUES (2^5+2^8+2^9,0,'m_06_09_10_summ-aggr-beast.lua');
]]

-- including the main script for gfx spells
require("magic.base.creaturspell");
module("magic.spell_06_09_10_summ-aggr-beast", package.seeall)
...
Monsters = { 121, 122, 241, 132 };  -- IDs of monsters that could be created
