--[[
    ...
    SQL:    INSERT INTO spells VALUES (2^2+2^3+2^23,0,'m_03_04_24_extinguish-iceflame-area.lua');
]]

-- including the main script for gfx spells
require("magic.base.gfxspell");
module("magic.spell_03_04_24_extinguish-iceflame-area", package.seeall)
