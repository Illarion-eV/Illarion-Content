--[[
    poison circle illusion
    Rune 13 & 14 & 23 & 24 & 28
        LHOR YEG SAV ANTH DUN

    Item-Spell

    SQL:    INSERT INTO spells VALUES (2^13+2^12+2^22+2^23+2^27,0,'m_13_14_23_24_28_poisoncircle-illusion.lua');
]]

-- including the main script for item spells
require("magic.base.itemspell");
module("magic.spell_13_14_23_24_28_poisoncircle-illusion", package.seeall)
