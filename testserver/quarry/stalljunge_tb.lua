        ...
        if (originator:getQuestProgress(8) == 0) then
            ...
            if CheckMoney(originator,GCoins,SCoins,CCoins) then
                ...
                if not posOfCow then
                    ...
                    thisNPC:talkLanguage( Character.say, Player.german, "Hier habt ihr den Esel. Bringt ihn sicher wieder dann bekommt ihr die "..(Kaution/100).." Silberstücke Kaution wieder.");
