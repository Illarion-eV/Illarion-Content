...
talkEntry:addResponse("Hurr. Give me the stuff... and now ask your question to tha ancestors.");
...
talkEntry:addResponse("The ancestors prophecy! The one with fire in head will need your help.");
talkEntry:addResponse("Don't trust tha bearer of fur! Your ancetors advice...");
...
talkEntry:addResponse("There one will be! Leading this Tribe! Glorious day come! Honourable Battle! ...maybes you...maybee.");
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("seek advice");
talkEntry:addResponse("Indeed! But the advice of mine and tha ancestors'll need 2 copper coins! Entrails and ashes from a campfire... uhm 'nd yes, yes a sausage also be needed, he he!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("suche rat");
talkEntry:addResponse("Türlich! Aber Rat von Ahnen und mirr braucht Kupfermünzen... 2! Gedärme und Asche von Lagerfeuer... uhm 'nd ja, ja ne Wurst brauchen wir auch, he he!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("Hrm, mes should tell another tale?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
talkEntry:addTrigger("stop");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("Hrm, mir soll erzählen etwas anderes?");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Chief Veralion was one of the first chiefs and founding fathers of the original clan. Under his reign, the clan saw their most prosperous and productive years...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("continue");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("...His efforts helped keep the clan together in times both thick and thin. In life, he was honourable, well respected by fellow clansmen, and revered as a great saviour of our kin. Rest in peace, old friend.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Gabon Corad maintained the Clan until Warrior Queen Kurga Wolfbane assumed control of the Clan as their first 'chieftess'. He currently serves as Red Skull as the eldest and most respected Bloodskull.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Warrior Queen Kurga Wolfbane was murdered by a clanman known as Zub. She was betrayed and ambushed by Zub and several humans and elves...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("continue");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("...Under her short term of leadership, the Orc Cave was expanded and Orcs recruited. May she rest well with the greatest honour an Orc can receive.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("WWarlord Retlak! His name stood for the strength and superiority of the Orcs. His name was mentioned with respect by Orcs and spoken with fear by others....");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("...All beings of the human town as well as the desert town held their breath when the Warlord entered the gates. The warlord lived for many, many years on the island...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("continue");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("...He fought side by side with Gabon Corad and Gort called 'Crunk' ((not sure what this means)). Even today many people will remember the Warlord's name, even many years after his death. The Orcs honour Retlak?s life.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse(" General Grivijak! Compared to the warlord Retlak, General Grivijak lived on Gobaith for only quite a short time. However, in his given time...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse(" ...he became the strongest warrior of the whole island. He used his strength and wisdom to unite the Orcs with the help of Gabon Corad. There are rumours about his disappearance...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse(" Borgrud, known also as Bor, was a loyal warrior of great strength, who was surrounded and attacked by the cowardly humans of Troll?s Bane...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("...They bound him with ropes, but he broke free, and shouting his last word 'FREE!' charged into them. He was killed that day, in front of his own daughter Krebla's eyes..");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("...He reformed the Orc Clan up from the ashes of the bloodskulls and created the largest clan known, the Dark'rest Clan. He expanded the cave defences with the building of the gates...");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addTrigger("continue");
talkEntry:addConsequence(npc.base.consequence.state.state("=", 0));
talkEntry:addResponse("...And the Hall of Ancestors was built under his reign as well as the jail. Then the Clan was able to fight a stunning victory against the dwarves of Silverbrand after a year long war, under his leadership.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("...his reputation there will be vast, and his ancestors will honour him. He will have many servants and slaves, and the woman will love him....");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Greebs.. seeking advice, are you?");
talkEntry:addResponse("#me wears a blindfold. Although he truns his head to you. '%CHARNAME...'");
...
talkEntry:addResponse("My name, Olokwa is! My eyes only see black and murk, although Olokwa see more than every other.");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Olokwa's eyes dead... But he hear tha voice of ancestors. He quizzes the bones. He see tha icy witch in his dreams!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Jag beh proud and honourfull redskull, hurr!");
...
talkEntry:addResponse("Yes, Murgo. He is honourfull warrior. Important for Orcs. Lot of great doings. Lot of.");
...
talkEntry:addResponse("Nub be weak with those weepy slave. She hab to learn, be strong! Bring tha owner honour! Yubba.");
...
talkEntry:addResponse("Mo'rurt be owner ob Stout. Stout be honourable slave is. Yubba. Got crossbow and joins Mo'rurt on hunting.");
...
talkEntry:addResponse("Stout be slave ob Mo'rurt. He good slave. Make tha owner much honour.");
talkEntry:addResponse("Altough he Oomie is, he be allrighty. Stout brave slave. Mo'rurt be proud ob 'hm.");
talkEntry:addResponse("Hurr, Stout strong slave. Nub like thus weepy girl 'nd tha dastardly halfer. Stout 'll earn great honour. Tha otha both earn punsihment.");
...
talkEntry:addTrigger("Kroch'Gurak");
talkEntry:addResponse("Kroch'gurak! Is where most ob us Orcs come from. This be the big winter camp at Norbuk Plateau be!");
talkEntry:addResponse("Kroch'Gurak is located in the West of the Plateau and in winter a lot of tribes gather there to camp. It's a big town of natural and dug caves, filled with many flocks and resources.");
...
talkEntry:addResponse("Kroch'Gurak ! This is the Orc town! Filled with Orcs and Orcs and goats and pigs and much more Orcs! You should hear the 'Bragg-Thu' and the drums!");
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addResponse("Hurr, long time gone, Orcs traveling to Norbuk, the 'Strong Land'. It's a big Plateau, split by the Black Current, so-called ?cause his water is black in spring.");
talkEntry:addResponse("Once a falcon appeared and led Grubuk Thunderhand, seer of the Bloodskull Clan down the path to the 'Strong Land'. Since these days, this land is Orc land.");
...
talkEntry:addResponse("Orks honour their Ancestors and the gods of his tribe. You go over there and talk to Grumlug! He's Schamane and knows everything about our gods. Tagtha.");
...
talkEntry:addResponse("I saw that coming.");
...
talkingNPC:addCycleText("#me klimpert mit der erloschenen Laterne in seinen Händen.", "#me jangles with his empty lantern.");
talkingNPC:addCycleText("#me schiebt seine Augenbinde zurecht.", "#me adjusts his blindfold.");
talkingNPC:addCycleText("Olokwa hört die Stimmen der Ahnen! Er befragt die Knochen! Er sieht die eisige Hexe in seinen Träumen.", "Olokwa hear tha voice of ancestors. He quizzes the bones. He see tha icy witch in his dreams!");
talkingNPC:addCycleText("Ich sehe tote Menschen!", "I see dead people!");
talkingNPC:addCycleText("#me nuckelt, breit grinsend an einer Wurst.", "#me slurps on a sausage with a broad grin.");
...
talkingNPC:addCycleText("Stein brechen wird. Holz morschen wird. Knochn splittern wird.", "Stone'll break. Wood'll root. Bone'll splash.");
...
talkingNPC:addCycleText("#me schwankt plötzlich für einige Sekunden beunruhigend ohne ein Wort von sich zu geben. Dann schnarcht er mit einem Mal laut auf und erwacht daraufhin wieder mit verwirrtem Gesichtsausdruck.", "#me sways ominously as he stands without a noise, then gives a loud snore before waking up again, grimacing with puzzled face.");
