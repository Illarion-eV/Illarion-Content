...
module("questsystem.information_runewick_1.trigger84", package.seeall)

local QUEST_NUMBER = 621
local PRECONDITION_QUESTSTATE = 31
local POSTCONDITION_QUESTSTATE = 31

local NPC_TRIGGER_DE = "[Dd]on|[Vv]alerio|[Gg]uilianni|[Kk]önigin|[Rr]osaline|[Ee]dwards"
local NPC_TRIGGER_EN = "[Dd]on|[Vv]alerio|[Gg]uilianni|[Qq]ueen|[Rr]osaline|[Ee]dwards"
