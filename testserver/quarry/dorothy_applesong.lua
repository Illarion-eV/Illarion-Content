...
VALUES (2, -66, -100, 0, 6, 'Dorothy Applesong', 'npc.dorothy_applesong', 1, 2, 5, 123, 62, 9, 245, 180, 137);
---]]
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(22, "=", 1));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
...
talkEntry:addConsequence(npc.base.consequence.quest.quest(22, "=", 3));
talkingNPC:addTalkingEntry(talkEntry);
end;
if (true) then
local talkEntry = npc.base.talk.talkNPCEntry();
