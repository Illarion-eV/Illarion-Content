...
function initializeNpc()
    ...
    AddConsequence("inform","[Game Help] This is NPC is the peasant Francois Delacroix. Keyphrases: Hello, peasant, YOURTRIGGER1, YOURTRIGGER2.");
    AddTraderTrigger("Hilfe","");
    AddConsequence("inform","[Spielhilfe] Dieser NPC ist der Bauer Francois Delacroix. Schlüsselwörter: Hallo, Bauer, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
