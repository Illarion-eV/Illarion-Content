-- INSERT INTO npc VALUES (nextval('npc_seq'),0,911,798,1,0,false,'Francois Delacroix','npc_francois_delacroix.lua',0);

require("npcs.base.autonpcfunctions")
module("npcs.francois_delacroix")
...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddConsequence("inform","[Game Help] This is NPC is the peasant Francois Delacroix. Keyphrases: Hello, peasant, YOURTRIGGER1, YOURTRIGGER2.");
    npcs.base.autonpcfunctions.AddTraderTrigger("Hilfe","");
    npcs.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist der Bauer Francois Delacroix. Schlüsselwörter: Hallo, Bauer, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
