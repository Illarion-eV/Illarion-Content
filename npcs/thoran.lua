...
function initializeNpc()
    ...
    AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", one of Galmairs order traders!");
    ...
    AddTraderTrigger("[Dd]u.+[Hh]ändler","Ich bin "..thisNPC.name..", einer der Großauftragshändler Galmairs!");
