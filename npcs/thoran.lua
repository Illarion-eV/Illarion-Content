...
module("npcs.thoran", package.seeall(npc.base.orders))
...
function init()
   ...
   --Pool 1(Carpentry easy items):
    AddItemToPool(1,myOrderNPC,2752,1, 7, 1,25);--carving tools
    AddItemToPool(1,myOrderNPC,2717,1, 7, 5,25);--pins&cotters
    AddItemToPool(1,myOrderNPC,2744,1, 7, 1,15);--pipe
    AddItemToPool(1,myOrderNPC, 118,1, 7, 1,15);--rolling pin
    AddItemToPool(1,myOrderNPC,2781,1, 7, 1,15);--Dyeing Rod
    AddItemToPool(1,myOrderNPC,  72,1, 7, 1,20);--Fishing rod
    AddItemToPool(1,myOrderNPC,2952,1, 7, 1,15);--plate
    AddItemToPool(1,myOrderNPC,2185,1, 7, 1,25);--wooden cup
    AddItemToPool(1,myOrderNPC, 227,1, 7, 1,25);--cooking spoon
    AddItemToPool(1,myOrderNPC, 312,1, 7, 1,25);--wooden shovel
    AddItemToPool(1,myOrderNPC,2567,1, 7, 1,30);--shovel handle
    AddItemToPool(1,myOrderNPC,2561,1, 7, 1,30);--saw handle
    AddItemToPool(1,myOrderNPC,2544,1, 7, 1,30);--large handle
    
	--chances for qualities of pool 1
    myOrderNPC.orderPool:setQualityChancesForPool(1,{100,0,0,0,0,0,0,0,0,0});

   --Pool 2(Carpentry more easy items):
    AddItemToPool(2,myOrderNPC,2570,1, 6, 1,30);--sickle handle
    AddItemToPool(2,myOrderNPC,2567,1, 6, 1,30);--shovel handle
    AddItemToPool(2,myOrderNPC,2561,1, 6, 1,30);--saw handle
    AddItemToPool(2,myOrderNPC,2544,1, 6, 1,30);--large handle
    AddItemToPool(2,myOrderNPC,2530,1, 6, 1,30);--dagger handle
    AddItemToPool(2,myOrderNPC,2664,1, 6, 1,15);--club
    AddItemToPool(2,myOrderNPC,  40,2, 6, 1,15);--cleric's staff
    AddItemToPool(2,myOrderNPC,  64,1, 6, 5,50);--arrow 
    AddItemToPool(2,myOrderNPC,  51,1, 6, 1,15);--bucket
    AddItemToPool(2,myOrderNPC,  65,2, 6, 1,15);--shortbow
    AddItemToPool(2,myOrderNPC,  90,1, 6, 1,20);--flute
    AddItemToPool(2,myOrderNPC, 533,2, 6, 1,30);--drum
    AddItemToPool(2,myOrderNPC,  17,2, 6, 1,10);--wooden shield
    AddItemToPool(2,myOrderNPC,  18,2, 6, 1,10);--light metal shield
    AddItemToPool(2,myOrderNPC,  39,2, 6, 1,15);--skull staff
   ...
   --Pool 3(Carpentry middle hard items):
    AddItemToPool(3,myOrderNPC,2584,1,15, 1,30);--sword handle
    AddItemToPool(3,myOrderNPC,2527,1,15, 1,30);--large ornate handle
    AddItemToPool(3,myOrderNPC,2549,1,10, 1,30);--morning star handle
    AddItemToPool(3,myOrderNPC,  76,2,15, 1,15);--mage's staff
    AddItemToPool(3,myOrderNPC, 209,2,10, 1,15);--elven mage's staff
    AddItemToPool(3,myOrderNPC, 237,2,10, 1,30);--bolt
    AddItemToPool(3,myOrderNPC, 323,3,15, 1,10);--wand
	--chances for qualities of pool 3
    myOrderNPC.orderPool:setQualityChancesForPool(3,{40,20,15,15,5,3,2,0,0,0});

   --Pool 4(Carpentry more middle hard items):
    AddItemToPool(4,myOrderNPC,2714,3,15, 1,10);--hunting bow
    AddItemToPool(4,myOrderNPC,2727,3,10, 1,10);--serinjah firebow
    AddItemToPool(4,myOrderNPC, 335,3,15, 1,10);--lute
    AddItemToPool(4,myOrderNPC, 332,4,10, 1,10);--harp
    AddItemToPool(4,myOrderNPC,  19,4,10, 1,10);--metal shield
    AddItemToPool(4,myOrderNPC,  20,4,10, 1,10);--large metal shield
    AddItemToPool(4,myOrderNPC,2388,4,10, 1,10);--red steel shield
    AddItemToPool(4,myOrderNPC,2194,4,10, 1, 5);--short hardwood greaves
    AddItemToPool(4,myOrderNPC,2193,3,10, 1, 5);--hardwood greaves
	--chances for qualities of pool 4
    myOrderNPC.orderPool:setQualityChancesForPool(4,{40,20,15,15,5,3,2,0,0,0});

   --Pool 5(Carpentry difficult items):
    AddItemToPool(5,myOrderNPC, 207,4,10, 1,10);--Battle Staff
    AddItemToPool(5,myOrderNPC, 322,6,10, 1, 4);--wind arrows
    ...
    AddItemToPool(5,myOrderNPC,2718,4,10, 1,10);--Elven Composite Longbow
	myOrderNPC.orderPool:setQualityChancesForPool(5,{60,35,5,0,0,0,0,0,0,0});

   --Pool 6(Carpentry more difficult items):
    AddItemToPool(6,myOrderNPC,  70,5,10, 1, 5);--crossbow
    AddItemToPool(6,myOrderNPC,2685,6,10, 1, 5);--magical elven bow
    AddItemToPool(6,myOrderNPC,  96,5,10, 1,10);--Steel Tower shield
...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", one of Galmairs order traders!");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]u.+[Hh]ändler","Ich bin "..thisNPC.name..", einer der Großauftragshändler Galmairs!");
