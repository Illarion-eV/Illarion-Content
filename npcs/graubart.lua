...
function initializeNpc()
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]rü[ßs]e","#me grummelt \"Ja ja. Siehste net dat Ick am arbeiten bin?! pfff...\"");
    npcs.base.functions.AddAdditionalText("#me sieht auf und zeigt dir eine frisch geschmiedete Schwertklinge \"Is' es nich' nen Prachtstück? Aye, natürlich isses, is' ja auch von mir, har har...Oh, richtig. Grüße, oder wat auch immer.\"");
    npcs.base.functions.AddTraderTrigger("[Hh]allo","Aye, Wat auch immer. Brauchste wat? Wenn net, geh!");
    npcs.base.functions.AddAdditionalText(" Hallo? Haste gerade \"Hallo\" gesagt?! Wat bisse? Nen Elfenmädchen? Dat heisst \"Hey Meister\" oder \"Grüß dich alter Kumpel\". Versuchs nochmal!");
    npcs.base.functions.AddTraderTrigger("[Dd]u.+[Hh]ändler","Aye, Ick verkauf un' kauf verschiedenstes Zeuch, allet ne Sach vom Geld!");
    npcs.base.functions.AddAdditionalText("Ne, ick bin nen verdammter Elf der hier aufm Boden kniet un' nen falschen Bart trägt um dat Geheimniss des verdammt guten Zwerchenbieres aus zu spionieren....Natürlich bin ick nen Händler!");
    npcs.base.functions.AddAdditionalText("#me brummt und sieht sich um \"Lass mal sehn. Ick steh hier vor ner menge geschmiedetes Zeuch welches zum Verkauf angeboten wird un', oh, ja, ick hab hier diesen großen Geldbeutel voller Münzen...Nein, denke nich' dat ick nen Händler bin\"");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+verkauf","Ick verkauf wichtiges Zeuch für dat täglich Zwergenleben. Du solltest dat also kaufn, verstanden? KAUFEN! Dat heisst mit Geld un' so. Du hast doch Geld, oder?");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeug","#me grummelt und zählt genervt auf \"Spitzhacken, Gußformen, Tiegel, Tiegelzangen! Biste nu glücklich? Du hast mir wichtig Zeit gestohln, nu kauf auch wat!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ww]affe","Gaaaaaarrg...Serinjahschwerter, Säbel, Kurzschwerter, Dolche un' Streitkolben. Un' wenn du nu nix kaufst, dann schmeiss ich dir das ganze Zeug gegn deinen Kopp!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Hh]elm","Grmpf...Hörner un' Ork Helme und Stahlkappn verkauf ich. Un' nu hör auf mich von der Arbeit abzuhalten!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ss]child","#me grummelt \"einfache, normale, gute und Rundschilde. Okay? Jetzt zieh ab.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ee]twas","Seh ick aus wie dein Großvater, oder wat?! Geh un' frag den! Ick werd mein Zeit nich' vergeudn un' dir Geschichtn erzähln.");
    npcs.base.functions.AddAdditionalText("Na jut. Schonmal die Geschicht von dem Zwerchen gehört der nen alten Zwerchenhändler mit Fragen ärgerte un' von dem desshalb innen Ofen gesteckt wurde? Aye, da hasse deine Geschicht. Un' nu lass mich allein!");
    npcs.base.functions.AddAdditionalText("Nun, ick fürchte du hörst doch nich' auf zu fragen bis ick wat erzähl, aye? Nun gut, wat willste hören? Wat über die Götter? Wat über manche der berühmten Zwerche Silverbrands? Wat übers Schmieden? Oder gar wat über die Insel oder Silverbrand?");
    ...
    npcs.base.functions.AddAdditionalTrigger("[Tt]schüss");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]as.*%skauf","#me spricht mit verstellt gehobener Stimme \" Ooooh, ick kaufe hübsche Blumen un' den Sonnenschein im Einmachglas....BAH! Verflucht nochmal, wat denkste denn? Ick bin' Zwerg inner Zwergenstadt! Natürlich kauf ick geschmiedetes Zeuch!\"");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+du?","Wat interessiert dich mein Name?! Ick würd dich eh nich' heiraten! Nun...nen mich "..thisNPC.name..".");
    ...
    npcs.base.functions.AddTraderTrigger("[Hh]ilfe","'Was für Waren verkauft ihr', 'Ich möchte <Anzahl> <Ware> kaufen', 'Ich möchte <Ware> kaufen', 'Ich möchte <Anzahl> <Ware> verkaufen', 'Was ist der Preis von <Ware>','Was zahlt ihr für <Ware>', 'Was kauft ihr?'");
    ...
    npcs.base.functions.AddTraderTrigger("[Mm]asterwork","Aye, so it is. Tha dwarves are 'is masterwork! He created us out of stone, with tha earth of mother Ushara. An' Irmorom gav' us Bragóns fire which burns in us an' let us be such damn good craftmens.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]ho.+[Bb]ragón","Bragón is a fine lad, 'e is tha god of fire. Fire is it which we uses for craftin' great stuff. Fire is it which burns inside of us dwarves, an' giv' us strength an' much more! Respect an' 'onor 'im!");
    npcs.base.functions.AddTraderTrigger("[Oo]ther.+[Gg]ods","Arrr! I am busy, an' no priest. Go an' ask one of them. Ask around for one!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+%s[Aa]rbeit","#me rollt mit den Augen \"Nach wat siehts denn aus, hä? Natürlich schmiede ick, un' dat verdammt gut, bei Irmorom! Doch bin ick hier auch der Händler, wenn du also wat handeln wills', dann nur zu.\"");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[Ii]rmorom","#me hebt eine Augenbraue \"Wat? Du kennst den Irmorom nich'? Dat kann nich' dein Ernst sein! Er is' der Vater der Zwerche. Der Erschaffer der Welt! Gott des Handwerks un' des Handelns! Der Weltenschmied! Un' wir Zwerche sin' sein Meisterstück, vergiss dat nich'!\"");
    npcs.base.functions.AddTraderTrigger("[Mm]eisterwerk","Aye, so isses. Die Zwerche sin' sein Meisterwerk! Er machte uns aus Stein, genommen von der Erde Mutter Usharas. Un' er gab uns dat Feuer Bragóns welches in uns allen brennt un' uns zu so klasse Handwerkern macht.");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[Uu]shara","#me seufzt \"Da is' ja schon wieder ne Frage...was solls, is' immerhin ne wichtige, also hör zu! Ushara is' die große Göttin der Erde un' der Höhlen. Sie is' die Mutter der Zwerche da Irmorom ihren Fels nahm um uns zu schaffen. Frag andre Zwerche für mehr über sie.\"");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[Bb]ragón","Bragón is' nen großartiger Bursche. Gott des Feuers, aye. Feuer isses wat wir zum Schmieden nehmen. Feuer isses wat in uns brennt un' uns Kraft und mehr gibt! Respektiere un' Ehre ihn!");
    npcs.base.functions.AddTraderTrigger("[Aa]ndere.+[Gg]ötter","Arrr! Ick bin beschäftigt, un' auch kein Priester. Geh un' frag so einen. Frag die andern nach einem.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]ie.+[Ww]etter","#me hebt eine Augenbraue und sieht zur Höhlendecke rauf \"WAS?!\"");
    npcs.base.functions.AddAdditionalText("#me blickt sich in der Höhle um und spricht in einem sarkastischen Tonfall \"Es regnet, siehste dat nich'?\"");
    ...
    npcs.base.functions.AddTraderTrigger("[Hh]ey.+[Mm]eister","Aye, Dat klingt gut. Klingst wien Zwerch mit dem nötigen Respekt! Nun, wie kann ick dir helfen?");
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]rüße.+[Kk]umpel","#me sieht dir mit ernstem Gesicht in die Augen und spricht mit tiefer, rauer Stimme \"Ick bin nich' dein Kumpel, verstanden? Aber schonmal besser als \"Hallo\" isses. Gut, wat willste?\"");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Gg]ötter","Nun, unsre Welt hat viele Götter, aber nur 4 sin' wirklich wichtich für uns Zwerche, aye. Dat is' natürlich Irmorom. Jeder echte Zwerch betet zu ihm. Un' dann sin' da Ushara un' Bragon. Un' natürlich Cherga, aye! Willste dat ick mehr über einen Erzähl?");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ii]rmorom","Aye, Irmorom is' natürlich der wichtigste Gott. Er is' Gott des Handwerks un' des Handels. Wir nennen ihn auch Weltenschmied. Denn wir wissen dat er die Welt, die Zwerche un' alles andre schuf. Natürlich glauben die Oberweltler dat nich', bah! Willste mehr hörn?");
    ...
    npcs.base.functions.AddTraderTrigger("[Mm]ehr.+[Ii]rmorom","Nun, frach nen Priester über die Schöpfung. Ick weiss jedenfalls dat Irmorom Diebe un' Betrüger hasst. Er liebt Schätze, wie Gold, un' nen gutes Bier, har har. Wie jeder gute Zwerch. Irmorom lebt allen Göttern un' mit bisher verstorbenen, guten Zwerchen im Borag-Urubur.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Bb]orag","Dat is' der große Berch von dem Irmorom nen Felsen nam un' unsre Welt Illarion draus schuf. Er is' riesig! Jeder Zwerch der stirbt kommt zum Berg, un' Irmorom befragt ihn über sein Leben un' entscheidet ob ers Wert is' die Hallen zu betreten, aye. Möchtest mehr hörn?");
    ...
    npcs.base.functions.AddTraderTrigger("[Mm]ehr.+[Bb]orag","Wenn du vor Irmorom im großen Berge stehst wird er dich über dein Zwerchenleben befragen. Wenns nen Leben voll Ehre un' Gerechtigkeit war, lässt er dich rein in die Hallen. Wenn nich', musste vorm Tor als Bauer leben, gleich neben den Elfen un' Orks.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Oo]berweltler","Die Oberweltler, dat sin' all die andern mehr oder weniger staatenbildende Rassen die anner Oberfläche leben, un' nich' drunter. Die Elfen, Halblinge, Menschen, Orks un' Echsen.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ee]lfen","Bah, verdammte Langohrn. Sie sin' arrogante, baumknuddelnde Klugscheisser! Trau keinem Langohr so weit wie du ihn werfen kannst! Sie denken sie sin' wat besseres, mit ihrer blöden Liebe zur Natur un' ihrem langen Leben. Sie denken sie müssen nur Nießen un' Weisheit wächst draus.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Hh]alblinge","Halblinge sin' nich' so übel. Nette kleine Kerlchen. Sie lieben nen gutes Mahl un' Tropfen mehr als alles andre. Großartige Bauern un' so. Doch sei vorsichtig, viele haben auch lange Finger. Sie sin' auch gute un' schamlose Diebe! Achte auf deinen Geldbeutel wenn du einem begegnest.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Mm]enschen","Nun, die Langbeine. Du findest sie überall auf der Welt. Wie Ratten verbreiten sie sich. Manche sin' okay, manche nich'mal nen Axthieb wert. Trau denen nich' zu schnell. Die Menschen sin'recht vielschichtig un' vielseitig. Nen sehr chaotisches Volk, wenn du mich fragst.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Oo]rks","Arrr! Die Grünhäute, oder auch Schweinenasen. Sei vorsichtig bei diesen stinkenden Bastarden. Sie sin' hinterhältig, wild un' gewalttätig. Sie lieben es zu Kämpfen un' zu töten. Sie verstehn nur die Sprache der scharfen Axt, aye. Dreh niemals einen von den Mistkerlen den Rücken zu.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ee]chsen","Sie leben unter Wasser! DAT sagt ja schon alles. Verdammte Fische un' Schuppenfressen. Die sin' mehr Tier als Person. Un' all dat Zischeln, man versteht ja kein einziges Wort. Nich' dasse wat wichtiges zu sagen hätten. Bah, Wasseratmer, trau denen nich'!");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ss]ilberbrand","Drei Zwerche hatten vor langer Zeit den Plan ne Zwerchenstadt zu baun. Bombor, Rugosch un' Tialdin. Un' schon bald schlossen sich andre an. Sie arbeiteten zusammen, un' bauten diese Stadt. Sie wuchs, un' wurde mächtig. Sie sah Kriege, Katatrophen, sogar Dämonen!");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ss]tädte","The wichtigsten sin' Silberbrand hier, dann Trolls Bane im Südwesten, danach kommt Varshikar weit im Nordosten. Dann is' da noch Greensbriar, weit im Südwesten, un' Tol Vanima, die Insel der Elfen.");
    ...
    npcs.base.functions.AddTraderTrigger("[Mm]ehr.+[Ss]ilberbrand","Wenn du mehr über die Geschichte hörn willste, dann frag andre Zwerche hier. Tialdin is' der Könich. Belegi is' chef des Clans der Axt, der Kämpfer unsrer Stadt. Rugosch is' Kopf des Tempels. Un' da sin' noch viele mehr. Die können dir besser un' mehr erzählen als ick.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Vv]arshikar","Varshikar isn Reich weit im Nordosten. Aristeaus is' der Herrscher dort. Es is' nen Heim für alle die nich' inner andern Stadt Leben wolln oder könn'. Sie habn ne verdammte Magier Akademie, un' die Kallahorn Ritter leben dort. Wilslte mehr über davon hörn?");
    ...
    npcs.base.functions.AddTraderTrigger("[Mm]ehr.+[Vv]arshikar","Der dunkle Herrscher Darlok gründete dat Land. Vielmehr erpresste uns mit dunkler Magie es zu baun. Wir führten Krieg gegen ihn, un' seine Schergen. Un' gewannen, er starb. Er hat viel Unheil gestiftet, nu is' dat Land mehr oder weniger friedlich. Geh besser nich' da hin.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Gg]reensbriar","Gibt nich' viel drüber zu erzähln. Wurde vonner Gruppe genannt \"Evergreen Halflings\" oder so gegründet. Is' ne friedliche Stadt von Bauern, weit im Südwesten auf ner Insel. Dat is' alles wat ick darüber weiss.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Vv]anima","Vanima, die Stadt der Elfen auf der Insel Tol Vanima. Is' die jüngste Ansiedlung. Ne Insel voll mit Elfen, kein Ort fürn Zwerchen. Nicht's interessantes dort. Du erreichst es mit nem verdammten Boot vom Hafen südwestlich von Trolls Bane. Aber wozu überhaupt.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ff]jalara","Sie is' die Frau des Könichs un' die Herrscherin. Wie alle unsre Fraun is' sie einfach großartig un' wunderschön, har har. Sie is' eine herrvoragende Führerin, ohne sie hätten wir einige der Verbesserungen anner Stadt nich'. Es gibt kene bessre Königin für uns, aye!");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Kk]lan der [Aa]xt","Sie sin' die Kampftruppe der Stadt, die stärksten Krieger sin' ihre Mitglieder. Belegi is' die cheffin, frag sie wenn du beitreten willst. Sie sin' gefürchtet bei unsren Feinden, aye. Sie verteidigten die Insel oft allein gegen gefährliche Feinde. Wir sin' stolz auf sie.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ii]ngrain","Ick weiss nich' viel über ihn, er verliess die Insel bevor ick her kam. Er gründete den Klan der Axt, aye. Nen großer Krieger un' Zwerch. wurde auch Grinbogg genannt. Frag Belegi oder so wenn du mehr wissen willst.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Tt]horam","Thoram Steinfaust, auch Josef genannt. Er war der beste Schmied des Klans. Nen alter un' ehrenvoller Zwerch. Hohes Mitglied des Klans. Ick bin sicher Belegi kann dir mehr erzähln, ick weiss auch net alles.");

    npcs.base.functions.AddCycleText("#me zählt und sortiert seine Sachen","#me counts and sorts his wares");
    ...
    npcs.base.functions.AddCycleText("#me streicht über ein Goldnugget und grinst glücklich","#me strokes over a goldnugget and grins happily");
    ...
    if npcs.base.functions.BasicNPCChecks(originator,2) then
        if (npcs.base.functions.LangOK(originator,TradSpeakLang)==true) then
            ...
            elseif (Status==6) then -- Verkauf eines einzelnen Items erfolgreich // Selling of a single item succeed
                gText=npcs.base.functions.GenusSel(Values[2],"Nen","Ne","Nen").." "..world:getItemName(Values[2],0).." willste habn'? Geht klar, dat macht dann"..MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..", aber hurtig.";
            ...
            elseif (Status==7) then -- Verkaufspreis Ansage für ein Item // selling price announcement for an item
                gText=npcs.base.functions.GenusSel(Values[1],"Nen","Ne","Nen").." "..world:getItemName(Values[1],0).." kost' dich"..MoneyText(0,Values[2],Values[3],Values[4],TraderLang)..", un' kein Kupfer weniger!.";
            ...
            elseif (Status==8) then -- Einkaufspreis Ansage für ein Item // buying price announcement for an item
                gText=npcs.base.functions.GenusSel(Values[2],"Nen","Ne","Nen").." "..world:getItemName(Values[2],0)..", Hmm, is ja nich' die beste Qualität, wa? Na, sin' wa nich' so, dat währ' mir"..MoneyText(0,Values[3],Values[4],Values[5],TraderLang).." wert. Un' damit treib ick mich selbst innen Ruin!";
            ...
            elseif (Status==13) then -- Einkauf eines einzelnen Items erfolgreich // Buying of a single item succeed
                gText=npcs.base.functions.GenusSel(Values[2],"Nen","Ne","Nen").." "..world:getItemName(Values[2],0).." haste da? Na, is' zwar nich' dat beste Zeuch, dennoch geb ick dir"..MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..". Bin ick nich' nett? Harr Harr!";
