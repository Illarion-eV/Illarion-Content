...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddConsequence("inform","[Game Help] This is NPC is the glass artisan Fronita Emery. Keyphrases: Hello, glass, YOURTRIGGER1, YOURTRIGGER2.");
    npcs.base.autonpcfunctions.AddTraderTrigger("Hilfe","");
    npcs.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist die Glaskünstlerin Fronita Emery. Schlüsselwörter: Hallo, Glas, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
