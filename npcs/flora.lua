...
-- Queststatus = 10 (COMPLETED) - Person named
    npcs.base.autonpcfunctions.AddTraderTrigger("hello","Hello again, sir %CHARNAME, it is always nice seeing you.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("greet","Ah, sir %CHARNAME, a pleasure seeing you again.");
    npcs.base.autonpcfunctions.AddCondition("state","=",1);
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    npcs.base.autonpcfunctions.AddTraderTrigger("hello","Hello %CHARNAME, it is always nice seeing you.");
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    npcs.base.autonpcfunctions.AddTraderTrigger("greet","%CHARNAME, a pleasure seeing you again.");
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
...
-- Queststatus = 10 (COMPLETED)
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddTraderTrigger("why","My mother used to tell me stories about this wonderful flower. But now she passed out, and I have no memories of her. The flower can serve as one.");
...
-- Queststatus = 4
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",4);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have it","You mean, the Night Angels Blossom? You have it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",4);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got it","You mean, the Night Angels Blossom? You have it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",4);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have night angels blossom","What? You have the flower with you?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",4);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got night angels blossom","What? You have got the flower with you?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",4);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- Queststatus = 5
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",5);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom? Can you give it to me?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",5);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have it","You mean, the Night Angels Blossom? You have it? May I take it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",5);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got it","You mean, the Night Angels Blossom? You have it? May I take it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",5);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","Oh you have it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","You brought the flower? May I look at it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- Queststatus = 6
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",6);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom? Can you give it to me please?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",6);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I brought flower","You brought the flower? Really? Can I take it please?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",6);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","You have the flower with you? Can I see it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","You brought the flower? May I look at it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
...
-- Queststatus = 7
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I got flower","#me blinks and lifts her eyebrows, 'What? You have the flower? Can I see it?'");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","Hm? You've brought the flower? Really? May I see it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npcs.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","What? You brought the flower? Can I see it?");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",7);
    npcs.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- INTRODUCTION PHRASES
    ...
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    npcs.base.autonpcfunctions.AddTraderTrigger("call sir","#me blushes a bit, then says, 'Apologies. I'll just say %CHARNAME then.'");
    npcs.base.autonpcfunctions.AddCondition("state","<>",2);
    npcs.base.autonpcfunctions.AddConsequence("state",2);
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    ...
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.elf);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
    npcs.base.autonpcfunctions.AddTraderTrigger("call sir","#me blushes a bit, then says, 'I aplogize. I'll just say %CHARNAME then.'");
    npcs.base.autonpcfunctions.AddCondition("state","<>",2);
    npcs.base.autonpcfunctions.AddConsequence("state",2);
    npcs.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npcs.base.autonpcfunctions.AddCondition("sex","male");
...
-- HELP
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("hilfe","[Game Help]: ((Das ist ein NPC, du kannst mit ihnen sprechen wie mit anderen Spielercharakteren. NPCs werden auf Schlüsselwörter wie 'Hallo' reagieren, also achte gut auf das was sie dir sagen.))");
...
-- JOB after quest completed
    npcs.base.autonpcfunctions.AddTraderTrigger("your job","I have basic abilities in druidry. If you are injured, please come to me.");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddTraderTrigger("what do you","I'm a competent druid. Should you be injured, come to me.");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
    npcs.base.autonpcfunctions.AddTraderTrigger("what you doing","Observing the beauty of the flowers.");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",10);
...
-- DEBUGGING
    npcs.base.autonpcfunctions.AddTraderTrigger("reset me","I will reset you");
...
function receiveText(texttype, message, originator)
    if npcs.base.autonpcfunctions.BasicNPCChecks(originator,2) then
        if npcs.base.autonpcfunctions.LangOK(originator,TradSpeakLang) then
            ...
            npcs.base.autonpcfunctions.TellSmallTalk(debugText..message,originator);
        else
