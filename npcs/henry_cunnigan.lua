...
function initializeNpc()
    ...
    -- small talk
    AddTraderTrigger("hello","Hello my friend. If you don't know where we were or what to do next, just say 'help'.");
    AddAdditionalTrigger("greet");
    AddAdditionalTrigger("hey");
    AddAdditionalTrigger("hiho");
    AddCondition("lang","english");
	AddCondition("qpg","<",20);
    AddAdditionalText("Be greeted. If you don't know where we were or what to do next, just say 'help'.");
    AddTraderTrigger("hallo","Hallo mein Freund. Wenn Ihr nicht wisst, wo wir waren oder was Ihr als nächstes tun sollt, sagt einfach 'Hilfe'.");
	...
	AddCondition("qpg","<",20);
    AddAdditionalText("Seid gegrüßt. Wenn Ihr nicht wisst, wo wir waren oder was Ihr als nächstes tun sollt, sagt einfach 'Hilfe'.");
    ...
    AddTraderTrigger("how are you","I'm fine, thanks. And you?");
    AddTraderTrigger("wie geht dir","Mir geht es gut, danke. Und Euch?");
    AddAdditionalTrigger("wie geht euch");
    AddTraderTrigger("who","I am "..thisNPC.name..". I help all people who are new to Illarion.");
    AddTraderTrigger("wer","Ich bin "..thisNPC.name..". Ich helfe allen Leuten, die neu in Illarion sind.");
    AddTraderTrigger("my name","Nice to meet you. My name is "..thisNPC.name..".");
    AddAdditionalTrigger("I am");
    AddAdditionalTrigger("I'm");
    AddTraderTrigger("mein name","Schön Euch zu treffen. Mein Name ist "..thisNPC.name..".");
    AddAdditionalTrigger("ich bin");
    AddTraderTrigger("what sell","I am not a trader.");
    AddAdditionalTrigger("what buy");
    AddTraderTrigger("was kauf","Ich bin kein Händler.");
    ...
    AddAdditionalText("Macht's gut.");
    AddAdditionalText("Lebt wohl.");
    -- explanations
    AddTraderTrigger("tasche","Ihr habt ja gar keine Tasche mehr! Ich gebe Euch eine. Ihr seht sie auf der rechten Seite in Eurem Inventar, links oben neben dem Kopf. Ein Rechtsklick auf sie öffnet das Kontextmenü, wählt dann 'öffnen', um die Tasche zu öffnen.");
    AddCondition("item",97,"body","=",0);
    AddConsequence("item",97,1,333,0);
    AddTraderTrigger("bag","Oh you don't have a bag anymore! I give you one. You can see it on the right side in your inventory, top left next to the head. A right click on it opens a context menu, then choose 'open' to open the bag.");
    AddCondition("item",97,"body","=",0);
    AddConsequence("item",97,1,333,0);
    AddTraderTrigger("tasche","Ihr seht die Tasche auf der rechten Seite, in Eurem Inventar links oben neben dem Kopf. Ein Rechtsklick auf sie öffnet das Kontextmenü, wählt dann 'öffnen', um die Tasche zu öffnen.");
    AddTraderTrigger("bag","You can see the bag on the right side, in your inventory top left next to the head. A right click on it opens a context menu, then choose 'open' to open the bag.");
	-- help?
	AddTraderTrigger(".+","Hey, was macht Ihr denn hier? Ihr seid nicht neu. Geht den Weg entlang zum Schloss und nehmt die Portale am Ende der Halle. Sie führen nach Gobaith.");
	AddCondition("lang","german");
	AddCondition("qpg","<",4);
	AddTraderTrigger(".+","Hey, what are you doing here? You are not new. Follow this way to the castle and take the portals at the other end of the hall. They lead to Gobaith.");
	AddCondition("lang","english");
	AddCondition("qpg","<",4);
	AddTraderTrigger(".+","Tut mir Leid, ich habe Euch nicht verstanden. Sagt einfach 'Hilfe', wenn Ihr nicht wisst, was zu tun ist oder wie Ihr etwas tun sollt.");
	AddCondition("lang","german");
	AddTraderTrigger(".+","I am sorry, I didn't understand you. Say 'help' if you don't know what to do or how to do it.");
	AddCondition("lang","english");
    -- ********* END DYNAMIC PART ********
