...
require("base.common")
module("npcs.findecano_melwasul")
...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger(".+","Kommt wieder, wenn Amelia Kolodem Euch zu mir schickt. Sie ist die Holzfällerin unten im Wald. Geht nach draußen, folgt der Straße, klettert die Leiter herunter und durchquert die Höhle und folgt wieder der Straße durch die Wüste in den Wald. Sie steht bei der Feuerstelle.");
    ...
    npcs.base.autonpcfunctions.AddAdditionalTrigger("hello");
    npcs.base.autonpcfunctions.AddTraderTrigger("gr[üu][sß]","Nochmals hallo, junger Reisender. Falls Ihr diese Insel verlassen wollt, sagt mir einfach 'Ich will nach Gobaith'. Falls Ihr mehr lernen wollt, fragt mich 'Was ist mit den Handwerksmeistern?'.");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("grue[sß]");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("hallo");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("gobiath","Es heißt Gobaith, nicht Gobiath. Narr.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("gobaith","Wollt Ihr nun Gobaith betreten? Aber bedenkt: Ihr könnt dann nie wieder hier her zurückkehren. Also falls Ihr noch andere Handwerke kennenlernen wollt, tut dies jetzt. Wollt Ihr trotzdem diesen Ort verlassen?");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("verlassen");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    npcs.base.autonpcfunctions.AddConsequence("state","=",2);
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("nein","Nun, dann könnt Ihr meine Handwerksmeister besuchen.");
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    ...
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger(".+","Ich fragte, ob Ihr Gobaith nun betreten wollt, bedenkt: es gibt keinen Weg zurück zu dieser Insel. Ja oder nein?");
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    -- ********* END DYNAMIC PART ********
