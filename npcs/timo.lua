...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(120 ,356 ,100 ,7  ,50 ,{5,7},{77,90},0   ,0); -- Hut
    npcs.base.trader_functions.AddTraderItem(150 ,55  ,100 ,15 ,50 ,{5,7},{77,90},0   ,0); -- Umhang
    npcs.base.trader_functions.AddTraderItem(120 ,2295,100 ,12 ,50 ,{5,7},{77,90},0   ,0); -- Handschuhe
    npcs.base.trader_functions.AddTraderItem(50  ,97  ,100 ,0  ,80 ,{5,7},{77,90},0   ,0); -- Tasche
    npcs.base.trader_functions.AddTraderItem(30  ,312 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Holz Kelle
    npcs.base.trader_functions.AddTraderItem(35  ,24  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Schaufel
    npcs.base.trader_functions.AddTraderItem(25  ,258 ,10  ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Dreschflegel
    npcs.base.trader_functions.AddTraderItem(25  ,271 ,10  ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Sense
    npcs.base.trader_functions.AddTraderItem(35  ,74  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Axt
    npcs.base.trader_functions.AddTraderItem(20  ,51  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Eimer
    npcs.base.trader_functions.AddTraderItem(20  ,121 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Ofenschieber
    npcs.base.trader_functions.AddTraderItem(20  ,118 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Nudelholz
    npcs.base.trader_functions.AddTraderItem(2   ,249 ,5   ,0  ,500,{3}  ,{33},0   ,0); -- Getreide
    npcs.base.trader_functions.AddTraderItem(5   ,728 ,10  ,0  ,500,{3}  ,{33},0   ,0); -- Hopfen Samen
    npcs.base.trader_functions.AddTraderItem(2   ,2917,10  ,0  ,500,{3}  ,{33},0   ,0); -- Tomaten Samen
    npcs.base.trader_functions.AddTraderItem(2   ,291 ,10  ,0  ,500,{3}  ,{33},0   ,0); -- Kohl Setzling
    npcs.base.trader_functions.AddTraderItem(2   ,2494,10  ,0  ,500,{3}  ,{33},0   ,0); -- Karotten Samen

    TraderCopper=5000;

    npcs.base.functions.AddTraderTrigger("[Gg]reetings","Welcome to Greenbriar! Can I help you?");
    npcs.base.functions.AddTraderTrigger("[Hh]ello","A good day to you! What do you want to buy?");
    npcs.base.functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", once I was one of Greenbriar's traders!");
    --npcs.base.functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", one of Greenbriar's traders!");
    npcs.base.functions.AddTraderTrigger("[Tt]ell.+[Gg]reenbriar","It was Crosis, leader of the Evergreen halflings, who animated all the other halflings to build the Briary bridge.");
    npcs.base.functions.AddTraderTrigger("[Tt]ell.+[Cr]osis","His group of halflings built the Briary bridge.");
    npcs.base.functions.AddTraderTrigger("[Ww]ho.+[Cr]osis","Crosis lead the Evergreen halflings to this land.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Gg]reenbriar","Once, Greenbriar was a peacefull little town not far from here. But the peacefull times, in which all live together in harmony are gone.");
    --npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Gg]reenbriar","All this nature around you belongs to this beautiful island, Greenbriar. You can enter and leave it through the Briary bridge, just north of here.");
    npcs.base.functions.AddTraderTrigger("[Ww]here.+[Gg]reenbriar","Go to the west, over the bridge and follow the path.");
    --npcs.base.functions.AddTraderTrigger("[Ww]here.+[Gg]reenbriar","You are already in Greenbriar! Welcome!");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Bb]riary.+bridge","The Briary bridge was built by the Evergreen halflings, the first people around here.");
    npcs.base.functions.AddTraderTrigger("[Ww]here.+[Bb]riary.+bridge","Go to the south.");
    --npcs.base.functions.AddTraderTrigger("[Ww]here.+[Bb]riary.+bridge","It's north of this beautiful town!");
    npcs.base.functions.AddTraderTrigger("[Ww]ho.+[Ee]vergreen.+halflings","The Evergreen halflings are a group of halflings that founded Greenbriar.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+sell","Oh, I sell clothes, tools and seeds Want to see my list?");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Cc]lothe","I have really nice hats, gloves and capes.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Tt]ool","I have axes, scythes, shovels and so on. For more ask for my list of wares");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Ss]eed","I have seeds of grain, cabbage, carrots and tomatos.");
    npcs.base.functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","We halflings discovered this beautiful island when we walked around in the east. It were the Evergreen halflings who built the Briary bridge.");
    npcs.base.functions.AddTraderTrigger("[Gg]oodbye","Have a nice day!");
    npcs.base.functions.AddTraderTrigger("[Bb]ye","Good bye!");
    npcs.base.functions.AddTraderTrigger("[Ff]arewell","Bye!");
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]rü[ßs]+e","Grüß' dich!");
    npcs.base.functions.AddTraderTrigger("[Hh]allo","Huhu!");
    npcs.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin "..thisNPC.name..", früher war ich einer von Greenbriars Händlern!");
    --npcs.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin "..thisNPC.name..", einer von Greenbriars Händlern!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+verkauf","Oh, ich verkaufe Kleidung, Werkzeuge und Samen. Willst du meine Liste sehen?");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Kk]leidung","Ich hab sehr schöne Hüte, Umhänge und Handschuhe.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeuge","Ich hab Äxte, Sensen, Schaufeln und so weiter. Frag nach meiner Warenliste wenn du es genau wissen willst.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ss]ame","Ich habe Samen von Getreide, Kohl, Karotten und Tomaten.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ee]twas","Weisst Du, wie wir Halblinge diese Insel entdeckt haben? Das geschah, als wir im Osten herumgewandert sind.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Gg]reenbriar","Crosis, der Anführer der Evergreen Halblinge hat den Bau der Briary Brücke veranlasst.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Cr]osis","Er hat die Briary Brücke bauen lassen, mit seinen Halblingen.");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[Cr]osis","Crosis hat eine Gruppe von Halblingen angeführt: die Evergreen Halblinge.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Gg]reenbriar","Einst war Greenbriar ein wunderschöne, friedlicher Ort. Aber Missgunst und Unmut hat sich unter den Bewohnern breit gemacht und den Freiden vertrieben.");
    --npcs.base.functions.AddTraderTrigger("[Ww]as.+[Gg]reenbriar","Die gesamte Natur um dich herum gehört zur Insel Greenbriar. Du kannst Greenbriar im Norden betreten und wieder verlassen, an der Briary Brücke!");
    npcs.base.functions.AddTraderTrigger("[Ww]o.+[Gg]reenbriar","Geh nach Westen, über die Brücke und folge einfach dem Pfad.");
    --npcs.base.functions.AddTraderTrigger("[Ww]o.+[Gg]reenbriar","Du bist mitten in Greenbriar! Willkommen!");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Bb]riary.+[Bb]rücke","Die Briary Brücke wurd' damals von den Evergreen Halblingen gebaut.");
    npcs.base.functions.AddTraderTrigger("[Ww]o.+[Bb]riary.+[Bb]rücke","Sie liegt genau westlich von hier!");
    --npcs.base.functions.AddTraderTrigger("[Ww]o.+[Bb]riary.+[Bb]rücke","Sie liegt genau nördlich von hier!");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[Ee]vergreen.+[Hh]alblinge","Die Evergreen Halblinge haben die Brücke bauen lassen und diese schöne Insel besiedelt.");
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Du gehst schon? Ach schade... Na, dann mach's mal gut!");
    npcs.base.functions.AddTraderTrigger("[Bb]is.+[Bb]ald","Ich hoffe, du kommst mal wieder vorbei!");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+du?","Ich werde "..thisNPC.name.." genannt.");
    npcs.base.functions.AddTraderTrigger("Ich bin .+","Huhu! Schön, dich kennenzulernen!");
