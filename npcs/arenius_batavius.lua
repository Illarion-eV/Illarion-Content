...
function initializeNpc()
    ...
    AddConsequence("inform","[Spielhilfe] Dieser NPC ist der Kreuzritter Arenius Batavius. Schlüsselwörter: Hallo, Quest, Beruf, Kreuzritter, Orden, Orks, Kult, Cherga.");
    -- General speech
    ...
    AddTraderTrigger("Grüße","Seid gegrüßt! Einst war ich ein edler Ritter, nun liege ich im Staub. Horcht meiner Geschichte über einen bösen Kult von Blutmagiern.");
    ...
    AddTraderTrigger("Hiho","Seid gegrüßt! Einst war ich ein edler Ritter, nun liege ich im Staub. Horcht meiner Geschichte über einen bösen Kult von Blutmagiern.");
    AddAdditionalTrigger("Hallo");
    AddAdditionalTrigger("Hey");
    AddAdditionalTrigger("Greebas");
    AddAdditionalTrigger("Greebs");
    ...
    AddTraderTrigger("Tschüß","Gehet mit dem Segen der Götter. Und verbreitet die alten Sitten überall, wo ihr könnt.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Ciao","Gehet mit dem Segen der Götter. Und verbreitet die alten Sitten überall, wo ihr könnt.");
    AddAdditionalTrigger("Adieu");
    AddAdditionalTrigger("Au revoir");
    AddCondition("lang","german");
    ...
    AddTraderTrigger("Wie geht","Ich habe meinen Feind unterschätzt und dafür bezahlt - ich bin froh, mit dem Leben davongekommen zu sein. Werdet ihr meine ehrbaren Taten vollenden?");
    ...
    AddTraderTrigger("dein name","Mein Name ist Arenius Batavius. Ich weile erst seit kurzem in diesen Landen, aber nur Unglück ist mir widerfahren. Bitte, werdet ihr mir auf meinem Kreuzzug beiseite stehen?");
    ...
    AddTraderTrigger("geschichte","Ich habe eine interessante Geschichte zu erzählen, sie handelt von einem bösen Kult von Blutmagiern. Seht ihr meine Wunden? Sie erzählen die Geschichte.");
    AddAdditionalTrigger("erzähl was");
    ...
    AddTraderTrigger("beruf","Ich bin ein Kreuzritter des Ordens der Silberdrachen. Ich bin in dieses Land gekommen um einem bösen Kult das Handwerk zu legen - aber ich habe versagt. Werdet ihr meine Mission vollenden?");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("job","Ich bin ein Kreuzritter des Ordens der Silberdrachen. Ich bin in dieses Land gekommen um einem bösen Kult das Handwerk zu legen - aber ich habe versagt. Werdet ihr meine Mission vollenden?");
    ...
    AddTraderTrigger("Ritter","Wir Ritter vom Orden der Silberdrachen bekämpfen das, was nicht mit den alten Sitten vereinbar ist, wo immer es möglich ist. Und in diesem Land bietet sich hierfür allerlei Möglichkeit.");
    AddAdditionalTrigger("kreuzzug");
    -- More small talk; add at least five triggers
    AddTraderTrigger("Orden","Der Orden der Silberdrachen mag in diesem Land unbekannt sein; aber im Reiche Albar fürchtet man unseren Namen.");
    AddAdditionalTrigger("Silberdrache");
    AddTraderTrigger("Ork","Ich habe einige Orks in der Nähe der Höhle, welche ich für den Unterschlupf eines bösen Kultes von Blutmagiern halte, umherstreifen gesehen. Ich frage mich, welche Verbindung sie miteinander haben.");
    AddTraderTrigger("Kult","Ich bekämpfe den Kult der Salavesh, ein Haufen böser Blutmagier. Die Diener des Kultes haben mir aufgelauert, als ich mich auf dem Weg zu ihrem Unterschlupf befand. Gerüchten zufolge ist er in einer Höhle.");
    AddTraderTrigger("Drache","Drachen sind majestätische Wesen und ich bin stolz darauf, einst einen gesehen zu haben. Gerüchten zufolge macht der Kult der Salavesh Jagd auf Drachen.");
    AddTraderTrigger("Blutmagie","Blutmagie ist das Böse in Reinform. Die alten Sitten verbieten es, solche Praktiken auch nur in Erwägung zu ziehen.");
    AddAdditionalTrigger("totenbeschwör");
    AddTraderTrigger("Höhle","Ich bin mir sicher, dass der Unterschlupf des Kults der Salavesh sich in einer Höhle, nordöstlich von hier, befindet.");
    AddAdditionalTrigger("Unterschlupf");
    AddTraderTrigger("Wund","Diener des Kultes der Salavesh fügten mir diese Wunden zu. Doch ich werde nicht klein bei geben; helft mir in meiner Mission für das die alten Sitten!");
    AddTraderTrigger("sitte","Die alten Sitten zu bewahren und zu schützen, das ist die Mission des Ordens der Silberdrachen.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Valerio","Ich musste einen sehr hohen Wegzoll zahlen, um das Land dieses Don Guiliannis durchquere zu dürfen. Ist dies üblich hier?");
    AddAdditionalTrigger("Guilianni");
    AddAdditionalTrigger("Don");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Galmair","Geld scheint das Lieblingswort der Leute von Galmair zu sein. Zumindestens war es das Wort, was sie am häufigsten zu mir gesagt haben.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("albar","Nun, was genau wollt ihr über Albar wissen? Es ist meine Heimat, daher verkneift euch unehrenhafte Worte.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("gync","Reisende berichteten mir schlimme Dinge über Gynk. Ein Sündenpfuhl soll es sein. Zeit, dort aufzuräumen!");
    AddAdditionalTrigger("gynk");
    AddTraderTrigger("salkama","Oh, please, can't we talk about the weather instead?");
    AddCondition("lang","english");
    AddTraderTrigger("salkama","Oh nein, lasst uns doch lieber über das Wetter reden.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Moshran","Moshran wird gemeinhin unterschätzt; der böse Bube soll er sein. Die entspricht nun wirklich nicht der Wahrheit, Moshran ist weit mehr als einfach nur 'gut' und 'böse'.");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Malachin","Vor einer Schlacht beten viele Ritter zu Malachin; aber wie fest ist ihr Glaube in seine Führung wirklich? Oder sind sie am Ende nur Feiglinge?");
    ...
    AddCondition("lang","english");
    AddTraderTrigger("Cherga","Cherga! Die Totengöttin! Was tot ist, ist tot und verrottet; alles andere ist einfach nur böse!");
    ...
    AddTraderTrigger("quest","Fremder, bevor ich euch über den bösen Kult der Salavesh berichten kann, mögt ihr mir ein halbes Dutzend weiße Stoffbahnen bringen, damit ich meine Wunden vom letzten Kampf mit den Kultisten versorgen kann?");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",0);
    AddConsequence("qpg","=",1);
    ...
    AddConsequence("qpg","=",1);
    AddConsequence("inform","[New quest] The Errant Crusade I");
    AddTraderTrigger("Auftrag","Fremder, bevor ich euch über den bösen Kult der Salavesh berichten kann, mögt ihr mir ein halbes Dutzend weiße Stoffbahnen bringen, damit ich meine Wunden vom letzten Kampf mit den Kultisten versorgen kann?");
    ...
    AddTraderTrigger(".+","Danke für die Bandagen. Hier, nehmt dies als Aufwandsentschädigung. Nun kann ich euch über die Mission berichten, auf der ich so kläglich versagte.");
    AddCondition("qpg","=",1);
    AddCondition("item",178,"all",">",5);
    AddCondition("town","=","cadomyr");
    AddConsequence("deleteitem",178,6);
    AddConsequence("inform","[Quest gelöst] Du erhältst 60 Kupferstücke. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",5);
    AddConsequence("money","+",60);
    AddConsequence("qpg","=",2);
    AddTraderTrigger(".+","Thank you for the bandages. Here, this should cover your expenses. Now I can tell you about the mission that I failed in.");
    ...
    AddCondition("item",178,"all",">",5);
    AddConsequence("deleteitem",178,6);
    AddConsequence("inform","[Quest gelöst] Du erhältst 60 Kupferstücke.");
    AddConsequence("money","+",60);
    AddConsequence("qpg","=",2);
    ...
    AddCondition("qpg","=",1);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Meine Wunden haben erneut zu bluten begonnen. Könntet ihr mir bitte ein halbes Dutzend weiße Stoffbahnen bringen, um sie zu versorgen?");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",1);
    ...
    AddAdditionalTrigger("adventure");
    AddCondition("qpg","=",1);
    AddTraderTrigger("Auftrag","Meine Wunden haben erneut zu bluten begonnen. Könntet ihr mir bitte ein halbes Dutzend weiße Stoffbahnen bringen, um sie zu versorgen?");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",1);
    ...
    AddTraderTrigger("quest","Um dem Kult der Salavesh das Handwerk zu legen ist zunächst Aufklärung erforderlich. Gehet hin und findet den Unterschlupf! Streckt dort wenigstens ein halbes Dutzend der untoten Diener nieder und bringt mir ihre Überreste, damit ich sie untersuchen kann.");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",2);
    AddConsequence("qpg","=",3);
    ...
    AddConsequence("qpg","=",3);
    AddConsequence("inform","[New quest] The Errant Crusade II");
    AddTraderTrigger("Auftrag","Um dem Kult der Salavesh das Handwerk zu legen ist zunächst Aufklärung erforderlich. Gehet hin und findet den Unterschlupf! Streckt dort wenigstens ein halbes Dutzend der untoten Diener nieder und bringt mir ihre Überreste, damit ich sie untersuchen kann.");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",2);
    AddConsequence("qpg","=",3);
    ...
    AddCondition("qpg","<",9);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Bitte rächt meine Niederlage. Gehet zum Unterschlupf des Kultes der Salavesh und streckt ein halbes Dutzend ihrer Diener nieder. Kommt zu mit mir ihren Überresten.");
    AddAdditionalTrigger("mission");
    AddCondition("qpg",">",2);
    AddCondition("qpg","<",9);
    ...
    AddCondition("lang","english");
    AddTraderTrigger("quest","Ihr seid zurück und am Leben! Aber ihr habt keine Überreste der untoten Diener dabei; die meisten Informationen kann ich aus ihren Eingeweiden ablesen.");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",9);
    AddCondition("item",63,"all","<",1);
    ...
    AddCondition("qpg","=",9);
    AddCondition("item",63,"all","<",1);
    AddTraderTrigger("Auftrag","Ihr seid zurück und am Leben! Aber ihr habt keine Überreste der untoten Diener dabei; die meisten Informationen kann ich aus ihren Eingeweiden ablesen.");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",9);
    AddCondition("item",63,"all","<",1);
    ...
    AddTraderTrigger(".+","#me untersucht die Eingeweide: 'Hab ich es mir doch gedacht! Blutmagie! Hier, nehmt diesen Streitkolben, er wird euch auf der nächsten Mission gute Dienste erweisen.'");
    AddCondition("qpg","=",9);
    AddCondition("item",63,"all",">",0);
    AddCondition("town","=","cadomyr");
    AddConsequence("deleteitem",63,1);
    AddConsequence("item",230,1,588,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 60 Kupferstücke und einen Streitkolben. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",10);
    AddConsequence("money","+",60);
    AddConsequence("qpg","=",10);
    AddTraderTrigger(".+","#me inspects the entrails: 'Just what I assumed - blood magic! Here, have this mace, it will help you on the next part of the mission'.");
    ...
    AddConsequence("deleteitem",63,1);
    AddConsequence("item",230,1,588,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 60 Kupferstücke und einen Streitkolben.");
    AddConsequence("money","+",60);
    AddConsequence("qpg","=",10);
    ...
    AddTraderTrigger(".+","Ich hoffe ihr habt diesen Kultisten eine Lektion erteilt, die sie so schnell nicht vergessen werden. Ich freue mich, dass ich euch vertrauen kann. Nehmt mein Schwert und nutzt es weise während der nächsten Mission.");
    AddCondition("qpg","=",24);
    AddCondition("town","=","cadomyr");
    AddConsequence("item",98,1,688,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 120 Kupferstücke und ein versilbertes Langschwert. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",10);
    AddConsequence("money","+",120);
    AddConsequence("qpg","=",25);
    AddTraderTrigger(".+","I hope you taught the cultists a lesson they won't forget anytime soon. I am glad that I can trust you and give you my sword. Use it wisely during the next mission.");
    ...
    AddCondition("qpg","=",24);
    AddConsequence("item",98,1,688,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 120 Kupferstücke und ein versilbertes Langschwert.");
    AddConsequence("money","+",120);
    AddConsequence("qpg","=",25);
    ...
    AddTraderTrigger("quest","Während ihr den Untoten Dienern den Garaus machtet, verriet mir ein Reisender, dass der Kult der Salavesh wohl ein dunkles Ritual vorbereitet. Stoppt die Blutmagier, die dieses Ritual durchführen wollen - meist arbeiten sie zu zweit.");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",25);
    AddConsequence("qpg","=",26);
    ...
    AddConsequence("qpg","=",26);
    AddConsequence("inform","[New quest] The Errant Crusade IV");
    AddTraderTrigger("Auftrag","Während ihr den Untoten Dienern den Garaus machtet, verriet mir ein Reisender, dass der Kult der Salavesh wohl ein dunkles Ritual vorbereitet. Stoppt die Blutmagier, die dieses Ritual durchführen wollen - meist arbeiten sie zu zweit.");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",25);
    AddConsequence("qpg","=",26);
    ...
    AddCondition("qpg","<",28);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Rasch! Mit jeder Minute, die vergeht, können die Blutmagier ihre Untaten fortsetzen. Erschlagt sie beide im Unterschlupf des Kultes der Salavesh!");
    AddAdditionalTrigger("mission");
    AddCondition("qpg",">",25);
    AddCondition("qpg","<",28);
    ...
    AddCondition("qpg",">",25);
    AddCondition("qpg","<",28);
    AddTraderTrigger("Auftrag","Rasch! Mit jeder Minute, die vergeht, können die Blutmagier ihre Untaten fortsetzen. Erschlagt sie beide im Unterschlupf des Kultes der Salavesh!");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg",">",25);
    AddCondition("qpg","<",28);
    ...
    AddTraderTrigger(".+","#me nickt knapp während er dem Bericht über die Ereignisse in der Höhle lauscht und antwortet: 'Ein guter Tag für uns alle. Hier, nehmt meinen Helm, er wird euch mehr nützen als mir während eurer nächsten Mission.'");
    AddCondition("qpg","=",28);
    AddCondition("town","=","cadomyr");
    AddConsequence("item",2287,1,788,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 200 Kupferstücke und einen albarischen Soldatenhelm. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",15);
    AddConsequence("money","+",200);
    AddConsequence("qpg","=",29);
    AddTraderTrigger(".+","#me nods briefly while listening to the report of the events in the cave and replies: 'One good day for all of us. Here, have my helmet, you'll need it more than me during your next mission.'");
    ...
    AddCondition("qpg","=",28);
    AddConsequence("item",2287,1,788,0);
    AddConsequence("inform","[Quest gelöst] Du erhältst 200 Kupferstücke und einen albarischen Soldatenhelm.");
    AddConsequence("money","+",200);
    AddConsequence("qpg","=",29);
    ...
    AddCondition("qpg","<",31);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Dämonenskelette sind mächtige Feinde; ich verstehe, wenn ihr zögert, euch ihm zu stellen. Aber wenn der Kult der Salavesh wirklich so ein Wesen beherbergt, dann muss es abgeschlachtet werden!");
    AddAdditionalTrigger("mission");
    AddCondition("qpg",">",29);
    AddCondition("qpg","<",31);
    ...
    AddCondition("qpg",">",29);
    AddCondition("qpg","<",31);
    AddTraderTrigger("Auftrag","Dämonenskelette sind mächtige Feinde; ich verstehe, wenn ihr zögert, euch ihm zu stellen. Aber wenn der Kult der Salavesh wirklich so ein Wesen beherbergt, dann muss es abgeschlachtet werden!");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg",">",29);
    AddCondition("qpg","<",31);
    ...
    AddTraderTrigger(".+","Großartig! Ich liebe es, wenn das Böse daniederliegt. Ich gebe euch meinen Schild, tragt ihn mit Würde. Aber ich gebe ihn euch nicht grundlos, sondern um meine Mission zu vollenden.");
    AddCondition("qpg","=",31);
    AddCondition("town","=","cadomyr");
    AddConsequence("item",96,1,888,51);
    AddConsequence("inform","[Quest gelöst] Du erhältst 500 Kupferstücke und einen Stahlturmschild. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",15);
    AddConsequence("money","+",500);
    AddConsequence("qpg","=",32);
    AddTraderTrigger(".+","Great! How much I love it when evil falls! I give you my shield; bear it with honour. But I give it to you for a reason; to complete my mission.");
    ...
    AddCondition("qpg","=",31);
    AddConsequence("item",96,1,888,51);
    AddConsequence("inform","[Quest gelöst] Du erhältst 500 Kupferstücke und einen Stahlturmschild.");
    AddConsequence("money","+",500);
    AddConsequence("qpg","=",32);
    ...
    AddTraderTrigger("quest","Ich habe die Schriftrolle, die der Junge gefunden hat, gründlichst studiert und bin zu dem Schluss gekommen, dass das Dämonenskelett etwas bewacht haben muss. Etwas die Quelle allen Übels? Zieht aus und eleminiert sie!");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",32);
    AddConsequence("qpg","=",33);
    ...
    AddConsequence("qpg","=",33);
    AddConsequence("inform","[New quest] The Errant Crusade VI");
    AddTraderTrigger("Auftrag","Ich habe die Schriftrolle, die der Junge gefunden hat, gründlichst studiert und bin zu dem Schluss gekommen, dass das Dämonenskelett etwas bewacht haben muss. Etwas die Quelle allen Übels? Zieht aus und eleminiert sie!");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",32);
    AddConsequence("qpg","=",33);
    ...
    AddCondition("qpg","<",34);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Ich bin davon überzeugt, dass das Dämonenskelett die Quelle der Blutmagie des Kultes der Salavesh bewacht hat. Ich befehle euch, sie zu zerstören, was auch immer es ist!");
    AddAdditionalTrigger("mission");
    AddCondition("qpg",">",32);
    AddCondition("qpg","<",34);
    ...
    AddCondition("qpg",">",32);
    AddCondition("qpg","<",34);
    AddTraderTrigger("Auftrag","Ich bin davon überzeugt, dass das Dämonenskelett die Quelle der Blutmagie des Kultes der Salavesh bewacht hat. Ich befehle euch, sie zu zerstören, was auch immer es ist!");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg",">",32);
    AddCondition("qpg","<",34);
    ...
    AddTraderTrigger(".+","Ihr habt was getan? Ihr habt das Leben eines der edelsten Kreaturen von ganz Illarion beendet? Was fällt euch ein! Was... fiel mir ein, euch auf diese Mission zu schicken. Ich werde als Ritter des Ordens der Silberdrachen abdanken müssen. Ich überantworte euch meine Rüstung und meinen weltlichen Besitz.");
    AddCondition("qpg","=",34);
    AddCondition("town","=","cadomyr");
    AddConsequence("item",2367,1,988,72);
    AddConsequence("inform","[Quest gelöst] Du erhältst 2000 Kupferstücke und eine albarische Adeligenrüstung. Dein Ansehen bei Königin Rosaline Edwards steigt.");
    AddConsequence("rankpoints","cadomyr","+",20);
    AddConsequence("money","+",2000);
    AddConsequence("qpg","=",35);
    AddTraderTrigger(".+","You did what! You ended the life of one of the most noble creatures of Illarion? How you dare! How... did I dare to send you on this mission. I have to resign as knight of the Order of the Silver Dragon - I surrender my armour and my belongings to you.");
    ...
    AddCondition("qpg","=",34);
    AddConsequence("item",2367,1,988,72);
    AddConsequence("inform","[Quest gelöst] Du erhältst 2000 Kupferstücke und eine albarische Adeligenrüstung.");
    AddConsequence("money","+",2000);
    AddConsequence("qpg","=",35);
    ...
    AddCondition("qpg","=",35);
    AddCondition("lang","english");
    AddTraderTrigger("quest","Nun, da ihr dem niederträchtigen Kult der Salavesh das Handwerk gelegt habt, gibt es nichts, was ihr für mich tun könntet, denn ich bin geschlagen und fehl am Platz auf dieser Welt. Ihr, auf zu neuen Abenteuern!");
    AddAdditionalTrigger("mission");
    AddCondition("qpg","=",35);
    ...
    AddAdditionalTrigger("adventure");
    AddCondition("qpg","=",35);
    AddTraderTrigger("Auftrag","Nun, da ihr dem niederträchtigen Kult der Salavesh das Handwerk gelegt habt, gibt es nichts, was ihr für mich tun könntet, denn ich bin geschlagen und fehl am Platz auf dieser Welt. Ihr, auf zu neuen Abenteuern!");
    AddAdditionalTrigger("Aufgabe");
    AddAdditionalTrigger("Abenteuer");
    AddCondition("qpg","=",35);
    ...
    AddAdditionalText("Ich weiß nicht recht...");
