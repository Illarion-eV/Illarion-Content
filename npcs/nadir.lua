...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(100 ,18  ,20,10 ,25  ,{3,4},{44,66},0   ,0       ); -- basic metalshield
    npcs.base.trader_functions.AddTraderItem(300 ,20  ,25,15 ,25  ,{3,4},{44,66},0   ,0       ); -- advanced metalshield
    npcs.base.trader_functions.AddTraderItem(400 ,186 ,15,20 ,15  ,{3,4},{44,66},0   ,0       ); -- round shield
    npcs.base.trader_functions.AddTraderItem(150 ,19  ,19,15 ,25  ,{3,4},{44,66},0   ,0       ); -- (medium) metalshield
    npcs.base.trader_functions.AddTraderItem(250 ,230 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- mace
    npcs.base.trader_functions.AddTraderItem(200 ,78  ,15,20 ,10  ,{3,4},{44,66},0   ,0       ); -- short sword
    npcs.base.trader_functions.AddTraderItem(300 ,2701,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- longsword
    npcs.base.trader_functions.AddTraderItem(100 ,27  ,25, 5 ,25  ,{3,4},{44,66},0   ,0       ); -- cheap dagger
    npcs.base.trader_functions.AddTraderItem(200 ,190 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- ornate dagger
    npcs.base.trader_functions.AddTraderItem(100 ,202 ,15,10 ,15  ,{3,4},{44,66},0   ,0       ); -- steel cap
    npcs.base.trader_functions.AddTraderItem(150 ,187 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- steel hat
    npcs.base.trader_functions.AddTraderItem(1200,101 ,10,50 ,5   ,{4,6},{44,66},0   ,0       ); -- chain shirt
    npcs.base.trader_functions.AddTraderItem(30  ,312 ,50,0  ,30  ,{5,7},{77,90},0   ,0); -- wooden shovel
    npcs.base.trader_functions.AddTraderItem(30  ,24  ,5 ,0  ,30  ,{5,7},{77,90},0   ,0); -- shovel
    npcs.base.trader_functions.AddTraderItem(30  ,2763,5 ,0  ,30  ,{5,7},{77,90},0   ,0); -- pickaxe
    npcs.base.trader_functions.AddTraderItem(30  ,23  ,3 ,0  ,30  ,{5,7},{77,90},0   ,0); -- hammer
    ...
    npcs.base.trader_functions.AddTraderItem(30  ,311 ,3 ,0  ,30  ,{5,7},{77,90},0   ,0); -- glass blow pipe
