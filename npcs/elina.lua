...
function initializeNpc()
    ...
    AddTraderItem(5   ,64  ,1000,1  ,1000,{5  },{77,90},0   ,0); -- arrow
    AddTraderItem(80  ,65  ,90  ,8  ,20  ,{5,6},{77,90},0   ,0); -- short bow
    AddTraderItem(120 ,2714,90  ,12 ,20  ,{5,6},{77,90},0   ,0); -- hunting bow
    AddTraderItem(150 ,2646,90  ,16 ,20  ,{5,6},{77,90},0   ,0); -- serinjah rider's bow
    AddTraderItem(500 ,2718,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- elven composite longbow
    AddTraderItem(200 ,2708,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- long bow
    AddTraderItem(100 ,90  ,90  ,10 ,20  ,{5,6},{77,90},0   ,0); -- flute
    AddTraderItem(400 ,335 ,90  ,40 ,20  ,{5,6},{77,90},0   ,0); -- lute
    AddTraderItem(500 ,332 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- harp
    AddTraderItem(200 ,2445,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- small wooden shield
    AddTraderItem(100 ,17  ,90  ,10 ,20  ,{5,6},{77,90},0   ,0); -- wooden shield
    AddTraderItem(200 ,2194,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- small hardwood greaves
    AddTraderItem(400 ,2193,90  ,40 ,20  ,{5,6},{77,90},0   ,0); -- hardwood greaves
    AddTraderItem(250 ,207 ,90  ,25 ,20  ,{5,6},{77,90},0   ,0); -- battle staff
    AddTraderItem(500 ,208 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- ornate mage's staff
    AddTraderItem(500 ,209 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- elven mage's staff



    TraderCopper=7000;

    npcs.base.autonpcfunctions.AddTraderTrigger("[Gg]reetings","The five with you. Can I help you?");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("[Hh]ello");
    npcs.base.autonpcfunctions.AddAdditionalText("Be blessed, my friend. Do you need something?");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am a trader, yes. I trade different carpentry tools.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hat.+sell","I sell all kinds of carpentry tools");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Tt]ools","I sell tools for carpenters. Saws, axes, planes and carving tools.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]ell.+[Ss]omething","This is Tol Vanima, the home of us elves.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Gg]oodbye","The five with you!.");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("[Bb]ye");
    npcs.base.autonpcfunctions.AddAdditionalText("May the gods bless your path!");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("[Ff]arewell");
    npcs.base.autonpcfunctions.AddAdditionalText("Farewell, my friend!");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hat.+buy","I buy all kinds of bows and crossbows.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]ho.+you?","My name is "..thisNPC.name..".");
    npcs.base.autonpcfunctions.AddTraderTrigger("I'm .+","Be greeted!");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Gg]r[üu][ßs]+","Die Fünf zum Gruße, kann ich euch helfen?");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("[Hh]allo");
    npcs.base.autonpcfunctions.AddAdditionalText("Möge euer Pfad gesegnet sein! Wie kann ich euch helfen?");
    npcs.base.autonpcfunctions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin ein Händler, ja, und ich verkaufe unter anderem Werkzeuge.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe Werkzeuge für jede Art von Tischlerei.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as.+[Ww]erkzeug","Nun, ich verkaufe Tischlerwerkzeug...Sägen, Äxte, Hobel und Schnitzwerkzeuge.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Dies ist Tol Vanima, die Heimat von uns Elfen.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Die Fünf seien mit euch. Bis bald!");
    npcs.base.autonpcfunctions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    npcs.base.autonpcfunctions.AddAdditionalText("Bis bald, mein Freund, der Segen der Fünf mit euch!");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as.+%s[Kk]auf","Ich kaufe alle Arten von Bögen und Armbrüsten.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]er.+[IiDd][hu]r*","Ich bin "..thisNPC.name..".");
    npcs.base.autonpcfunctions.AddTraderTrigger("Ich bin .+","So grüße ich euch, mein Freund!");
    ...
    npcs.base.autonpcfunctions.AddCycleText("#me schnitzt mit eleganten Bewegungen an einer kleinen Holzstatue herum","#me carves on a small wooden statue with a elegant motions");
    npcs.base.autonpcfunctions.AddCycleText("#me blickt sich kurz um","#me looks around a moment");
    npcs.base.autonpcfunctions.AddCycleText("#me betrachtet einen Pfeil prüfend","#me looks on an arrow with a checking glance");
    ...
    if npcs.base.autonpcfunctions.BasicNPCChecks(originator,2) then
        if (npcs.base.autonpcfunctions.LangOK(originator,TradSpeakLang)==true) then
			...
			elseif (Status==7) then -- Verkaufspreis Ansage für ein Item // selling price announcement for an item
                ...
                eText="The "..world:getItemName(Values[1],0).." costs"..MoneyText(1,Values[2],Values[3],Values[4],TraderLang)..".";
