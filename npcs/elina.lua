...
function initializeNpc()
    ...
    AddTraderTrigger("[Gg]reetings","The five with you. Can I help you?");
    AddAdditionalTrigger("[Hh]ello");
    AddAdditionalText("Be blessed, my friend. Do you need something?");
    AddTraderTrigger("[Yy]ou.+[Tt]rader","I am a trader, yes. I trade different carpentry tools.");
    AddTraderTrigger("[Ww]hat.+sell","I sell all kinds of carpentry tools");
    AddTraderTrigger("[Ww]hat.+[Tt]ools","I sell tools for carpenters. Saws, axes, planes and carving tools.");
    AddTraderTrigger("[Tt]ell.+[Ss]omething","This is Tol Vanima, the home of us elves.");
    AddTraderTrigger("[Gg]oodbye","The five with you!.");
    AddAdditionalTrigger("[Bb]ye");
    AddAdditionalText("May the gods bless your path!");
    AddAdditionalTrigger("[Ff]arewell");
    AddAdditionalText("Farewell, my friend!");
    AddTraderTrigger("[Ww]hat.+buy","I buy all kinds of bows and crossbows.");
    AddTraderTrigger("[Ww]ho.+you?","My name is "..thisNPC.name..".");
    AddTraderTrigger("I'm .+","Be greeted!");
    ...
    AddTraderTrigger("[Gg]r[üu][ßs]+","Die Fünf zum Gruße, kann ich euch helfen?");
    AddAdditionalTrigger("[Hh]allo");
    AddAdditionalText("Möge euer Pfad gesegnet sein! Wie kann ich euch helfen?");
    AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin ein Händler, ja, und ich verkaufe unter anderem Werkzeuge.");
    AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe Werkzeuge für jede Art von Tischlerei.");
    AddTraderTrigger("[Ww]as.+[Ww]erkzeug","Nun, ich verkaufe Tischlerwerkzeug...Sägen, Äxte, Hobel und Schnitzwerkzeuge.");
    AddTraderTrigger("[Ee]rzähl.+[Ww]as","Dies ist Tol Vanima, die Heimat von uns Elfen.");
    AddTraderTrigger("[Aa]uf.+[Bb]ald","Die Fünf seien mit euch. Bis bald!");
    AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    AddAdditionalText("Bis bald, mein Freund, der Segen der Fünf mit euch!");
    AddTraderTrigger("[Ww]as.+%s[Kk]auf","Ich kaufe alle Arten von Bögen und Armbrüsten.");
    AddTraderTrigger("[Ww]er.+[IiDd][hu]r*","Ich bin "..thisNPC.name..".");
    AddTraderTrigger("Ich bin .+","So grüße ich euch, mein Freund!");
    ...
    AddCycleText("#me schnitzt mit eleganten Bewegungen an einer kleinen Holzstatue herum","#me carves on a small wooden statue with a elegant motions");
    AddCycleText("#me blickt sich kurz um","#me looks around a moment");
    AddCycleText("#me betrachtet einen Pfeil prüfend","#me looks on an arrow with a checking glance");
