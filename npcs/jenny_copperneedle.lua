...
function initializeNpc()
    ...
    AddTraderTrigger("hallo","Hallo mein Freund! Ich bin "..thisNPC.name..", die beste Schneiderin auf der Insel. Wenn du möchtest zeige ich dir, wie du ein guter Schneider wirst.");
    ...
    AddTraderTrigger("wer du","Hallo mein Freund! Ich bin "..thisNPC.name..", die beste Schneiderin auf der Insel. Wenn du möchtest zeige ich dir, wie du ein guter Schneider wirst.");
    ...
    AddTraderTrigger("hilf","Wenn du möchtest kann ich dir zeigen, wie man schneidert. Möchtest du?");
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",1);
    AddTraderTrigger("schneider","Du möchtest also lernen, wie man schneidert? Das freut mich sehr. Wollen wir gleich anfangen?");
    ...
    AddTraderTrigger("hilf","Klappt etwas nicht? Du musst dich direkt neben das Schaf stellen und dann die Schere 'benutzen. Das erfordert manchmal viel geschickt, weil die Schafe sich bewegen, aber mit etwas Übung wirst du es sicher schaffen. Ich kann dir aber auch einfach etwas Wolle geben. Möchtest du das?");
    AddCondition("state","=",10);
    AddConsequence("state","=",11);
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",2);
    AddTraderTrigger(".+","Großartig! Du hast's geschafft! Ein Hinweis noch: Du bekommst auch Wolle, wenn du die Schafe angreifst und tötest. Aber es ist viel effektiver das lebende Schaf zu scheren. Gut, als nächstes erkläre ich dir, wie du die Wolle zu einem Wollknäuel verarbeiten kannst. Bereit?");
    AddCondition("state","=",10);
    AddCondition("item",170,"all",">",14);
    AddCondition("lang","german");
    AddConsequence("state","=",2);
    ...
    AddTraderTrigger("hilf","Klappt etwas nicht? Du must die Schere in der Hand halten und die Wolle 'im' Gürtel haben. Stell dich direkt vor das Spinnrad und 'benute' das Spinnrad. Ich kann dir aber auch einfach etwas Wolle geben. Möchtest du das?");
    AddCondition("state","=",20);
    AddConsequence("state","=",21);
    ...
    AddTraderTrigger(".+","Du hast noch zu wenig Wollknäule. Komm wieder, wenn du mindestens 15 Stück hast.");
    AddCondition("lang","german");
    AddCondition("state","=",20);
    AddCondition("item",168,"all","<",15);
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",3);
    AddTraderTrigger(".+","Großartig! Dann zeig ich dir jetzt, wie du aus den Wollknäulen Stoffe herstellen kannst. Bist du soweit?");
    AddCondition("state","=",20);
    AddCondition("item",168,"all",">",14);
    AddCondition("lang","german");
    AddConsequence("state","=",3);
    ...
    AddTraderTrigger("ja","Mit einem Webstuhl kannst du nun die Wollknäule zu Stoff weben. Stell dich einfach vor den Webstuhl und 'benutze' ihn. Du solltest dafür die Schere in der Hand und die Wollknäule 'im' Gürtel haben. Wenn du fertig bist, dann komm wieder.");
    AddCondition("state","=",3);
    AddCondition("lang","german");
    AddConsequence("state","=",30);
    AddTraderTrigger("no","It's a pity, but maybe later. You can come back whenever you want.");
    ...
    AddTraderTrigger("hilf","Klappt etwas nicht? Du must die Schere in der Hand halten und die Wollknäule 'im' Gürtel haben. Stell dich direkt vor den Webstuhl und 'benute' den Webstuhl. Ich kann dir aber auch einfach etwas Stoff geben. Möchtest du das?");
    AddCondition("state","=",30);
    AddConsequence("state","=",31);
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",4);
    AddTraderTrigger(".+","Großartig! Jetzt können wir mit dem nächsten Schritt weitermachen. Bist du soweit?");
    AddCondition("state","=",30);
    AddCondition("item",176,"all",">",0);
    AddCondition("lang","german");
    AddConsequence("state","=",4);
    ...
    AddTraderTrigger("hilf","Klappt etwas nicht? Du must die Schere in der Hand halten und die Eingeweide 'im' Gürtel haben. Dann einfach die Schere 'benutzen'. Ich kann dir aber auch einfach etwas Stoff geben. Möchtest du das?");
    AddCondition("state","=",40);
    AddConsequence("state","=",41);
  ...
  --
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",5);
    AddTraderTrigger(".+","Großartig! Jetzt können wir anfangen mit dem nähen von Kleidung. Bist du soweit?");
    AddCondition("state","=",40);
    AddCondition("item",50,"all",">",0);
    AddCondition("lang","german");
    AddConsequence("state","=",5);
    ...
    AddTraderTrigger("hilf","Klappt etwas nicht? Du must die Nadel in der Hand halten und den Stoff und das Garn am Gürtel tragen. Dann 'benutze' die Nadel um das Haupmenü zu öffnen. Das rote Hemd ist das Symbol für Kleidung. Klick darauf um das Kleidungsmenü zu öffnen. In diesem Menü wähle dann \"Grauer Mantel\".");
    AddCondition("state",">=",50);
    AddCondition("state","<",52);
    ...
    AddTraderTrigger(".+","Geh zum Schneidertisch und nähe einen grauen Mantel. Komm wieder, wenn du fertig bist.");
    AddCondition("lang","german");
    AddCondition("state","=",50);
    AddCondition("item",196,"all","=",0);
    ...
    AddCondition("lang","english");
    AddConsequence("state","=",50);
    AddTraderTrigger(".+","Oh...dieser Mantel ist noch nicht fertig. Wenn du die Arbeit an einem unfertigen Kleidungsstück weiterführen willst, dann 'benutze' die Nadel mit diesem Kleidungsstück, das du natürlich am Gürtel trägst.");
    AddCondition("state","=",51);
    AddCondition("lang","german");
    AddConsequence("state","=",50);
