...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(5   ,176 ,100,0  ,100,{3}  ,{33}   ,0   ,0     ); -- grey cloth
    npcs.base.trader_functions.AddTraderItem(9   ,174 , 70,1  ,100,{3}  ,{33}   ,0   ,0     ); -- red cloth
    npcs.base.trader_functions.AddTraderItem(9   ,175 , 70,1  ,100,{3}  ,{33}   ,0   ,0     ); -- black cloth
    npcs.base.trader_functions.AddTraderItem(9   ,179 , 70,1  ,100,{3}  ,{33}   ,0   ,0     ); -- blue cloth
    npcs.base.trader_functions.AddTraderItem(9   , 54 , 70,1  ,100,{3}  ,{33}   ,0   ,0     ); -- green cloth
    npcs.base.trader_functions.AddTraderItem(9   ,177 , 70,1  ,100,{3}  ,{33}   ,0   ,0     ); -- yellow cloth
    npcs.base.trader_functions.AddTraderItem(5   ,50  ,500,0  ,500,{3}  ,{33}   ,0   ,0     ); -- thread
    npcs.base.trader_functions.AddTraderItem(20  ,47  , 30,0  , 30,{4,6},{77,90},0   ,0     ); -- needle
    npcs.base.trader_functions.AddTraderItem(20  , 6  , 30,0  , 30,{4,6},{77,90},0   ,0     ); -- scissor
    npcs.base.trader_functions.AddTraderItem(30  ,2295, 11,2  , 20,{4,6},{44,66},0   ,0     ); -- cloth gloves
    npcs.base.trader_functions.AddTraderItem(100 ,385 , 10,10 , 20,{4,6},{44,66},0   ,0     ); -- blue dress
    npcs.base.trader_functions.AddTraderItem(40  ,34  , 10,4  , 20,{4,6},{44,66},0   ,0     ); -- black trousers
    npcs.base.trader_functions.AddTraderItem(30  ,180 , 10,3  , 20,{4,6},{44,66},0   ,0     ); -- red shirt
    npcs.base.trader_functions.AddTraderItem(30  ,182 , 10,3  , 20,{4,6},{44,66},0   ,0     ); -- black shirt
    npcs.base.trader_functions.AddTraderItem(30  ,55  , 10,3  ,20,{4,6},{44,66},0   ,0      ); -- green robe
    npcs.base.trader_functions.AddTraderItem(70  ,2380, 10,7  ,20,{4,6},{44,66},0   ,0      ); -- blue coat
