...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(30  ,227 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- cooking spoon
    npcs.base.trader_functions.AddTraderItem(30  ,121 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- Ofenschieber
    npcs.base.trader_functions.AddTraderItem(30  ,118 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- Nudelholz
    npcs.base.trader_functions.AddTraderItem(10  ,2952,20 ,2 ,36,{3}  ,{33}   ,0   ,0       ); -- plate X
    npcs.base.trader_functions.AddTraderItem(10  ,2935,20 ,2 ,36,{3}  ,{33}   ,0   ,0       ); -- soup bowl X
    npcs.base.trader_functions.AddTraderItem(0   ,2647,0 ,5  ,36,{3}  ,{33}   ,0   ,0       ); -- cutlery X
    npcs.base.trader_functions.AddTraderItem(0   ,1908,0 ,1  ,36,{3}  ,{33}   ,0   ,0       ); -- beer mug X
    npcs.base.trader_functions.AddTraderItem(0   ,2185,0 ,2  ,36,{3}  ,{33}   ,0   ,0       ); -- wooden cup X
    npcs.base.trader_functions.AddTraderItem(0   ,223 ,0 ,6  ,36,{3}  ,{33}   ,0   ,0       ); -- iron goblet X
    npcs.base.trader_functions.AddTraderItem(0   ,1858,0 ,4  ,36,{3}  ,{33}   ,0   ,0       ); -- goblet X
    npcs.base.trader_functions.AddTraderItem(0   ,164 ,0 ,1  ,36,{3}  ,{33}   ,0   ,0       ); -- big empty bottle X
    npcs.base.trader_functions.AddTraderItem(0   ,1317,0 ,2  ,36,{3}  ,{33}   ,0   ,0       ); -- empty bottle X
    npcs.base.trader_functions.AddTraderItem(0   ,2498,0 ,3  ,36,{3}  ,{33}   ,0   ,0       ); -- grey bottle X
    npcs.base.trader_functions.AddTraderItem(0   ,2055,0 ,3  ,36,{3}  ,{33}   ,0   ,0       ); -- glass X

    TraderCopper=400;

    npcs.base.functions.AddTraderTrigger("[Hh]ello","Hello");
    npcs.base.functions.AddAdditionalTrigger("[Gg]reetings");
    npcs.base.functions.AddAdditionalText("Greetings");
    npcs.base.functions.AddTraderTrigger("[Hh]allo","Hallo");
    npcs.base.functions.AddAdditionalTrigger("[Gg]r[üu][ßs]+");
    npcs.base.functions.AddAdditionalText("Grüße");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+buy","I’ll buy cutlery, plates and bowls, cups, goblets, bottles and cooking tools.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+%skauf","Ich kaufe Besteck, Teller und Schüsseln, Becher, Kelche, diverse Flaschen und Kochutensilien.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+do","I buy table supplies for the tavern");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[tm][ua][tsc]","Ich kaufe Tisch Gedeck für die Taverne");
    npcs.base.functions.AddTraderTrigger("[Ww]ho.+you","Gambret.");
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Gambret.");
    npcs.base.functions.AddTraderTrigger("[Ii][' ]*m.+","Alright then. Have anything to sell me?");
    npcs.base.functions.AddTraderTrigger("[Ii]ch.+[Bb]in","In Ordnung. Habt ihr was, das ihr mir verkaufen könntet?");
    npcs.base.functions.AddTraderTrigger("[Bb]ye","Goodbye");
    npcs.base.functions.AddAdditionalTrigger("[Ff]arewell");
    npcs.base.functions.AddAdditionalText("Goodbye");
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Auf bald");
