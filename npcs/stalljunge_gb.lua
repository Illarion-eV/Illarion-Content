...
function initializeNpc()
    ...
    npcs.base.functions.AddTraderTrigger("[Hh]allo","Grüß dich!");
    ...
    npcs.base.functions.AddTraderTrigger("[Ff]arewell","Bye Bye!");
    ...
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Tschüss. Schau mal wieder vorbei.");
