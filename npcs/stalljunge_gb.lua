...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ff]arewell","Bye Bye!");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Tschüss. Schau mal wieder vorbei.");
