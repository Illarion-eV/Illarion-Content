...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(20  ,49  ,500 ,3  ,300 ,{3}  ,{33}   ,0   ,0       ); -- bread
    npcs.base.trader_functions.AddTraderItem(0   ,191 ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- roll
    npcs.base.trader_functions.AddTraderItem(10  ,306 ,500 ,2  ,300 ,{3}  ,{33}   ,0   ,0       ); -- ham
    npcs.base.trader_functions.AddTraderItem(10  ,73  ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- fish
    npcs.base.trader_functions.AddTraderItem(15  ,355 ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- trout
    npcs.base.trader_functions.AddTraderItem(40  ,258 ,60  ,0  ,60  ,{5}  ,{88}   ,0   ,0       ); -- flail
    npcs.base.trader_functions.AddTraderItem(40  ,271 ,70  ,0  ,70  ,{5}  ,{88}   ,0   ,0       ); -- scythe
    npcs.base.trader_functions.AddTraderItem(40  ,126 ,30  ,0  ,30  ,{5}  ,{88}   ,0   ,0       ); -- sickle
    npcs.base.trader_functions.AddTraderItem(40  ,72  ,50  ,0  ,50  ,{5}  ,{88}   ,0   ,0       ); -- fishing rod
    npcs.base.trader_functions.AddTraderItem(3   ,259 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- grain
    npcs.base.trader_functions.AddTraderItem(3   ,534 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- onion seeds
    npcs.base.trader_functions.AddItemTrigger("onion");
    npcs.base.trader_functions.AddItemTrigger("zwiebel");
    npcs.base.trader_functions.AddTraderItem(3   ,291 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- cabbage
    npcs.base.trader_functions.AddItemTrigger("cabbage");
    npcs.base.trader_functions.AddItemTrigger("Kohl");
    ...
    npcs.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Jap, ich bin Händler. Was brauchst du?");
    ...
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Schönen Tag noch! Bis bald!");
