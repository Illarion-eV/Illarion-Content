...
function initializeNpc()
    ...
    AddConsequence("inform","[Game Help] This is NPC is the scholar William Daloire. Keyphrases: Hello, scholar, YOURTRIGGER1, YOURTRIGGER2.");
    AddTraderTrigger("Hilfe","");
    AddConsequence("inform","[Spielhilfe] Dieser NPC ist der Gelehrte William Daloire. Schlüsselwörter: Hallo, Gelehrter, DEINTRIGGER1, DEINTRIGGER2.");
    -- General speech
