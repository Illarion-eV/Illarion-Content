...
function initializeNpc()
    ...
    npcs.base.functions.AddTraderTrigger("[Ff]arewell","Farewell. The Five with you");
    ...
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Auf Bald. Die Fünf mit euch!");
