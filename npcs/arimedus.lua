...
function initializeNpc()
    ...
    -- Begrüßungen
    npcs.base.autonpcfunctions.AddTraderTrigger("[Gg]rüß","Elara zum Gruße. Kann ich euch behilflich sein?");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Hh]allo","Scht! Dies ist eine Bücherei, keine Taverne.");
    ...
    -- Smaltalk
    npcs.base.autonpcfunctions.AddTraderTrigger("[Hh]ilfe","Ihr braucht hilfe? Wobei? Ich kann euch etwas über die Bedeutung von Runen erzählen, wenn ihr mögt.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]u","Ich möchte euch bitten mich nicht so unformell anzusprechen.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]arüber erzählen","Sicher kann ich das, von welcher Rune möchtet ihr die Bedeutung wissen?");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]arüber erzählen","Of course. About which rune you like to hear the meaning?");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Rr]une","Von welcher Rune möchtet ihr die Bedeutung wissen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Rr]une","About which rune you like to hear the meaning?");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Bb]edeutung","Von welcher Rune möchtet ihr die Bedeutung wissen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("HEPT","HEPT ist die Rune des Eises. Sie kann für offensive Eiszauber genutzt werden, sowie zum Entfachen und Auslöschen von Eisflammen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("PEN","PEN ist die Rune des des Geistes und eine Elementarrune. Sie kann für starke und schwache Heilzauber benutzt werden.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("MES","MES ist die Rune des Lichts. Sie kann für starke und schwache Heilzauber benutzt werden.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("ORL","ORL ist die Rune der Materialisierung. Sie kann genutzt werden um Steinwände zu erschaffen, Hunger zu stillen und Gewitterstürme heraufzubeschwören.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("CUN","CUN ist die Rune des Wassers und eine Elementarrune. Sie kann benutzt werden um Lagerfeuer auszulöschen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SAV","SAV ist die Rune des Schutzes. Sie kann benutzt werden um Flammen und Steinwälle um dich herum entstehen zu lassen, die dich schützen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SOLH","MES ist die Rune der Erde und eine Elementarrune. Sie kann genutzt werden um Steinwände zu erschaffen, Stürme heraufzubeschwören und den Gegner zu paralysieren.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("FHEN","FHEN steht als Rune für das Holen. Sie kann benutzt werden, um kleine und größere Objekte zu dir zu holen. Es gibt jedoch Gerüchte, es gäbe noch eine andere Verwendung für sie...");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("KAH","KAH ist die Rune der Nahrung und Ernährung. Sie kann sie benutzen um sich selbst leicht, oder auch ausreichend zu sättigen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LHOR","LHOR ist die Rune der Illusion. Sie kann benutzt werden um illusionäre Objekte zu erschaffen, wie Feuerbälle, Feuerflammen, Eisbälle und solche Dinge.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("KEL","KEL ist die Rune der Bewegung. Sie kann genutzt werden für bewegungsgebundene Zauber wie zum Beispiel Feuerbälle, Eisbälle und Teleportation");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("TAH","TAH ist die Rune der Umkehrung. Sie kann genutzt um erschaffene Dinge wieder aufzulösen, zum Beispiel Flammen, Portale, Giftwolken und Illusionen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("TAUR","Die Rune TAUR steht für alle Kreaturen. Sie kann bei der Teleportation genutt werden und bei der Beschwörung von Wesenheiten.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("URA","URA is the rune of nature. It can be used to summon natural creatures.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("URA","URA ist die Rune des Natürlichen. Sie kann benutzt werden um natürliche Kreaturen herbeizubeschwören.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("IRA","IRA ist die Rune des Unnatürlichen. Sie wird benutzt um unnatürliche Kreaturen herbeizubeschwören, aber auch um Flammen und Giftwolken zu beschwören.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("YEG","YEG ist die Rune des Giftes. Sie wird für offensive Giftsprüche benutzt, um Giftwolken zu erschaffen oder auszulöschen aber auch um Vergiftungen zu heilen");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("JUS","JUS ist die Rune des Windes und eine Elementarrune. Sie wird genutzt für defensive und offensive Windsprüche, um Objekte zu bewegen, für die Teleportation und um zu Paralysieren.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SIH","SIH die Rune der Heilung. Sie wird für starke Heilzauber genutzt und um Vergiftungen zu heilen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("ANTH","ANTH ist die Rune des Objekts. Sie wird benutzt um Flammen und Giftwolken zu beschwören, um Türen zu öffnen und Objekte zu bewegen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SUL","SUL ist die Rune der Unbeweglichkeit. Sie wird genutzt um Personen für eine kurze Dauer zu paralysieren.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("QWAN","QWAN ist die Rune der Stärke. Sie wurd benutzt um Sprüche zu verstärken und macht sie so wirkungsvoller.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("DUN","DUN is the rune of area. It can be used to create areas of things. ");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("DUN","DUN ist die Rune der Fläche. Sie wird benutzt um den Effekt von anderen Sprüchen auszuweiten.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("PHERC","PHERC ist die Rune der Verletzung. Sie wird genutzt um Blitze herbeizubeschwören und um effektiv jemanden zu vergiften.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("FHAN","FHAN ist die Rune des Bringens. FHEN ist eine sehr mysteriöse Rune, ich habe bisher noch keine Anwendung dafür gefunden, aber vielleicht findet ihr ja eine...");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("LUK","LUK is the rune of evil. It is used to summon hostile creatures. ");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LUK","LUK ist die Rune des Böse. Sie kann benutzt werden um aggresive Kreaturen herbeizubeschwören.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LEV","LEV ist die Rune der Veränderung. Ich habe von ein paar Personen gehört, die fähig sein sollen Teleportsprüche damit in Schriftrollen zu bannen, aber es soll sehr schwer sein.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("BHONA","BHONA ist die Rune des Lehrens. Sie wird benutzt um anderen Personen Runen zu lehren. Nur Lehrer können diese Rune bekommen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCycleText("#me hebt kurz den Kopf an und blickt über den Rand seiner Brille durch den Raum.","#me raises his head slightly and looks over the edge of his glassen through the room.");
