...
function initializeNpc()
    ...
    npcs.base.trader_functions.AddTraderItem(100 ,333 ,5  ,5  ,5  ,{6,8},{66,88},0   ,0       );    -- Horn
    npcs.base.trader_functions.AddTraderItem(100 ,2760,10 ,40 ,2  ,{6,8},{66,88},0   ,0       );    -- Rope/Seil
    npcs.base.trader_functions.AddTraderItem(40  ,58  ,15 ,0  ,15 ,{6,8},{66,88},0   ,0       );    -- Mortar/Mörser
    npcs.base.trader_functions.AddTraderItem(90  ,2586,15 ,5  , 5 ,{6,8},{66,88},0   ,0       );    -- Fur/Felle
    npcs.base.trader_functions.AddTraderItem(3   ,2588,300,0  ,300,{3,3},{33,33},0   ,0       );    -- Bricks/Ziegelsteine
    npcs.base.trader_functions.AddTraderItem(150 ,92  ,5 ,30  ,10 ,{6,7},{33,66},0   ,0       );    -- Oil lamp/Öllampe
    npcs.base.trader_functions.AddTraderItem(400 ,236 ,0 ,50  ,50 ,{6,7},{33,66},0   ,0       );    -- Gold ingots/Goldbarren
    npcs.base.trader_functions.AddTraderItem(400 ,1008 ,0 ,50 ,50 ,{6,7},{33,66},0   ,0       );    -- Copper kettle/Kupferkessel
    ...
    npcs.base.functions.AddAdditionalTrigger("[Gg]rü[ßs]+e");
    npcs.base.functions.AddAdditionalText("Aye. Grüß euch.");
    ...
    npcs.base.functions.AddAdditionalText("Aye. Schön Tag noch.");
