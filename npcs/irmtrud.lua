...
function initializeNpc()
    ...
    AddCycleText("#me lehnt sich auf ihre Axt und lässt einen prüfenden Blick durch die Mine schweifen.","#me leans on her axe and looks vetting through the mine.");
