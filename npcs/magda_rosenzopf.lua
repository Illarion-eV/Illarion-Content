...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddCycleText("#me lehnt sich auf ihre Axt und lässt einen prüfenden Blick durch die Gegend schweifen.","#me leans on her axe and looks vetting through the area.");
