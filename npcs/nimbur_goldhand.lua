...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("hallo","Hey ho! Ich bin "..thisNPC.name..". Wußtest du, dass aus der Familie Goldhand seit Generationen die besten Goldschmiede stammen? Aber der Allerbeste von ihnen bin ich! Wenn du willst zeige ich dir ein wenig über mein Handwerk.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("wer du","Ich bin "..thisNPC.name..". Wußtest du, dass aus der Familie Goldhand seit Generationen die besten Goldschmiede stammen? Und ich bin der Allerbeste von ihnen! Wenn du willst zeige ich dir ein wenig über mein Handwerk.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("tsch[üu][ßs]","Mach's gut, bis zum nächstn Mal.");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddConsequence("state","=",1);
    npcs.base.autonpcfunctions.AddTraderTrigger("schmied","Arr...in Ordnung. Hör mich genau zu, ich kann dir alles über das goldschmieden beibringen, was du wissen must. Bist du bereit?");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("weiter","Arr...du weiß also schon, wie man Eisenbarren herstellt? Auch gut, ich geb dir einfach die Eisenbarren, die du für das Goldschmieden brauchst. Einverstanden?");
    npcs.base.autonpcfunctions.AddCondition("state","=",10);
    npcs.base.autonpcfunctions.AddConsequence("state","=",11);
