...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("Hallo","Hallo, mein Freund. Bist du dir sicher, dass du die kleinen Schweinchen töten willst?");
    npcs.base.autonpcfunctions.AddConsequence("state",1);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",0);
    npcs.base.autonpcfunctions.AddTraderTrigger("Grüsse","Grüsse, mein Freund. Bist du dir sicher, dass du die kleinen Schweinchen töten willst?");
    npcs.base.autonpcfunctions.AddConsequence("state",1);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",0);
    npcs.base.autonpcfunctions.AddTraderTrigger("Grüße","Grüße, mein Freund. Bist du dir sicher, dass du die kleinen Schweinchen töten willst?");
    npcs.base.autonpcfunctions.AddConsequence("state",1);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",0);
    npcs.base.autonpcfunctions.AddTraderTrigger("Guten Tag","Guten Tag, mein Freund. Bist du dir sicher, dass du die kleinen Schweinchen töten willst?");
    npcs.base.autonpcfunctions.AddConsequence("state",1);
    npcs.base.autonpcfunctions.AddCondition("qpg","=",0);
    ...
    npcs.base.autonpcfunctions.AddConsequence("item",49,1,333,0);
    npcs.base.autonpcfunctions.AddConsequence("qpg",1);
    npcs.base.autonpcfunctions.AddTraderTrigger("Ja","Kann ich dich nicht umstimmen? Ich gebe dir fünf Kupfer. Dann kannst du dir ein Brot kaufen. Bist du einverstanden?");
    npcs.base.autonpcfunctions.AddCondition("state","=",1);
    ...
    npcs.base.autonpcfunctions.AddConsequence("money","+",5);
    npcs.base.autonpcfunctions.AddConsequence("qpg",1);
    npcs.base.autonpcfunctions.AddTraderTrigger("Nein","Dann kann ich dir leider nicht helfen. Mögen dich die Schweine beissen!");
    npcs.base.autonpcfunctions.AddCondition("state","=",2);
    npcs.base.autonpcfunctions.AddConsequence("state",3);
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("Grüsse","Grüsse, mein Freund.");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",1);
    ...
    npcs.base.autonpcfunctions.AddCondition("qpg","=",1);
    npcs.base.autonpcfunctions.AddTraderTrigger("Hallo","Verschwinde, elender Mörder! ");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",2);
    npcs.base.autonpcfunctions.AddTraderTrigger("Grüsse","Verschwinde, elender Mörder! ");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",2);
    npcs.base.autonpcfunctions.AddTraderTrigger("Grüße","Verschwinde, elender Mörder! ");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",2);
    npcs.base.autonpcfunctions.AddTraderTrigger("Guten Tag","Verschwinde, elender Mörder! ");
    npcs.base.autonpcfunctions.AddCondition("qpg","=",2);
