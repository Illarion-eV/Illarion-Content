...
function initializeNpc()
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]r[uü][sß]+","Hiho! Willkommen Reisender! Könntest du mir helfen?");
    ...
    npcs.base.functions.AddTraderTrigger("[Hh][ei]lf","Ich brauche zwei Äpfel um einen sehr leckeren Kuchen zu backen. Könntest du mir welche bringen?");
    npcs.base.functions.AddTraderTrigger("[Bb][äa]um","#me zeigt auf die Bäume \"Dort! Die Bäume! Kannst du sie sehen?\"");
    npcs.base.functions.AddTraderTrigger("[Ww]ie.+[Bb]ekomm","#w (( drück die Shift Taste. Klicke den Baum an und lass die Shift-Taste wieder los. So kannst du Gegenstände benutzen ))");
