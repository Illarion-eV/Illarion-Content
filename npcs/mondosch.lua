...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Yy]ou.+[Tt]rader","No. I'm no trader. I'm the tax collector of Silverbrand.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Nein ich bin kein Händler. Ich bin der Steuerneintreiber von Silberbrand.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]ell.+[Ss]omething","Sorry, I'm pretty busy right now.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Tut mir leid, ich bin grad ziemlich beschäftigt.");
