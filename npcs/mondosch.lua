...
function initializeNpc()
    ...
    npcs.base.functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","No. I'm no trader. I'm the tax collector of Silverbrand.");
    npcs.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Nein ich bin kein Händler. Ich bin der Steuerneintreiber von Silberbrand.");
    ...
    npcs.base.functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","Sorry, I'm pretty busy right now.");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Tut mir leid, ich bin grad ziemlich beschäftigt.");
