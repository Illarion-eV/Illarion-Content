...
thisNPC:increaseSkill(1,"common language",100);
    ...
    npcs.base.trader_functions.AddTraderItem(120 ,180 ,200 ,12 ,100 ,{5,7},{55,77},0   ,0   ); -- shirt
    npcs.base.trader_functions.AddTraderItem(140 ,183 ,200 ,14 ,100 ,{5,7},{55,77},0   ,0   ); -- trousers
    npcs.base.trader_functions.AddTraderItem(100 ,369 ,200 ,10 ,100 ,{5,7},{55,77},0   ,0   ); -- shoes
    npcs.base.trader_functions.AddTraderItem(10  ,191 ,500 ,1  ,100 ,{3}  ,{33},0   ,0      ); -- roll
    npcs.base.trader_functions.AddTraderItem(20  ,306 ,500 ,2  ,100 ,{3}  ,{33},0   ,0      ); -- ham
    npcs.base.trader_functions.AddTraderItem(100 ,353 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- apple pie
    npcs.base.trader_functions.AddTraderItem(100 ,354 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- strawberry cake
    npcs.base.trader_functions.AddTraderItem(100 ,303 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- cherry cake
    npcs.base.trader_functions.AddTraderItem(20  ,49  ,200 ,2  ,100 ,{3}  ,{33},0   ,0       ); -- bread
    npcs.base.trader_functions.AddTraderItem(5   ,201 ,500 ,1  ,100 ,{3}  ,{33},0   ,0       ); -- onions
    npcs.base.trader_functions.AddTraderItem(5   ,2493,500 ,1  ,100 ,{3}  ,{33},0   ,0       ); -- cabbage
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin "..thisNPC.name.."! Ich leb hier in Greenbriar mit den anderen Halblingen. Und würd nicht um alles in der Welt hier weggehen!");
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Wenn du jemals in den Wald gehst und Pilze sammelst, pass auf Leuchtkäfer auf. Ich hab gehört das Feen auf denen reiten.");
    ...
    if npcs.base.functions.BasicNPCChecks(originator,2) then
        if (npcs.base.functions.LangOK(originator,TradSpeakLang)==true) then
            ...
            elseif (Status==8) then -- Einkaufspreis Ansage für ein Item // buying price announcement for an item
                gText=npcs.base.functions.GenusSel(Values[2],"Ein","Eine","Ein").." "..Tworld:getItemName(Values[2],0).." wäre mir"..npcs.base.trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang).." wert.";
