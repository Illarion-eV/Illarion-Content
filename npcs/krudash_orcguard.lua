...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddAdditionalText("Goodbyes."); 
  	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]ho.+yo.+","Meh beh "..thisNPC.name..", nub single rat whub enterr orc embassy witout meh sees it!"); 
  	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Nn]ame", "Meh "..thisNPC.name.."! Meh guard ob orc embassy!"); 
  	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hub.+[Nn]ame", "Meh "..thisNPC.name.."! Meh guard ob orc embassy!"); 
  	...
  	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Yy]o.*do",""..thisNPC.name.." opens and closes embassy! Yoo wunt get in or out? Den tell meh keyword"); 
...
--TRIGGER FUER LOCATIONS ENGLISCH    
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Nn]orthmark","Dey lib on ottur side ob island far in north. Dey hab strrong warriors meh hab heard! And best beh dat dey nub like magic neithurrr - jus' bit like orcs, hurrr."); 
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english"); 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]roll['s].*[Bb]ane","Oomie town Troll's Bane beh biggest town on Gobaith. Though, orcs ususally get in trouble in here! Beh careful when passing town gates!"); 
    npcs.base.autonpcfunctions.AddCondition("lang","english"); 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Vv]arshikar","Desert town Varshikar beh far abay from here! Orcs hab peace wit dem! Treat dem fair and dey whub treat yoo fair toos! But beh careful ob mages in desert town!"); 
    npcs.base.autonpcfunctions.AddCondition("lang","english"); 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]esert.*town","Desert town Varshikar beh far abay from here! Orcs hab peace wit dem! Treat dem fair and dey whub treat yoo fair toos! But beh careful ob mages in desert town!"); 
...
--SONSTIGE TRIGGER 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Cc]lan", "Yubba, dis beh embassy ob strong orc clan! Tell meh clan name and meh whub open gate fer yoo!"); 
...
--TRIGGER FÜR LOCATIONS DEUTSCH 
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","german"); 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]roll['s].*[Bb]ane","Menschenstadt in Mitte der Insel du fragen nach? Groß und hässlich sie sein! Orkse nicht gern gesehen heir! Nim Waffen mit, wenn du in Stadt müssen!"); 
    npcs.base.autonpcfunctions.AddCondition("lang","german"); 
    npcs.base.autonpcfunctions.AddTraderTrigger("[Vv]arshikar","Meisten Wesen dort dumm und stinkig - aber Clanführer, Grrrypus, Ehre haben! Sei gut zu Wüstenvolk, dann sie gut zu Orks sind!"); 
    npcs.base.autonpcfunctions.AddCondition("lang","german"); 
