...
--------------------------------------------- *** EDIT BELOW HERE ***--------------------------------------
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]rü[ßs]+e","Hiho! Wie kann ich dir helfen? Ich habe allerhand Farben. Alle selbst gemacht!");
    ...
    npcs.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh][äa]ndler","Ja, ich handle mit Farben und Zutaten zur Herstellung von Farben.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Tt]ränke","Ich habe keine Tränke mehr. Ich handele nur noch mit Farben und Zutaten zu deren Herstellung.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Kk]leidung","Ich habe keine Kleidung mehr im Angebot. Das Geschäft mit den abgetragenen Klamotten lief nicht gut.");
    ...
    npcs.base.functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Schönen Tag noch! Oldra segne euch!");
    npcs.base.functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    npcs.base.functions.AddAdditionalText("Schönen Tag!");
    ...
    npcs.base.functions.AddTraderTrigger("[Hh]ilfe","'Welche Waren verkauft ihr', 'Ich möchte <Anzahl> <Ware> kaufen', 'Ich möchte <Ware> kaufen', 'Ich möchte <Anzahl> <Ware> verkaufen', 'Was ist der Preis von <Ware>','Was zahlt ihr für <Ware>', 'Was kauft ihr?', 'Erzähl über <etwas>'");
