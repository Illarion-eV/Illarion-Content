...
function initializeNpc()
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Hh]elf","Ich kann euch einiges über die verschiedenen Runen und Runenschulen erzählen wenn ihr Interesse daran habt.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Hh]ilf","Ich kann euch einiges über die verschiedenen Runen und Runenschulen erzählen wenn ihr Interesse daran habt.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Gg]rüß","Ich Grüße euch, setzt euch doch zu mir.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Hh]eho","Ich Grüße euch, setzt euch doch zu mir.");
    ...
    npcs.base.autonpcfunctions.AddTraderTrigger("[Kk]auf","Das einzige was ich euch abkaufen würde, ist ein Manaenergiestabilisator.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Mm]anaenergiestabilisator","Manaenergiestabilisator, ja das würde ich euch abkaufen. Ich denke das ihr keinen dabei habt also werde ich ihn irgendwann einmal aus Lor Angur bestellen.");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Bb]enötigt","Da so ein Apparat höchst komplex ist, verzichten wir lieber auf eine Erklärung. Wenn ihr aber etwas über die Runenkunde  beigebracht haben wollt, stehe ich euch zur Verfügung.");  
    npcs.base.autonpcfunctions.AddTraderTrigger("[Kk]ost","So ein Manaenergiestabilisator, lasst mich einmal nachdenken. Er würde 120 Goldmünzen kosten und das in einer nicht transportablen Größe.");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]ransport","Nur das fünffache. Ich würde nun gerne weiter an meiner Ausarbeitung arbeiten oder soll ich euch noch etwas über die Runenkunde beibringen?");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Vv]erkauf","Ich bin ein Lehrmeister der Runenkunde und kein Händler.");

	

	
    -- Smaltalk
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]ein","Ich möchte euch bitten mich nicht so unformell anzusprechen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]ir","Ich möchte euch bitten mich nicht so unformell anzusprechen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]ich","Ich möchte euch bitten mich nicht so unformell anzusprechen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]er seid ihr?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Spektabilität für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");                               
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]ie ist euer [Nn]ame?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Magister für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as macht?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Magister für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as tut ihr hier?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Magister für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as ist [Aa]ufgabe?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Magister für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]oher kommt?","Ich bin Winfried Birks und stamme aus Lor Angur. Nun bin ich hier Magister für Runenkunde. Ich lehre neuen Studenten die Bedeutung der Runen und der Runenschulen.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]ie geht","Es läge mir völlig fern zu klagen. Hier ist es viel ruhiger als in Lor Angur.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english")
	npcs.base.autonpcfunctions.AddTraderTrigger("[Bb]efinden","Es läge mir völlig fern zu klagen. Hier ist es viel ruhiger als in Lor Angur. ");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Aa]ngenommen","Mich reizte es eine andere Lehranstallt kennen zu lernen. Außerdem habe ich hier mehr Zeit für meine Studien und werde genauso gut bezahlt.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Bb]ezahlt","Kost und Logis das ist meine Bezahlung. Wenn ihr keine Fragen über Runen oder die Runenkunde habt, würde ich mich nun gerne wieder diesem interessanten Buch widmen.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ss]tudien","Ich studiere die Runen. Wie man sie richtig ausspricht. Wie man sie optimal anwendet und noch vieles mehr. Ihr werdet noch merken was man alles beachten muß.");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as beibringen","Aber selbstverständlich, wollt ihr etwas über die Bedeutung der Runen oder die Schulen der Runen Wissen? ");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",1);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);	
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as erzählen","Aber selbstverständlich, wollt ich etwas über die Bedeutung der Runen oder die Schulen der Runen Wissen? ");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",1);	
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as lehren","Aber selbstverständlich, wollt ich etwas über die Bedeutung der Runen oder die Schulen der Runen Wissen? ");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",1);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ww]as erklären","Aber selbstverständlich, wollt ich etwas über die Bedeutung der Runen oder die Schulen der Runen Wissen? ");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    npcs.base.autonpcfunctions.AddCondition("qpg","!=",1);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("MES","Die Rune MES benutzt man auch für Heilsprüche, man bring sie oft mit Licht wohliger Wärme in Verbindung, die genaue Übersetzung heißt aber 'Licht'. ");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("ORL","ORL steht für Erschaffung und wird Beispielsweise zum erschaffen von Nahrung im eigenen Magen oder zur Beschwörung von Erdwällen gebraucht.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SAV","SAV heißt Schut auf Antik. Mann kann damit zum Beispiel Steinkreise um sich zaubern.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("SOLH","The elementrune of the earth is SOLH.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SOLH","Die Elemntarrune der Erde heißt SOLH.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("FHEN","FHEN is he opposite of FHAN and means 'to get' or 'to take'.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("FHEN","FHEN ist das Gegenteil von FHAN und heißt holen beziehungsweise nehmen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("KAH","A mage needs this rune to satiate. It means food.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("KAH","Diese Runen braucht ein Magier zum Sättigen, sie bedeutet Nahrung oder auch Essen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LHOR","Die Rune LHOR erschafft Trugbilder. Man kann sie mit Illusion oder täuschen übersetzen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("KEL","KEL bedeutet Vogel oder bewegen. Diese Rune kommt in vielen Sprüchen vor, bei denen den Etwas oder Jemand bewegt wird. Beispielsweise das Werfen eines Feuerballs oder die Erschaffung eines Portals.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("TAH","Diese Rune steht für umkehren oder auch bannen. Alle Runensprüche, die eine andere Form von Magie zerstören, werden mit TAH gesprochen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("TAUR","This rune stands for being and creature. You need it to summon.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("TAUR","Für Wesen oder Kreatur steht diese Rune. Man benötigt sie für Beschwörungen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("URA","Kann man mit natürlich, beziehungsweise lebendig übersetzen. Mit ihrer Hilfe lassen sich Wild, Vieh, Insekten aber auch Oger beschwören.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("IRA","IRA bedeutet so viel wie unnatürlich, tot oder auch untot. Mit dieser Rune kann man Skelette, Geister und Mumien herbei rufen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("YEG","Gift, die ist die übersetzung von YEG, mit Hilfe dieser Rune kann man unter anderem Giftwolken erschaffen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SIH","SIH steht für Heilen, zum Beispiel von Gift.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("SUL","SUL wird zum Lähmen verwendet und bedeutet soviel wie stehen oder auch festhalten.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("QWAN","To boost a spell you need QWAN. QWAN means something like 'big'.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("QWAN","Um Runensprüche zu verstärken braucht man QWAN. Übersetzt bedeutet QWAN soviel wie 'groß'.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("DUN","DUN is needed to extend spells. The translation is plane.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("DUN","Um Sprüche auszubreiten braucht man DUN, die Übersetzung lautet 'flächig'.");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("FHAN","FHAN ist eine Richtungsrune und kann mit bringen oder geben übersetzt werden.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("LUK","With LUK you can summon aggressive creatures. The translation is 'evil'.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LUK","Mit Hilfe von LUK kann man aggressive Kreaturen beschwören, ihre Übersetzung lautet 'Böses'.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");

    npcs.base.autonpcfunctions.AddTraderTrigger("LEV","The meaning of LEV is unknown, but can be translated with 'to alter'.");
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("LEV","Die Bedeutung von LEV ist unklar, kann aber mit 'verändern' übersetzt werden.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("BHONA","Dies ist die Lehrrune, die benötigt wird, um eine Rune von einen Magier auf einen anderen zu übertragen. BHONA zeichnet einen Lehrer aus.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ee]lementarrune","Die Elementarrunen stehen für die fünf Elemente. RA für Feuer, CUN für Wasser, SOLH für Erde, JUS für Luft und PEN für den Geist.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
	npcs.base.autonpcfunctions.AddTraderTrigger("[Ss]chule.*","Es gibt fünf Runenschulen die sich aus der Beobachtung ergeben, das man durch häufige Anwendung bestimmter Sprüche sich gleichzeitig in der Verwendung ähnlicher verbessert. Die Runenschulen heißen Commotio, Transfreto, Pervestigatio, Desicio und Transformo. Sagt mir von welcher ich euch mehr erzählen soll?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Cc]ommotio","Commotio bedeutet Zerstörung und umfasst die meisten Angriffszauber, wie beispielsweise den klassischen Feuerball. Auch die Bannsprüche zählen zu Commotio. Soll ich dir darüber mehr erzählen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",2);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Tt]ransfreto","Diese Runenschule bedeutet 'Umkehrung' und beschäftigt sich zum Beispiel mit dem Heil dem Umkehren von Gift in einem Wesen. Soll ich dir darüber mehr erzählen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",2);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Pp]ervestigatio","Pervestigatio lässt sich am besten mit 'Erschaffung' übersetzen. Neben den klassischen Heilzaubern zählen hier vor allen das erschaffen von Flammen und Erdwällen dazu. Soll ich dir darüber mehr erzählen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",2);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[Dd]esicio","Bei Desicio sprechen wir von Herbeirufung. Sie umfasst Sprüche bei der man Kreaturen zu sich ruft oder aber sich selbst zu einem anderen Ort ruft, wie die Eigenteleportation. Soll ich dir darüber mehr erzählen?");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",2);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
	...
	npcs.base.autonpcfunctions.AddTraderTrigger("[T]ransformo","Zu Transformo zählen vor allem Lähmungszauber, aber auch Sprüche bei denen man Dinge zu oder von sich bewegt. Die Schule kann ganz allgemein mit Bewegung übersetzt werden. Soll ich dir darüber mehr erzählen?");
	npcs.base.autonpcfunctions.AddCondition("lang","german");
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",2);
	npcs.base.autonpcfunctions.AddCondition("qpg","!=",3);
	npcs.base.autonpcfunctions.AddConsequence("qpg","=",1);
    ...
    npcs.base.autonpcfunctions.AddCondition("lang","english");
    npcs.base.autonpcfunctions.AddTraderTrigger("RA","RA ist die Rune des Feuers und eine Elementarrune. Sie kann für offensive Feuerzauber genutzt werden, sowie zum Entfachen und Auslöschen von Feuerflammen.");
    npcs.base.autonpcfunctions.AddCondition("lang","german");
	
     npcs.base.autonpcfunctions.AddCycleText("hmmmmm?","hmmmmm?");
     npcs.base.autonpcfunctions.AddCycleText("*räusper*?","*harrumph*");
	 npcs.base.autonpcfunctions.AddCycleText("KEL RI? KEL RE? KEL RA? *knall* aua!*?","KEL RI? KEL RE? KEL RA? *bang* aua!");
     npcs.base.autonpcfunctions.AddCycleText("#me murmelt \"SIM -SALA- BIM? Was ist das denn für eine alberne Runenfolge?\"","#me mumbles \"SIM -SALA - BIM? What  silly rune combination is that?\"");
     npcs.base.autonpcfunctions.AddCycleText("#me blättert eine Seite weiter?","#me pages a side forward"); 
