...
function initializeNpc()
    ...
    AddConsequence("inform","[Game Help] This NPC is Queen Rosaline Edwards of Cadomyr. Keyphrases: TRIGGERS.");
    AddTraderTrigger("Hilfe","");
    AddConsequence("inform","[Spielhilfe] Dieser NPC ist Königin Rosaline Edwards von Cadomyr. Schlüsselwörter: TRIGGERS.");
    -- General speech
