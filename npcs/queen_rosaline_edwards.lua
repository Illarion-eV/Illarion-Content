...
module("npcs.queen_rosaline_edwards")
...
function initializeNpc()
    ...
    npcs.base.autonpcfunctions.AddConsequence("inform","[Game Help] This NPC is Queen Rosaline Edwards of Cadomyr. Keyphrases: TRIGGERS.");
    npcs.base.autonpcfunctions.AddTraderTrigger("Hilfe","");
    npcs.base.autonpcfunctions.AddConsequence("inform","[Spielhilfe] Dieser NPC ist Königin Rosaline Edwards von Cadomyr. Schlüsselwörter: TRIGGERS.");
    -- General speech
