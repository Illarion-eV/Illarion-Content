-- INSERT INTO npc VALUES (nextval('npc_seq'),1,388,336,0,6,false,'Rilonna','npc_rilonna.lua',1);
--Location: Galmair
...
function init()
   ...
   --Pool 1(Baking easy items):
    ...
    AddItemToPool(1,myOrderNPC, 453,2,15, 1,20);--cookies
    AddItemToPool(1,myOrderNPC,  49,1,15, 1,20);--bread
    AddItemToPool(1,myOrderNPC,2456,2,15, 1,10);--mushroom soup
    AddItemToPool(1,myOrderNPC,2923,1,15, 1,15);--onion soup
    AddItemToPool(1,myOrderNPC,2278,1,15, 1,15);--cabbage stew
    AddItemToPool(1,myOrderNPC,3051,2,15, 1,15);--sausage
	--chances for qualities of pool 1
    myOrderNPC.orderPool:setQualityChancesForPool(1,{100,0,0,0,0,0,0,0,0,0});

   --Pool 2(Baking more easy items):
    AddItemToPool(2,myOrderNPC,2923,1,15, 1,15);--onion soup
    AddItemToPool(2,myOrderNPC,2278,1,15, 1,15);--cabbage stew
    AddItemToPool(2,myOrderNPC,3051,2,15, 1,15);--sausage
    AddItemToPool(2,myOrderNPC,2940,1,15, 1,15);--steak
    AddItemToPool(2,myOrderNPC,2459,2,15, 1,15);--fish filet
    AddItemToPool(2,myOrderNPC,2499,2,15, 1,15);--bottle with cider
    AddItemToPool(2,myOrderNPC,2497,2,15, 1,15);--bottle with mead
   ...
   --Pool 3(Baking middle hard items):
    AddItemToPool(3,myOrderNPC, 454,2,15, 1,10);--muffin
    AddItemToPool(3,myOrderNPC, 353,3,15, 1,10);--apple pie
    AddItemToPool(3,myOrderNPC,2276,2,10, 1,10);--mulligan
    AddItemToPool(3,myOrderNPC, 556,2,15, 1,10);--salmon dish
    AddItemToPool(3,myOrderNPC,2277,3,10, 1,10);--meat dish
    AddItemToPool(3,myOrderNPC,2501,3,10, 1,15);--bottle with beer
   ...
   --Pool 7(Baking difficult items):
	AddItemToPool(7,myOrderNPC, 303,3,15, 1,10);--cherry cake
	AddItemToPool(7,myOrderNPC, 354,4,15, 1,10);--strawberry cake
	AddItemToPool(7,myOrderNPC,2922,4,15, 1,10);--sausage dish
	AddItemToPool(7,myOrderNPC, 555,4,15, 1,10);--rabbit dish
	AddItemToPool(7,myOrderNPC, 559,4,15, 1,10);--lamb dish
	AddItemToPool(7,myOrderNPC, 557,4,15, 1,10);--steak dish
	AddItemToPool(7,myOrderNPC, 554,5,15, 1,10);--venison dish
	AddItemToPool(7,myOrderNPC,2500,4,15, 1,10);--bottle with wine

	myOrderNPC.orderPool:setQualityChancesForPool(7,{100,0,0,0,0,0,0,0,0,0});
	
	
	--chances for every pool
	myOrderNPC.orderPool.poolchances = {15,14,14,15,14,14,14};
