...
function initializeNpc()
   ...
   thisNPC:increaseSkill(1,"common language",100);
    ...
    npcs.base.trader_functions.AddTraderItem(8   ,2   ,500,0  ,500,{3}  ,{33}   ,0   ,0       ); -- flour
    npcs.base.trader_functions.AddTraderItem(4   ,259 ,500,0  ,500,{3}  ,{33}   ,0   ,0       ); -- grain
    npcs.base.trader_functions.AddTraderItem(5   ,291 ,500,0  ,500,{3}  ,{33}   ,0   ,0       ); -- cabbage seeds
    npcs.base.trader_functions.AddTraderItem(5   ,3   ,500,0  ,500,{3}  ,{33}   ,0   ,0       ); -- logs of conifer wood
    npcs.base.trader_functions.AddTraderItem(5   ,21  ,1000,1 ,500,{3}  ,{33}   ,0   ,0       ); -- coal
    npcs.base.trader_functions.AddTraderItem(5   ,2536,1000,1 ,500,{3}  ,{33}   ,0   ,0       ); -- copper ore
    npcs.base.trader_functions.AddTraderItem(5   ,22  ,1000,1 ,500,{3}  ,{33}   ,0   ,0       ); -- iron ore
    npcs.base.trader_functions.AddTraderItem(10  ,2717,1000,2 ,500,{3}  ,{33}   ,0   ,0       ); -- pins and cotters
    npcs.base.trader_functions.AddTraderItem(5   ,2738,1000,1 ,500,{3}  ,{33}   ,0   ,0       ); -- pins
    npcs.base.trader_functions.AddTraderItem(100 ,97  ,500 ,10,200,{5,6},{50,90},0   ,0       ); -- leather bag
    npcs.base.trader_functions.AddTraderItem(30  ,2763,500,5  ,200,{5,6},{50,90},0   ,0       ); -- pickaxe
    npcs.base.trader_functions.AddTraderItem(30  ,9   ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- saw
    npcs.base.trader_functions.AddTraderItem(30  ,74  ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- axe
    npcs.base.trader_functions.AddTraderItem(50  ,2715,500,5  ,200,{5,6},{50,90},0   ,0       ); -- plane
    npcs.base.trader_functions.AddTraderItem(50  ,2752,500,5  ,200,{5,6},{50,90},0   ,0       ); -- carving tools
    npcs.base.trader_functions.AddTraderItem(25  ,126 ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- sickle
    npcs.base.trader_functions.AddTraderItem(25  ,24  ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- shovel
    npcs.base.trader_functions.AddTraderItem(25  ,23  ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- hammer
    npcs.base.trader_functions.AddTraderItem(40  ,311 ,500,5  ,200,{5,6},{50,90},0   ,0       ); -- glass blow pipe
    ...
    npcs.base.functions.AddTraderTrigger("[Gg]rü[ßs]+e","Willkommen. Wie kann ich euch helfen?");
    npcs.base.functions.AddAdditionalTrigger("[Hh]allo");
    npcs.base.functions.AddAdditionalText("Guten Tag. Braucht ihr etwas?");
    npcs.base.functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","A trader I am, right. I trade very different wares.");
    npcs.base.functions.AddTraderTrigger("[IiDd][hu][r ].*[Hh]ändler","Ich bin ein Händer, richtig. Ich handle mit verschiedenen Waren.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+sell","I sell all kinds of wares for everyday useage.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe alle Arten von Waren für den täglichen Gebrauch.");
    npcs.base.functions.AddTraderTrigger("[Ww]hat.+[Ww]ares","Ressources, for example. Or different tools.");
    npcs.base.functions.AddTraderTrigger("[Ww]as.+[Ww]are","Rohstoffe zum Beispiel. Oder verschiedene Werkzeuge.");
    ...
    npcs.base.functions.AddTraderTrigger("[Ee]rzähl.+was","Es war einmal, da kam ich hier her. Jetzt bin ich da. Ist das nicht interessant?");
    ...
    npcs.base.functions.AddAdditionalTrigger("[Tt]schüs");
    npcs.base.functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    npcs.base.functions.AddAdditionalText("Schönen Tag noch.");
    ...
    npcs.base.functions.AddTraderTrigger("Ich bin .+","Erfreut euch kennen zu lernen.");
