...
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", "=<", 20));
talkEntry:addCondition(npc.base.condition.language.language("english"));
...
talkEntry:addTrigger("mission");
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", ">", 20));
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", "=<", 40));
talkEntry:addCondition(npc.base.condition.language.language("english"));
...
talkEntry:addTrigger("mission");
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", ">", 40));
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", "=<", 60));
talkEntry:addCondition(npc.base.condition.language.language("english"));
...
talkEntry:addTrigger("mission");
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", ">", 60));
talkEntry:addCondition(npc.base.condition.skill.skill(2, "cookingAndBaking", "=<", 80));
talkEntry:addCondition(npc.base.condition.language.language("english"));
