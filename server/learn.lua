            ...
            while minorIncrease > 0 do --for the rare case that an action results in two level ups, we have this loop.
                ...
                if minorSkill + realIncrease < 10000 then
                    ...
                    if user:getType() == 0 and user:getQuestProgress(154) == 0 and user:getQuestProgress(325) == 1 then --Only players get an inform once.
                        ...
                        "Deine Fertigkeit '"..skillstring.."' hat sich soeben erhöht. Drücke 'C' um deine \z
                        Fertigkeiten anzeigen zu lassen. Das Fähigkeitensystem Illarions basiert auf \z
                        'Learning by doing'. Dein Charakter wird also besser in dem, was er tut. Dein Charakter \z
                        kann mit der Zeit von einem Anfänger im Handwerk zu einem Meister werden, wodurch er dann \z
                        eine größere Vielfalt von Gegenständen besserer Qualität herstellen kann.\n\nJe mehr \z
                        Handlungen du pro Zeit ausführst desto weniger lernst du von jeder Handlung. Unter dem \z
                        Strich lernt aber jeder Charakter gleich viel über die Zeit. Du kannst also so viel Zeit in \z
                        Rollenspiel oder Training stecken wie du möchtest, ohne dass eine Art Illarion zu spielen \z
                        bevorzugt wird.",
