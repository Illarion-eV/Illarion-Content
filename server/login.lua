...
function onLogin( player )
	...
	if (player.pos.z == 100) or (player.pos.z == 101) then --On Noobia	
		...
		if player:getPlayerLanguage() == 0 then		
			dialogNewbie = MessageDialog("Willkommen bei Illarion!", "Eine lange Reise nähert sich ihrem Ende. Du gehst von Bord des Schiffes, welches dich zu den letzten sicheren Bastionen der Menscheit Illarions gebracht hat. Das edle Cadomyr, das weise Runewick oder das reiche Galmair - welchen Weg wirst du einschlagen? \n Willkommen bei Illarion, dem kostenlosen Online-Rollenspiel. Dieses Tutorial wird dich auf deinen ersten Schritten begleiten und dir die Bedienung des Spiels beibringen. Du kannst das Tutorial jederzeit überspringen indem du 'Tutorial überspringen' zu einem NPC sagst.", callbackNewbie);
		else		
			dialogNewbie = MessageDialog("Welcome to Illarion!", "A long journey comes to an end. You disembark the ship that brought you to Illarion's last save strongholds of mankind. Noble Cadomyr, wise Runewick or wealthy Galmair - which way will you chose? \n Welcome to Illarion, the free online roleplaying game. This tutorial will guide you through your first steps and teach you the controls of the game. You may skip the tutorial at any time by saying 'skip tutorial' to a NPC.", callbackNewbie);
		end	
