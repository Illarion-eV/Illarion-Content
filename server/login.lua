	...
	if (player.pos.z == 100) or (player.pos.z == 101) then --On Noobia
		...
		if  player:isInRangeToPosition(position(31,22,100),7) then --only show the dialog if the char is close to the noob spawn
		    ...
		    if player:getPlayerLanguage() == 0 then
			    ...
			    dialogNewbie = MessageDialog("Welcome to Illarion!", "The long, tiresome journey finally comes to an end. You disembark the ship and feel solid ground beneath your feet for the first time in weeks. It is never an easy decision to make the voyage here. And yet, you will soon be faced with another choice, perhaps even more important than the last. The noble soldiers of Cadomyr, the wise scholars of Runewick, or the wealthy merchants of Galmair - whose side shall you join? Welcome to Illarion, the free online roleplaying game. This tutorial will guide you through your first steps and teach you the controls of the game. You may skip the tutorial at any time by saying 'skip tutorial' to an NPC.", callbackNewbie);
		    end
