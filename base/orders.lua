        ...
        if ( string.find(text,ttext) ) then
            ...
            if ( number ~= nil ) then
                if ( number <= 0 or number > table.getn(self.openOrders) ) then
                    base.common.TalkNLS(self.npc,Character.say,"Ich habe nur "..table.getn(self.openOrders).." Auftr�ge!","I only have "..table.getn(self.openOrders).." orders!");
                else
            ...
            if ( number ~= nil ) then
                if ( number <= 0 or number > ordercount ) then
                    ...
                    elseif (ordercount == 1 ) then
                        ...
                        base.common.TalkNLS(self.npc, Character.say,"Ich habe nur "..ordercount.." Auftr�ge!","I only have "..ordercount.." orders!");
                    end
                else
                    local order = self.openOrders[number];
                    order:setTime();
                ...
                elseif (ordercount == 1 ) then
                    ...
                    base.common.TalkNLS(self.npc, Character.say,"Welchen der "..table.getn(self.openOrders).." Auftr�ge m�chtest du sehen?","Which one of the "..table.getn(self.openOrders).." orders do you want to see?");
                end
            end
            return;
        end
