...
function unsocketGems(user)
        ...
        if success then
            ...
            if isSocketable(item.id) and itemHasGems(item) then
                if money.CharHasMoney(user, price) then
                    ...
                    user:inform("Alle Edelsteine wurden aus dem Gegenstand entfernt und dir zurÃ¼ckgegeben für den Preis von " .. gstring ..".",
    ...
    local description = common.GetNLS(user, "Bitte wähle einen Gegenstand der entsockelt werden soll. Kosten sind abhÃ¤ngig vom Wert des Gegenstands",
