...
--ferryEN[2]={"Cadomyr Harbour (one way ticket)","Farmer Island (return journey included)","Cadomyr - Lost Harbour (return journey included)","Lighthouse (no return possible)","Lonely Islands (return journey included)","Eastland Harbour (one way ticket)","Northern Harbour (one way ticket)"} --for the future with farmer island & lonely islands
ferryDE[2]={"Cadomyr Hafen (Einwegticket)","Cadomyr - Verlorener Hafen (inklusive Rück- oder Weiterfahrt)","Leuchtturm (keine Rück- oder Weiterfahrt möglich)","Ostland Hafen (Einwegticket)","Nördlicher Hafen (Einwegticket)"}  ---replace this with the one above
ferryEN[2]={"Cadomyr Harbour (one way ticket)","Cadomyr - Lost Harbour (return journey included)","Lighthouse (no return possible)","Eastland Harbour (one way ticket)","Northern Harbour (one way ticket)"}  ---replace this with the one above
