...
for gem=1,7 do
    ...
    if catId then
        for level=2,10 do
            ...
            product = gemCraft:addProduct(catId, gems.gemItemId[gem], 0, 0, duration, duration*2, 1, {gemLevel = level})
