...
M.blueprints = {
    ...
    level = getLevel(Item.cupriteIngot), item = Item.cupriteIngot, treasure = {"small", "average", "big", "giant"}, rareness = 4,
    ingredients = {
    ...
    level = getLevel(Item.duskcloth), item = Item.duskcloth, treasure = {"small", "average", "big", "giant"}, rareness = 3,
    ingredients = {
