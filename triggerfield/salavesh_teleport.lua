...
function M.MoveToField( User )
    ...
    if User.pos == position(731, 441, -3) then --To the dragon chamber
        common.InformNLS(User, "Du trittst durch das Portal. Eine wohlmöglich schlechte Idee!", "You step through the portal. A bad idea!")
    ...
    elseif User.pos == position(689, 388, -3) then --to the big hall
        common.InformNLS(User, "Das Portal trägt dich fort an einen Ort, der nicht gerade deine erste Wahl ist...", "The portal takes you to a place that wouldn't be your first choice...")
        world:gfx(41, User.pos)
        world:makeSound(13, User.pos)
