...
function M.PutItemOnField(Item,User)
    ...
    if success == false then
        myNPC:talk(Character.say, "Dafür werde ich euch nichts lehren. Schaut auf meine Liste und zeigt mir, was euch interessiert und ich saga euch, was ich dafür verlange.", "I won't teach you anything for this. Have a look at my list, show me what you would like to learn and I will tell you what you have to give me in return.")

    else
        local ListEffectId = id_3109_open_pell.ListEffectId[town]
        if User:getQuestProgress(ListEffectId[myListPos]+1000) ~= 0 then
            myNPC:talk(Character.say, "Mhh. Ich würda euch wohl dafür etwas zeigen, aber ihr macht den Eindruck, diese Kenntnisse schon zu haben.", "Hmm. Well, I would teach you something for this, but you seem to already have this knowledge.")
        else
