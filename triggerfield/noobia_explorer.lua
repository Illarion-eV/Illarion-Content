...
function M.MoveToField(Character)
    ...
    if find then --Is this even a noob?
        local value = Character:getQuestProgress(320)
        if (value == 0) then --Didn't visit the triggerfield yet
            ...
            local dialogText = common.GetNLS(Character,
                "Auf das gesamte Spiel verteilt, kannst du Markierungssteine finden. Wenn du diese Steine doppelt anklickst und somit sammelst, bekommst du Punkte. Wenn du eine bestimmte Anzahl von Punkten gesammelt hast, bekommst du eine Belohnung.\n\n Versuche es einmal und klicke doppelt auf den Markierungsstein.",
                "Throughout the game you can find marker stones. If you double click a stone, and therefore collect it, you will get points for it. When you collect a specific number of stones you will get a reward.\n\n Try it now and double click the marker stone.")
