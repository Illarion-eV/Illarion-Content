...
local messageG = {}
messageG[1] = "[Queststatus] Du hörst aus den Tiefen den Klang der Spitzhacken, welche auf Steine treffen."
...
messageG[4] = "[Queststatus] Raspelnden Stimmen und klappernde Knochen warnen dich vor bevorstehendem Unheil."
local messageE = {}
