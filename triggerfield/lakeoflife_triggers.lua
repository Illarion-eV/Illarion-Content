...
function M.MoveToField( User )
    ...
    if User.pos == position(641, 266, -9) then -- inform
        ...
        elseif math.random(1, 4) == 1 and User.pos == position(666, 235, -9) then -- inform
            common.InformNLS(User,"In der Nähe hörst du etwas laut etwas ins Wasser rutschen.","You hear something loud slip under the water nearby.")
            world:makeSound(9, User.pos)
        ...
        elseif User.pos == position(721, 244, -9) or User.pos == position(721, 243, -9) or User.pos == position(720, 243, -9)  then -- bridge inform
            common.InformNLS(User,"Am anderen Ufer der unvollständigen Brücke siehst du einen Hebel. Vielleicht gibt es auf dieser Seite auch einen.", "Across the water from the partial bridge you see a lever, maybe there is one somewhere on this side as well.")
    end
