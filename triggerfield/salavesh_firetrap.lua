...
function M.MoveToField(User)
    ...
    common.InformNLS(User, "Ein Feuerball schießt aus einem kleinen Loch in der Wand die Halle entlang!", "A fireball is shot from a small hole in the wall down the hallway!")
    ...
    for i = 399, 415 do --replace with proper coordinates
        if world:isCharacterOnField(position(xcord,i,-3)) then --there is someone!
            local target = world:getCharacterOnField(position(xcord, i, -3)) --and who is it?
