...
function M.MoveToField(User)
    ...
    common.InformNLS(User, "Ein Feuerball schießt aus einem kleinen Loch in der Wand die Halle entlang!", "A firewall is shot from a small hole in the wall down the hallway!")
