	...
	if find then --Is this even a noob?
	    ...
	    if (value == 0) then --Didn't visit the triggerfield yet
	        ...
	        if Character:getPlayerLanguage() == 0 then
		        ...
		        dialogNewbie = MessageDialog("Tutorial", "This is the final station of the tutorial. Please chose a realm now by stepping through a portal on one of the islands. Viola Baywillow will answer your questions on the available realms, just ask her for 'help'.", callbackNewbie)
	        end	
