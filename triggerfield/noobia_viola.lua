	...
	if find then --Is this even a noob?
	    ...
	    if (value == 0) then --Didn't visit the triggerfield yet
	        ...
	        if Character:getPlayerLanguage() == 0 then
		        dialogNewbie = MessageDialog("Tutorial","Dies ist nun die letzte Station des Tutorials. Wähle ein Reich aus, welchem dein Charakter zukünftig angehören wird - Cadomyr, Galmair oder Runewick? Gehe hierzu durch eines der Portale auf den kleinen Inseln. Du kannst diese Entscheidung später im Spiel jederzeit revidieren. Viola Baywillow kann dir einiges über die drei Reiche erzählen, frage sie einfach nach 'Hilfe'.\n\nUnd nebenbei - hast du den Markierungsstein gesehen?", callbackNewbie)
	        else	
		        dialogNewbie = MessageDialog("Tutorial", "This is the final station of the tutorial. Please choose which realm you desire to be the home for your character by stepping through the corresponding portal on the three islands - Cadomyr, Galmair or Runewick? You can reconsider this decision at any time once you have joined the game. Viola Baywillow will provide you with more information on the three available realms, just ask her for 'help'.\n\nBy the way - did you notice the marker stone?", callbackNewbie)
	        end	
