...
mtLetmaList.add( position(233,812,0),nil,"Tiefe Krater liegen auf dem Weg vor dir. Etwas riesiges, schweres wandert darin herum.","Large craters are in the path ahead. Something large and heavy has been walking in here.",nil,nil,50); 
...
mtLetmaList.add( position(234,794,-6),nil,"Eine Stimme wir, wie ein Echo von der Wand zurückgeworfen: 'Ich sehe Dich.'","A voice echoes off the walls, 'I see you.'",nil,nil,40); 
