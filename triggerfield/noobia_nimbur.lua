    ...
    if find then --Is this even a noob?
        ...
        if (value == 0) then --Didn't visit the triggerfield yet
            ...
            local dialogText = common.GetNLS(Character,
                "An dieser Station wird dir beigebracht, wie man einem Handwerk nachgeht. Nimbur Goldhand ist ein sehr begabter Artisan, der die nötigen Kenntnisse vermittelt, die du benötigst, um die Laufbahn des Handwerkers einzuschlagen.\n\nHandwerke erfordern ebenso wie das Sammeln von Ressourcen ein Handwerkzeug und einen Arbeitsplatz sowie die nötigen Rohstoffe. Massenproduktion wird dir nicht dabei helfen, ein Handwerk zu meistern, denn du wirst immer weniger lernen, je mehr Handlungen du ohne Rast durchführst.",
                "At this station, you will learn how to craft items. Nimbur Goldhand is a very skilled artisan who can teach you the necessary steps to get started with a crafting profession.\n\nCrafting requires a hand tool, just like gathering, and a static tool. You also need the necessary resources. You don't need mass production to master a craft as you will learn less and less the more actions you do over time.")
