...
-- INSERT INTO triggerfields VALUES (625, 616, -3,'triggerfield.dragon_cave_triggers');
-- INSERT INTO triggerfields VALUES (725, 638, -3,'triggerfield.dragon_cave_triggers');
-- INSERT INTO triggerfields VALUES (728, 697, -3,'triggerfield.dragon_cave_triggers');
-- INSERT INTO triggerfields VALUES (709, 649, -3,'triggerfield.dragon_cave_triggers');
	...
	if User:getType() ~= Character.player then
     ...
     local theFiretrigger
        ...
        elseif Random.uniform(1, 3) == 1 and theWaypoint>= 5 and theWaypoint <= 8 then -- trigger fire
			...
			world:makeSound(5, position(699, 655, -6)) --a flame
        ...
        elseif Random.uniform(1, 4) == 1 and User.pos == position(739, 640, -3) then -- vision
		    ...
		    world:makeSound(9, position(739, 642, -3))
			
	    elseif Random.uniform(1, 4) == 1 and User.pos == position(625, 616, -3) then -- vision		
			...
			world:makeSound(9, position(723, 618, -3))
