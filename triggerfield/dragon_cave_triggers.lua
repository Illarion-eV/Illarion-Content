...
function M.MoveToField(User)
    ...
    if math.random(1, 3) == 1 and theFiretrigger >= 1 and theFiretrigger <=  4 then  -- trigger fire
        common.InformNLS(User,
            "Flammen schießen neben dir in die Höhe. Die Hitze wird fast unerträglich.",
    ...
    elseif math.random(1, 3) == 1 and theFiretrigger >= 5 and theFiretrigger <= 8 then -- trigger fire
        common.InformNLS(User,
            "Ein riesiges Feuer explodiert in der Nähe. Funken und Feuerbälle prasseln hernieder.",
    ...
    elseif math.random(1, 4) == 1 and User.pos == position(739, 640, -3) then -- vision
        common.InformNLS(User,
            "Dir erscheint die Vision eines Bergtrolls, der einen prallen kleinen Halbling über einem lodernden Feuer brät.",
    ...
    elseif math.random(1, 4) == 1 and User.pos == position(725, 616, -3) then -- vision
        common.InformNLS(User,
            "Dir erscheint die Vision von zwei Drachen im Kampf miteinander, die große Verwüstung an den Ländereien ringsherum anrichten.",
    ...
    elseif math.random(1, 4) == 1 and User.pos == position(725, 638, -3) then -- vision
        common.InformNLS(User,
    ...
    elseif math.random(1, 4) == 1 and User.pos == position(728, 627, -3) then -- vision
        common.InformNLS(User,
    ...
    elseif User:getQuestProgress(510) == 18 and User.pos == position(731, 616, -3) then -- vision for quest
        common.InformNLS(User,
            "Dir erscheint die Vision eines Zwerges, der von einem Drachen angegriffen wird. Der Zwerg ist in Flammen eingehüllt, ehe er von den Krallen des Drachens vom Boden gepflückt wird. Gehen Sie zurück und sagen, Obsidimine.",
    ...
    elseif math.random(1, 4) == 1 and User.pos == position(731, 616, -3) then -- vision
        common.InformNLS(User,
            "Dir erscheint die Vision eines Zwerges, der von einem Drachen angegriffen wird. Der Zwerg ist in Flammen eingehüllt, ehe er von den Krallen des Drachens vom Boden gepflückt wird.",
        ...
        world:gfx(5, position(728, 616, -3))
        world:makeSound(13, position(728, 616, -3))
    elseif math.random(1, 4) == 1 and User.pos == position(850, 666, 1) or User.pos == position(850, 665, 1) then -- Inform
        common.InformNLS(User,
            "Der Anblick da vorne, mit dem kleinen Becken und dem Sandhügel, ist seltsam. Irgendwie scheinen sie miteinander verbunden, voneinander abhängig.",
