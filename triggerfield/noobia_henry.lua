	...
	if find then --Is this even a noob?
	    ...
	    if (value == 0) then --Didn't visit the triggerfield yet
	        ...
	        if Character:getPlayerLanguage() == 0 then
		        ...
		        dialogNewbie = MessageDialog("Tutorial", "In order to speak to the human, activate the chat box with the return key, type the word you wish to say and then hit return again. All non-player characters (NPCs) react on certain keywords if you stand directly beside them. If you ever get stuck trying while trying to communicate with an NPC, typing 'help' will provide you with a list of recommended commands.", callbackNewbie)
	        end	
