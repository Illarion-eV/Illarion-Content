...
function M.MoveToField(Character)
    ...
    elseif Character.pos == position(56,96,100) and find then --Cadomyr for new player
        ...
        dialogNewbieTaskText = common.GetNLS(Character,
            "Als Neuling hat man es nicht leicht. Man kennt die Gegend und die Leute nicht; und die Leute kennen dich nicht. Dein erstes Ziel sollte es sein, die Stadt Cadomyr zu erkunden und andere Charaktere zu finden. Interessante Orte sind auf deiner Karte mit einem orangenem Symbol gekennzeichnet. Dein Questlog (Q) enthält weitere Informationen. Einige NPCs vergeben auch Quests, diese erkennst du an einem '?' über ihrem Kopf.",
            "Being new in town isn't easy. You don't know the area or the people, and neither do they know you. Your first objective will be to explore the city of Cadomyr and to find other characters. Interesting places are marked on your map with an orange symbol. For further information, see your quest log (Q). Some NPCs issue quests, those have a '?' above their head.")
