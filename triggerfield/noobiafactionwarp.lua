...
function M.MoveToField(Character)
    ...
    elseif Character.pos == position(20,99,100) and find then --Runewick for new player
        ...
        dialogNewbieTaskText = common.GetNLS(Character,
            "Als Neuling hat man es nicht leicht. Man kennt die Gegend und die Leute nicht; und die Leute kennen dich nicht. Dein erstes Ziel sollte es sein, die Stadt Runewick zu erkunden und andere Spieler zu finden. Interessante Orte sind auf deiner Karte mit einem rotem Symbol gekennzeichnet. Dein Questlog (Q) enthält weitere Informationen. Einige NPCs vergeben auch Quests, diese erkennst du an einem '!' über ihrem Kopf.",
            "Being new in town isn't easy. You don't know the area or the people, and neither do they know you. Your first objective will be to explore the city of Runewick and to find other players. Interesting places are marked on your map with a red symbol. For further information, see your quest log (Q). Some NPCs issue quests, those have a '!' above their head.")
    ...
    elseif Character.pos == position(40,111,100) and find then --Galmair for new player
        ...
        dialogNewbieTaskText = common.GetNLS(Character,
            "Als Neuling hat man es nicht leicht. Man kennt die Gegend und die Leute nicht; und die Leute kennen dich nicht. Dein erstes Ziel sollte es sein, die Stadt Galmair zu erkunden und andere Spieler zu finden. Interessante Orte sind auf deiner Karte mit einem rotem Symbol gekennzeichnet. Dein Questlog (Q) enthält weitere Informationen. Einige NPCs vergeben auch Quests, diese erkennst du an einem '!' über ihrem Kopf.",
            "Being new in town isn't easy. You don't know the area or the people, and neither do they know you. Your first objective will be to explore the city of Galmair and to find other players. Interesting places are marked on your map with a red symbol. For further information, see your quest log (Q). Some NPCs issue quests, those have a '!' above their head.")
