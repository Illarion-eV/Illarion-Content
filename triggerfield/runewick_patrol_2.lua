...
local messageG = {}
messageG[1] = "[Queststatus] Sanft schlagen die Wellen an die Pfeiler der Lunord Brücke. Einige Bauern bringen Feldfrüchte von Eibental."
messageG[2] = "[Queststatus] Die Boote schaukeln im Hafen, ansonsten ist der Hafen ruhig."
messageG[3] = "[Queststatus] Die glückliche Lichtung bietet sich das Bild eines friedlichen Bauernhofes, Hühner gacker, ein Schwein grunzt wohlig."
