...
function M.MoveToField(char)
    ...
    if char:getQuestProgress(612) == 2 and math.random(0, 99) < 10 then -- riddle has been solved yet; the voice one more time; chance be warped
        if char.pos == position(890, 596, 0) or char.pos == position(876, 590, 0) or char.pos == position(878, 562, 0) then
            ...
            char:inform("Du hörst eine krächzende Stimme ängstlich schreien: \"Nein! Nicht schon wieder du. Geh weg und lass mich in Ruhe!\" Danach kehrt Stille ein.",
                        "You hear a croaking voice crying scared: \"No! Not you again. Leave me alone!\" Afterwards there is silence.")
    ...
    if char:getQuestProgress(612) < 2 then -- riddle hasn't been solved yet
        ...
        if char.pos == position(884, 594, 0) or char.pos == position(884, 593, 0) or char.pos == position(884, 595, 0) then
            ...
            char:inform("Du vernimmst noch ein langezogenes 'Nein'. Danach kehrt Stille ein. Du bist wieder frei.",
                        "You hear a dying 'No'. Afterwards there is silence. You are free again.")
        ...
        elseif char.pos == position(886, 584, 0) or char.pos == position(886, 583, 0) or char.pos == position(886, 585, 0) then
            ...
            world:gfx(37, char.pos)
            world:makeSound(13, char.pos)
            char:inform("Die krächzende Stimme brüllt: \"Verdammt! Nun gut, du darfst über die Brücke gehen.\" Worauf die eine Stimme aus dem Norden ruft: \"Nicht zur Brücke. In der Pinie! In der Pinie!\"",
                        "The jagged voice bellows: \"Blimey! Well, you are allowed to pass the bridge.\". A voice from the north shouts: \"Don't go to the bridge. Into the pine tree! Into the pine tree!\"")
            return
        ...
        elseif char.pos == position(890, 560, 0) or char.pos == position(889, 560, 0) or char.pos == position(891, 560, 0) then
            ...
            world:gfx(37, char.pos)
            world:makeSound(13, char.pos)
            char:inform("Die krächzende Stimme bellt: \"Narr!\" Worauf eine Stimme aus dem Osten ruft: \"Zum Meer! Zu Mir!\"",
                        "The jagged voice barks: \"Fool!\". A voice from the east shouts: \"To the sea! Come to me!\"")
            return
        ...
        elseif char.pos == position(885, 573, 0) or char.pos == position(884, 573, 0) or char.pos == position(886, 573, 0) then
            ...
            world:gfx(37, char.pos)
            world:makeSound(13, char.pos)
            char:inform("Die krächzende Stimme ruft: \"Vergeblich!\" Worauf eine Stimme aus dem Süden flüstert: \"Zu mir!\"",
                        "The jagged voice says: \"Futile!\". A voice from the south whispers: \"To me!\"")
            return
        ...
        elseif char.pos == position(906, 573, 0) or char.pos == position(905, 573, 0) or char.pos == position(906, 574, 0) then
            ...
            world:gfx(37, char.pos)
            world:makeSound(13, char.pos)
            char:inform("Die krächzende Stimme schreit: \"Gib auf! Du bist mein!\" Worauf eine Stimme aus dem Norden antwortet: \"Komm zu mir!\"",
                        "The scratchy voice shouts: \"Surrender! You are mine!\". A voice from the north answers: \"Come to me!\"")
            return
        ...
        elseif char.pos == position(901, 581, 0) or char.pos == position(900, 581, 0) or char.pos == position(901, 580, 0) then
            ...
            world:gfx(37, char.pos)
            world:makeSound(13, char.pos)
            char:inform("Die krächzende Stimme meldet sich wieder: \"Keine Chance!\" Worauf eine Stimme aus dem Südwesten sagt: \"Lauf weg!\"",
                        "The jagged voice says: \"No Chance!\". A voice from the southwest replies: \"Run away!\"")
            return
        ...
        elseif char.pos == position(890, 596, 0) or char.pos == position(876, 590, 0) or char.pos == position(878, 562, 0) then
            ...
            char:inform("Du hörst ein Lachen und eine krächzende Stimme sagen: \"HAHA! Du gehörst nun mir!\" Nach einer Weile hörst du eine andere Stimme aus dem Nordwesten: \"Geh weg von mir!\"",
                        "You hear laughter and a croaking voice, saying: \"HAHA! You are mine now!\" After a while you hear another voice from the northwest: \"Get away from me!\"")
            return
