...
Akaltuts_chamberList:add( position(436,855,-9),nil,"Unten kannst du große Höllenhunde sehen, die Fleisch von Knochen reißen. Gehe vorsichtig weiter!","Down below, you can see large hellhounds, tearing flesh from bones. Proceed with caution!",nil,nil,100); --Akaltuts_Chamber_-9
Akaltuts_chamberList:add( position(435,855,-9),nil,"Unten kannst du große Höllenhunde sehen, die Fleisch von Knochen reißen. Gehe vorsichtig weiter!","Down below, you can see large hellhounds, tearing flesh from bones. Proceed with caution!",nil,nil,100); --Akaltuts_Chamber_-9
