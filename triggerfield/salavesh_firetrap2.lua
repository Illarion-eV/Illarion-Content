...
function MoveToField(User)
	...
	if User:getType() ~= Character.player then
		...
		common.InformNLS(User,"Ein Feuerball schießt aus einem kleinen Loch in der Wand die Halle entlang!","A firewall is shot from a small hole in the wall down the hallway!"); --sending a message
