...
if (MonID==531) then --Walking Dead, Level: 5, Armourtype: heavy, Weapontype: puncture
        ...
        if not done then done=monster.base.drop.AddDropItem(505,1,1,(100*math.random(4,5)+math.random(44,55)),0,1); end --treasure map
    ...
    elseif (MonID==533) then --Zombie, Level: 6, Armourtype: light, Weapontype: slashing
        ...
        if not done then done=monster.base.drop.AddDropItem(505,1,1,(100*math.random(5,6)+math.random(55,66)),0,1); end --treasure map
