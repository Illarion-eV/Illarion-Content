...
if (MonID==331) then --Silvergolem, Level: 6, Armourtype: medium, Weapontype: puncture
        ...
        local done=drop.AddDropItem(1062,1,20,(100*math.random(5,6)+math.random(55,66)),0,3); --silver ore
        if not done then done=drop.AddDropItem(733,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --stone block
        ...
        if not done then done=drop.AddDropItem(22,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --iron ore
