...
base.messages.msgs:addMessage("#me atmet laut ein und aus.", "#me takes deep breaths.");
base.messages.msgs:addMessage("#me ist mit Wunden übersäht", "#me is littered with wounds.");
base.messages.msgs:addMessage("#me macht ächzende Geräusche.", "#me makes groaning noises.");
base.messages.msgs:addMessage("#me spuckt etwas Blut auf den Boden.", "#me spits out some blood.");
base.messages.msgs:addMessage("#me starrt ins Leere.", "#me stares into oblivion.");
base.messages.msgs:addMessage("#me stöhnt unter Schmerzen.", "#me moans with pain.");
base.messages.msgs:addMessage("#me torkelt.", "#me staggers.");
base.messages.msgs:addMessage("#me wackelt etwas unsicher.", "#me is a bit unsteady on its feet.");
base.messages.msgs:addMessage("Hiiirne!", "Braaains!");
base.messages.msgs:addMessage("Komm... zu... uns...", "Join... us...");
base.messages.msgs:addMessage("#me fährt sich mit einer klauenhaften Hand murmelnd über den pilzbefallenen Kopf, ehe er ein schlürfendes Geräusch von sich gibt.", "#me runs with claw-like hands over its fungus-stricken head as it makes a shuffling noise.");
...
base.messages.msgs:addMessage("#me tropft dicklicher Speichel aus dem Mundwinkel und seine milchigen Augen starren trübsinnig drein, während ihm unverständliche Worte entfläuchen.", "#me drops syrupy saliva from its mouth and its eyes stare gloomily as it speaks unintelligible words.");
