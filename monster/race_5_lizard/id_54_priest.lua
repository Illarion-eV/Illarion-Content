...
magic.addHealing{probability = 0.05, damage = {from = 1000, to = 1700}}
magic.addHealing{probability = 0.03, damage = {from =  500, to = 850}, targetCount = 3}

magic.addHealing{probability = 0.005, damage = {from = 1200, to = 1700}}
magic.addHealing{probability = 0.002, damage = {from = 650, to = 850}, targetCount = 5}
