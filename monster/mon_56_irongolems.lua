...
if (MonID==561) then -- Iron Golem, Level: 6, Armourtype: medium, Weapontype: concussion
        ...
        local done=drop.AddDropItem(22,1,20,(100*math.random(5,6)+math.random(55,66)),0,3); --iron ore
        if not done then done=drop.AddDropItem(735,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --raw stone
        if not done then done=drop.AddDropItem(234,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --gold nugget
        if not done then done=drop.AddDropItem(2534,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --merinium ore
        if not done then done=drop.AddDropItem(2536,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --copper ore
    ...
    elseif (MonID==562) then --Steelgolem, Level: 7, Armourtype: medium, Weapontype: slashing
        ...
        local done=drop.AddDropItem(316,1,20,(100*math.random(6,7)+math.random(66,77)),0,3); --quartz sand
        ...
        if not done then done=drop.AddDropItem(1266,20,1,(100*math.random(6,7)+math.random(66,77)),0,3); end --stone
