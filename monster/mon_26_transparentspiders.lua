...
module("monster.mon_26_transparentpiders", package.seeall)
...
function onDeath(Monster)
   ...
   if (MonID==261) then --Kingsfright, Level: 7, Armourtype: heavy, Weapontype: distance
        ...
        local done=monster.base.drop.AddDropItem(254,1,20,(100*math.random(5,6)+math.random(55,66)),0,1); --raw diamond
    ...
    elseif (MonID==262) then --Shadowmuncher: 8, Armourtype: medium, Weapontype: wrestling
        ...
        local done=monster.base.drop.AddDropItem(277,1,20,(100*math.random(4,5)+math.random(44,55)),0,2); --amethyst ring
        if not done then done=monster.base.drop.AddDropItem(280,1,10,(100*math.random(4,5)+math.random(44,55)),0,2); end --diamond ring
        ...
        if not done then done=monster.base.drop.AddDropItem(68,1,1,(100*math.random(4,5)+math.random(44,55)),0,2); end --ruby ring
        if not done then done=monster.base.drop.AddDropItem(45,1,1,(100*math.random(4,5)+math.random(44,55)),1,2); end --magic emerald

        --Category 3: Cutted gems + rings

        local done=monster.base.drop.AddDropItem(283,1,20,(100*math.random(4,5)+math.random(44,55)),0,3); --blackstone
        ...
        if not done then done=monster.base.drop.AddDropItem(284,1,1,(100*math.random(4,5)+math.random(44,55)),0,3); end --bluestone
