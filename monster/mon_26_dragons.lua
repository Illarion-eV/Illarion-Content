...
base.messages.msgs:addMessage("#me bringt den Boden mit donnernder Wut zum Beben als er sich mit geschmeidiger Eleganz bewegt.", "#me shakes the ground with thunderous rage as it manoeuvres in its intuitive grace.");
base.messages.msgs:addMessage("#me gräbt die Krallen seiner Hinterläufe fest in den Boden während er die Luft mit einer seiner Vordertatzen bösartig zerteilt.", "#me firmly plants the jagged talons of its back legs into the ground as it maliciously swipes the air with one of its front claws.");
base.messages.msgs:addMessage("#me peitscht mit seinem verhornten Schwanz rigoros auf den Boden, diesen mit nachhallenden Erschütterungen böse zurichtend.", "#me savagely lashes its horned tail as it batters the ground with reverberating tremors.");
base.messages.msgs:addMessage("#me schwenkt seinen Kopf rasend vor und zurück, bevor er erfüllt von Bragons Zorn ein markerschütterndes Gebrüll ausstößt.", "#me swivels its head to and fro maniacally before erupting into a blood-curdling roar of Brägon's wrath.");
base.messages.msgs:addMessage("#me streckt seine echsenhaften Flügel aus um sich bei jedem Flügelschlag mit unerbittlichen Winböen in unzähmbarer Herrlichkeit aufzubäumen.", "#me expands its wings revealing its glorious majesty with vicious and unrelenting gales of wind sent forth by each flap.");
base.messages.msgs:addMessage("#mes kühne Augen glimmen mit unnachahmbarer Intensität während er den kleinsten Bewegungen und Geräuschen nachgeht.", "#me's keen eyes smoulder with an unparalleled intensity as it perceives the slightest movements or sounds.");
...
base.messages.msgs:addMessage("#mes ungestümes Brüllen füllt die Luft einem Wirbel von heißen Blasen gleich und in seinem Maul beginnt ein feuriger Wirbelwind zu tosen.", "#me's obstreperous roar fills the air in a blistering pother of heat as a fiery inferno comes to life in its mouth.");
base.messages.msgs:addMessage("#mes Erregung schwillt einer aufbrausenden Welle gleich an während er Kopf und Körper verdreht, um in eine defensive Haltung zu kommen.", "#me's agitation swells like a rising tide as it pivots its neck and torso assuming a defensive posture.");
base.messages.msgs:addMessage("#mes glühende Augen funkeln mit tödlicher Gewissheit während er vor unbezwingbarer Wut schäumt.", "#me's searing eyes glare with baneful intent as its insurmountable rage seethes.");
