...
if (MonID==1041) then --Wandering Garbage, Level: 2, Armourtype: light, Weapontype: concussion
        ...
        if not done then done=drop.AddDropItem(253,1,10,(100*math.random(1,2)+math.random(11,22)),0,3); end --raw sapphire
    ...
    elseif (MonID==1043) then --Corpsebile, Level: 4, Armourtype: light, Weapontype: slashing
        ...
        local done=drop.AddDropItem(355,1,20,(100*math.random(3,4)+math.random(33,44)),0,3); --salmon
        if not done then done=drop.AddDropItem(256,1,10,(100*math.random(3,4)+math.random(33,44)),0,3); end --raw emerald
        if not done then done=drop.AddDropItem(22,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --iron ore
        if not done then done=drop.AddDropItem(183,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --round metal shield
        if not done then done=drop.AddDropItem(56,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --bough
