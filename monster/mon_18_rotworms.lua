...
function onDeath(Monster)
    ...
    if (MonID==181) then --Rotworm, Level: 7, Armourtype: -, Weapontype: wrestling
        ...
        local done=AddDropItem(68,1,20,(100*math.random(6,7)+math.random(66,77)),0,3); --ruby ring
        if not done then done=AddDropItem(279,1,10,(100*math.random(6,7)+math.random(66,77)),0,3); end --bluestone ring
        if not done then done=AddDropItem(282,1,1,(100*math.random(6,7)+math.random(66,77)),0,3); end --topaz ring
        if not done then done=AddDropItem(278,1,1,(100*math.random(6,7)+math.random(66,77)),0,3); end --blackstone ring
        if not done then done=AddDropItem(281,1,1,(100*math.random(6,7)+math.random(66,77)),0,3); end --emerald ring
    ...
    elseif (MonID==182) then --Small Rotworm, Level: 6, Armourtype: -, Weapontype: wrestling
        ...
        local done=AddDropItem(251,1,20,(100*math.random(5,6)+math.random(55,66)),0,1); --raw amethyst
        if not done then done=AddDropItem(256,1,10,(100*math.random(5,6)+math.random(55,66)),0,1); end --raw emerald
        ...
        local done=AddDropItem(197,1,20,(100*math.random(5,6)+math.random(55,66)),0,2); --amethyst
        if not done then done=AddDropItem(45,1,10,(100*math.random(5,6)+math.random(55,66)),0,2); end --emerald
        ...
        local done=AddDropItem(277,1,20,(100*math.random(5,6)+math.random(55,66)),0,3); --amethyst ring
        if not done then done=AddDropItem(281,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --emerald ring
    ...
    elseif (MonID==183) then --Stoneworm, Level: 7, Armourtype: -, Weapontype: wrestling
        ...
        local done=AddDropItem(281,1,20,(100*math.random(6,7)+math.random(66,77)),0,3); --emerald ring
    ...
    elseif (MonID==184) then --Agressive Rotworm, Level: 7, Armourtype: -, Weapontype: wrestling
        ...
        local done=AddDropItem(257,1,20,(100*math.random(6,7)+math.random(66,77)),0,1); --raw topaz
        if not done then done=AddDropItem(253,1,10,(100*math.random(6,7)+math.random(66,77)),0,1); end --raw bluestone
        ...
        local done=AddDropItem(198,1,20,(100*math.random(6,7)+math.random(66,77)),0,2); --topaz
        if not done then done=AddDropItem(284,1,10,(100*math.random(6,7)+math.random(66,77)),0,2); end --bluestone
        ...
        local done=AddDropItem(282,1,20,(100*math.random(6,7)+math.random(66,77)),0,3); --topaz ring
        if not done then done=AddDropItem(279,1,10,(100*math.random(6,7)+math.random(66,77)),0,3); end --bluestone ring
    ...
    elseif (MonID==185) then --Giant Earthworm, Level: 8, Armourtype: -, Weapontype: wrestling
        ...
        local done=AddDropItem(254,1,20,(100*math.random(7,8)+math.random(77,88)),0,1); --raw diamond
        if not done then done=AddDropItem(252,1,10,(100*math.random(7,8)+math.random(77,88)),0,1); end --raw blackstone
        ...
        if not done then done=AddDropItem(253,1,1,(100*math.random(7,8)+math.random(77,88)),0,1); end --raw bluestone

        --Category 2: Special loot

        local done=AddDropItem(285,1,20,(100*math.random(7,8)+math.random(77,88)),0,2); --diamond
        if not done then done=AddDropItem(283,1,10,(100*math.random(7,8)+math.random(77,88)),0,2); end --blackstone
        ...
        if not done then done=AddDropItem(278,1,10,(100*math.random(7,8)+math.random(77,88)),0,3); end --blackstone ring
