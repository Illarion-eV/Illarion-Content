...
function enemyNear(Monster,Enemy)
    ...
    if (MonID==13) then
        return ( monster.base.monstermagic.CastLargeAreaMagic(Monster, {1000, 2000}, {35, 50}) or monster.base.monstermagic.SuddenWarp(Monster, Enemy) or monster.base.drop.CastMonMagic(Monster,Enemy,7,{1000,2000},{{36,5}},{},40,1,{35,50}) );
    else
        return false
    end
end
...
function enemyOnSight(Monster,Enemy)
    ...
    elseif (MonID==13) then
		return ( monster.base.monstermagic.CastLargeAreaMagic(Monster, {1000, 2000}, {35, 50}) or monster.base.drop.CastMonMagic(Monster,Enemy,4,{1000,2000},{{37,5}},{},40,1,{35,50}) or monster.base.monstermagic.CastHealing( Monster, {1000, 2000}) );
    else
        return false
    end
end
