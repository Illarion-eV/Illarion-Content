...
function M.enemyNear(Monster,Enemy)
    ...
    if (MonID==13) then
        return ( monstermagic.CastLargeAreaMagic(Monster, {1000, 2000}, {35, 50}) or monstermagic.SuddenWarp(Monster, Enemy) );
    else
        return false
    end
end
...
function M.enemyOnSight(Monster,Enemy)
    ...
    elseif (MonID==13) then
		return ( monstermagic.CastLargeAreaMagic(Monster, {1000, 2000}, {35, 50}) or monstermagic.CastFireball(Monster, Enemy, {1000, 2000}, {35, 50}) or monstermagic.CastHealing( Monster, {1000, 2000}) );
    else
        return false
    end
end
...
function M.onDeath(Monster)
    ...
    if (MonID==11) then --Dwarf, Level: 5, Armourtype: medium, Weapontype: slashing
        ...
        if not done then done=drop.AddDropItem(192,1,100,(100*math.random(4,5)+math.random(44,55)),0,3); end --coppered battleaxe
    ...
    elseif (MonID==15) then --Dwarven Hunter, Level: 5, Armourtype: light, Weapontype: distance
        ...
        if not done then done=drop.AddDropItem(2708,1,1,(100*math.random(4,5)+math.random(44,55)),0,3); end --longbow
