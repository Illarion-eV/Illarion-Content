...
function enemyOnSight(Monster,Enemy)
    ...
    elseif (MonID==13) then
        return (( monster.base.drop.ThrowMolotov(Monster,Enemy,2,50) and monster.base.drop.HitChar(Posi,Hitpoints) or monster.base.drop.CastLargeAreaMagic(Monster,10,3,{37,0},{1000, 2000},8,{36,5},60,{35,50} ) );
