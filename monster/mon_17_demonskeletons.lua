...
base.messages.msgs:addMessage("Die Toten dulden keine Lebenden in ihrer Mitte. Die Strafe für euer Eindringen ist der Tod.", "The undead shall not allow the living to dwell here. The punishment for such insolence shall be death!");
base.messages.msgs:addMessage("Die Toten verlangen nach frischem Blut. Deinem Blut!", "The undead demand fresh blood, your blood!");
base.messages.msgs:addMessage("Es ist gut das ihr hier seid, Sterblicher. Die Stimmung hier war irgendwie tot.", "It's good that you are here, mortal. Now you can entertain me.");
base.messages.msgs:addMessage("Selbst wenn du meinen Körper zerschlägst, werde ich zurück kommen. Wie ist es bei dir?", "Even if you destroy my body, I will return. How about you?");
base.messages.msgs:addMessage("Wie tötet man etwas was schon tot ist? Das hättest du dir eher überlegen sollen!", "How do you expect to kill something that is already dead? You should have thought about that earlier!");
...
base.messages.msgs:addMessage("#mes schreckliche Aura zerstört das natürliche Gleichgewicht. Jene, denen die höheren, geistigen Ebenen offen stehen, spüren vielleicht seine ruchlose Gier.", "#me's unholy aura corrupts the natural balance, even those oblivious to the ethereal planes might sense its heinous lust.");
base.messages.msgs:addMessage("#mes Durst nach Zerstörung ist unerbittlich, und so benutzt es seine höllische Macht um seine verderbliche Wut zu entfesseln.", "#me is unrelenting in its thirst for destruction, using its infernal powers to unleash its baleful wrath.");
base.messages.msgs:addMessage("#mes Knochen krachen und knirschen bedrohlich mit jeder lebhaften Bewegung.", "#me's bones grind and crack ominously with its animated movements.");
base.messages.msgs:addMessage("#mes teuflisch gerötete Knochen tropfen von geronnenem Blut während ein abscheulicher Gestank die Luft vergiftet.", "#me's fiendishly reddened bones drip with clotted blood as an abhorrent stench pollutes the air.");
base.messages.msgs:addMessage("#me bewegt seinen deformierten Unterkiefer als wolle es sprechen, aber stattdessen rasselt ein beunruhigendes Krachen durch die Luft.", "#me moves its mangled jaw as if to speak, but instead an unsettling crackle rattles through the air.");
base.messages.msgs:addMessage("#me weicht wie in Trance erstarrt aus, niemals zögerlich oder locker, sein einziges Ziel ist es die zerstörerische Gier zu befriedigen.", "#me manoeuvres in a rigid trance, never hesitant or lax, its only purpose is to devour.");
base.messages.msgs:addMessage("#me beugt sich in verwirrtem Irrsinn nieder, all sein Können benutzend um in elendem Zorn Leben zu verschlingen.", "#me bears down with a deranged frenzy using everything in its répertoire to consume life in its blighted rage.");
base.messages.msgs:addMessage("#mes scheinbar zerbrechliches Äußeres stellt sich als täuschend heraus, verschleiert es doch die tatsächliche Macht der schwarzen Magie, die das Skelett umgibt, auf verräterische Weise.", "#me's seemingly fragile exterior proves to be deceiving as he mutters words of black magic.");
base.messages.msgs:addMessage("#me streift eine lästige Sammlung blutverkrusteter, ineinander verwickelter Ketten über seine Schultern und seinen Oberkörper.", "#me drags a cumbersome set of blood encrusted chains that intertwine around its shoulders and torso.");
base.messages.msgs:addMessage("#me zischt erbost: 'Ich bin nicht auferstanden, um mir von euch erneut ein Ende bereiten zu lassen. Sterbt!'", "#me hisses in fury: 'I did not rise from the dead just to get finished off by you. Die!'");
base.messages.msgs:addMessage("#me lacht mit krachenden Kiefern und kleine Flammen züngeln aus seinen Augenhöhlen.", "#me laughs with snapping jaw, small flames glowing from its eyeholes.");
base.messages.msgs:addMessage("Du kannst mich nicht bezwingen, das vermochte nicht einmal der Tod zu erreichen.", "You will not succeed in what death failed in.");
base.messages.msgs:addMessage("Ich werde dich töten, Sterblicher, auf dass du die Qualen erleiden mögest, die ich durchgestanden habe!", "I will slay you, mortal, for you shall suffer as I did.");
base.messages.msgs:addMessage("#me schnarrt drohend und dreht den Kopf von einer Seite zur anderen.", "#me snares evilly and turns its head from side to side.");
base.messages.msgs:addMessage("#me kreischt hysterisch mit schriller Stimme 'Na los, erlöse mich von meinem unseligen Dasein!'.", "#me screams in a shrill voice: 'Come on, relive me from my puny existance!'.");
...
base.messages.msgs:addMessage("Geht in die Knie, Sterblicher, und ich werde euch vielleicht verschonen… vielleicht werd ich euer Ende aber auch nur schneller bereiten!", "Kneel down, mortal, and I will spare you... or just make the end approach faster.");
base.messages.msgs:addMessage("#me krächzt verworren: 'Du dachtest, du hättest mich erledigt. Das wirst du nun büßen!'", "#me croaks abstrusely: 'You thought you were done with me. You shall regret this!'");
base.messages.msgs:addMessage("#me flüstert lockend: 'Begib dich in Cherga's Umarmung und werde einer von uns…'.", "#me whispers alluringly: 'Embrace Cherga and become one of us…'.");
