...
magic.addFireball{probability = 0.05, damage = {from = 1000, to = 1500}}
magic.addFireball{probability = 0.005, damage = {from =  500, to = 1000}, targetCount = 3}

magic.addVioletFlame{probability = 0.005, damage = {from = 1200, to = 2000}}
magic.addVioletFlame{probability = 0.002, damage = {from = 650, to = 1200}, targetCount = 3}
