...
magic.addSummon{probability = 0.045, monsters = {113, 111, 112}} -- summon simple skeltons
magic.addSummon{probability = 0.008, monsters = {741, 754, 751}} -- surprise spawn. Stronger skeletons
