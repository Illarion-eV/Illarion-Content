...
function M.enemyOnSight(Monster,Enemy)
    ...
    elseif (MonID==115) then
        return ( monstermagic.CastHealing( Monster, {1500,3000}) or drop.CastMonMagic(Monster,Enemy,5,{1000,1700},{{4,5},{9,5},{51,5}},{},40,1,{25,65}));
    else
        return false
    end
...
function M.onDeath(Monster)
    ...
    elseif (MonID==113) then --Armored Skeleton, Level: 4, Armourtype: heavy, Weapontype: puncture
        ...
        local done=drop.AddDropItem(2290,1,20,(100*math.random(3,4)+math.random(33,44)),0,1); --round steel hat
        if not done then done=drop.AddDropItem(2112,1,10,(100*math.random(3,4)+math.random(33,44)),0,1); end --short blue steel greaves
        if not done then done=drop.AddDropItem(2364,1,1,(100*math.random(3,4)+math.random(33,44)),0,1); end --albarian steel plate
        ...
        local done=drop.AddDropItem(1317,1,20,(100*math.random(3,4)+math.random(33,44)),0,2); --bottle
        if not done then done=drop.AddDropItem(255,1,10,(100*math.random(3,4)+math.random(33,44)),0,2); end --raw rubies
        if not done then done=drop.AddDropItem(257,1,1,(100*math.random(3,4)+math.random(33,44)),0,2); end --raw topaz
        ...
        if not done then done=drop.AddDropItem(189,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --dagger
    ...
    elseif (MonID==114) then --Crippled Skeleton, Level: 2, Armourtype: light, Weapontype: slashing
        ...
        local done=drop.AddDropItem(314,1,20,(100*math.random(1,2)+math.random(11,22)),0,2); --potash
    ...
    elseif (MonID==117) then --Weakened Lich
        ...
        if not done then done=drop.AddDropItem(279,1,10,(100*math.random(7,8)+math.random(77,88)),0,2); end --sapphire ring
        if not done then done=drop.AddDropItem(314,1,1,(100*math.random(7,8)+math.random(77,88)),0,2); end --potash
        ...
        local done=drop.AddDropItem(209,1,20,(100*math.random(7,8)+math.random(77,88)),0,3); --battle staff
        if not done then done=drop.AddDropItem(1044,1,10,(100*math.random(7,8)+math.random(77,88)),0,3); end --ornate mage's staff
        if not done then done=drop.AddDropItem(2551,1,1,(100*math.random(7,8)+math.random(77,88)),0,3); end --pure air
