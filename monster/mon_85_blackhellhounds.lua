...
if (MonID==851) then --Shadowrunner, Level: 5, Armourtype: light, Weapontype: distance
        ...
        if not done then done=drop.AddDropItem(67,1,1,(100*math.random(4,5)+math.random(44,55)),0,3); end --rubin amulet
    ...
    elseif (MonID==852) then --Shadowfright, Level: 6, Armourtype: midium, Weapontype: slashing
        ...
        if not done then done=drop.AddDropItem(198,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --topaz
    ...
    elseif (MonID==853) then --Giant Shadowrunner, Level: 7, Armourtype: heavy, Weapontype: concussion
        ...
        if not done then done=drop.AddDropItem(82,1,1,(100*math.random(6,7)+math.random(66,77)),0,3); end --obsidian amulet
