...
if (MonID==881) then --Bloodhunter, Level: 2, Armourtype: cloth, Weapontype: concussion
        ...
        local done=drop.AddDropItem(63,1,20,(100*math.random(1,2)+math.random(11,22)),0,1); --entrails
        if not done then done=drop.AddDropItem(254,1,10,(100*math.random(1,2)+math.random(11,22)),0,1); end --raw diamonds
        if not done then done=drop.AddDropItem(83,1,1,(100*math.random(1,2)+math.random(11,22)),0,1); end --topas amulet
        if not done then done=drop.AddDropItem(283,1,1,(100*math.random(1,2)+math.random(11,22)),0,1); end --obsidian
        ...
        if not done then done=drop.AddDropItem(285,1,10,(100*math.random(1,2)+math.random(11,22)),0,2); end --diamond
        ...
        local done=drop.AddDropItem(284,1,20,(100*math.random(1,2)+math.random(11,22)),0,3); --sapphire
        if not done then done=drop.AddDropItem(46,1,10,(100*math.random(1,2)+math.random(11,22)),0,3); end --ruby
    ...
    elseif (MonID==882) then --Monstrosity, Level: 3, Armourtype: light, Weapontype: puncture
        ...
        if not done then done=drop.AddDropItem(257,1,10,(100*math.random(2,3)+math.random(22,33)),0,1); end --raw topaz
        if not done then done=drop.AddDropItem(46,1,1,(100*math.random(2,3)+math.random(22,33)),0,1); end --ruby
        if not done then done=drop.AddDropItem(198,1,1,(100*math.random(2,3)+math.random(22,33)),0,1); end --topaz
        if not done then done=drop.AddDropItem(359,1,1,(100*math.random(1,1)+math.random(11,11)),0,1); end --flame

        --Category 2: Gems

        local done=drop.AddDropItem(198,1,20,(100*math.random(2,3)+math.random(22,33)),0,2); --topaz
        if not done then done=drop.AddDropItem(45,1,10,(100*math.random(2,3)+math.random(22,33)),0,2); end --emerald
        ...
        if not done then done=drop.AddDropItem(284,1,10,(100*math.random(2,3)+math.random(22,33)),0,3); end --sapphire
        ...
        if not done then done=drop.AddDropItem(83,1,1,(100*math.random(2,3)+math.random(22,33)),0,3); end --topaz amulet
    ...
    elseif (MonID==883) then --Bloodsniffer, Level: 4, Armourtype: light, Weapontype: slashing
        ...
        if not done then done=drop.AddDropItem(197,1,10,(100*math.random(3,4)+math.random(33,44)),0,2); end --amethyst
        ...
        if not done then done=drop.AddDropItem(283,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --obsidian
