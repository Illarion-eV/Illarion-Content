...
magic.addFirecone{probability = 0.05, damage = {from = 1250, to = 1400}, range = 6, angularAperture = 30,
    itemProbability = 0.08, quality = {from = 0, to = 1}}
magic.addFirecone{probability = 0.005, damage = {from = 1300, to = 1700}, range = 3, angularAperture = 30,
    itemProbability = 0.08, quality = {from = 1, to = 2}}
