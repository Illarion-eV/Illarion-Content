...
if (MonID==301) then --Stone Golem, Level: 4, Armourtype: light, Weapontype: concussion
        ...
        local done=drop.AddDropItem(735,1,20,(100*math.random(3,4)+math.random(33,44)),0,3); --raw stone
        if not done then done=drop.AddDropItem(733,1,10,(100*math.random(3,4)+math.random(33,44)),0,3); end --stone block
        if not done then done=drop.AddDropItem(22,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --iron ore
        if not done then done=drop.AddDropItem(2536,1,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --copper ore
        if not done then done=drop.AddDropItem(1266,10,1,(100*math.random(3,4)+math.random(33,44)),0,3); end --stone
    ...
    elseif (MonID==302) then --Son of the Mountains, Level: 9, Armourtype: medium, Weapontype: concussion
        ...
        if not done then done=drop.AddDropItem(252,1,10,(100*math.random(8,9)+math.random(88,99)),0,1); end --raw obsidian
        ...
        if not done then done=drop.AddDropItem(253,1,1,(100*math.random(8,9)+math.random(88,99)),0,1); end --raw sapphire
        ...
        if not done then done=drop.AddDropItem(2551,1,1,(100*math.random(8,9)+math.random(88,99)),0,3); end --pure air
        if not done then done=drop.AddDropItem(2552,1,1,(100*math.random(8,9)+math.random(88,99)),0,3); end --pure earth
