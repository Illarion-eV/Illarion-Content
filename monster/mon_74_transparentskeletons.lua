...
function onSpawn(Monster)
	...
	if MonID == 743 then --Keeper of Fire
...
function onDeath(Monster)
    ...
    if (MonID==741) then --Phantom Skeleton, Level: 5, Armourtype: heavy, Weapontype: slashing
        ...
        if not done then done=monster.base.drop.AddDropItem(252,1,10,(100*math.random(4,5)+math.random(44,55)),0,1); end --raw obsidian
    ...
    elseif (MonID==743) then --Bone Ghost, Level: 7, Armourtype: heavy, Weapontype: puncture
        ...
        if not done then done=monster.base.drop.AddDropItem(314,1,1,(100*math.random(6,7)+math.random(66,77)),0,2); end --potash
        ...
        if not done then done=monster.base.drop.AddDropItem(27,1,10,(100*math.random(6,7)+math.random(66,77)),0,3); end --obsidian ring
