...
--    Körper drehen, Schritte machen
	  ...
	  if Runde - (math.floor(Runde/30)*30) == 0 then
		if paranoiaList == nil then
			...
			paranoiaList[1][7] = "Eine dunkle Wolke bildet sich direkt über deinen Kopf. Spannung liegt in der Luft. Mit einem Mal schießen Blitze aus der Wolke und treffen den Boden um dich herum. Flieh, bevor du zu Asche wirst!";
...
-- Standard: jede 10. Runde:
   if Runde -(math.floor(Runde/10)*10) == 0 then
      if math.random(6) == 6 then
         base.common.InformNLS(Character,
			"#w Du hast das Gefühl, dein Organe würden brennen.",
