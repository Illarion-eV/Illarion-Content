...
module("druids.base.plants", package.seeall)
		...
		dummyNameListDE = {}
		dummyNameListEN = {}		
		dummyNameListDE[1] = "Einbl�ttrige Vierbeere";		-- Sonnenkraut
		dummyNameListDE[2] = "Blaue Vogelbeere";			-- Vierbl�ttrige Einbeere
		dummyNameListDE[3] = "Schwefelkraut";				-- Gelbkraut
		dummyNameListDE[4] = "Frommbeere";					-- Wutbeere
		dummyNameListDE[5] = "Wasserbl�te";					-- Flamkelchbl�te
		dummyNameListDE[6] = "Tagteufel";					-- Nachtengelsbl�te
		dummyNameListDE[7] = "Rauchblatt";					-- Donfblatt
		dummyNameListDE[8] = "Graue Distel";				-- Schwarze Distel
		dummyNameListDE[9] = "W�stenbeere";					-- Sandbeere
		dummyNameListDE[10] = "Altweiberkraut";				-- Jungfernkraut
		dummyNameListDE[11] = "Regenkraut";					-- Heidebl�te
		dummyNameListDE[12] = "Gottesblume";				-- W�stenhimmelskapsel
		dummyNameListDE[13] = "Feuerwurz";					-- Lebenswurz
		dummyNameListDE[14] = "Trugbl�te";					-- Firnisbl�te
