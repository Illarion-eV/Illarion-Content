...
module("druids.items.131_book_letter", package.seeall())

-- UPDATE common SET com_script='druids.items.131_book_letter' WHERE com_itemid = 131;
...
--User:inform("debug 129-1")
    if base.books.InitBook() then
        ...
        base.books.AddGermanBookText("Es liegt nun einige Jahre zurück, als das Kloster Eldan auf Gobaith im Rahmen einer kriegerischen Auseinandersetzung angegriffen, geplündert und gebrandschatzt wurde.",0,0,0);
        base.books.AddGermanBookText("Ich war damals noch ein junger Mann, erst wenige Monate zuvor der Bruderschaft beigetreten und ohne viel Wissen um die uns in dieser Welt umgebenden Kräfte.",0,0,0);
        base.books.AddGermanBookText("Der Abt des Klosters, Falk vom Wald, erkannte wohl, dass die wenigen Mönche einem massiven Angriff nicht würden standhalten können. Deshalb schickte uns der Alte weg, zwang uns zur Flucht und dazu, ihn alleine zurückzulassen. Widerwillig haben wir uns damals gefügt und in alle Winde zerstreut. Mich führte das Schicksal an die Gestade des Festlandes, wo ich in aller Zurückgezogenheit eine geraume Zeit lebte.",0,0,0);
        base.books.AddGermanBookText("Dort erreicht mich seinerzeit auch die Nachricht von der Niederlegung des Klosters. Vom Alten gab es damals keine einzige Spur. Wiederum einige Zeit später erreichte mich die Nachricht, das Klostergebäude sei wieder aufgebaut worden und werde seitdem von seinen neuen Besitzern bewohnt. Nie wieder wollte ich an diesen Ort zurückkehren, ich blieb auf dem Festland, legte mein Mönchsgelübde nieder und erlernte den Beruf eines Zimmermanns.",0,0,0);
        base.books.AddGermanBookText("Vor nicht allzu langer Zeit erhielt mein Meister, in dessen Dienste als Geselle ich nach meiner Lehrzeit eingetreten war, aus Gobaith den Auftrag, die seit der Brandlegung unzugänglichen Gewölbekeller des Klosters  freizulegen und zu restaurieren. So führte mich das Schicksal erneut zum Ort meiner Novizenschaft, wir begannen mit den Arbeiten, die sich als schwierig und zeitraubender als gedacht erwiesen.",0,0,0);
        base.books.AddGermanBookText("Bei diesen Arbeiten stießen wir auf die Reste eines Raumes, dessen Eingang wir zunächst nicht lokalisieren konnten. Wie sich herausstellte, war die Tür entfernt und durch eine massive Mauer ersetzt worden.",0,0,0);
        base.books.AddGermanBookText("Durch den Feuersturm, der auf die Plünderung des Klosters gefolgt sein muss, war die Decke des Gewölbe in Teilen eingestürzt und hatte das Inventar des geheimen Raumes teilweise unter sich begraben. Diesem Umstand ist es wohl zuzuschreiben, dass die Kammer bis zu unserer Ankunft unentdeckt geblieben war.",0,0,0);
        base.books.AddGermanBookText("Mit großer Vorsicht entfernten wir Schutt und Trümmerteile, bis es uns gelang, die wenigen unversehrten Stellen freizulegen. Der Raum hatte wohl dem Kloster als geheimes Experimentarium gedient, ich erinnere mich vage an Gerüchte, die zur Zeit meiner Novizenschaft unter den Brüdern die Runde machten, wonach der Abt des nachts über eine Wendeltreppe in seiner Turmkammer schleiche, in einen für andere Mönche unzugänglichen Bereich, wo er sich seinen Studien der Alchemie widme. Offenbar hatten wir dieses verborgene Labor entdeckt.",0,0,0);
        base.books.AddGermanBookText("Neben allerlei zerbrochenen Behältern, verrosteten Werkzeugen und etlichem undefinierbaren Unrat fanden wir auch einige Fässer mit einem unbekanntem Inhalt, die wir unversehrt bergen konnten. Zusammen mit einigen wenigen alten Büchern, allesamt angelegt in mir nicht bekannter Sprache, haben wir diese Fässer zum nahen Ordenshaus der Druiden geschafft. Der Abt hatte uns stets von seiner Freundschaft zu den Druiden berichtet, so dass ich denke, Ihr Ehrenwerten werdet mit dem Fund etwas anzufangen wissen.",0,0,0);
        base.books.AddGermanBookText("Ganz in einer Nische verborgen mussten wir schließlich auch die sterblichen Überreste eines älteren Menschen in Mönchsgewand bergen. Ich hege kein Zweifel, dass es sich bei dem teilweise mumifizierten Leichnam um den des Abtes Falk vom Wald handelt. Nachdem die Mönche den Alten zurückgelassen und sich in Sicherheit gebracht hatten, muss sich der Abt in den Gewölbekeller begeben haben. Anhand der zahlreichen zerstörten Pergamente nehme ich an, dass er bemüht war, die wichtigsten Schriften des Klosters vor den Angreifern zu verbergen. Dazu schaffte er was er tragen konnte aus der einstmals so berühmten und reichen Bibliothek des Klosters in die Tiefe und Verborgenheit des geheimen Labors. Und so unglaublich es klingen mag, dort angekommen muss der Abt den Eingang eigenhändig zugemauert haben. Die Spuren deuten eindringlich darauf hin, dass sich der Unglückliche selbst eingemauert hatte und dort in tiefer Dunkelheit den Untergang erwartete. Die Umstände des Todes mögen dramatisch gewesen sein, es lässt sich nicht mit Sicherheit sagen, ob Falk vom Wald qualvoll verhungerte oder seinem Leben mit einem Gifttrank selbst ein Ende setzte. Die einstürzenden Mauern begruben dieses Geheimnis wohl für immer unter sich.",0,0,0);
        base.books.AddGermanBookText("Falk vom Wald hätte sich selbst in Sicherheit bringen müssen, stattdessen widmete er seine letzten Stunden der Rettung einiger Schriften, von denen ich nicht einmal sagen kann, ob sie denn überhaupt irgend ein interessanten Inhalt aufweisen. Wenn aber der Abt die Rettung der Bücher wichtiger als das eigene Leben achtete, so nehme ich an, er wusste um deren Bedeutung.",0,0,0);
        base.books.AddGermanBookText("Den Leichnam des Falk vom Wald haben mein Meister und ich in einem Sarg aus dem Holz der Eldaneiche niedergelegt. Wir bitten Euch, die Druiden des Waldes nun darum, dem Abt ein Andenken zu widmen und den Sarg beizusetzen. Sicherlich hätte sich der Alte sehr gewünscht, nicht allzuweit entfernt von seiner geliebten Heimat begraben zu sein, das Kloster hatte ihm stets viel bedeutet.",0,0,0);
        base.books.AddGermanBookText("Mich führt mein Weg indes zurück aufs Festland, nach der Errichtung des neuen Gewölbekellers gibt es für mich hier auf Gobaith nichts mehr zu tun.",0,0,0);
        base.books.AddGermanBookText("Mit dem Gruß unseres Abtes \'Eldan auf all Euren Wegen\' verbleibe ich in größter Hochachtung und wünsche dem Druidentum dieses Landes eine von Neuem erblühende Hochzeit. Mögen Euch die Götter den Weg weisen, so wie ihn der Alte in seinen Studien so lange Zeit zu ergründen und vorauszusehen suchte.",0,0,0);     
