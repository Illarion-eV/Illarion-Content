...
function UseItem(User, SourceItem, TargetItem, Counter, Param, ltstate)
      if base.books.InitBook() then
        ...
        base.books.AddEnglishBookText("Who has patience and fills his cruse up to the brim diligently, will soon be lavished in the spirit of druidism, just have a look into your rune-schedule, now you are a member of the circle of druids.",0,0,0);
