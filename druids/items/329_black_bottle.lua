...
module("druids.items.329_black_bottle", package.seeall(druids.base.alchemy))

-- UPDATE common SET com_script='druids.items.329_black_bottle' WHERE com_itemid = 329;
...
function UseItem(Character,SourceItem,TargetItem,Counter,Param)
  if SourceItem.data == 0 then
	return;
    -- vermutlich Tinte
  elseif SourceItem.data == 71796337 then
