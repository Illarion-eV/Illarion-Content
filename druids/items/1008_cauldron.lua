...
module("druids.items.1008_cauldron", package.seeall(druids.base.alchemy), package.seeall(items.general.metal))

-- UPDATE common SET com_script='druids.items.1008_cauldron' WHERE com_itemid = 1008;
