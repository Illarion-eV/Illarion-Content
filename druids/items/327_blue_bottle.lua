...
require("druids.base.missile")

module("druids.items.327_blue_bottle", package.seeall(druids.base.alchemy), package.seeall(druids.base.missile))

-- UPDATE common SET com_script='druids.items.327_blue_bottle' WHERE com_itemid = 327;
