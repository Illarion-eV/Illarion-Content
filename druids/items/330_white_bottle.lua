...
module("druids.items.330_white_bottle", package.seeall(druids.base.alchemy))

-- UPDATE common SET com_script='druids.items.330_white_bottle' WHERE com_itemid = 330;
