...
require("base.common")
module("druids.spells.05_quality_stock", package.seeall)

-- INSERT INTO spells VALUES (2^4,3,'druids.spells.05_quality_stock');
...
--     "#b|0|0|Dieser Sud hat eine "..qListDe[qualstat].." Qualit�t",
