...
module("druids.spells.01_analyze_plant", package.seeall(druids.base.alchemy), package.seeall(druids.base.plants))

-- INSERT INTO spells VALUES (2^0,3,'druids.spells.01_analyze_plant');
